...
D.npcs = {
  ...
  byungchul:{name:'병철', face:'🔨', role:'밀양 대장간', node:'miryang',
    ...
    greetGood:'어, 봉고차. 지난번 그 경첩 잘 붙어 있드나? 내 쇠는 안 떨어진다.',
  ...
  hwasun:  {name:'화순',  face:'🏹', role:'성벽 야간 순찰대장', node:'suwon',
    ...
    greetGood:'봉고차. 어젯밤 성벽에서 너희 차 지붕 잘 보였다. 물통 위치 바꿨더군. 관찰력이 늘었네, 하고 적어뒀다.',
...
{id:'prev_trace_shunned', type:'발견', w:0, noPool:true, once:true,
 ...
 choices:[{label:'표식을 지운다',
  out:[{p:1, text:'젖은 천으로 문질렀다. 차량 윤곽은 반쯤 남았지만 가위표는 지워졌다. 천에 파란 페인트가 묻어났다.',
