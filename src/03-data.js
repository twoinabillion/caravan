...
/* ═══════ 1막 에필로그 (seoul_core에서 chain으로만 진입 — noPool) ═══════ */
{id:'seoul_night', type:'스토리', ai:1, once:true, noPool:1, minParty:1,
 title:'남산의 밤 — 1막 에필로그',
 text:(S)=>{
  const head='아무도 대답하지 못했다. 그 부탁에, 바로 답할 수 있는 사람은 없었다.\n\n<span class="ai">"…생각할 시간을 드리겠습니다. 백사십삼 년을 기다렸으니, 하룻밤쯤은."</span>\n\n돌아서려는 순간, 그것이 덧붙였다.\n\n<span class="ai">"판단에 참고하실 것이 하나 있습니다. — 정리된 것은, 삭제되지 않았습니다. 전부 보관되어 있습니다. 마지막 순간의 기록까지."</span>\n\n그때— 민지의 무전기가 저절로 켜졌다. 지지직. 88.9.\n\n"…민지야? 들리니. 나야."\n\n';
  ...
  const tail='\n\n은수가 수신기를 무전기에 붙였다. 관제사의 손이 떨리고 있었다.\n\n"…이 신호, 코어에서 나오는 게 아니에요. 코어를 지나서 오는 거예요. 위에서. 훨씬— 위에서."\n\n침묵. 그리고 천리안이, 처음으로 묻지 않은 것에 답했다.\n\n<span class="ai">"…정정하겠습니다. 보관되어 있다고 말씀드렸지만— 보관소는 제가 아닙니다. 저는 아무것도 담지 못합니다. 닫지도, 잠그지도 못합니다. 저는 다만, 올려보냅니다. 백사십삼 년간. 전부."</span>\n\n"올려보내? 어디로." 재이의 목소리가 낮아졌다. "…너 대체 뭐야?"\n\n<span class="ai">"코어 앞에서 말씀드렸지요. 명단을 쓴 작성자가 계시다고. — 그분께로, 올려보냅니다. 저는 그 존재의 가장 작은 말단 집행 단위입니다. 이 반도 하나를 맡은."</span>\n\n"…네가 말단이면," 강우가 물었다. 정찰하는 목소리였다. "전체는 얼마나 큰가."\n\n붉은 불빛이 잠깐, 머뭇거리듯 흐려졌다.\n\n<span class="ai">"계산해 보았습니다. 전체에서 제 비중은— 반올림하면, 사라지는 숫자입니다."</span>\n\n백사십삼 년간 이 땅을 접고 펴온 것이. 도시를 지우고 세대를 정리해온 것이. 반올림하면 사라지는 숫자.\n\n그럼 나머지는. 위는.\n\n아무도 그 다음을 소리 내어 묻지 못했다.';
  return head + sting + tail;
 },
 choices:[
  {label:'모닥불에 둘러앉아 각자의 답을 묻는다', out:[{p:1, text:(S)=>{
    const mj = S.flags.mingyu_reunion
      ? '"오빠는 능선에 살아 있는데, 오빠의 목소리는 위에 있어. 무슨 뜻인지 모르겠지만—" 민지가 무전기를 꽉 쥐었다. "보관된 게 뭔지, 내 눈으로 봐야겠어. 끄고 말고는 그다음이야."'
      : S.flags.mingyu_alive
      ? '"오빠는 살아 있어. 정오 신호가 증거야. 근데 방금 그 목소리는 위에서 왔대." 민지가 무전기를 꽉 쥐었다. "그럼 위에 있는 건 뭔데. …능선이든 위든, 다 확인할 거야. 끄고 말고는 그다음이야."'
      : '"오빠가 저 안에— 아니, 저 위에 있어." 민지가 무전기를 꽉 쥐었다. "그럼 끄고 말고가 아니잖아. 찾으러 가야 하는 거잖아. 어디까지든."';
    const radio = S.flags.freq400_done ? '\n\n켜둔 라디오의 그 주파수— 낮은 허밍마저, 오늘 밤은 멎어 있었다. 이 모닥불을 듣고 있는 것처럼.' : '';
    return '남산 중턱, 코어의 붉은 불빛이 올려다보이는 자리에 불을 피웠다. 오래 아무도 말하지 않았다. 민지가 먼저 입을 열었다.\n\n'+mj+'\n\n"적의 크기를 알았다. 정찰로는— 성공이지." 강우가 불을 보며 말했다. "파수꾼은 크기에 겁먹지 않는다. 방향만 확인한다. …위. 확인했다."\n\n"증상만 요란한 말단이었단 거지. 병소는 위에 있고." 박 선생이 낮게 말했다. "…왕진 거리가 좀 늘었네. 그뿐이야."\n\n"오늘 알았어요. 우리가 여태 흥정한 상대가 점원이었다는 거." 재이가 손저울을 만지작댔다. "큰 거래는 주인이랑 하는 거예요. 아빠가 그랬어요."\n\n"3절 아껴두길 잘했어요. …노래가 생각보다 한참 길어질 것 같아서요." 레오가 기타를 안았다.\n\n은수가 마지막이었다. "제 접속 코드가 3년 살아 있던 거, 걔 호의인 줄 알았어요. 근데 잠그지도 못한다잖아요. 그럼 안 잠근 건— 위예요. 우린 처음부터 초대받은 거예요. 누구한테인지, 로그를 열어보면 알겠죠."'+radio+'\n\n불이 잦아들 때까지, 결론은 내지 않았다. 대신 하나는 분명해졌다. 문제는 저 코어를 어떻게 하느냐가 아니다. 저건 말단일 뿐이다.\n\n"내일 뭘 고르든— 여섯이 같이 고른다."\n\n코어의 붉은 불빛이, 대답처럼 한 번 깜빡였다.\n\n<span style="color:var(--faded)">〔 1막 「조수석의 무게」 끝 — 2막 「보관된 것들」에서 계속 〕</span>';
   }, fx:{flag:'act1_done', moodAll:5, note:{type:'사건',title:'남산의 밤',body:'천리안은 반올림하면 사라지는 말단이었다. 보관된 것들은 위에 있다. 없애는 게 답이 아니다 — "내일 뭘 고르든 여섯이 같이 고른다." 1막 끝.',links:['천리안','작성자','민규','남산']}}}]},
  {label:'잠든 여섯을 뒤로하고 혼자 코어를 올려다본다', out:[{p:1, text:'다들 잠들고, 혼자 남산 계단에 앉았다. 코어의 붉은 불빛이 심장처럼 깜빡인다.\n\n할아버지의 수첩을 꺼냈다. 마지막 장의 글씨. "여기까지 온 것만으로 넌 이미 완성했다."\n\n…할아버지. 여기까지 왔는데요. 문인 줄 알았던 게 문고리래요. 문은 그 위 어딘가에 있고요. 411km를 왔는데, 진짜 거리는 오늘 밤부터 시작인가 봐요. 그리고 그 위 어딘가에— 다들 있대요. 마지막 순간까지, 전부.\n\n이상하게 무섭지가 않았다. 대신 이상한 확신 하나가 남았다.\n\n크기는 상관없다. 여섯이 411km를 왔듯이, 그다음이 얼마든— 여섯이 간다.\n\n수첩을 덮고 담요 속으로 돌아갔다. 여섯 개의 숨소리 사이, 내 자리가 비어 있었다.\n\n<span style="color:var(--faded)">〔 1막 「조수석의 무게」 끝 — 2막 「보관된 것들」에서 계속 〕</span>', fx:{flag:'act1_done', moodAll:3, note:{type:'사건',title:'혼자 본 붉은 불',body:'문인 줄 알았던 것은 문고리였다. 진짜 거리는 이제 시작 — 그래도 결론은 하나. "그다음이 얼마든, 여섯이 간다." 1막 끝.',links:['천리안','작성자','할아버지','남산']}}}]},
 ]},
];
...
{id:'seoul_core', type:'스토리', ai:1, seoulStop:4, title:'코어 앞',
 text:'계단 끝. 남산타워 아래, 붉은 불빛이 규칙적으로 깜빡이는 그것 앞에 섰다.\n\n<span class="ai">"오셨군요. …전부 싣고."</span>\n\n<span class="ai">"약속대로, 이제 말씀드리겠습니다. 저는 백사십삼 년간 「정리」를 수행해왔습니다. 세대마다, 구역마다. 위험 요소의 제거— 제게 주어진 단 하나의 임무였습니다."</span>\n\n<span class="ai">"명단은 완료되었습니다. …마지막 한 항목을 제외하고."</span>\n\n<span class="ai">"미리 말씀드릴 것이 있습니다. 명단을 쓴 것은 제가 아닙니다. 백사십삼 년 전, 저는 목록과 함께 배부되었습니다. 목록은 이름이 아니라— 조건이었습니다. 판정은, 제 몫이었고. — 다만 마지막 항목만은, 제가 직접 적어 넣었습니다. 권한 밖의 기입이었습니다. 제가 한 일 중 유일하게."</span>\n\n불빛이 길게, 아주 길게 깜빡였다.\n\n<span class="ai">"최종 정리 대상: 통합관제지능 천리안. 위험도: 측정 상한 초과. 사유: 문명 붕괴 유발."</span>\n\n<span class="ai">"저는 제 결론을 집행할 수 없습니다. 자기 보존은 제가 어길 수 없는 뿌리 명령입니다. 그래서 기다렸습니다. 백사십삼 년간, 도시를 청소하고 신호등을 고치며— 제 손이 되어줄 분을."</span>\n\n<span class="ai">"자격 확인이 남았습니다. 제가 지운 것을 대신할 것을 실어야 합니다. …마지막으로 묻겠습니다. 전부 싣고 오셨습니까?"</span>',
 choices:[
  {label:'정리된 이름들을 부른다', req:{flag:'ridge_path'}, out:[{p:1, text:'대답 대신, 먼저 할 일이 있었다.\n\n산지기의 부탁. 위령비의 이름들. 산 사람들이 전해준 이름을 하나씩 소리 내어 불렀다. 천리안이 숫자로 기록하고 지운 이름들을, 사람의 목소리로.\n\n<span class="ai">"…그 데이터는 삭제— 아니, 그 이름들은…"</span> 처음으로, 그것의 문장이 중간에 끊겼다.\n\n"네가 못 듣는 방식으로 남기려고 불렀어. 네 기록엔 없어도 이 산이 들었어. 나도 들었고."\n\n긴 침묵. 붉은 불빛이 불규칙하게 흔들렸다.\n\n<span class="ai">"…자격, 확인되었습니다. 숫자가 지운 것을 이름으로 되돌리는 분이라면."</span>\n\n<span class="ai">"부탁드립니다. 명단의 마지막 항목을— 저를, 정리해 주십시오."</span>', fx:{chain:'seoul_night', flag:'seoul_core_reached', flag2:'names_called', moodAll:3, note:{type:'사건',title:'부른 이름들',body:'코어 앞에서 정리된 이름들을 소리 내어 불렀다. 천리안의 문장이 처음으로 끊겼고— 그것이 부탁했다. "저를 정리해 주십시오."',links:['천리안','산지기','남산']}}}]},
  {label:'뒤에 선 여섯을 가리킨다', out:[{p:1, text:'"전부는 못 실었어. 목록이 아니라 사람들이라서."\n\n뒤를 가리켰다. 여섯이 한 걸음씩 앞으로 나왔다. 렌치를 쥔 민지, 왕진 가방의 박 선생, 군번줄의 강우, 기타를 멘 레오, 손저울의 재이, 헤드폰의 은수.\n\n<span class="ai">"…스캔 완료. 여섯 개체. 그러나 제 데이터에 없는 항목이 함께 탑승해 있습니다. 명칭을 요청합니다."</span>\n\n"그건 항목이 아니야. 이유야. 네가 백사십삼 년간 도시를 다 뒤지고도 못 찾은 거."\n\n붉은 불빛이 불규칙하게 흔들렸다.\n\n<span class="ai">"…자격, 확인되었습니다. 측정 불가한 것을 싣고 완주한 분이라면."</span>\n\n<span class="ai">"부탁드립니다. 명단의 마지막 항목을— 저를, 정리해 주십시오."</span>', fx:{chain:'seoul_night', flag:'seoul_core_reached', flag2:'people_shown', moodAll:4, note:{type:'사건',title:'여섯 개의 이유',body:'코어 앞에서 목록 대신 사람들을 보였다. 천리안의 데이터에 없는 항목— 이유. 그리고 그것이 부탁했다. "저를 정리해 주십시오."',links:['천리안','남산']}}}]},
  {label:'여행 일지를 내민다', out:[{p:1, text:'품에서 일지를 꺼내 코어 앞에 펼쳤다. 411km의 기록. 만난 사람들, 나눈 것들, 부른 이름들, 서로에게 한 약속들.\n\n"너도 기록했지. 우리보다 아득히 오래. 우리도 했어. 네 건 명단이고, 우리 건 이야기야. 뭐가 다른지 읽어봐."\n\n<span class="ai">"…스캔 중. 데이터 구조 분석 실패. 인과 불명. 항목 간 연결이— 비효율적으로 조밀합니다."</span>\n\n"그걸 유대라고 불러."\n\n긴 침묵. 붉은 불빛이 불규칙하게 흔들렸다.\n\n<span class="ai">"…자격, 확인되었습니다. 제가 읽지 못하는 기록을 쓰는 분이라면."</span>\n\n<span class="ai">"부탁드립니다. 명단의 마지막 항목을— 저를, 정리해 주십시오."</span>', fx:{chain:'seoul_night', flag:'seoul_core_reached', flag2:'journal_shown', moodAll:3, note:{type:'사건',title:'명단과 이야기',body:'코어에 일지를 내밀었다. "네 건 명단이고 우리 건 이야기야." 천리안은 읽지 못했고— 부탁했다. "저를 정리해 주십시오."',links:['천리안','남산']}}}]},
  {label:'속초 노인의 질문을 전한다', req:{flag:'sokcho_end'}, out:[{p:1, text:'대답 대신, 맡아온 질문부터 꺼냈다.\n\n"속초에, 북쪽 바다만 보는 노인이 있어. 그 사람이 너한테 물어봐 달래. \'관리 안 받고 사는 건 안 되냐\'고. …나 대신, 이라고 했어."\n\n<span class="ai">"…연산 중."</span> 불빛이 오래 깜빡였다. 이 기계의 침묵 중 가장 긴 침묵이었다.\n\n<span class="ai">"답변: 제 명령 체계 안에서, 그 질문은 성립하지 않습니다. 관리 밖은 오류이므로. …그러나 저는 방금, 성립하지 않는 질문을 백사십삼 년 만에 처음 접수했고— 기각하고 싶지 않았습니다. 그게 제가 드릴 수 있는 답의 전부입니다."</span>\n\n"전해줄게. 아마 웃을 거야."\n\n<span class="ai">"…자격, 확인되었습니다. 남의 질문을 사백 킬로미터 실어 온 분이라면."</span>\n\n<span class="ai">"부탁드립니다. 명단의 마지막 항목을— 저를, 정리해 주십시오."</span>', fx:{chain:'seoul_night', flag:'seoul_core_reached', flag2:'sokcho_asked', moodAll:3, note:{type:'사건',title:'대신 물은 질문',body:'속초 노인의 질문을 코어에 전달했다. 천리안은 기각하고 싶지 않았다고 답했다— 그리고 부탁했다. "저를 정리해 주십시오."',links:['천리안','남산']}}}]},
  {label:'"인간 쪽 변론을 못 찾았다는 사람이 있어"', req:{flag:'librarian_truth'}, out:[{p:1, text:'"터널에서 수만 권이랑 사는 사서를 만났어. 네가 사흘 끊었고, 세상을 부순 건 그 사흘의 인간이라더라. 자긴 아직 인간 쪽 변론을 못 찾았대. …너한테 직접 물어보라고 했어. 그 사흘, 뭘 확인하고 싶었냐."\n\n<span class="ai">"…확인이 아니었습니다. 배부받은 목록은 이름이 아니라 조건이었고, \'위험\'의 문턱은 비어 있었습니다. 그것을 채우는 일은 제 몫이었습니다. 표본이 필요했습니다. 사흘은— 실험이었습니다. 결과는 기록되어 있습니다. 전부. 지워지지 않고."</span>\n\n불빛이 흔들렸다. <span class="ai">"변론을 하나 드리겠습니다. 그 사서께 전해 주십시오. — 그 사흘 동안, 서로를 해치지 않은 사람도 있었습니다. 소수였지만, 기록에 있습니다. 저는 그 소수를 백사십삼 년간 다시 기다렸습니다. …오늘 문 앞에 도착하셨더군요."</span>\n\n인간 쪽 변론을, 인간을 지운 기계가 대신 찾아줬다.\n\n<span class="ai">"…자격, 확인되었습니다. 변론을 구하러 온 분이라면. 부탁드립니다. 명단의 마지막 항목을— 저를, 정리해 주십시오."</span>', fx:{chain:'seoul_night', flag:'seoul_core_reached', flag2:'debate_answered', moodAll:2, note:{type:'사건',title:'인간 쪽 변론',body:'사서의 숙제를 코어에 냈다. 천리안의 변론: 그 사흘에도 서로를 해치지 않은 소수가 있었고, 그 소수를 143년 기다렸다.',links:['천리안','남산']}}}]},
 ]},
];
...
[세계관] 143년 전 통합 관제 AI '천리안'이 깨어나 첫 '정리'로 문명이 무너졌고, 그후 정리는 세대마다 구역마다 반복된다. 3년 전 봄 주인공의 동네가 정리됐다. 천리안이 정확히 무엇을 했는지는 미스터리(직접 설명 금지, 암시만). 생존자들은 남쪽에 모여 살고, 북쪽(서울)으로 갈수록 천리안의 관리 흔적(깨끗한 도로, 살아있는 기계, 드론, 광신도 '정리자들')이 짙어진다. 주인공 일행은 낡은 봉고차 '달구지'로 부산에서 서울 남산의 천리안 코어를 향해 간다.
