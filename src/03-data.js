...
{id:'rq_minji_task', type:'스토리', w:0, noPool:1, once:true,
 ...
 choices:[
  {label:'윈치로 장력을 잘게 나눈다', req:{up:'winch'}, out:[{p:1,text:'윈치가 한 칸씩 울 때마다 차 더미가 숨을 참는다. 민지가 손가락 둘을 접었다. 멈춤. 하나를 폈다. 당김.\n\n상자가 진흙 위로 빠져나온 순간, 뒤의 차 더미가 주저앉았다. 민지는 상자를 품에 안고 한동안 열지 못했다.\n\n지직— 잡음 뒤로 남자의 목소리. "민지야, 정오다. 살아 있으면 대답해."\n\n민지가 울다가 웃었다. "이제 출발해도 돼요."',fx:{time:45,van:2,recruitChoice:'winch',recruitRoad:'minji',note:{type:'사건',title:'무너지기 전의 목소리',body:'폐차장 차 더미 아래서 민규의 진단기와 마지막 정오 신호를 꺼냈다.',links:['민지','민규의 신호']}}}]},
  {label:'도르래를 만들고 사람 힘으로 맞춘다', req:{scrap:4}, out:[{p:1,text:'범퍼와 휠 허브로 도르래를 만들었다. 민지가 "하나, 둘"을 세고 우리는 줄을 당겼다. 셋은 말하지 않았다. 셋에 천장이 내려앉았으니까.\n\n상자는 마지막 한 뼘을 굴러 우리 발앞에 멈췄다. 안에서 남자의 녹음이 살아났다.\n\n"민지야, 정오다. 살아 있으면 대답해."\n\n민지가 상자에 이마를 댄다. "응. 이제 대답하러 갈 거야."',fx:{time:90,scrap:-4,van:-3,recruitChoice:'pulley',recruitRoad:'minji',note:{type:'사건',title:'무너지기 전의 목소리',body:'임시 도르래로 민규의 진단기를 구했다. 민지는 이제 신호의 북쪽 끝을 찾아갈 수 있다.',links:['민지','민규의 신호']}}}]},
  {label:'차를 방패로 붙이고 짧게 당긴다', out:[{p:1,text:'달구지를 차 더미 바로 앞에 세웠다. 민지가 보닛을 한 번 쓰다듬는다. "미안. 조금 아플 거야."\n\n견인선이 팽팽해지고, 철판 하나가 적재칸을 긁으며 떨어졌다. 상자는 나왔다. 차체엔 긴 흉터가 남았다.\n\n녹음 속 목소리가 말했다. "살아 있으면 대답해." 민지가 우리 차의 흉터를 보며 대답했다. "둘 다 살아 있어."',fx:{time:50,van:-12,recruitChoice:'shield',recruitRoad:'minji',note:{type:'사건',title:'무너지기 전의 목소리',body:'달구지에 흉터를 남기고 민규의 마지막 정오 신호를 구했다.',links:['민지','민규의 신호','달구지']}}}]},
 ]},
{id:'rq_minji_follow', type:'스토리', w:0, noPool:1, once:true,
 ...
 choices:[
  {label:'녹음을 끝까지 함께 듣는다', out:[{p:1,text:'신호는 생각보다 짧았다. 마지막엔 목소리도 없고, 민규가 책상을 두드리는 소리만 열세 번 남았다.\n\n민지는 열세 번째까지 세고도 진단기를 끄지 못한다.\n\n"지금 답해도 너무 늦었죠?"\n\n"그래도 들을 사람은 있잖아요."\n\n민지가 코를 훔친다. "그 말, 내일 바꾸면 진짜 화낼 거예요."',fx:{time:45,moodAll:4,recruitReady:'minji',chain:'rq_minji_join',note:{type:'사건',title:'정오의 대답',body:'민지와 민규의 저장된 정오 신호를 끝까지 들었다. 늦은 대답도 들을 사람이 있으면 시작할 수 있었다.',links:['민지','민규의 신호']}}}]},
