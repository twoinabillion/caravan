...
{id:'gp_note1', type:'동행', w:7, once:true,
 ...
 choices:[
  {label:'수첩대로 엔진 소리를 듣는다', out:[{p:1, text:'시동을 켠 채 5분을 들었다. 할아버지가 가르쳐준 순서대로.\n\n벨트 텐션이 반 바퀴 어긋난 걸 잡아냈다. 수첩은 오늘도 정비사다.\n\n…그리고 차 안이 유난히 조용한 사람이 없는지, 한 명씩 돌아봤다.', fx:{van:5, moodAll:3, note:{type:'사건',title:'수첩 — 접힌 페이지',body:'"기계는 아프면 운다. 사람은 조용해진다." 벨트를 잡았고, 수첩을 오래 봤다.',links:['할아버지']}}}]},
 ]},
...
{id:'exp_chalkwall', minParty:1, type:'탐색', w:7, once:true,
 title:'소식벽',
...
{id:'exp_pool', minParty:1, type:'탐색', w:6, needRain:true,
 title:'실내 수영장',
...
{id:'exp_artshop', minParty:1, type:'탐색', w:6, once:true,
 title:'화방',
...
{id:'exp_selfwash', minParty:1, type:'탐색', w:6, once:true,
 title:'셀프 세차장',
