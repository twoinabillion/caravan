...
D.comps = {
  ...
  kangwoo:{name:'강우',   face:'🪖', cls:'파수꾼', role:'파수꾼 · 34', color:'#a8c69a',
    bio:'말이 없다. 오래전 "그날" 서울에 있었다. 서울 얘기가 나오면 창밖만 본다.',
    perk:'전투 · 위협 감지 · 매복 회피',
    perks:{
  ...
  jaeyi:  {name:'재이',   face:'🎒', cls:'수집꾼', role:'수집꾼 · 22', color:'#b8e090',
    bio:'고물 리어카 하나로 여러 해를 버텼다. "쓰레기란 말은 상상력 부족이에요." 까치처럼 반짝이는 걸 모은다.',
    perk:'이벤트 고철 수확 +30%',
    perks:{
...
/* 네 기둥 — 어느 하나도 건너뛸 수 없다. 관계=6명 전원 개인 서사 Lv3 */
 D.seoulPillars = { 세계:3, 진실:3, 유산:2 };   // 저항 3 + 추방의 실상·작성자·상행선 3 + 회수 2 (+관계 6명 Lv3)
D.deeds = [
...
{id:'es_backdoor', type:'추적', w:14, once:true, region:['north'], needsComp:'eunsu', needFlag:'es_backdoor_ready',
 ...
 choices:[
  {label:'"서울에서 사람들을 왜 쫓아냈나"', out:[{p:1, text:'3초의 침묵. 그리고 응답.\n\n<span class="ai">"답변: 배부받은 조건 목록을 이 구역에 집행했습니다. 목록의 작성자는 제가 아닙니다."</span>\n\n<span class="ai">"추방의 이유를 묻는 질의는 제 권한 밖입니다. 관측 기록은 삭제하지 않았습니다. 남산을 거쳐 상위 배부처로 전송했습니다. 저는 보관소가 아닙니다."</span>\n\n채널이 끊겼다. 은수가 상행 로그를 저장했다. 작성자가 있고, 천리안은 그 아래에 있다. 이유는 아직 비어 있다.', fx:{flag:'es_truth', flag2:'uplink_seen', pursuit:1, moodAll:-4, mood:{eunsu:10}, note:{type:'사건',title:'백도어 — 작성자와 상행선',body:'천리안은 목록을 배부받은 지역 집행자였다. 서울에서 사람들을 쫓아낸 이유는 상위 배부처에도 남아 있지 않다. 관측 기록은 상행선으로 전송된다.',links:['은수','천리안','작성자']}}}]},
