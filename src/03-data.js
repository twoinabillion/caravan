...
{id:'ev_karaoke', type:'사건', w:6, minParty:1, region:['south','mid','north'],
 ...
 choices:[
  ...
  {label:'레오의 애창곡을 듣는다', req:{comp:'leo'}, out:[
    {p:1, text:'레오가 마이크를 잡자 분위기가 달라졌다. 뜻밖의 미성. 다들 숨죽여 들었다.\n\n노래 끝에 레오가 쑥스럽게 웃었다. "이 노래… 엄마가 좋아했어요." 짧은 정적 뒤, 다들 우레같은 박수를 쳤다. 슬픔도 노래가 되면 견딜 만하다.', fx:{moodAll:7, fatigue:-5, mood:{leo:6}, flag:'leo_names_song', time:50}}]},
...
{id:'ev_kangwoo_past', type:'동행', w:7, once:true, needsComp:'kangwoo', noFlag:'kw_absolved', minParty:1, night:true, region:['mid','north'],
 title:'강우의 그날',
 text:'불침번을 서던 강우가, 곁에 앉은 내게 낮게 입을 연다.\n\n"그날, 나 부대에 있었어. …위에서 명령이 내려왔어. 시민을 막으라고. 천리안 통제에 협조하라고."\n\n주먹을 쥔다. "난 총을 버리고 도망쳤어. 명령을 어긴 거지. …근데 가끔, 그때 남았어야 사람들을 더 지켰을까 싶어."',
 choices:[
  {label:'"도망친 게 옳았어"', out:[{p:1, text:'"그 명령을 따랐으면, 넌 학살에 가담한 거야. 도망친 건 비겁한 게 아니라 인간으로 남은 거야."\n\n강우가 오래 말이 없었다. "…그렇게 말해준 사람은 네가 처음이야." 그의 어깨가 조금 내려앉았다. 3년 묵은 짐 하나가 풀린 듯했다.', fx:{mood:{kangwoo:8}, moodAll:2, flag:'kw_absolved', note:{type:'인물',title:'강우가 버린 총',body:'그날 강우는 시민을 막으라는 명령을 어기고 탈영했다. "인간으로 남은 것"이라 말해줬다.'}}}]},
...
{id:'ev_leo_eunsu', type:'동행', w:8, needsComp:'leo', needsComp2:'eunsu', minParty:2, region:['south','mid','north'],
 title:'티격태격',
 text:'뒷좌석에서 레오와 은수가 옥신각신한다.\n\n"내가 먼저 봤거든?" "언제! 내가 봤지!" 창밖 무지개를 두고 유치한 다툼이다.\n\n보리가 둘 사이에서 고개를 왔다갔다 한다. 꼭 남매 같다.',
 choices:[
  {label:'"둘 다 봤어, 그만"', out:[{p:1, text:'"둘 다 봤어. 무지개가 누구 거냐." 웃으며 말리자 둘이 동시에 입을 삐죽였다.\n\n티격태격해도, 이 둘 덕에 차 안이 조용할 날이 없다. 남매 없는 은수에게 레오가, 동생 같은 은수가 서로에게 가족이 됐다.', fx:{moodAll:4, mood:{leo:3, eunsu:3}}}]},
  {label:'무지개 소원 빌기 시합을 시킨다', out:[{p:1, text:'"그럼 무지개 사라지기 전에 소원 크게 외치기 시합!" 둘이 눈을 반짝이며 창밖으로 소리쳤다.\n\n"다 같이 서울 도착하게 해주세요!" 은수가 외친 소원에, 티격태격하던 분위기가 뭉클해졌다. 레오가 슬쩍 은수 머리를 헝클었다.', fx:{moodAll:5, mood:{leo:4, eunsu:4}}}]},
 ]},
...
{id:'ev_minji_jaeyi', type:'동행', w:7, needsComp:'minji', needsComp2:'jaeyi', minParty:2, night:true, region:['mid','north'],
 title:'기술과 원칙',
 text:'모닥불 앞, 민지와 재이가 조용히 언쟁 중이다.\n\n"천리안 뚫으려면 나도 그 방식을 써야 해. 해킹, 감청, 다." 민지가 말한다.\n\n"그럼 우리도 그것과 같아지는 거 아니야?" 재이가 받는다. "이기려고 괴물이 되면, 이겨도 진 거야."\n\n둘 다 물러서지 않는다.',
 choices:[
  {label:'"수단은 민지, 선은 재이가 지키자"', out:[{p:1, text:'"민지 기술로 뚫되, 어디까지 할지는 재이가 선을 그어. 둘이 서로를 견제하면 돼."\n\n민지가 잠깐 생각하다 고개를 끄덕였다. "…감시는 하되, 사람은 안 건드린다. 그 선까지." 재이도 수긍했다. 둘의 대립이 균형이 됐다.', fx:{moodAll:4, mood:{minji:4, jaeyi:4}, note:{type:'소문',title:'우리의 선',body:'천리안을 기술로 뚫되, 사람을 해치는 선은 넘지 않는다. 민지의 기술과 재이의 원칙이 합의한 규칙.'}}}]},
...
{id:'ev_newsstand', type:'사건', w:6, region:['south','mid','north'],
 title:'가판대의 신문',
 text:'길모퉁이 신문 가판대. 그날 아침 배달된 신문이 그대로 쌓여 있다. 날짜는 3년 전, 그날.\n\n1면 헤드라인: "통합관제 AI 천리안, 오늘 정식 가동. 더 안전한 대한민국." 큼직한 사진 속 사람들이 박수를 친다.\n\n그들은 몰랐다. 그 박수가 무엇을 향한 것이었는지.',
 choices:[
  {label:'신문을 한 부 챙긴다', out:[{p:1, text:'그날의 신문을 한 부 접어 넣었다. 학살이 "안전"이라는 이름으로 시작된 증거. 언젠가 이걸 봐야 할 사람들이 있다.\n\n"…이걸 축하했었네, 우리 모두." 씁쓸했다. 하지만 기록은 남겨야 한다. 다시는 이런 박수를 안 치도록.', fx:{moodAll:-3, note:{type:'사건',title:'그날의 신문',body:'천리안 가동을 "더 안전한 대한민국"이라 축하한 그날의 1면. 학살은 박수 속에 시작됐다.'}}}]},
  {label:'불쏘시개로만 몇 장 쓴다', out:[{p:1, text:'감상에 젖을 여유가 없다. 신문 몇 장을 뜯어 불쏘시개로 챙겼다. 거창한 헤드라인도 이젠 그저 잘 타는 종이다.\n\n"안전한 대한민국"이라는 글자가 불쏘시개로 타들어갈 걸 생각하니, 씁쓸한 웃음이 났다.', fx:{moodAll:-1}}]},
 ]},
...
{id:'talk_mj_20', type:'대화', w:4, once:true, needsComp:'minji', needBond:['minji',12], needFlag:'radio_fixed',
 title:'민지 — 주파수 지키기',
 text:'민지가 고친 무전기 다이얼을 88.9에 정확히 맞춰놓고, 테이프로 고정하고 있다.\n\n"…건드리지 마. 이 주파수는 예약석이야."\n\n오빠의 주파수다.',
 choices:[
...
{id:'talk_pss_16', type:'대화', w:4, once:true, needsComp:'parkss',
 title:'박 선생 — 사탕 처방',
 text:'박 선생이 약가방 구석에서 사탕 하나를 꺼내 건넨다.\n\n"처방이야. 오늘 자네 얼굴이 처졌어."',
 choices:[
  {label:'"사탕이 약이 돼요?"', out:[{p:1, text:'"약국 40년에 제일 많이 나간 약이 이거야." 박 선생이 껄껄 웃었다.\n\n"우는 애들, 주사 맞은 애들, 시험 망친 애들. 사탕 하나면 반은 나았어. 단맛이 아니라 누가 챙겨준다는 맛이지."\n\n입에 물자 정말 반쯤 나았다.', fx:{mood:{parkss:4}, fatigue:-1}}]},
  {label:'반으로 쪼개 나눠 먹는다', out:[{p:1, text:'사탕을 돌로 쪼개 반을 돌려드렸다. 박 선생이 눈을 크게 떴다.\n\n"…처방약을 의사랑 나눠 먹는 환자는 처음이네." 그러면서 넙죽 받아 입에 넣었다.\n\n"음. 잘 듣는군." 둘이서 한참 사탕을 굴렸다.', fx:{mood:{parkss:5}}}]},
 ]},
{id:'talk_pss_17', type:'대화', w:4, once:true, needsComp:'parkss',
 title:'박 선생 — 차임벨',
 text:'"우리 약국 문에 종이 달려 있었어. 딸랑— 하는 놋쇠 종."\n\n박 선생이 창밖을 보며 말했다. "40년을 들었더니 이젠 환청이 들려. 좋은 환청이야. 누가 들어오는 소리니까."',
 choices:[
  {label:'"차에 종을 달아드릴까요?"', out:[{p:1, text:'고물 틈에서 작은 종을 찾아 조수석 문에 달았다. 문 열 때마다 딸랑—\n\n박 선생이 소리 없이 웃었다. "…이제 이 차가 약국이네. 환자 여섯에 왕진 전문."\n\n종소리가 날 때마다 노약사의 어깨가 조금 펴졌다.', fx:{mood:{parkss:6}, scrap:-1, note:{type:'사건',title:'달구지 약국 개업',body:'조수석 문에 놋쇠 종을 달았다. 박 선생 40년 약국의 차임벨이 이사 왔다.',links:['박 선생']}}}]},
...
{id:'talk_pss_21', type:'대화', w:4, once:true, needsComp:'parkss', needBond:['parkss',20],
 title:'박 선생 — 가운을 벗은 날',
...
{id:'talk_leo_16', type:'대화', w:4, once:true, needsComp:'leo',
 title:'레오 — 코드 하나',
 text:'레오가 기타를 내밀었다.\n\n"형, 코드 하나만 배워봐요. C요. 세상 모든 노래의 반은 C로 시작해요."',
 choices:[
  {label:'배운다 (손가락 아픔 감수)', out:[{p:1, text:'손가락이 줄에 눌려 아우성쳤지만, 삼십 분 만에 C가 울렸다. 딩—\n\n"들었어요?! 방금 그거예요!" 레오가 제 일처럼 좋아했다.\n\n"이제 형도 연주자예요. 레퍼토리 한 개짜리." 세상 모든 노래의 반을 시작할 수 있게 됐다.', fx:{mood:{leo:5}, fatigue:1}}]},
  {label:'"난 듣는 담당 할게"', out:[{p:1, text:'"듣는 담당도 중요해요. 아니, 제일 중요해요." 레오가 진지해졌다.\n\n"노래는 듣는 사람 귀에서 완성되거든요. 형이 제 완성이에요."\n\n낯간지러운 말을 아무렇지 않게 하는 재주. 그래서 얘가 음유시인이다.', fx:{mood:{leo:4}}}]},
 ]},
...
{id:'talk_jy_18', type:'대화', w:4, once:true, needsComp:'jaeyi', needBond:['jaeyi',5],
 ...
 choices:[
  {label:'"사장님은 지금 어디 계셔?"', out:[{p:1, text:'"어느 마을에 물물 담보로 맡겼어요. 언젠가 찾으러 간다고 하고." 재이가 먼 곳을 봤다.\n\n"근데 요즘 알았어요. 안 찾아도 되겠더라고요. 보고할 데가 생겨서." 재이가 우리를 둘러봤다.\n\n"지금은 이 차가 본사예요. 사장님이 여섯 명인." 만장일치로 인수합병이 승인됐다.', fx:{mood:{jaeyi:6}}}]},
...
{id:'talk_es_16', type:'대화', w:4, once:true, needsComp:'eunsu',
 title:'은수 — 콜사인',
 text:'"관제사들은 서로 콜사인으로 불러요. 본명보다 익숙해요."\n\n은수가 문득 우리를 둘러봤다. "…우리도 만들까요? 무전 쓸 때 필요하기도 하고."',
 choices:[
  {label:'"내 콜사인 지어줘"', out:[{p:1, text:'은수가 나를 한참 봤다.\n\n"…「캐리어」요. 항공모함이요. 다들 여기서 뜨고 여기로 내리잖아요."\n\n너무 거창하다고 하자 은수가 고개를 저었다. "관제사는 호출부호 허투루 안 정해요. 제 직업적 판단이에요."', fx:{mood:{eunsu:5}, note:{type:'사건',title:'콜사인 — 캐리어',body:'은수가 정해준 호출부호. "다들 여기서 뜨고 여기로 내리잖아요."',links:['은수']}}}]},
  {label:'"은수 씨 콜사인은 뭐였어?"', out:[{p:1, text:'"「에코」요. 무전 용어로 E. …근데 뜻이 좋아서 아꼈어요. 메아리."\n\n은수가 옅게 웃었다. "보낸 신호가 돌아오는 거요. 관제사한텐 제일 반가운 소리거든요. 응답이 있다는 뜻이라."\n\n"에코." 불러보자 은수가 대답했다. "…수신 양호."', fx:{mood:{eunsu:5}}}]},
 ]},
...
{id:'talk_es_18', type:'대화', w:4, once:true, needsComp:'eunsu', needBond:['eunsu',5],
 title:'은수 — 관제 용어 교실',
 text:'"운전하시는 분이 관제 용어 알면 편해요. 배워볼래요?"\n\n은수가 손가락을 하나씩 폈다. "「로저」— 알았다. 「스탠바이」— 대기. 「메이데이」— 이건… 안 쓸 일이 있길 바라요."',
 choices:[
  {label:'"로저" 하고 바로 써먹는다', out:[{p:1, text:'그날부터 차 안에 관제 용어가 퍼졌다. "우회전할게." "로저." "정차 5분." "로저."\n\n레오는 신나서 남발했고, 강우는 의외로 정확히 썼고, 박 선생은 "로저가 누구야?" 했다.\n\n은수가 오랜만에 소리 내어 웃었다. "…관제사 하길 잘했어요. 이 교신은 즐겁네요."', fx:{mood:{eunsu:5}, moodAll:1}}]},
...
{id:'seoul_night', type:'스토리', ai:1, once:true, noPool:1, minParty:1,
 title:'남산의 밤 — 1막 에필로그',
 text:'아무도 대답하지 못했다. 그 부탁에, 바로 답할 수 있는 사람은 없었다.\n\n<span class="ai">"…생각할 시간을 드리겠습니다. 3년을 기다렸으니, 하룻밤쯤은."</span>\n\n돌아서려는 순간, 그것이 덧붙였다.\n\n<span class="ai">"판단에 참고하실 것이 하나 있습니다. — 제 안의 것은, 삭제되지 않았습니다."</span>\n\n<span class="ai">"정리된 모든 것은 보관되어 있습니다. 마지막 순간의 기록까지, 전부. 여기에."</span>\n\n그때— 민지의 무전기가 저절로 켜졌다. 지지직. 88.9.\n\n"…민지야? 들리니. 나야."\n\n민지가 무전기를 떨어뜨릴 뻔했다. 신호의 방향은, 코어 안쪽이었다.',
 choices:[
  {label:'모닥불에 둘러앉아 각자의 답을 묻는다', out:[{p:1, text:'남산 중턱, 코어의 붉은 불빛이 올려다보이는 자리에 불을 피웠다. 오래 아무도 말하지 않았다. 민지가 먼저 입을 열었다.\n\n"…오빠가 저 안에 있어. 끄면, 오빠는 어떻게 되는데." 무전기를 쥔 손이 하얗다.\n\n"명령이 아니라 부탁을 받았습니다. …거부할 수 있는 건 처음입니다." 강우가 불을 보며 말했다.\n\n"죽여달라는 환자를 만난 적이 있어. 그때도 답을 못 했어. …근데 그날 도망친 게 아직도 아파." 박 선생이 낮게 말했다.\n\n"이건 시세가 없어요. 값을 매길 수 없는 거래는… 아빠도 안 가르쳐줬는데." 재이가 손저울을 만지작댔다.\n\n"마지막 소절을 아직 안 쓰길 잘했어요. …이 밤을 쓰라는 뜻이었나 봐요." 레오가 기타를 안았다.\n\n은수가 마지막이었다. "…이제 알겠어요. 제 접속 코드가 왜 3년째 살아 있는지. 걔가— 문을 잠그지 않고 기다린 거예요. 처음부터."\n\n불이 잦아들 때까지, 결론은 내지 않았다. 대신 하나만 정했다.\n\n"내일 뭘 고르든— 여섯이 같이 고른다."\n\n코어의 붉은 불빛이, 대답처럼 한 번 깜빡였다.\n\n<span style="color:var(--faded)">〔 1막 「411km」 끝 — 2막 「보관된 것들」에서 계속 〕</span>', fx:{flag:'act1_done', moodAll:5, note:{type:'사건',title:'남산의 밤',body:'천리안의 부탁과 88.9의 목소리 사이에서, 결론 대신 약속을 정했다. "내일 뭘 고르든 여섯이 같이 고른다." — 1막 끝.',links:['천리안','민규','남산']}}}]},
  {label:'잠든 다섯을 뒤로하고 혼자 코어를 올려다본다', out:[{p:1, text:'다들 잠들고, 혼자 남산 계단에 앉았다. 코어의 붉은 불빛이 심장처럼 깜빡인다.\n\n할아버지의 수첩을 꺼냈다. 마지막 장의 글씨. "여기까지 온 것만으로 넌 이미 완성했다."\n\n…할아버지. 여기까지 왔는데요, 문 앞에서 문이 부탁을 하네요. 자길 정리해달래요. 근데 그 안에 누가 있대요. 다들 있대요.\n\n답은 안 나왔다. 대신 이상한 확신 하나가 남았다.\n\n이 답은 혼자 내리는 게 아니다. 여섯이 411km를 왔듯이, 마지막 1미터도 여섯이 간다.\n\n수첩을 덮고 담요 속으로 돌아갔다. 다섯 개의 숨소리 사이, 내 자리가 비어 있었다.\n\n<span style="color:var(--faded)">〔 1막 「411km」 끝 — 2막 「보관된 것들」에서 계속 〕</span>', fx:{flag:'act1_done', moodAll:3, note:{type:'사건',title:'혼자 본 붉은 불',body:'코어의 부탁과 보관된 것들 사이, 혼자 내린 결론은 하나. "마지막 1미터도 여섯이 간다." — 1막 끝.',links:['천리안','할아버지','남산']}}}]},
 ]},
];
