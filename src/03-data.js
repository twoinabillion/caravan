...
D.eventScenes = {
  ...
  rq_minji_task:'recruit-minji-task', rq_minji_follow:'recruit-minji-task', rq_minji_join:'recruit-minji-task',
  rq_parkss_task:'recruit-parkss-task', rq_parkss_follow:'recruit-parkss-task', rq_parkss_join:'recruit-parkss-task',
  rq_leo_task:'recruit-leo-task', rq_leo_follow:'recruit-leo-task', rq_leo_join:'recruit-leo-task',
  rq_jaeyi_task:'recruit-jaeyi-task', rq_jaeyi_follow:'recruit-jaeyi-task', rq_jaeyi_join:'recruit-jaeyi-task',
  rq_eunsu_task:'recruit-eunsu-task', rq_eunsu_follow:'recruit-eunsu-task', rq_eunsu_join:'recruit-eunsu-task',
  rq_kangwoo_task:'recruit-kangwoo-task', rq_kangwoo_follow:'recruit-kangwoo-task', rq_kangwoo_join:'recruit-kangwoo-task',
...
엔진이 살아난 날에는 길에 나갔다. 고장 난 차를 밀고, 사람을 태워다 주고, 돌아오면 들은 이야기를 수첩에 적었다.
...
우리는 용달차 짐칸에 생활칸을 올렸다.
폐냉장고 단열판으로 벽을 세우고 버스 창문과 접이식 나무판을 달았다. 바닥 밑엔 물통, 차대 뒤엔 <span class="em">연장 레일</span>.
...
목소리는 목적도, 보낸 사람도 숨긴 채 끊겼다. 봉투 어디에도 “서울로 가라”는 말은 없었다.`
  },
  {
...
{id:'rq_minji_task', type:'스토리', w:0, noPool:1, once:true,
 ...
 choices:[
  {label:'윈치로 장력을 잘게 나눈다', req:{up:'winch'}, out:[{p:1,text:'윈치가 한 칸씩 울 때마다 차 더미가 숨을 참는다. 민지가 손가락 둘을 접었다. 멈춤. 하나를 폈다. 당김.\n\n상자가 진흙 위로 빠져나온 순간, 뒤의 차 더미가 주저앉았다. 민지는 상자를 품에 안고 한동안 열지 못했다.\n\n지직— 잡음 뒤로 남자의 목소리. "민지야, 정오다. 살아 있으면 대답해."\n\n민지가 울다가 웃었다. "이제 출발해도 돼요."',fx:{time:45,van:2,recruitRoad:'minji',note:{type:'사건',title:'무너지기 전의 목소리',body:'폐차장 차 더미 아래서 민규의 진단기와 마지막 정오 신호를 꺼냈다.',links:['민지','민규의 신호']}}}]},
  {label:'도르래를 만들고 사람 힘으로 맞춘다', req:{scrap:4}, out:[{p:1,text:'범퍼와 휠 허브로 도르래를 만들었다. 민지가 "하나, 둘"을 세고 우리는 줄을 당겼다. 셋은 말하지 않았다. 셋에 천장이 내려앉았으니까.\n\n상자는 마지막 한 뼘을 굴러 우리 발앞에 멈췄다. 안에서 남자의 녹음이 살아났다.\n\n"민지야, 정오다. 살아 있으면 대답해."\n\n민지가 상자에 이마를 댄다. "응. 이제 대답하러 갈 거야."',fx:{time:90,scrap:-4,van:-3,recruitRoad:'minji',note:{type:'사건',title:'무너지기 전의 목소리',body:'임시 도르래로 민규의 진단기를 구했다. 민지는 이제 신호의 북쪽 끝을 찾아갈 수 있다.',links:['민지','민규의 신호']}}}]},
  {label:'차를 방패로 붙이고 짧게 당긴다', out:[{p:1,text:'달구지를 차 더미 바로 앞에 세웠다. 민지가 보닛을 한 번 쓰다듬는다. "미안. 조금 아플 거야."\n\n견인선이 팽팽해지고, 철판 하나가 적재칸을 긁으며 떨어졌다. 상자는 나왔다. 차체엔 긴 흉터가 남았다.\n\n녹음 속 목소리가 말했다. "살아 있으면 대답해." 민지가 우리 차의 흉터를 보며 대답했다. "둘 다 살아 있어."',fx:{time:50,van:-12,recruitRoad:'minji',note:{type:'사건',title:'무너지기 전의 목소리',body:'달구지에 흉터를 남기고 민규의 마지막 정오 신호를 구했다.',links:['민지','민규의 신호','달구지']}}}]},
 ]},
{id:'rq_minji_follow', type:'스토리', w:0, noPool:1, once:true,
 title:'정오의 대답',
 text:'정오 1분 전. 민지는 아무 말 없이 라디오 소리를 줄인다.\n\n달구지 엔진이 식어 가는 동안, 무릎 위 진단기에서 잡음이 깨어난다. 매일 같은 시각에 남겨진 민규의 목소리다.\n\n"민지야, 정오다. 살아 있으면 대답해."\n\n민지의 엄지가 정지 버튼 위에서 멈춘다. "폐차장에선 늘 여기서 껐어요. 끝까지 들으면… 그날 내가 대답 안 한 것도 같이 들리는 것 같아서."\n\n그녀는 웃는 척하다가 그만둔다. "차 안에서까지 이럴 줄은 몰랐네."',
 choices:[
  {label:'녹음을 끝까지 함께 듣는다', out:[{p:1,text:'정오 신호는 생각보다 짧았다. 마지막엔 목소리도 없고, 민규가 책상을 두드리는 소리만 열세 번 남았다.\n\n민지는 열세 번째까지 세고도 한동안 진단기를 끄지 못했다.\n\n"사고 난 날, 오빠 신호가 왔어요. 난 무너진 차 밑에 있었고. 대답하면 오빠가 돌아올까 봐 겁났어요."\n\n"그럼 오늘 답은 같이 해요."\n\n민지가 코를 훔친다. "그 말, 내일도 물리지 마요."',fx:{time:45,moodAll:4,recruitReady:'minji',chain:'rq_minji_join',note:{type:'사건',title:'정오의 대답',body:'민지와 민규의 마지막 정오 신호를 끝까지 들었다. 대답하지 못한 날의 죄책감도 함께 꺼내 놓았다.',links:['민지','민규의 신호']}}}]},
  {label:'보닛을 열고 달구지의 소리를 묻는다', out:[{p:1,text:'민지는 기다렸다는 듯 보닛 안으로 상체를 넣었다. 벨트를 누르고, 호스를 짚고, 귀를 가까이 댄다.\n\n"이건 베어링. 이건 팬. 이건…" 손이 멎는다. "사람들이 나한테 필요한 건 늘 이런 거였어요. 고쳐. 살려. 더 가게 해."\n\n"오늘은 안 고쳐도 돼요. 그냥 어떤 소린지 궁금했어요."\n\n민지가 한참 뒤 보닛을 닫는다. "그러면 대답은 할 수 있겠네요. 이 차, 아직 가고 싶어 해요. 나도 그렇고."',fx:{time:40,van:4,recruitReady:'minji',chain:'rq_minji_join',note:{type:'사건',title:'달구지가 내는 소리',body:'민지는 쓸모를 증명하라는 부탁 대신, 자신이 들은 소리를 말해 달라는 질문을 받았다.',links:['민지','달구지']}}}]},
  {label:'오늘의 소리를 새로 녹음한다', out:[{p:1,text:'진단기의 녹음 버튼을 눌렀다. 처음엔 바람뿐이었다.\n\n누군가 물통을 내려놓는 소리. 문짝이 덜컹대는 소리. 민지가 작게 "민지, 정오. 살아 있음" 하고 말한다. 잠깐 망설이다가 한마디를 더 붙인다.\n\n"혼자 아님."\n\n재생하자 자기 목소리를 못 견디겠다는 듯 얼굴을 찡그린다. 그래도 지우진 않았다. 진단기를 공구함 가장 위에 올려둔다.',fx:{time:30,moodAll:6,recruitReady:'minji',chain:'rq_minji_join',note:{type:'사건',title:'오늘의 정오 신호',body:'민규의 오래된 신호 뒤에 달구지의 소리와 민지의 새 대답을 녹음했다. “살아 있음. 혼자 아님.”',links:['민지','민규의 신호','달구지']}}}]},
 ]},
{id:'rq_minji_join', type:'스토리', w:0, noPool:1,
 title:'민지가 고른 자리',
 text:'한 구간 내내 민지는 공구함을 무릎에서 놓지 않았다. 손님 짐이라며 끈도 묶지 않았던 상자다.\n\n이제 그녀가 적재칸 안쪽의 빈 볼트 구멍을 가리킨다. "여기 써도 돼요? 다음 정차까지만이면 안 뚫었을 텐데."\n\n진단기에는 오늘 녹음한 정오가 남아 있다. 민지는 그걸 한 번 보고 우리를 본다.\n\n"북쪽 끝까지 가고 싶어요. 고치는 사람으로만 말고… 같이 대답하는 사람으로."',
...
{id:'rq_parkss_task', type:'스토리', w:0, noPool:1, once:true,
 ...
 choices:[
  {label:'의약품을 보태 처방을 완성한다', req:{item:'의약품'}, out:[{p:1,text:'우리 약 상자를 열자 박 선생이 잠깐 눈을 감았다. 아까웠기 때문이 아니라, 선택하지 않아도 돼서였다.\n\n세 아이 몫이 나란히 놓였다. 새벽까지 열이 한 명씩 내려갔다. 보호자가 울며 고개를 숙이자 박 선생은 손사래를 친다.\n\n"약이 할 일을 한 거요. 나는 운반했고, 이 사람들은 멈춰줬고."\n\n그가 처음으로 달구지를 가리킨다. "이제 나도 저 차가 가는 데까지 가보고 싶소."',fx:{item:{'의약품':-1},time:180,moodAll:4,recruitRoad:'parkss',note:{type:'사건',title:'식기 전에 닿은 약',body:'버스에서 꺼낸 냉장 약품을 길가 진료소의 아이 셋에게 전달했다.',links:['박 선생']}}}]},
  {label:'물을 나눠 냉각과 해열을 버틴다', req:{water:3}, out:[{p:1,text:'젖은 천으로 상자를 감싸고, 남은 물로 아이들의 목과 손목을 식혔다. 박 선생은 세 시간 동안 한 번도 시계를 놓지 않았다.\n\n새벽, 가장 어린 아이가 먼저 죽을 달라고 했다. 보호자가 웃다가 울었다.\n\n박 선생이 빈 냉장 상자를 닫는다. "약은 도착했고, 사람은 밤을 넘겼소. 이제 내 발이 어디로 갈지 정해도 되겠군."',fx:{water:-3,time:210,fatigue:8,recruitRoad:'parkss',note:{type:'사건',title:'식기 전에 닿은 약',body:'물과 밤을 들여 아이들의 열이 내려갈 때까지 박 선생 곁을 지켰다.',links:['박 선생']}}}]},
  {label:'달구지 배터리로 냉장기를 살린다', out:[{p:1,text:'배선을 직결하자 달구지 실내등이 꺼지고 냉장기가 낮게 울었다. 박 선생은 그 소리를 들으며 약병을 나눴다.\n\n밤새 배터리가 버텼고, 아이들도 버텼다. 아침 시동은 세 번 만에 걸렸다.\n\n"차도 사람도 무리했소." 박 선생이 보닛에 손을 얹는다. "빚을 오래 두는 성격이 아니라서. 가는 길에 갚겠소."',fx:{time:180,van:-7,fuel:-2,recruitRoad:'parkss',note:{type:'사건',title:'식기 전에 닿은 약',body:'달구지 전기로 냉장 약품을 살려 길가 진료소의 밤을 넘겼다.',links:['박 선생','달구지']}}}]},
 ]},
{id:'rq_parkss_follow', type:'스토리', w:0, noPool:1, once:true,
 ...
 choices:[
  {label:'함께 상태를 보고 다음 진료소까지 잇는다', out:[{p:1,text:'박 선생은 환자의 숨과 맥박을 보고, 우리가 들고 온 물로 천을 적셨다. 기적 같은 처방은 없었다. 대신 보호자에게 밤새 볼 것과 즉시 움직여야 할 징후를 하나씩 적어줬다.\n\n우리는 다음 진료소로 갈 길과 태워 줄 사람을 찾았다.\n\n천막을 나오자 박 선생이 묻는다. "살린 건 아니오. 그런데도 멈춘 게 맞았을까?"\n\n"혼자 두지 않았잖아요."\n\n그가 빈 가방을 내려다본다. "그 답이면, 오늘은 견딜 만하군."',fx:{time:70,water:-1,moodAll:4,recruitReady:'parkss',chain:'rq_parkss_join',note:{type:'사건',title:'가방이 비어도',body:'약이 없는 자리에서 할 수 있는 처치와 다음 진료소까지의 연결을 만들었다. 박 선생 혼자만의 책임으로 남기지 않았다.',links:['박 선생']}}}]},
  {label:'주변 사람들에게 할 일을 나눠 부탁한다', out:[{p:1,text:'한 사람은 물을 끓이고, 한 사람은 밤새 상태를 기록하고, 한 사람은 새벽에 출발할 차를 찾았다. 박 선생은 자꾸 모든 일을 다시 가져오려 했다.\n\n"선생님, 그건 저분이 하기로 했어요."\n\n세 번째로 말하자 그가 마지못해 손을 놓는다. 얼마 뒤 천막 안에서 먼저 웃음소리가 났다.\n\n"내 손이 모자라면 더 빨리 움직여야 한다고만 생각했소."\n\n박 선생이 가방을 닫는다. "손을 더 부르면 되는 걸, 오래도 몰랐군."',fx:{time:55,fatigue:4,moodAll:6,recruitReady:'parkss',chain:'rq_parkss_join',note:{type:'사건',title:'여럿이 드는 왕진 가방',body:'진료와 이동 준비를 주변 사람들과 나눴다. 박 선생은 환자를 혼자 책임지는 대신 도움을 청했다.',links:['박 선생']}}}]},
  {label:'운행 일지를 건네 이름과 다음 길을 적게 한다', out:[{p:1,text:'박 선생은 빈 종이에 환자 이름부터 적었다. 그 아래엔 증상, 지켜볼 사람, 새벽에 갈 곳. 마지막 줄엔 우리 차량 번호를 남겼다.\n\n"다시 지나가면 확인한다는 뜻이오."\n\n"다시 못 지나가면요?"\n\n펜이 잠깐 멎는다. 그는 옆 사람에게 종이를 한 장 더 뜯어준다. "그땐 이 사람이 다음 이름을 잇겠지."\n\n명단은 실패한 사람들의 묘비가 아니라, 다음 사람이 이어받을 약속이 됐다.',fx:{time:45,moodAll:5,recruitReady:'parkss',chain:'rq_parkss_join',note:{type:'사건',title:'이어지는 진료 기록',body:'박 선생의 명단에 환자뿐 아니라 지켜볼 사람과 다음 목적지를 함께 적었다. 기록은 혼자 지는 빚이 아니라 이어받는 약속이 됐다.',links:['박 선생','달구지']}}}]},
 ]},
{id:'rq_parkss_join', type:'스토리', w:0, noPool:1,
 title:'왕진 가방이 놓인 곳',
 text:'박 선생은 빈 왕진 가방 안에 오늘 쓴 기록을 넣는다. 한 사람의 이름 옆에 여러 사람의 손이 적힌 종이다.\n\n"나는 환자를 만나면 자꾸 혼자 남소. 책임진다는 말 뒤에 숨어서 말이오."\n\n그가 달구지 사람들을 천천히 둘러본다. "이 차에선 그러기 어렵겠군. 누가 물을 끓이고, 누가 길을 찾고, 누가 내 손을 떼어놓으니."\n\n열린 문 앞에서 가방을 든다. "서울까지 그 버릇 좀 고쳐 봐도 되겠소?"',
...
{id:'rq_leo_task', type:'스토리', w:0, noPool:1, once:true,
 ...
 choices:[
  {label:'윈치 줄을 안전선으로 건다', req:{up:'winch'}, out:[{p:1,text:'레오의 허리에 건 줄이 어둠 속으로 풀린다. 노래가 교각에 부딪혀 돌아온다.\n\n잠시 뒤, 줄이 두 번 당겨졌다. 우리는 윈치를 감았다. 레오가 보리를 안고 물 위로 떠올랐다. 개는 기침을 하면서도 레오의 얼굴부터 핥았다.\n\n밖에 나오자 레오는 젖은 수첩을 확인하고, 그다음 보리를 확인하고, 다시 보리를 확인했다. "돌아와줘서 고마워요. 둘 다한테 하는 말이에요."',fx:{time:70,moodAll:5,recruitRoad:'leo',note:{type:'사건',title:'보리를 데리러 돌아간 밤',body:'침수 지하차도에서 레오와 보리를 함께 끌어냈다.',links:['레오','보리']}}}]},
  {label:'두 번째 로프가 되어 함께 들어간다', out:[{p:1,text:'물은 생각보다 빠르고 차가웠다. 레오의 노래가 끊길 때마다 우리가 뒤에서 다음 소절을 엉망으로 이었다.\n\n보리는 부서진 난간 위에서 떨고 있었다. 돌아오는 길엔 셋이 한 줄이 됐다. 레오, 보리, 우리.\n\n도로에 엎어진 레오가 한참 웃는다. "노래를 이렇게 못 부르는 사람 처음 봤어요. 그래서 안 잊어버릴 것 같아요."',fx:{time:100,fatigue:16,water:-1,moodAll:6,recruitRoad:'leo',note:{type:'사건',title:'보리를 데리러 돌아간 밤',body:'같이 물에 들어가 보리를 구했다. 끊긴 노래는 엉망인 합창으로 이어졌다.',links:['레오','보리']}}}]},
  {label:'트럭을 물가까지 붙여 불빛을 만든다', out:[{p:1,text:'달구지 앞바퀴가 물에 잠길 만큼 붙였다. 헤드라이트가 교각 아래를 훑자, 보리의 두 눈이 반짝였다.\n\n레오가 그 빛을 따라 들어가 개를 안고 나왔다. 시동이 물을 먹어 거칠게 떨렸지만 꺼지진 않았다.\n\n"보리는 불빛을 따라왔고, 나는 보리를 따라왔고." 레오가 젖은 머리를 쓸어 넘긴다. "당신들은 왜 돌아왔어요?" 대답 대신 보리에게 수건을 덮어줬다.',fx:{time:75,van:-9,moodAll:5,recruitRoad:'leo',note:{type:'사건',title:'보리를 데리러 돌아간 밤',body:'달구지의 불빛을 침수 차도 안까지 밀어 넣어 보리와 레오를 돌아오게 했다.',links:['레오','보리','달구지']}}}]},
 ]},
{id:'rq_leo_follow', type:'스토리', w:0, noPool:1, once:true,
 ...
 choices:[
  {label:'"안 불러도 자리는 그대로예요"', out:[{p:1,text:'레오는 농담을 기다리는 얼굴로 우리를 본다. 아무도 웃지 않자 오히려 본인이 웃어버린다.\n\n"그 말 되게 무책임한 거 알아요? 그럼 내가 뭘 해야 할지 모르잖아요."\n\n"모르면 오늘은 보리랑 물이나 마셔요."\n\n보리가 제 그릇을 앞발로 밀었다. 레오는 물을 따르며 중얼거린다. "얘는 진작 알고 있었네. 아무것도 안 해도 밥 주는 사람을 따라가야지."',fx:{time:30,moodAll:6,recruitReady:'leo',chain:'rq_leo_join',note:{type:'사건',title:'노래하지 않아도 되는 자리',body:'레오에게 공연의 대가가 아닌 자리를 내주었다. 그는 아무것도 증명하지 않은 채 한 끼를 함께 먹었다.',links:['레오','보리']}}}]},
...
{id:'rq_jaeyi_task', type:'스토리', w:0, noPool:1, once:true,
 ...
 choices:[
  {label:'윈치와 도르래로 하중을 들어낸다', req:{up:'winch'}, out:[{p:1,text:'재이가 분필로 당길 순서를 표시한다. 우리는 그 숫자만 따라갔다. 철근이 들리고, 리어카가 먼저 빠지고, 마지막에 양철 상자가 나왔다.\n\n안에는 사진, 고장 난 손목시계, 찰흙으로 빚은 작은 새가 있었다. 재이는 하나씩 닦아 다시 넣는다.\n\n"쓸모없는 게 이렇게 무거운 줄 몰랐네요." 그 말은 불평이 아니었다.',fx:{time:80,scrap:4,recruitRoad:'jaeyi',note:{type:'사건',title:'고철값이 없는 상자',body:'무너진 창고에서 재이 가족의 사진과 작은 물건들을 꺼냈다.',links:['재이']}}}]},
  {label:'쓸 만한 부품을 받침대로 써 버린다', req:{item:'부품'}, out:[{p:1,text:'새 베어링과 멀쩡한 프레임을 받침으로 밀어 넣었다. 재이는 아까운 표정을 숨기지 못했지만 손은 멈추지 않았다.\n\n상자가 빠진 뒤, 받침은 천장 아래서 납작해졌다. 재이가 사진을 꺼내 우리에게 보여준다. 리어카보다 작은 재이가 가족 사이에 서 있다.\n\n"부품은 또 구하면 돼요." 재이가 스스로에게 말하듯 한다. "이건 아니고."',fx:{item:{'부품':-1},time:60,moodAll:4,recruitRoad:'jaeyi',note:{type:'사건',title:'고철값이 없는 상자',body:'쓸 만한 부품을 포기해 재이 가족의 상자를 구했다.',links:['재이']}}}]},
  {label:'잔해를 손으로 한 조각씩 걷어낸다', out:[{p:1,text:'큰 걸 당기면 다 무너졌다. 결국 작은 것부터 옮겼다. 볼트, 유리, 철판, 벽돌. 해가 질 때까지.\n\n상자가 빠지자 재이는 첫 번째로 찰흙 새를 확인했다. 날개가 하나 부러졌지만 남아 있었다.\n\n"사람들이 내가 물건을 못 버린다고 했어요." 재이가 먼지를 턴다. "오늘은 그게 맞아서 다행이네요."',fx:{time:220,fatigue:18,scrap:7,recruitRoad:'jaeyi',note:{type:'사건',title:'고철값이 없는 상자',body:'하루를 들여 잔해를 걷고 재이 가족의 상자를 손으로 꺼냈다.',links:['재이']}}}]},
 ]},
{id:'rq_jaeyi_follow', type:'스토리', w:0, noPool:1, once:true,
 title:'값을 매기지 않는 자리',
 text:'빗방울이 굵어지자 적재칸 한쪽에서 물이 샌다. 마른 자리는 하나. 재이의 가족 상자와 교환할 부품 상자가 나란히 놓여 있다.\n\n재이는 묻지도 않고 가족 상자를 문 쪽으로 민다.\n\n"이쪽이 젖어도 돼요. 저 부품은 물 먹으면 값 떨어지잖아요."\n\n"사진도 상하잖아요."\n\n"사진은 제 거고, 부품은 차에 필요한 거니까요."\n\n말은 빠른데 손은 상자에서 떨어지지 않는다.',
 choices:[
  {label:'가족 상자를 마른 자리에 놓고 부품은 함께 든다', out:[{p:1,text:'가족 상자를 침상 안쪽에 넣고, 부품 상자는 비가 그칠 때까지 무릎 위에 나눠 들었다.\n\n재이가 몇 번이나 바꿔 들겠다고 했지만 자리는 내주지 않았다.\n\n"무거운데 왜 이래요."\n\n"그 상자도 무거웠잖아요."\n\n재이는 창고에서 했던 말을 알아듣고 입을 다문다. 잠시 뒤 사진 모서리를 마른 천으로 닦아 우리에게 한 장씩 보여줬다.',fx:{time:40,fatigue:5,moodAll:5,recruitReady:'jaeyi',chain:'rq_jaeyi_join',note:{type:'사건',title:'가족 상자의 마른 자리',body:'교환할 부품보다 재이의 가족 상자를 먼저 마른 곳에 두었다. 짐의 값이 사람의 자리값은 아니었다.',links:['재이','달구지']}}}]},
  {label:'고철로 천장 선반을 하나 더 단다', req:{scrap:2}, out:[{p:1,text:'남은 앵글 두 개와 창틀을 천장에 걸었다. 재이는 물 새는 곳부터 막자고 했지만, 우리는 먼저 상자가 들어갈 높이를 물었다.\n\n"가족 상자 높이를 왜 외워요?"\n\n"계속 실을 거니까."\n\n재이가 볼트를 받아 조인다. 새 선반엔 부품이, 그 아래 마른 자리엔 가족 상자가 들어갔다.\n\n"공간이 없으면 사람부터 줄이는 줄 알았는데." 재이가 선반을 세게 흔들어 본다. "여긴 공간을 만드네요."',fx:{time:65,scrap:-2,van:2,recruitReady:'jaeyi',chain:'rq_jaeyi_join',note:{type:'사건',title:'한 칸을 더 만드는 법',body:'짐을 버리는 대신 달구지 천장에 선반을 덧댔다. 재이는 자리가 부족하면 사람을 줄이지 않고 공간을 만들 수도 있다는 걸 보았다.',links:['재이','달구지']}}}]},
  {label:'"뭘 버릴지가 아니라 어디 둘지 네가 정해"', out:[{p:1,text:'재이는 적재칸을 두 바퀴 훑었다. 부품 상자를 세워 묶고, 가족 상자는 방수포 안에 넣은 뒤 자기 발밑에 고정한다.\n\n"이러면 둘 다 안 젖어요. 대신 내가 다리를 못 펴지만."\n\n"다음 정차 때 다시 고치면 돼요."\n\n재이가 끈을 한 번 더 당긴다. "자리라는 게 완성품은 아니네요. 계속 맞추는 거지."\n\n그녀는 처음으로 자기 짐을 허락받지 않고 달구지에 고정했다.',fx:{time:45,moodAll:6,recruitReady:'jaeyi',chain:'rq_jaeyi_join',note:{type:'사건',title:'재이가 정한 자리',body:'재이가 가족 상자와 부품이 함께 갈 자리를 직접 만들었다. 달구지의 공간은 주어지는 것이 아니라 함께 맞추는 것이었다.',links:['재이','달구지']}}}]},
 ]},
{id:'rq_jaeyi_join', type:'스토리', w:0, noPool:1,
 title:'리어카를 접는 법',
 text:'재이는 가족 상자를 다시 풀지 않는다. 대신 한 구간 동안 임시로 묶어 둔 끈을 풀어, 달구지 고정 레일에 맞게 길이를 잰다.\n\n"전에는 리어카가 제 집이었어요. 그래서 자리값을 내려면 쓸모 있는 걸 계속 주워야 한다고 생각했고."\n\n그녀가 우리가 함께 만든 자리를 손바닥으로 눌러 본다. "이 차는 집이 아직 안 끝났네요. 저도 손님 말고, 고치는 사람으로 끼어들어도 돼요?"',
...
{id:'rq_eunsu_task', type:'스토리', w:0, noPool:1, once:true,
 ...
 choices:[
  {label:'안테나로 가짜 응답을 먼저 만든다', req:{up:'antenna'}, out:[{p:1,text:'달구지 안테나가 중계기인 척 짧은 승인음을 보냈다. 푸른 불이 한 박자 느려진다.\n\n"하나. 둘." 차단기를 당겼다. 은수는 셋 대신 루프선을 꽂았다.\n\n좌표가 하나씩 지워졌다. 마지막 줄엔 이 중계기를 처음 켠 오퍼레이터 코드가 남았다. 은수의 것이었다. 그녀가 직접 삭제 키를 눌렀다.\n\n"이번엔 내가 껐어요."',fx:{time:70,pursuit:-1,recruitRoad:'eunsu',note:{type:'사건',title:'은수가 끈 중계기',body:'추방 좌표를 올리던 중계기를 속이고 기록까지 지웠다. 마지막 삭제는 은수가 직접 했다.',links:['은수','천리안']}}}]},
  {label:'둘에 차단기를 당긴다', out:[{p:1,text:'"하나."\n\n빗물이 손잡이를 타고 흐른다.\n\n"둘."\n\n몸으로 차단기를 내렸다. 동시에 위에서 불꽃이 터졌다. 푸른 표시등이 한 바퀴 더 돌다가 멎는다.\n\n은수가 내려와 수신기를 건넸다. 잡음뿐이다. "예전엔 켜라는 시간만 맞췄어요. 끄는 데는 누군가를 믿어야 하네요."',fx:{time:90,fatigue:10,van:-3,recruitRoad:'eunsu',note:{type:'사건',title:'은수가 끈 중계기',body:'정확히 둘에 차단기를 당겨 추방 좌표 송신을 끊었다.',links:['은수','천리안']}}}]},
  {label:'선을 끊고 좌표가 새기 전에 이동한다', out:[{p:1,text:'정교한 루프 대신 주 케이블을 잘랐다. 중계기는 죽었지만, 하늘의 점 하나가 곧장 이쪽을 향했다.\n\n은수는 달구지에 올라타지 않고 끝까지 배전함을 지켰다. 저장 장치가 완전히 타는 걸 확인한 뒤에야 뛰었다.\n\n차가 능선을 내려갈 때 수신기엔 아무 좌표도 남지 않았다. 우리 위치가 들킨 것 말고는.',fx:{time:45,pursuit:1,recruitRoad:'eunsu',note:{type:'사건',title:'은수가 끈 중계기',body:'본망에 들킬 위험을 감수하고 중계기와 저장 좌표를 함께 태웠다.',links:['은수','천리안']}}}]},
 ]},
{id:'rq_eunsu_follow', type:'스토리', w:0, noPool:1, once:true,
 ...
 choices:[
  {label:'"듣는 건 네가, 결정은 같이 해요"', out:[{p:1,text:'은수는 좌표의 세기와 반복 간격부터 설명했다. 확실한 것, 짐작인 것, 모르는 것을 나눠 말한다.\n\n우리는 지도에서 우회 시간과 남은 연료를 함께 셌다. 결론은 짧게 들러 육안으로 확인하는 것.\n\n"이렇게 느려도 돼요?"\n\n"다섯 사람 일이잖아요."\n\n은수가 처음으로 승인음 없이 송신 버튼을 누른다. "접근 중. 응답 가능하면 불빛 두 번." 명령이 아니라 질문이었다.',fx:{time:55,fuel:-1,moodAll:5,recruitReady:'eunsu',chain:'rq_eunsu_join',note:{type:'사건',title:'함께 내린 판단',body:'은수가 수신 내용을 사실과 추측으로 나눠 설명하고, 경로 결정은 모두와 함께 내렸다. 송신은 명령이 아니라 질문으로 보냈다.',links:['은수','천리안']}}}]},
...
{id:'rq_eunsu_join', type:'스토리', w:0, noPool:1,
 title:'송신이 멎은 뒤',
 text:'은수는 수신기를 오래 듣는다. 좌표는 남아 있지만, 무엇을 하라는 승인음은 오지 않는다.\n\n"나를 못 믿는 게 맞아요. 나도 아직 나를 다 못 믿으니까."\n\n그녀가 장비 가방을 닫는다. "그래도 이 차에선 모른다고 말해도 결정에서 빠지진 않네요."\n\n은수가 지도의 북쪽을 짚는다. "서울까지 가고 싶어요. 이번엔 명령을 옮기는 사람이 아니라, 들은 걸 같이 판단하는 사람으로."',
...
{id:'rq_kangwoo_join', type:'스토리', w:0, noPool:1,
 title:'등을 돌릴 수 있는 아침',
 text:'강우는 무전기에 짧게 남긴다. "수신 양호. 판단도 양호."\n\n서연의 대답은 바로 온다. "알았으면 이제 호출 없을 때 끼어들지 마세요."\n\n강우가 웃음인지 한숨인지 모를 숨을 뱉는다. 무전기를 끄진 않는다. 다만 군장 깊숙이 넣고, 달구지의 문과 비상 탈출구를 다시 살핀다.\n\n"시장은 나 없이도 간다. 그걸 한 구간이나 걸려서 배웠군." 그가 우리를 본다. "너희 차는 아직 파수꾼이 필요해 보이고. 이번 자리는 내가 고르고 싶다."',
...
{id:'react_seoul_kw', type:'대화', w:5, once:true, needsComp:'kangwoo', needFlag:'seoul_seen',
 ...
 choices:[
  {label:'"돌려주러 가는 거죠"', out:[{p:1, text:'"돌려주고 사과할 거다. 제가 반대쪽을 맡겼다고."\n\n강우는 군번줄을 손바닥 안에 감췄다. "원망하면 듣는다. 안 만나주면 문 앞에 두고 오고. 그건 그분들이 정할 일이지."\n\n한참 뒤에 그가 덧붙였다. "사라져버리면 원망도 못 해. 그건 해선 안 될 짓이다."', fx:{mood:{kangwoo:4}, note:{type:'사건',title:'돌려줄 군번줄',body:'강우는 박 일병의 군번줄을 부모에게 돌려주고, 그들이 원하는 방식으로 사과받기로 했다.',links:['강우','박일병','남산']}}}]},
 ]},
...
{id:'react_seoul_all', type:'대화', w:5, once:true, needFlag:'seoul_seen', minParty:2,
 ...
 choices:[
  {label:'다 같이 앉아 본다', out:[{p:1, text:'모닥불 주위에 자리가 하나씩 찼다. 다들 남산을 볼 수 있는 쪽으로 앉았다.\n\n"내일 진짜 들어가는 거네."\n\n"잠이 오겠냐."\n\n누군가는 물을 끓였고, 누군가는 공구를 다시 셌다. 레오는 기타를 꺼냈다가 도로 넣었다.\n\n"내일 가자." 내가 말했다. "오늘은 여기서 보고만 있자."\n\n그날은 계획을 더 짜지 않았다. 불이 꺼질 때까지 서울 불빛만 봤다.', fx:{moodAll:5, note:{type:'사건',title:'목적지를 마주 본 밤',body:'남산이 보인 밤, 일행은 계획 대신 불빛을 함께 바라봤다.',links:['남산','할아버지']}}}]},
 ]},
...
{id:'gw_gangneung', type:'스토리', w:0, locEvent:'gangneung', once:true,
 ...
 choices:[
  {label:'벽돌을 나른다', out:[{p:1, text:'한 시간 벽돌을 날랐다. 십장은 말보다 손짓을 더 많이 했다. 이건 저쪽, 깨진 건 아래, 물은 그늘.\n\n쉬는 참에 십장이 벽을 두드렸다. "저 기계는 있는 것만 굴리지, 이런 건 안 해줘요."\n\n"천리안이요?"\n\n"벽돌 한 장도 안 날라주더라고." 십장이 웃었다. "그러니 우리가 해야지."\n\n떠날 때 상비약과 붕대를 챙겨줬다. "박 선생이라고, 약사 데리고 다닌다며. 이거 보여주면 잔소리부터 할걸. 양이 적다고."', fx:{flag:'cell_gangneung_help', item:{'의약품':2}, moodAll:4, note:{type:'사건',title:'짓는 사람들',body:'강릉 사람들과 폐병원 벽을 올리고 상비약을 나눠 받았다.',links:['강릉행 호송대']}}}]},
 ]},
...
{id:'talk_es_16', type:'대화', w:4, once:true, needsComp:'eunsu',
 title:'은수 — 콜사인의 무게',
 text:'"관제실에선 본명보다 호출부호를 더 많이 써요. 저도 선배 성을 한참 뒤에 알았어요."\n\n은수가 헤드폰을 만지작거렸다. "그 이름 들으면 아직도 저절로 대답해요. 일을 그만뒀는데도."',
 choices:[
