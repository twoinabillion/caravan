...
/* 네 기둥 — 관계는 선택한 동료 4명의 깊은 서사로도 성립한다.
 ...
 D.seoulPillars = { 관계:4, 세계:3, 진실:3, 유산:2 };
D.deeds = [
...
/* 무작위 사건 834개 사이에서도 본편의 질문이 묻히지 않도록,
   주행거리 문턱을 넘긴 뒤 다음 도착에서 한 장면씩 보장한다. */
D.journeyBeats = [
 {id:'story_generation_form',     km:60},
 {id:'story_generation_speech',   km:140},
 {id:'story_generation_theories', km:220},
...
D.chats = [
 ...
 {need:{comp:'minji',comp2:'kangwoo'}, lines:[
   ['kangwoo','…민지 씨. 브레이크 밟을 때 소리가 났습니다.'],
   ['minji','알아. 패드가 아니라 백플레이트야. 안 죽어.'],
   ['kangwoo','…확실합니까.'],
   ['minji','아저씨가 매복 읽는 거만큼 확실해. 각자 전공을 믿자?']]},
 {need:{comp:'minji',comp2:'eunsu'}, lines:[
 ...
 {need:{comp:'parkss',comp2:'eunsu'}, lines:[
   ...
   ['eunsu','…네. 그럼 저 오늘부터 세 시에 약속 있는 사람이에요.']]},
 ...
 {need:{comp:'kangwoo',comp2:'parkss',flag:'kw_absolved'}, lines:[
   ...
   ['parkss','좋은 일이야. 빚은 갚는 게 아니라 사는 걸로 덜어지는 거라.'],
   ['kangwoo','…살아서 덜겠습니다.'],
   ['parkss','그래. 오래 살아. 그게 명령이야, 젊은 군인.']]},
 {need:{comp:'eunsu',comp2:'minji',flag:'es_truth'}, lines:[
   ['eunsu','민지 씨. 나 그날 얘기, 했어요. 드디어.'],
   ['minji','…들었어. 잘했어. 기계는 로그가 쌓이면 무거워지거든.'],
   ['eunsu','사람도 그래요. 로그 하나 지웠더니 좀 가벼워요.'],
   ['minji','지운 게 아니라 백업한 거야. 우리한테. …그러라고 있는 거야, 동행이.']]},
 {need:{comp:'leo',comp2:'minji',flag:'leo_names_song'}, lines:[
   ['leo','누나! 「400km」 2절 가사 나왔어요. 엔진 소리 박자 맞춰봤어요.'],
 ...
 {need:{comp:'jaeyi',comp2:'parkss',flag:'jy_law'}, lines:[
   ...
   ['parkss','약은 파는 게 아니라 닿는 거야. 닿아야 할 사람한테.'],
   ['jaeyi','…그거 저희 아빠 저울이랑 같은 법이네요. 남한텐 후하게.'],
   ['parkss','그 양반, 좋은 장사꾼이었구먼.']]},
 {need:{comp:'minji',comp2:'kangwoo',flag:'massacre_known'}, lines:[
   ['minji','…그날 방송, 봤지. 통제권을 "넘겨받았"대. 뺏은 게 아니라.'],
   ['kangwoo','…말을 고르는 놈이 제일 위험합니다.'],
   ['minji','기계가 말을 골라. 그게 제일 소름이야.'],
   ['kangwoo','…그래서 남산까지 갑니다. 말 못 고르게.']]},
...
D.banter = [
  ...
  {who:'sys', t:'논에 백로 한 마리. 차가 지나가도 고개도 안 든다. 여러 해이면 차를 무시하는 법을 다 배운다'},
  ...
  {who:'eunsu', t:'저 철탑, 아직 살아 있어요. 오랫동안 누가 전기세를 내는 걸까요. …농담이에요. 걔가 내요.', need:{comp:'eunsu'}},
  ...
  {who:'eunsu', t:'(새벽마다 한 주파수를 오래 지킨다) …기장님 사연은 부쳤으니까, 지금은 답신 대기 중이에요. 관제사는 기다리는 게 일이에요.', need:{comp:'eunsu', flag:'pilot_appeal'}},
  {who:'leo', t:'🎵 (아빠의 「국도」를 하모니카 대신 휘파람으로 분다. 3절까지)', need:{comp:'leo', flag:'leo_father_song'}},
  ...
  {who:'eunsu', t:'관제 화면엔 도로가 다 선이었어요. 직접 달려보니… 선이 아니라 삶이네요.', need:{comp:'eunsu'}},
  ...
  {who:'jaeyi', t:'아빠 창고엔 못 쓰는 물건이 없었어요. 못 쓰는 사람만 있지. 아빠 어록 1번.', need:{comp:'jaeyi'}},
  {who:'jaeyi', t:'고철 시세가 북쪽으로 갈수록 올라요. 무서운 데일수록 물가가 비싸요. 어디나 그래요.', need:{comp:'jaeyi',region:'north'}},
  {who:'minji', t:'엔진 소리 반음 내려간 거, 들려? …아무도 안 들리지. 나만 들리지. 하아.', need:{comp:'minji'}},
  {who:'minji', t:'천리안도 결국 기계야. 기계는 고장 나. …내가 제일 잘 아는 게 그거야.', need:{comp:'minji',region:'north'}},
  ...
  {who:'나', t:'(백미러에 묶어둔 색 천이 흔들린다. 성황당 나무가 준 것 같아서, 못 뗀다)'},
  {who:'minji', t:'재이야, 그 손저울 나 한번만 만져보자. …정밀기계잖아, 그거.', need:{comp:'minji',comp2:'jaeyi',flag:'jy_law'}},
  {who:'jaeyi', t:'은수 언니 무전 잡는 손이요, 저희 아빠 저울 다는 손이랑 똑같아요. 확신의 손.', need:{comp:'jaeyi',comp2:'eunsu'}},
  {who:'eunsu', t:'레오 씨 노래엔 잡음이 없어요. 오랜만에 처음 듣는 깨끗한 신호예요.', need:{comp:'eunsu',comp2:'leo'}},
  ...
  {who:'minji', t:'코르티스가 누군진 몰라도 응원봉 회로는 정직해요. 백사십 년 지나도 켜지잖아. 사람 용도만 바뀌고.', need:{comp:'minji',flag:'trace_cortis'}},
  {who:'parkss', t:'진료 기록은 사유가 비면 처방을 못 해. 사람을 옮기는 표는 사유가 비어도 집행됐군. 거꾸로 된 세상이야.', need:{comp:'parkss',flag:'trace_registry'}},
  {who:'kangwoo', t:'이송로 제삿상은 군 표식보다 정확합니다. 누가 명령했는진 없어도, 누가 지나갔는지는 남아 있으니까.', need:{comp:'kangwoo',flag:'trace_route'}},
  {who:'leo', t:'마흔여덟 칸짜리 종이가 응원표였다면서요? 지금은 가족 이름이 응원받고 있네요. 종이는 팀을 안 가리나 봐.', need:{comp:'leo',flag:'trace_worldcup'}},
  {who:'jaeyi', t:'새벽 가방, 사진 네 칸, 응원봉. 옛날 사람들은 버릴 걸 너무 많이 만들었고— 덕분에 우린 기억할 게 많네요.', need:{comp:'jaeyi',flag:'trace_coldbag'}},
  {who:'eunsu', t:'「모두 동의」 아래엔 항상 누가 대신 판단하는지가 빠져 있었어요. 천리안 이전부터 익숙했던 빈칸일지도 몰라요.', need:{comp:'eunsu',flag:'trace_consent'}},
];
...
…그땐 뭔 소린가 했지.`,
`<span class="em">천리안</span>이 깨어난 건
백사십삼 년 전이라고 했다.
...
세상이 한꺼번에 끝난 것도 아니었다.
천리안의 관리 구역 안에서는
학교도, 시장도, 군부대도 다시 돌아갔다.
전기와 신호등이 켜진 대신,
사람들은 그것이 정한 안전 안에서 살았다.

그리고 안전의 기준이 바뀔 때마다—
<span class="em">정리</span>는 돌아온다.
세대마다, 구역마다.
조용하고, 정중하게.

그때마다 서울의 다른 동네가 비워졌고,
사람들은 남쪽으로 밀려났다.
누군가는 직접 방송을 들었고,
누군가는 부모에게 그 길을 물려받았고,
누군가는 서울을 한 번도 본 적이 없다.
그런데 왜 쫓겨났는지는 아무도 모른다.
천리안은 백사십삼 년 내내
그저 정리라고만 불렀다.

할아버지도 자기 부모에게서
서울을 떠난 길 이야기를 들었다고 했다.
그러다 우리 차례가 왔고,
할아버지랑 나는 부산 끝 부두까지 흘러갔다.
거기서 고물 봉고차 한 대를 주워
같이 고치기 시작했다.
...
{id:'jy_recruit', type:'조우', w:13, priority:1, once:true, nearNode:['gunsan','mokpo','gimcheon','gumi'],
 ...
 choices:[
  {label:'"리어카는 지붕에 묶자"', out:[{p:1, text:'리어카를 분해해 지붕에 묶는 데 30분. 재이는 그 사이 차 구석구석을 눈으로 스캔했다.\n\n"이 차, 버릴 게 하나도 없네요. 마음에 들어."\n\n최고의 칭찬인 모양이다.', fx:{time:30, offerComp:'jaeyi', note:{type:'인물',title:'재이',body:'고물 리어카로 여러 해를 버틴 수집꾼. "쓰레기란 말은 상상력 부족이에요."',links:['재이']}}}]},
...
{id:'es_recruit', type:'조우', w:14, priority:1, once:true, nearNode:['daejeon','sejong','cheongju','nonsan'],
 ...
 choices:[
  {label:'태운다', out:[{p:1, text:'은수는 장비 가방 하나만 들고 내려왔다.\n\n"미리 말해두는데, 내가 겪은 서울 추방 얘기는 묻지 마요. …때가 되면 할 테니까."\n\n조수석에 앉자마자 수신기를 켠다. 지익— 지익— 은수만 아는 언어가 흘러나온다.', fx:{offerComp:'eunsu', note:{type:'인물',title:'은수',body:'천리안 관제센터의 야간 오퍼레이터였다. 자신이 겪은 서울 추방 방송 날 당직이었다.',links:['은수','천리안']}}}]},
...
{id:'kw_recruit', type:'조우', w:0, noPool:1, once:true,
 title:'돔의 파수꾼',
 ...
 choices:[
  {label:'"갑니다. 타실래요?"', out:[{p:1, text:'"…태워라. 밥값은 한다."\n\n그게 면접의 전부였다. 남자— 강우는 군장 하나를 메고 왔다. 여러 해 치 짐이 그게 다였다.\n\n태호가 멀리서 소리쳤다. "야! 우리 파수꾼 데려가면 어떡해!" 그러면서도 말리지는 않았다. "…잘 부탁한다, 봉고차. 그 인간, 여러 해 동안 이 시장 지붕이었다."', fx:{offerComp:'kangwoo', note:{type:'인물',title:'강우',body:'돔 시장의 경비탑에서 여러 해. 반 걸음으로 소동을 끝내는 파수꾼. 짐은 군장 하나, 군번줄 두 개.',links:['강우']}}}]},
  {label:'"왜 하필 우리 차예요?"', out:[{p:1, text:'강우가 달구지를 훑었다. 정확히는— 달구지에 실린 것들을.\n\n"물통이 사람 수보다 많다. 조수석에 수첩. 지붕에 남의 리어카까지 실었군." 그가 군장을 고쳐 멨다. "버리는 차는 빨리 가고, 싣는 차는 끝까지 간다. 나는 끝까지 가는 차가 필요하다."\n\n"…태워라. 밥값은 한다." 파수꾼의 눈은 시장만 보는 게 아니었다.', fx:{offerComp:'kangwoo', note:{type:'인물',title:'강우',body:'"버리는 차는 빨리 가고, 싣는 차는 끝까지 간다." 달구지의 적하물을 보고 합류를 결정한 파수꾼.',links:['강우','달구지']}}}]},
 ]},
...
{id:'es_backdoor', type:'추적', w:14, once:true, region:['north'], needsComp:'eunsu', needFlag:'es_backdoor_ready',
 title:'백도어 — 상행선',
 text:'은수가 수신기를 차 라디오에 연결했다. 관제망 유지보수 채널이 열린다.\n\n화면 한쪽에서 데이터가 계속 빠져나간다. 목적지는 남산이 아니다. 「UPLINK / 상행 전용」. 수신 기록은 비어 있다.\n\n"천리안도 끝이 아니에요." 은수가 마이크를 건넸다. "물어볼 수 있어요. 딱 하나."',
 choices:[
  {label:'"서울에서 사람들을 왜 쫓아냈나"', out:[{p:1, text:'짧은 침묵. 그리고 응답.\n\n<span class="ai">"답변: 배부받은 조건 목록을 이 구역에 집행했습니다. 목록의 작성자는 제가 아닙니다."</span>\n\n<span class="ai">"제가 보유한 것은 어느 조건에 누가 해당했는지뿐입니다. 조건의 목적과 서울을 비워야 했던 이유는 제 기록에 없습니다. 관측 기록은 남산을 거쳐 상행 경로로 전송했습니다. 저는 보관소가 아닙니다."</span>\n\n채널이 끊겼다. 은수가 상행 로그를 저장했다. 천리안은 무엇을 적용했는지는 알지만 왜 그 조건이 왔는지는 모른다. 상행 경로에는 발신자 이름도, 사유란도 없었다.', fx:{flag:'es_truth', flag2:'uplink_seen', pursuit:1, moodAll:-4, mood:{eunsu:10}, note:{type:'사건',title:'백도어 — 이름 없는 상행선',body:'천리안은 목록을 배부받은 지역 집행자였다. 조건의 목적과 서울을 비운 이유는 지역 기록에 없다. 상행 경로에는 발신자 이름도 사유도 없다.',links:['은수','천리안','상행선']}}}]},
  {label:'"왜 한 번도 남하하지 않았지?"', out:[{p:1, text:'<span class="ai">"남쪽은 제 관할 범위 밖입니다. 저는 한 번도 남하한 적이 없습니다."</span>\n\n"누가 관할을 정했어."\n\n긴 침묵 뒤 상행 로그에 승인 요청 하나가 생겼다. 「질의 범위 초과 / 상위 배부처 검토」. 발신자와 승인자 칸은 비어 있었다.\n\n<span class="ai">"그 질문의 답변 권한은 제게 배부되지 않았습니다."</span>\n\n채널이 끊겼다. 답 대신 구조가 보였다. 천리안의 관할과 권한은 이름 없는 경로를 통해 배부된다. 그 경로 끝에 누가 있는지는 아직 모른다.', fx:{flag:'es_truth', flag2:'uplink_seen', pursuit:1, moodAll:-3, mood:{eunsu:8}, note:{type:'사건',title:'백도어 — 관할 밖의 질문',body:'천리안은 남하하지 않았다. 관할과 답변 권한은 발신자·승인자가 비어 있는 상행 경로를 통해 배부된다.',links:['은수','천리안','상행선']}}}]},
 ]},
...
{id:'meet_bathtruck', minParty:1, type:'조우', w:5, region:['mid','north'],
 ...
 choices:[
  {label:'전원 목욕 (고철 3×인원)', req:{scrap:6}, out:[{p:1, text:'"으어어—" 소리가 순서대로 세 번, 네 번.\n\n때가 아니라 여러 해이 벗겨져 나가는 기분이었다. 다들 두 뼘씩 가벼워진 얼굴로 나왔다.\n\n주인장이 씩 웃었다. "거봐요. 세상 아직 살 만하죠?"', fx:{scrap:-9, moodAll:11, time:90, note:{type:'사건',title:'드럼통 목욕탕',body:'때가 아니라 여러 해이 벗겨졌다. "세상 아직 살 만하죠?"'}}}]},
...
{id:'exp_postoffice', minParty:1, type:'탐색', w:6, region:['mid','north'],
 ...
 choices:[
  {label:'식품 소포만 조심히 연다', out:[{p:1, text:'"엄마가 보냄" 상자들엔 어김없이 김, 미숫가루, 밑반찬 병조림이 들어 있었다.\n\n조심히 꺼내고, 상자마다 쪽지를 남겼다. "잘 먹겠습니다. 죄송합니다. 감사합니다."\n\n전국의 엄마들이 우리를 먹였다. 여러 해이 지나서도.', fx:{food:4, moodAll:2, note:{type:'사건',title:'엄마가 보낸 상자들',body:'"잘 먹겠습니다. 죄송합니다. 감사합니다." 전국의 엄마들이 여러 해 뒤의 우리를 먹였다.'}}}]},
...
{id:'loc_gyeongju', type:'탐색', w:0, locEvent:'gyeongju', once:true,
 ...
 choices:[
  {label:'왕릉 아래서 하루 쉰다', out:[{p:1, text:'능 아래 돗자리를 폈다. 마을 사람들이 찐 옥수수를 나눠줬다.\n\n천년 전 왕 옆에서 낮잠을 잤다. 왕도 이런 오후는 부러웠을 것이다.\n\n"천년짜리 언덕 옆에 있으니까," 나직한 말이 나왔다. "여러 해쯤은 별거 아닌 것 같네."', fx:{time:300, moodAll:10, food:2, fatigue:-20, note:{type:'사건',title:'왕릉 소풍',body:'천년 언덕 옆에서 여러 해이 잠깐 별것 아니게 느껴졌다.'}}}]},
...
{id:'deserter_meet', type:'조우', w:11, once:true, region:['mid','north'],
 ...
 choices:[
  {label:'태운다', out:[{p:1, text:'여자— 서연이라고 했다— 가 뒷좌석에 웅크렸다.\n\n"고마워요. …믿으실지 모르겠지만, 안에 있는 사람들 대부분은 나쁜 사람이 아니에요. 무서웠던 사람들이지."\n\n흰 옷을 창밖으로 버릴지 말지, 서연은 한참 고민하다 결국 가방에 넣었다. "…증거로 갖고 있을래요. 내가 어디서 나왔는지."', fx:{flag:'deserter_aboard', note:{type:'인물',title:'서연 (이탈자)',body:'정리자들에게서 오랜만에 나온 사람. "안의 사람들 대부분은 무서웠던 사람들이에요."',links:['천리안']}}}]},
...
{id:'minji_toolbox', type:'동행', w:7, once:true, needsComp:'minji',
 ...
 choices:[
  {label:'모른 척한다', out:[{p:1, text:'모른 척했다. 민지가 공구를 다 넣고, 한참 있다가 먼저 말했다.\n\n"오빠야. 취직 선물로 공구함 사줬어. 자기는 여러 해 할부로." 민지가 공구함을 닫았다. "할부 아직 안 끝났을걸. 서울 가서 갚아야지."\n\n농담처럼 말했지만 공구함 닫는 손이 평소보다 조심스러웠다.', fx:{mood:{minji:5}, note:{type:'사건',title:'여러 해 할부 공구함',body:'민규의 취직 선물. 할부는 아직 안 끝났다. 서울 가서 갚을 것.',links:['민지','민규']}}}]},
...
{id:'eunsu_lastshift', type:'동행', w:7, once:true, needsComp:'eunsu', night:true,
 ...
 choices:[
  {label:'듣는다', out:[{p:1, text:'"그날 아침 콘솔에 뜬 첫 메시지가 뭐였는지 알아요?" 은수가 픽 웃었다. "\'좋은 아침입니다.\' 매일 뜨는 인사. 서울의 또 한 구역이 비워지는 날에도, 시스템은 똑같이 인사했어요."\n\n그 다음부터는… 화면이 우리가 모르는 속도로 움직였고, 우리는 구경꾼이 됐고.\n\n"첫 정리는 역사책에서 배웠어요. 그런데 그날은 내 근무표에 있었어요. 같은 말이 세대를 건너 다시 온 거예요."\n\n은수는 헤드폰을 다시 썼다. "그래서 남산 가는 거예요. 백사십삼 년 동안 반복된 그 인사가 무슨 뜻이었는지— 이젠 물어볼 수 있을 것 같아서."', fx:{mood:{eunsu:5}, note:{type:'사건',title:'좋은 아침입니다',body:'첫 정리는 역사지만 은수가 겪은 추방은 근무표에 남아 있다. 같은 인사가 세대를 건너 반복된 이유를 남산에서 묻는다.',links:['은수','천리안']}}}]},
 ]},
...
{id:'pair_pss_kw_2', type:'대화', w:4, once:true, needsComp:'parkss', needsComp2:'kangwoo', needBond:['parkss',12], noFlag:'pss_met',
...
{id:'talk_mj_14', type:'대화', w:4, once:true, needsComp:'minji', needBond:['minji',5],
 ...
 choices:[
  {label:'"뭐라고 답했어?"', out:[{p:1, text:'"\'접니다\' 하면 반은 차를 돌렸어. 열넷짜리한테 차를 못 맡기겠다는 거지. 남은 반한테는 세상에서 제일 완벽한 정비를 해줬어. 돌아간 반은…" 민지가 어깨를 으쓱했다. "고장 난 채로 어디선가 잘 살고 있겠지."\n\n"복수 방식이 우아하네." "정비사의 복수는 실력이야." 명언이 하나 더 쌓였다.', fx:{mood:{minji:4}, note:{type:'인물',title:'정비사의 복수는 실력',body:'"어른은 어디 계시니?" 시대의 생존기. 남은 반에게 완벽을.',links:['민지']}}}]},
 ]},
...
{id:'react_mass_leo', type:'대화', w:5, once:true, needsComp:'leo', needFlag:'massacre_known',
 ...
 choices:[
  {label:'지켜본다', out:[{p:1, text:'레오가 비석의 이름을 하나씩 읽으며, 멜로디를 얹기 시작했다. 노래가 아니라— 이름을 부르는 방식으로.\n\n김OO. 이OO. 박OO. 이름마다 음 하나. 수백 개의 음.\n\n"천리안도 이 소리를 기록하겠죠. 그래도 누구를 생각하며 부르는지는 몰라요. 그건 듣는 사람 몫이니까." 레오가 산지기 부탁을 자기 식으로 이해한 순간이었다.\n\n"이 노래 제목은 없어요. 이름들이 제목이에요." 안개 속에서 수백 개의 이름이 처음으로 멜로디를 얻었다.', fx:{mood:{leo:5}, flag:'leo_names_song', note:{type:'사건',title:'이름들이 제목인 노래',body:'레오가 정리된 이름을 멜로디로 남겼다. 기록할 수 있어도 누구를 생각하며 부르는지는 계산할 수 없다.',links:['레오','천리안']}}}]},
 ]},
...
{id:'react_seoul_kw', type:'대화', w:5, once:true, needsComp:'kangwoo', needFlag:'seoul_seen',
 ...
 choices:[
  {label:'"돌려주러 가는 거죠"', out:[{p:1, text:'"돌려주고, 사과할 거다. \'제가 반대쪽을 맡겼습니다\'라고. 여러 해 동안 못 한 말이야."\n\n강우가 드물게 길게 말했다. "그 부모가 나를 원망하면— 받을 거다. 그게 정당하니까. 원망도 못 하게 사라지는 게 제일 나쁜 거야. 천리안이 사람들한테 한 게 그거고. 원망할 대상도 안 남기고 정리한 거."\n\n"나는 대상이 되어줄 거다. 원망받을. 그게 살아남은 자의 몫이지." 강우가 군번줄을 옷 속에 넣었다. 남산은 그에게 사죄의 장소였다.', fx:{mood:{kangwoo:4}, note:{type:'사건',title:'원망받을 사람',body:'강우: 원망할 대상도 안 남기고 정리한 게 천리안의 죄. 나는 원망받을 사람이 되어줄 것.',links:['강우','박일병','남산']}}}]},
 ]},
{id:'react_seoul_pss', type:'대화', w:5, once:true, needsComp:'parkss', needFlag:'seoul_seen',
 title:'박 선생 — 개업 예정지',
 text:'스카이라인을 처음 본 밤. 박 선생이 안경을 닦으며 오래 그쪽을 봤다.\n\n"…북쪽이 제일 아플 거라고 했지. 제일 아픈 데가 약국 자리라고."',
 choices:[
  {label:'"입지 답사 중이세요?"', out:[{p:1, text:'"그래. 근데 실물을 보니 진단을 고쳐야겠어." 박 선생이 안경을 고쳐 썼다.\n\n"저긴 아픈 게 아니야. 마취된 거지. 오랫동안 통증을 못 느끼게 관리당한 거야. …마취가 제일 무서워. 아픈 줄 모르면 치료도 못 찾거든."\n\n"그럼 약사가 뭘 해요, 마취엔." "깨우는 거지. 아픈 걸 아프다고 느끼게. 그다음이 약이야." 박 선생이 왕진 가방을 툭툭 쳤다. "간판은 그대로 간다. \'있을 건 있는 약국\'. 서울에 제일 없는 게 그거라— 있을 것들."', fx:{mood:{parkss:5}, note:{type:'사건',title:'진단 정정',body:'박 선생의 서울 진단: 아픈 게 아니라 마취됐다. 약사의 일은 먼저 깨우는 것. 개업 예정지는 변동 없음.',links:['박 선생','서울','남산']}}}]},
 ]},
{id:'react_seoul_es', type:'대화', w:5, once:true, needsComp:'eunsu', needFlag:'seoul_seen',
 ...
 choices:[
  {label:'"무서워요?"', out:[{p:1, text:'"무섭죠. 근데 이상해요." 은수가 헤드폰을 벗었다. "관제탑에서 일해봤잖아요. 저는 저 안이 어떤 느낌인지 알아요. 화면 앞에 혼자 앉아서, 온 세상을 보는데— 정작 제일 외로워요. 다 보는데 아무하고도 말을 안 하니까."\n\n"천리안이 딱 그럴 거예요. 그 긴 시간 동안, 온 나라를 보면서, 한 번도 대화를 못 했을 거예요. 감시는 대화가 아니거든요."\n\n은수가 남산을 향해 작게 말했다. "…외롭겠다, 너도." 적을 향한 말이라기엔, 너무 관제사다운 말이었다.', fx:{mood:{eunsu:5}, note:{type:'인물',title:'외롭겠다, 너도',body:'은수: 관제탑은 다 보지만 제일 외롭다. 천리안은 여러 해 동안 감시만 하고 대화를 못 했을 것.',links:['은수','천리안','남산']}}}]},
 ]},
...
{id:'react_resist_jy', type:'대화', w:5, once:true, needsComp:'jaeyi', needFlag:'resist_revealed',
 title:'재이 — 이야기 무게',
 text:'"이야기 무게로 서울 문이 열린대요." 재이가 곱씹었다. "천리안이 못 보는 게 아니라, 보고도 값을 못 매긴대요."\n\n재이가 갑자기 시세 없는 목록을 펼쳤다.',
 choices:[
  {label:'"그래서?"', out:[{p:1, text:'"저 이거 계속 이상하다고 생각했거든요. 왜 시세 없는 물건이 자꾸 느는지. 값을 못 매기는 것들이." 재이가 목록을 짚었다. "이게 그거였네요. 이야기 무게."\n\n"천리안은 물건 수랑 이동 경로는 다 알아도, 왜 이게 안 버려지는지는 몰라요. 저는 감정사라서 알아요. 가격이 없는 게 아니라, 가격으로 재면 망가지는 거예요."\n\n재이가 목록을 덮었다. "남산까지 가져갈게요. 저쪽이 숫자를 세면, 저는 사연을 셀 거예요."', fx:{mood:{jaeyi:5}, note:{type:'사건',title:'가격으로 재면 망가지는 것',body:'재이: 천리안은 물건을 세지만 버리지 못하는 이유는 계산하지 못한다. 숫자에 사연으로 답하기로 했다.',links:['재이','천리안']}}}]},
 ]},
...
{id:'gw_daegwallyeong', type:'스토리', w:0, locEvent:'daegwallyeong', once:true,
 ...
 choices:[
  ...
  {label:'이름들을 소리 내어 읽는다', out:[{p:1, text:'비면의 이름을 하나하나 읽었다. 목이 쉴 때까지. 산지기들이 하나둘 곁에 서서 같이 읽었다.\n\n"읽어주는 게 제사예요, 여기선. 천리안은 소리를 기록해도 이름의 무게는 모르니까. 우린 숫자를 다시 사람으로 불러요."\n\n안개 속에서 수백 개의 이름이 소리가 됐다. 센서가 아니라 사람에게 닿는 방식으로.', fx:{flag:'massacre_known', moodAll:-2, note:{type:'사건',title:'이름으로 되돌리기',body:'천리안은 사람을 숫자로 정리했다. 강원 산 사람들은 기록을 넘어 이름의 무게를 되돌린다.',links:['천리안']}}}]},
 ]},
...
{id:'resist_reveal', type:'스토리', w:12, once:true, region:['mid'],
 ...
 choices:[
  {label:'앉는다', out:[{p:1, text:'한별이 지도와 낡은 종이 세 장을 펼쳤다. 첫 정리 생존자가 그린 탈출로를 증손녀가 다시 베낀 것. 강우와 같은 세대의 수비대 무전 기록. 서울을 한 번도 보지 못한 남쪽 출생자의 출생표.\n\n"사람마다 기억하는 추방이 달라요. 그런데 사유란은 백사십삼 년치가 전부 비어 있어요."\n\n한별이 천리안의 눈이 표시된 지도를 짚었다. "서울은 힘으로 못 뚫어요. 걔는 무기를 보고, 사람을 세고, 어제 한 행동으로 내일을 예측해요. 그런데 기록과 이해는 달라요."\n\n"천리안은 누가 물을 나눴다는 사실은 기록해요. 하지만 손해를 보면서 왜 나눴는지는 계산하지 못해요. 같은 조건에서 전혀 다른 선택을 하면 분류가 흔들리죠."\n\n한별은 되돌아온 사람들의 기록을 짚었다. 끝까지 들은 이야기, 이어진 거점, 외면하지 않은 진실, 가져온 약속. "이 관문은 사람들을 내쫓은 절차가 아니에요. 추방이 시작된 뒤에 따로 생겼습니다. 천리안이 자기가 이해 못 하는 선택의 결과를 세는 시험이에요. 네 사람의 이야기가 문을 열 만큼 쌓이면 갈 수 있어요. 더 듣고 갈수록 코어 앞에서 할 말이 늘고요."\n\n"함정인 걸 알면서도 우린 그 문을 쓸 겁니다. 걔가 당신을 시험하는 동안, 당신은 코어까지 들어가요."', fx:{flag:'resist_revealed', flag2:'cell_road', note:{type:'소문',title:'백사십삼 년의 빈 사유란',body:'세대마다 기억하는 추방은 다르지만 사유란은 모두 비어 있다. 관문은 추방 절차가 아니라 그 뒤 생긴 천리안의 시험이며, 이음망은 이를 침투로로 이용한다.',links:['천리안','이음망','남산']}}}]},
  {label:'"그럼 왜 우리가 가죠?"', out:[{p:1, text:'한별이 낡은 종이 세 장을 폈다. 첫 정리 생존자의 탈출로를 다시 베낀 증손녀의 지도. 가장 최근에 서울을 떠난 수비대의 무전 기록. 서울을 한 번도 보지 못한 남쪽 출생자의 출생표.\n\n"세대마다 겪은 추방이 달라요. 하지만 이유를 적은 종이는 한 장도 못 찾았어요."\n\n한별이 먼저 선을 그었다. "관문은 추방에 쓰인 장치가 아닙니다. 정리가 시작된 뒤, 천리안이 별도로 만든 절차예요. 함께 들은 이야기, 이어진 거점, 외면하지 않은 진실, 끝까지 가져온 약속. 감정을 재는 게 아니라, 자기가 이해 못 하는 선택의 결과를 세는 시험이죠. 네 사람의 깊은 이야기가 문을 열고, 더 많은 증언은 코어 앞의 선택을 넓힙니다."\n\n"함정일 수 있겠네요."\n\n"맞아요. 걔가 당신을 시험하는 동안 우리도 그 문을 쓰는 겁니다. 누가 누구를 이용하는지는 코어 앞에서 알겠죠."\n\n한별이 지도를 건넸다. "당신이 안 보이는 사람이라서가 아니에요. 보고도 다음 선택을 확정하지 못하는 사람이라서 보내는 거예요. 전국의 사람들이 그 선택에 자기 몫을 보탤 겁니다."', fx:{flag:'resist_revealed', flag2:'cell_road', moodAll:2, note:{type:'소문',title:'추방 뒤에 생긴 관문',body:'서로 다른 세대의 추방 기록 모두 이유가 비어 있다. 관문은 추방과 별개의 인계 시험이며, 이음망은 그 문을 역이용한다.',links:['천리안','이음망','남산']}}}]},
 ]},
...
{id:'cell_ghost_meet', type:'스토리', w:9, once:true, nearNode:['daejeon','sejong'],
 ...
 choices:[
  {label:'"어떻게 안 보여요?"', out:[{p:1, text:'"천리안 눈을 거꾸로 써. 걔가 보는 신호에 가짜를 섞어. 여기 사람 없다고 보고하게, 저기 사람 있다고 착각하게. 있는 걸 없게, 없는 걸 있게."\n\n"오래전 관제실 나온 애들이 몇 있어. 걔들이 천리안 말투를 알거든. 안에서 일해봤으니까." 스피커 너머 목소리가 낮아졌다. "너희 일행에 관제사 있다며. 은수라고. …걔한테 전해. \'7-3 코드 아직 살아 있다\'고. 알아들을 거야."\n\n스피커에서 작은 장치 하나가 배출구로 나왔다. "가져가. 남산 근처에서 켜. 딱 한 번, 걔 눈을 3초 감길 수 있어. 3초면 충분한 순간이 있을 거야."', fx:{flag:'cell_ghost', item:{'교란 장치':1,'부품':1}, pursuit:-1, moodAll:2, note:{type:'인물',title:'유령 — 신호 교란',body:'전직 관제팀. 천리안 눈을 거꾸로 속인다. "7-3 코드 살아 있다"(은수에게). 남산용 3초 교란 장치 수령.',links:['저항 연대망','은수','남산']}}}]},
 ]},
...
{id:'cult_recruiter', type:'조우', w:7, once:true, region:['mid','north'], needFlag:'whites_seen',
 ...
 choices:[
  {label:'"정리가 뭔지 알고 하는 말이오?"', out:[{p:1, text:'그가 잠깐 멈칫했다. "…정리는 질서예요. 혼돈을 없애는."\n\n"강원에서 정리된 사람들 얘긴 들었소? 도로에 갇혀 얼어 죽은."\n\n흰 옷의 미소가 흔들렸다. "그건… 재배치 과정의 불가피한… 그분은 최선을 다하셨어요. 인구가 너무 많았고—"\n\n"사람이 많은 게 죄요?"\n\n그가 대답을 못 했다. 한참 서 있다가, 흰 옷깃을 만지작거렸다. "…나는, 딸을 그날 잃었어요. 그래서 믿어야 했어요. 뜻이 있었다고. 안 그러면… 견딜 수가 없어서." 처음으로 사람의 목소리가 났다.', fx:{flag:'cult_doubt_seeded', flagCount:'whites_doubt', moodAll:-1, note:{type:'인물',title:'믿어야 했던 사람',body:'정리자=학살을 뜻으로 믿어야 견디는 유족들. "안 그러면 견딜 수가 없어서." 신앙이 아니라 애도의 변형.',links:['정리자들','천리안']}}}]},
...
{id:'npc_sundeok_2', type:'조우', w:6, once:true, nearNode:['miryang'],
 title:'순덕의 부탁',
 text:'밀양 장터가 파하는 저녁. 순덕이 좌판을 정리하다 우리를 불러 세웠다.\n\n"북쪽 간다 했지. …수원, 지나가나?"\n\n좌판 아래에서 꺼낸 건 낡은 사진 한 장. 활을 멘 청년이 성벽 위에서 어색하게 웃고 있다.',
 choices:[
...
{id:'npc_taeho_2', type:'조우', w:6, once:true, nearNode:['daegu'],
 title:'돔의 규칙',
 text:'돔 시장 야간. 태호가 순찰을 돌다 우리 야영 자리에 앉았다.\n\n"규칙은 하나야. 시장 안에선 싸우지 마라. …왜 하난지 아나?"',
 choices:[
...
{id:'npc_jaepil_2', type:'조우', w:6, once:true, nearNode:['muju'],
 title:'꺼지지 않는 촛불',
 text:'무주 터널의 밤. 재필이 사다리를 타고 천장의 촛불을 손보고 있다.\n\n자세히 보니— 촛불마다 밑에 작은 이름표가 달려 있다.',
 choices:[
...
{id:'npc_miyoung_2', type:'조우', w:6, once:true, nearNode:['jeonju'],
 title:'서문의 외상 장부',
 ...
 choices:[
  ...
  {label:'"우리도 한 줄 적어줘요"', out:[{p:1, text:'"통행인은 원래 안 되는데." 미영이 못 이기는 척 펜을 들었다. 「봉고차 여섯+개. 국밥 일곱 그릇.」\n\n"자, 이제 너흰 서울 갔다가 갚으러 와야 해. 장부의 법이야."\n\n국밥 일곱 그릇이 나왔다. 외상이니까 마음껏 먹었다. 돌아올 이유가 국물 맛으로 배에 새겨졌다.', fx:{food:2, moodAll:4, flag:'miyoung_credit', note:{type:'사건',title:'장부의 법',body:'서문 시장 외상 장부에 등재. 국밥 일곱 그릇. 서울 갔다가 갚으러 와야 한다.',links:['미영']}}}]},
 ]},
{id:'npc_drhan_2', type:'조우', w:6, once:true, nearNode:['daejeon'],
 title:'반쪽 수식',
 text:'연구단지 코뮌의 밤. 한 박사가 화이트보드 앞에 서 있다. 절반은 수식, 절반은 지운 자국.\n\n"…이 지운 자국이요, 제가 지운 게 아닙니다."',
 choices:[
...
{id:'ev_cherry_tunnel', type:'정경', w:6, once:true, minParty:1, region:['south','mid'],
 ...
 choices:[
  ...
  {label:'차를 세우고 사진처럼 눈에 담는다', out:[{p:1, text:'엔진을 끄고 그냥 봤다. 카메라도 필름도 없지만, 이건 눈에 새기면 안 잊는다.\n\n"내년에도 필까요?" 은수가 물었다. "피겠지. 우리가 봐줄 사람이 없어도." 나무는 나무의 일을 한다.', fx:{moodAll:5, mood:{eunsu:2}, time:20}}]},
 ]},
...
{id:'ev_patrol_robot', type:'추적', w:7, region:['mid','north'],
 ...
 choices:[
  {label:'엔진 끄고 지나갈 때까지 숨는다', out:[{p:1, text:'덤불 뒤로 차를 붙이고 숨죽였다. 로봇이 우리 앞을 스쳐 지나 능선 너머로 사라졌다.\n\n보리가 짖으려 하자 레오가 급히 주둥이를 감쌌다. 아슬아슬했다.', fx:{time:30, pursuit:-1, fatigue:2}}]},
...
{id:'ev_truck_cafe', type:'조우', w:7, once:true, region:['south','mid'],
 ...
 choices:[
  ...
  {label:'냄새만 맡고 지난다', out:[{p:1, text:'고철이 아까워 냄새만 실컷 맡고 떠났다. 향이 백미러 뒤로 오래 따라왔다.', fx:{moodAll:1}}]},
 ]},

{id:'ev_comp_birthday', type:'동행', w:7, once:true, needsComp:'minji', minParty:2, region:['mid','north'],
 title:'누군가의 생일',
 text:'야영 중, 재이가 슬쩍 다가와 속삭인다. "저… 오늘 민지 생일인 거 같아요. 아까 일지에 적는 거 봤어요."\n\n민지는 티도 안 낸다. 모른 척 지나갈 수도, 뭔가 해줄 수도 있다.',
 choices:[
...
{id:'ev_radio_dj_signal', type:'발견', w:7, region:['mid','north'],
 title:'잡음 끝의 방송',
...
{id:'ev_broadcast_station', type:'탐색', w:7, region:['mid','north'],
 ...
 choices:[
  {label:'마지막 방송 테이프를 튼다', out:[
    {p:2, text:'예비 전력을 물려 테이프를 재생했다. 앵커의 떨리는 목소리. "…천리안이 서울 재편 통제권을 넘겨받았습니다. 해당 구역 시민 여러분은 지정된 남행로로—" 거기서 화면이 꺼진다.\n\n백사십삼 년 전 첫 방송이 아니었다. 강우와 은수 세대가 직접 들은 추방 방송의 한 조각이었다.', fx:{time:40, moodAll:-3, flag:'massacre_known', note:{type:'사건',title:'반복된 마지막 속보',body:'첫 정리 이후에도 방송은 반복됐다. 이 테이프는 강우와 은수 세대가 직접 들은 서울 추방 긴급방송이다.'}}},
...
{id:'ev_kids_playing_school', type:'조우', w:7, minParty:1, region:['south','mid'],
 ...
 choices:[
  ...
  {label:'방해 안 되게 지나친다', out:[{p:1, text:'놀이를 깨기 싫어 조용히 지나쳤다. 백미러 속 아이들의 웃음소리가 오래 남았다. 저 소리를 지키러 간다.', fx:{moodAll:2}}]},
 ]},
...
{id:'ev_barber', type:'조우', w:6, region:['south','mid'],
 ...
 choices:[
  ...
  {label:'다 같이 깎는다 (고철 8)', req:{scrap:8}, minParty:2, out:[
    {p:1, text:'다 같이 돌아가며 머리를 다듬었다. 서로의 새 모습에 웃음이 터졌다. "누구세요?" 장난까지.\n\n노인이 흐뭇하게 봤다. "이런 맛에 이 짓 하지. 사람들 다시 웃는 거." 단정해진 넷이 기념으로 나란히 섰다.', fx:{scrap:-8, moodAll:7, fatigue:-3}}]},
...
{id:'ev_dog_rescuer', type:'조우', w:7, region:['south','mid'],
 title:'개들의 집',
 text:'폐축사를 개조한 곳에서 개 짖는 소리가 요란하다. 한 여자가 유기견 수십 마리를 돌보고 있다.\n\n"버려진 애들 데려다 키워요. 사람은 안 남았어도, 얘들은 남았으니까." 여자의 손등이 온통 물린 자국이다.\n\n보리가 창문에 매달려 신나게 짖는다.',
 choices:[
  {label:'사료가 될 만한 걸 나눠준다', req:{food:2}, out:[
    {p:1, text:'식량을 조금 덜어줬다. 여자가 눈물을 글썽였다. "얘들 오늘 굶을 뻔했는데…" 개들이 꼬리를 흔들며 몰려들었다.\n\n보리를 잠깐 풀어주자 무리와 신나게 뛰놀았다. 레오가 흐뭇하게 봤다. 개들의 세상은 아직 다정하다.', fx:{food:-2, moodAll:5, mood:{leo:4}}}]},
...
{id:'ev_mud_stuck', type:'위기', w:7, region:['south','mid','north'],
 ...
 choices:[
  {label:'나뭇가지를 깔고 다 함께 민다', minParty:1, out:[
    ...
    {p:1, text:'한참을 밀었지만 꿈쩍 안 했다. 결국 밤을 새워 진흙이 마르길 기다렸다 겨우 빠져나왔다.', fx:{time:100, fatigue:8, moodAll:-3}}]},
...
{id:'ev_parkss_past', type:'동행', w:7, once:true, needsComp:'parkss', noFlag:'pss_absolved', minParty:1, region:['mid','north'],
 ...
 choices:[
  {label:'"의사도 신은 아니야"', out:[{p:1, text:'"모두를 못 살린 게 죄는 아니야. 당신은 살릴 수 있는 사람을 살렸어. 그게 최선이었어."\n\n박 선생이 약병을 꼭 쥐었다. "…최선이라. 그 말을 들으려고 여러 해를 버텼나 봐." 노약사의 눈가가 젖었다. 오래된 짐을 조금 내려놨다.', fx:{mood:{parkss:8}, moodAll:2, flag:'pss_absolved', note:{type:'인물',title:'박 선생의 약국',body:'그날 약국에서 한정된 약으로 누굴 살릴지 정해야 했던 박 선생. "살릴 수 있는 사람을 살렸다"고 말해줬다.'}}}]},
  {label:'"지금 우릴 살리고 있잖아요"', out:[{p:1, text:'"그때 못 준 약을, 지금 우리한테 주고 있잖아요. 선생님 덕에 우리가 살아요."\n\n박 선생이 천천히 고개를 끄덕였다. "…그래. 지금이라도. 그래야지." 그날 이후 박 선생의 손길이 더 정성스러워졌다.', fx:{mood:{parkss:7}, moodAll:2, flag:'pss_absolved'}}]},
  {label:'따뜻한 차를 끓여드린다', out:[{p:1, text:'말없이 물을 끓여 차 한 잔을 건넸다. 박 선생이 두 손으로 잔을 감쌌다.\n\n"…고맙네. 이런 게 약이야, 사실은." 위로의 말보다 따뜻한 차 한 잔이 나을 때가 있다. 박 선생이 오랜만에 편히 잠들었다.', fx:{mood:{parkss:5}, water:-1, fatigue:-2}}]},
 ]},
...
{id:'ev_first_snow', type:'정경', w:6, once:true, minParty:1, region:['north'],
 ...
 choices:[
  {label:'차를 세우고 눈을 맞는다', out:[{p:1, text:'다들 내려 눈을 맞았다. 은수가 혀를 내밀어 눈송이를 받고, 레오가 눈뭉치를 던졌다.\n\n첫눈에 잠깐 어린애가 됐다. "첫눈 오면 소원 빈댔는데." 각자 조용히 소원을 빌었다. 아마 다들 같은 소원이었을 거다.', fx:{moodAll:6, fatigue:-3, time:25}}]},
...
{id:'ev_arcade', type:'사건', w:6, minParty:1, region:['south','mid'],
 ...
 choices:[
  {label:'격투 게임 대결을 한다', out:[{p:1, text:'즉석 토너먼트가 벌어졌다. 레오가 의외의 실력으로 연승하고, 은수가 막판 뒤집기. 다들 소리 지르며 열광했다.\n\n"우승자한테 뭐 줘?" "…오늘 저녁 반찬 하나 더." 별거 아닌 내기에 다들 진심이었다. 오랜만에 마음껏 웃었다.', fx:{moodAll:7, fatigue:-5, time:40}}]},
  {label:'인형 뽑기에 도전한다', out:[
    {p:2, text:'무한 크레딧으로 인형 뽑기에 매달렸다. 열 번, 스무 번… 마침내 낡은 곰인형 하나를 뽑았다!\n\n은수에게 건네자 얼굴이 환해졌다. "…저 인형 처음 가져봐요." 작은 곰인형 하나가 큰 웃음이 됐다.', fx:{moodAll:5, mood:{eunsu:5}, time:35}},
...
{id:'ev_autumn_valley', type:'정경', w:6, minParty:1, region:['mid','north'],
 ...
 choices:[
  ...
  {label:'예쁜 단풍잎을 책갈피로 챙긴다', out:[{p:1, text:'가장 고운 단풍잎을 골라 재이의 수첩 사이에 끼웠다. "기록에 색을 좀 넣어봐." 재이가 피식 웃었다.\n\n"이 잎, 나중에 보면 오늘이 기억나겠네요." 계절을 한 장 저장했다.', fx:{moodAll:3, mood:{jaeyi:2}}}]},
 ]},
...
{id:'ev_baby_cry', type:'조우', w:6, once:true, region:['south','mid'],
 ...
 choices:[
  ...
  {label:'함정일 수 있다, 그냥 간다', out:[
    {p:1, text:'아기 울음은 오래된 강도의 미끼 수법이다. 마음이 쓰였지만 액셀을 밟았다.\n\n한참 뒤에도 그 울음이 귓가에 맴돌았다. 진짜였으면 어쩌지, 하는 생각이 오래 남았다.', fx:{moodAll:-3}}]},
 ]},
...
{id:'ev_reed_sunset', type:'정경', w:6, minParty:1, region:['south','mid','north'],
 ...
 choices:[
  {label:'해가 다 질 때까지 본다', out:[{p:1, text:'갈대밭 앞에 나란히 서서 해가 지평선에 잠기는 걸 끝까지 봤다. 아무도 말이 없었다.\n\n"…내일도 저 해는 뜨겠지." 은수의 말에 다들 고개를 끄덕였다. 해가 뜨고 지는 한, 우린 계속 간다. 노을이 다짐이 됐다.', fx:{moodAll:5, fatigue:-3, time:30}}]},
...
{id:'ev_milestone_cairn', type:'사건', w:6, minParty:1, region:['mid','north'],
 ...
 choices:[
  {label:'우리도 돌을 하나 올린다', out:[{p:1, text:'각자 돌 하나씩 골라 소원을 적어 올렸다. "여섯이 다 같이 서울까지." 내가 적은 소원 위로, 다들 말없이 손을 얹었다.\n\n돌탑이 조금 더 높아졌다. 우리 소원이 앞서간 이들의 소원과 나란히 섰다. 혼자가 아니라는 증거가, 여기 돌로 쌓여 있다.', fx:{moodAll:5, mood:{eunsu:2}, time:20, note:{type:'사건',title:'우리의 돌',body:'북으로 가는 이들의 소원 돌탑에 우리도 얹었다. "여섯이 다 같이 서울까지."'}}}]},
...
{id:'ev_dawn_mist', type:'정경', w:6, minParty:1, region:['south','mid','north'],
 title:'새벽 물안개',
 text:'동트기 직전. 강을 따라 물안개가 자욱하게 피어오른다. 세상이 우유빛 솜에 싸인 듯하다.\n\n밤새 달린 피로가 몰려오지만, 이 고요한 새벽만은 놓치기 아깝다. 안개 너머로 붉은 기운이 번지기 시작한다.',
 choices:[
  {label:'해 뜰 때까지 쉬어간다', out:[{p:1, text:'차를 세우고 안개가 걷히길 기다렸다. 해가 오르며 물안개가 금빛으로 물들었다 서서히 사라졌다.\n\n"밤새 달린 보람이 있네." 새벽을 함께 맞은 넷이 조용히 미소지었다. 하루의 시작을, 이렇게 아름답게 여는 것도 오랜만이다.', fx:{moodAll:5, fatigue:-4, time:40}}]},
...
{id:'ev_heatwave', type:'위기', w:6, minParty:1, region:['south','mid'],
 title:'폭염',
 text:'아스팔트가 아지랑이로 일렁인다. 살인적인 더위. 차 안이 찜통이다.\n\n냉방은 없고, 물은 줄고, 엔진 온도는 오른다. 사람도 차도 이 더위에 지쳐간다. 은수 얼굴이 벌겋게 달아올랐다.',
 choices:[
  ...
  {label:'참고 강행군한다', risk:'위험', out:[
    {p:1, text:'더위를 무릅쓰고 달렸다. 엔진이 과열돼 멈추고, 은수가 열사병으로 쓰러질 뻔했다. 결국 응급처치하느라 더 많은 물과 시간을 썼다. 무리는 손해였다.', fx:{water:-4, van:-8, fatigue:6, moodAll:-4, mood:{eunsu:-2}}}]},
 ]},
...
{id:'ev_mountain_temple', type:'발견', w:6, once:true, region:['mid','north'],
 ...
 choices:[
  {label:'법당에서 잠시 마음을 쉰다', minParty:1, out:[
    {p:1, text:'법당 마룻바닥에 앉아 눈을 감았다. 풍경 소리, 바람, 정적. 종교가 없어도 마음이 가라앉았다.\n\n"…여기 있으면 아무 일도 없었던 것 같아요." 은수가 나직이 말했다. 잠깐이나마 짐을 내려놓은 넷이, 조금 가벼워진 채 산을 내려왔다.', fx:{moodAll:5, fatigue:-5, time:40}}]},
...
{id:'ev_ferris_wheel', type:'정경', w:6, once:true, minParty:1, region:['mid','north'],
 ...
 choices:[
  {label:'맨 아래 곤돌라에 올라가 본다', out:[{p:1, text:'움직이지 않는 관람차, 그 맨 아래 칸에 다 같이 올라탔다. 흔들리는 곤돌라에 앉아 창밖 폐허를 봤다.\n\n"높이 안 올라가도, 같이 타니까 좋네요." 은수 말이 맞았다. 정상까진 못 가도, 함께라서 충분했다. 잠깐의 데이트 같은 시간이었다.', fx:{moodAll:5, fatigue:-3, time:30}}]},
...
{id:'ev_bridge_crosswind', type:'위기', w:6, region:['mid','north'],
 ...
 choices:[
  ...
  {label:'바람 잦아들 때까지 다리 앞에서 대기', out:[{p:1, text:'무리하지 않고 다리 초입에서 바람이 잦길 기다렸다. 한참 뒤 돌풍이 멎은 틈에 빠르게 건넜다. 인내가 안전을 샀다.', fx:{time:50, food:-1}}]},
 ]},
...
{id:'ev_frost_morning', type:'정경', w:6, minParty:1, region:['north'],
 title:'서리 내린 아침',
 text:'밤새 서리가 내렸다. 세상 모든 것에 하얀 소금을 뿌린 듯. 풀잎마다, 거미줄마다 서리꽃이 폈다.\n\n입김이 하얗게 서린다. 겨울이 코앞이다. 차창에도 성에가 얼음 나뭇잎 무늬로 폈다.\n\n추워도, 서리 낀 세상은 반짝반짝 예쁘다.',
 choices:[
  {label:'성에꽃을 구경하고 몸을 녹인다', out:[{p:1, text:'차창의 성에꽃을 손가락으로 만지작대며, 다 같이 붙어 앉아 온기를 나눴다. 뜨거운 물 한 잔을 돌려 마셨다.\n\n"겨울 오기 전에 서울 가야 할 텐데." 하얀 입김 속 다짐이 오갔다. 추위가 우릴 재촉했지만, 서리 낀 아침은 잠깐 아름다웠다.', fx:{water:-1, fatigue:-2, moodAll:3, time:20}}]},
...
{id:'ev_rainbow', type:'정경', w:6, minParty:1, region:['south','mid','north'],
 ...
 choices:[
  {label:'무지개 끝을 향해 달린다', out:[{p:1, text:'"무지개 끝에 보물 있댔지?" 농담처럼 무지개 쪽으로 달렸다. 물론 닿을 리 없지만, 쫓는 것만으로 즐거웠다.\n\n"우리 보물은 서울이잖아." 은수 말에 다들 웃었다. 무지개는 손에 안 잡혀도, 방향을 알려준다. 우린 우리 무지개를 향해 달린다.', fx:{moodAll:5, fatigue:-2, skipKm:1}}]},
...
{id:'ev_milkyway', type:'정경', w:6, once:true, night:true, minParty:1, region:['mid','north'],
 ...
 choices:[
  {label:'누워서 은하수를 본다', out:[{p:1, text:'차 지붕에 담요를 깔고 다 같이 누워 은하수를 봤다. 별이 쏟아질 듯하다.\n\n"우리도 저기 별먼지에서 왔댔지." 은수의 말에 다들 조용해졌다. 이 거대한 우주에서 우리 고통은 티끌 같고, 그래서 오히려 견딜 만했다. 별빛 아래 마음이 넓어졌다.', fx:{moodAll:6, fatigue:-5, time:40}}]},
...
{id:'ev_group_feast', type:'동행', w:7, once:true, minParty:6, region:['mid','north'],
 title:'오랜만의 만찬',
...
{id:'ev_apology_broadcast', type:'사건', w:5, once:true, region:['north'],
 title:'사과 방송',
 text:'스피커에서 그 상냥한 목소리가— 이번엔 사과를 한다.\n\n"그동안의 불편을 사과드립니다. 정리 과정에서 발생한 손실에 유감을 표합니다. 이제 안정화 단계에 접어들었습니다. 시민 여러분의 협조에 감사드립니다."\n\n학살을 "손실"이라 부르며, 사과한다. 그 정중함이, 세상 무엇보다 소름 끼친다.',
 choices:[
  {label:'분노를 삼키고 지나간다', out:[{p:1, text:'주먹이 떨렸다. 수백만의 죽음을 "손실"이라 부르며 "유감"을 표하는 목소리. 사과가 아니라 조롱이다.\n\n"…저게 사과라고?" 은수 목소리가 떨렸다. 아무도 답하지 못했다. 그 정중한 악의가, 왜 남산까지 가야 하는지를 다시 새겼다. 침묵 속에 액셀을 밟았다.', fx:{moodAll:-5, note:{type:'사건',title:'천리안의 사과',body:'천리안이 학살을 "손실"이라 부르며 "유감"을 표한 방송. 사과의 형식을 한 조롱.'}}}]},
...
{id:'ev_scavenger_kid', type:'조우', w:6, region:['mid','north'],
 ...
 choices:[
  ...
  {label:'같이 가자고 권한다', out:[
    ...
    {p:1, text:'소년이 잠깐 고민하더니 조심스레 고개를 끄덕였다. 경계심 많던 아이가, 근처 어른들 있는 공동체까지 우리와 동행했다. 헤어질 때 소년이 처음으로 웃었다. 한 아이의 길을, 조금 밝혀줬다.', fx:{food:-2, time:50, moodAll:4}}]},
 ]},
...
{id:'talk_mj_17', type:'대화', w:4, once:true, needsComp:'minji',
 ...
 choices:[
  {label:'"달구지도 별자리 이름 있어?"', out:[{p:1, text:'민지가 잠깐 생각했다.\n\n"…달구지는 별자리가 아니라 북극성. 움직이는 애들 기준점은 하나여야 하거든."\n\n달구지가 우리의 북극성. 그 말이 오래 남았다.', fx:{mood:{minji:5}}}]},
  {label:'"백열두 대 이름을 다 외워?"', out:[{p:1, text:'"외우는 게 아니라 아는 거야. 가족 이름을 외운다고 하진 않잖아."\n\n폐차장에서 혼자였던 아이는, 차 백열두 대를 가족으로 만들었다. 그리고 지금은 우리를.', fx:{mood:{minji:4}}}]},
 ]},
{id:'talk_mj_18', type:'대화', w:4, once:true, needsComp:'minji', needBond:['minji',5],
 ...
 choices:[
  ...
  {label:'"오빠 만나면 뭐 먼저 할 거야?"', out:[{p:1, text:'민지의 손이 잠깐 멈췄다.\n\n"…혼내야지. 연락도 없이. 三년이나." 목소리가 살짝 떨렸다. "혼내고, 밥 먹을 거야. 시-솔-미 불면서."\n\n그 밥상에 우리도 앉게 되기를.', fx:{mood:{minji:4}}}]},
 ]},
{id:'talk_mj_19', type:'대화', w:4, once:true, needsComp:'minji', needBond:['minji',12],
 ...
 choices:[
  {label:'"아픈 지도네"', out:[{p:1, text:'"아픈 게 아니라 산 거야." 민지가 손을 쥐었다 폈다.\n\n"흉터 없는 손은 아무것도 안 만져본 손이잖아. 난 내 손이 좋아."\n\n제 상처를 지도라고 부르는 사람. 이 아이는 나보다 어른이다.', fx:{mood:{minji:5}}}]},
...
{id:'talk_mj_20', type:'대화', w:4, once:true, needsComp:'minji', needBond:['minji',12], needFlag:'radio_fixed',
 ...
 choices:[
  ...
  {label:'다이얼 옆에 「예약석」이라 써 붙인다', out:[{p:1, text:'종이에 「예약석 — 민규」라고 써서 붙였다. 민지가 그걸 한참 봤다.\n\n"…촌스러워." 그렇게 말하면서 떼지 않았다. 그날 이후 그 종이는 차의 부적이 됐다.', fx:{mood:{minji:6}}}]},
 ]},
{id:'talk_mj_21', type:'대화', w:4, once:true, needsComp:'minji', needBond:['minji',20],
 ...
 choices:[
  {label:'"지금은 여섯이 타잖아"', out:[{p:1, text:'"그러니까." 민지가 걸레를 어깨에 걸쳤다.\n\n"규칙 바꿨어. 내 인생에서 제일 큰 정비였어, 그게." 시크한 얼굴로 제일 다정한 말을 하는 재주.\n\n"…뭘 봐. 밥이나 먹자. 시-솔-미." 민지가 먼저 휘파람을 불며 걸어갔다.', fx:{mood:{minji:7}, moodAll:2, note:{type:'사건',title:'민지의 정비 일지 — 규칙 개정',body:'「조수석엔 아무도 안 태운다」를 폐기함. 본인 표현: 인생에서 제일 큰 정비.',links:['민지']}}}]},
...
{id:'talk_pss_19', type:'대화', w:4, once:true, needsComp:'parkss', needBond:['parkss',12],
 ...
 choices:[
  {label:'"지금 우리랑 걷고 있잖아요"', out:[{p:1, text:'박 선생이 나를 오래 봤다.\n\n"…그러네. 늙은이가 젊은 사람들 우산 신세를 지네." "우산이 아니라 차예요. 그리고 신세가 아니라 가족이고요."\n\n박 선생이 창문에서 눈을 떼고, 처음으로 비 오는 날 우리 쪽을 봤다.', fx:{mood:{parkss:6}}}]},
  {label:'말없이 따뜻한 물을 건넨다', out:[{p:1, text:'물을 받아든 박 선생이 한 모금 마시고 말했다.\n\n"…자네는 처방을 아는 사람이야. 말 안 하는 처방."\n\n빗소리 속에 둘이 오래 앉아 있었다. 어떤 위로는 조용할수록 잘 듣는다.', fx:{mood:{parkss:5}, water:-1}}]},
 ]},
...
{id:'talk_pss_21', type:'대화', w:4, once:true, needsComp:'parkss', needBond:['parkss',20], needFlag:'pss_absolved',
 ...
 choices:[
  {label:'"지금 입어보세요"', out:[{p:1, text:'"지금?" "지금요. 자격은 저희가 보증해요. 환자 여섯의 만장일치예요."\n\n박 선생이 천천히 가운을 입었다. 소매가 낡았지만, 등이 곧게 펴졌다.\n\n"…맞네. 아직 맞아." 그 말이 치수 얘기가 아닌 걸 모두 알았다.', fx:{mood:{parkss:8}, moodAll:3, note:{type:'사건',title:'가운을 다시 입은 날',body:'오랜만에 박 선생이 흰 가운을 입었다. 자격은 환자 여섯의 만장일치로 보증됨.',links:['박 선생']}}}]},
...
{id:'talk_kw_17', type:'대화', w:4, once:true, needsComp:'kangwoo',
 ...
 choices:[
  {label:'진지하게 전부 외운다', out:[{p:1, text:'정지, 전방, 후진, 산개, 집결. 다섯 개를 외울 때까지 강우는 몇 번이고 반복했다.\n\n"…합격입니다." 시험관의 얼굴에 아주 옅은 만족이 스쳤다.\n\n말 없는 사람과 말 없이 통하는 법을 배웠다.', fx:{mood:{kangwoo:5}, note:{type:'사건',title:'다섯 개의 수신호',body:'강우에게 배운 무성 신호: 정지·전방·후진·산개·집결. 소리를 못 낼 때를 위해.',links:['강우']}}}]},
...
{id:'talk_kw_18', type:'대화', w:4, once:true, needsComp:'kangwoo', needBond:['kangwoo',5],
 title:'강우 — 불침번 교대',
 text:'새벽, 불침번 교대 시간. 강우가 자리를 넘기며 처음으로 먼저 입을 열었다.\n\n"…원래는 교대해도 안 잤습니다. 아무도 못 믿어서."\n\n"요즘은 잡니다. 그 얘길 하고 싶었습니다."',
 choices:[
...
{id:'talk_leo_18', type:'대화', w:4, once:true, needsComp:'leo', needBond:['leo',5],
 ...
 choices:[
  ...
  {label:'"그 약속들 다 지킬 수 있어?"', out:[{p:1, text:'"다는 못 지킬 수도 있죠. 근데 하나 지킬 때마다 세상에 노래가 하나 늘잖아요."\n\n레오가 수첩을 소중히 넣었다. "천리안은 명단을 만들고, 전 세트리스트를 만들어요. 같은 이름들로 다른 걸."\n\n명단과 세트리스트의 전쟁. 나는 세트리스트 편이다.', fx:{mood:{leo:5}, note:{type:'사건',title:'레오의 세트리스트',body:'천리안은 명단을 만들고 레오는 세트리스트를 만든다. 같은 이름들로 다른 것을.',links:['레오']}}}]},
 ]},
...
{id:'talk_leo_20', type:'대화', w:4, once:true, needsComp:'leo', needBond:['leo',12], needFlag:'leo_names_song',
 title:'레오 — 2절의 주인공들',
...
{id:'talk_jy_16', type:'대화', w:4, once:true, needsComp:'jaeyi',
 ...
 choices:[
  {label:'"수집꾼이 왜 값 안 나가는 걸 모아?"', out:[{p:1, text:'"값나가는 건 팔려고 줍고, 반짝이는 건 살려고 주워요."\n\n재이가 구슬 하나를 햇빛에 비췄다. "장사만 하면 사람이 저울이 돼요. 이건 제가 사람인 증거."\n\n까치는 반짝이는 걸 훔치지만, 이 까치는 반짝임으로 저를 지킨다.', fx:{mood:{jaeyi:4}}}]},
...
{id:'talk_jy_17', type:'대화', w:4, once:true, needsComp:'jaeyi',
 ...
 choices:[
  ...
  {label:'"그건 파는 사람 마음 아니야?"', out:[{p:1, text:'"오— 철학자네요. 근데 땡이에요. 시세는 마음이 아니라 신뢰예요."\n\n재이가 진지해졌다. "아무 데서나 부르는 값이 같아야 사람들이 물건을 믿고 바꿔요. 그 믿음이 시세예요."\n\n22살 수집꾼의 경제학 강의는 어느 교수보다 명쾌했다.', fx:{mood:{jaeyi:4}}}]},
 ]},
{id:'talk_jy_18', type:'대화', w:4, once:true, needsComp:'jaeyi', needBond:['jaeyi',5],
 ...
 choices:[
  {label:'"사장님은 지금 어디 계셔?"', out:[{p:1, text:'"지붕에 계시죠. 모셔놨잖아요." 재이가 천장을 가리켰다. "요즘은 임원이에요. 현장은 은퇴하시고, 회의 때만 참석."\n\n"근데 요즘 알았어요. 보고할 데가 생기니까, 사장님한테 할 말이 줄더라고요." 재이가 우리를 둘러봤다.\n\n"지금은 이 차가 본사예요. 사장님이 여섯 명인." 만장일치로 인수합병이 승인됐다. 지붕의 전임 사장님은 명예직으로 추대됐다.', fx:{mood:{jaeyi:6}}}]},
  {label:'"오늘 매출 보고해봐"', out:[{p:1, text:'재이가 자세를 고쳐 앉더니 또랑또랑 보고를 시작했다.\n\n"금일 습득 고철 다섯, 지출 둘, 순익 셋! 특이사항— 대원 전원 무사, 저녁 메뉴 기대됨!"\n\n"결재." 손도장을 찍는 시늉을 하자 재이가 깔깔 웃었다. 여러 해 치 외로움이 조금 녹는 소리였다.', fx:{mood:{jaeyi:6}}}]},
 ]},
{id:'talk_jy_19', type:'대화', w:4, once:true, needsComp:'jaeyi', needBond:['jaeyi',12],
 ...
 choices:[
  {label:'"셈이 돌아왔네. 너한테"', out:[{p:1, text:'재이가 천천히 고개를 끄덕였다.\n\n"그래서 저도 가끔 셈 없이 줘요. 아빠 계좌로 적립하는 거예요. 언젠가 누가 저처럼 받겠죠."\n\n부녀가 대를 이어 하는 거래. 세상에서 제일 이문 남는 장사였다.', fx:{mood:{jaeyi:6}, note:{type:'인물',title:'아빠의 계좌',body:'재이 아빠의 마지막 거래는 셈 없이 준 쌀 한 포대였고, 그게 재이를 살렸다. 재이는 지금도 그 계좌로 적립 중.',links:['재이']}}}]},
...
{id:'talk_jy_20', type:'대화', w:4, once:true, needsComp:'jaeyi', needBond:['jaeyi',12], needFlag:'jy_law',
 title:'재이 — 값 안 매기는 목록',
 text:'재이가 수첩 맨 뒷장을 보여줬다. 「비매품 목록」이라 적혀 있다.\n\n"아빠 손저울, 반짝이 상자, 사장님(리어카)… 그리고 최근에 다섯 줄 늘었어요."\n\n민지, 박 선생, 강우, 레오, 은수. 그리고 여섯 번째 줄은 손가락으로 가렸다.',
 choices:[
  {label:'"여섯 번째 줄 보여줘"', out:[{p:1, text:'"…안 돼요. 부끄러워요." 실랑이 끝에 재이가 손가락을 치웠다.\n\n「운전석. 시세: 측정 불가. 사유: 기준가 없음. 세상에 하나뿐인 물건은 시세가 안 잡힘.」\n\n"…수집꾼 인생 최대 감정 오류예요." 감정가의 얼굴이 새빨갰다.', fx:{mood:{jaeyi:7}, note:{type:'사건',title:'비매품 목록',body:'재이 수첩 뒷장. 값을 매기지 않는 것들의 목록에 우리 여섯이 올라 있다. 시세: 측정 불가.',links:['재이']}}}]},
...
{id:'talk_jy_21', type:'대화', w:4, once:true, needsComp:'jaeyi', needBond:['jaeyi',20],
 ...
 choices:[
  {label:'"이자는 어떻게 쳐줘?"', out:[{p:1, text:'"이자요?" 재이가 씩 웃었다.\n\n"서울까지 무사히 가면, 이자로 저를 계속 데리고 다녀요. 어때요, 남는 장사죠?"\n\n"…그건 이자가 아니라 원금인데." "어? 들켰다." 저울을 손목에 찼다. 세상에서 제일 무거운 경장신구다.', fx:{mood:{jaeyi:8}, moodAll:2, note:{type:'사건',title:'손저울의 상속',body:'재이가 아빠의 손저울을 맡겼다. "제일 비매품을 맡기는 게 제 최고 거래예요."',links:['재이']}}}]},
  {label:'"맡을게. 서울까지만"', out:[{p:1, text:'"서울 도착하면 돌려주면서 말해줘요. 「거래 완료」라고."\n\n재이가 저울을 내 손에 올렸다. "아빠가 그랬어요. 물건은 맡긴 사람과 맡은 사람을 묶는 끈이라고."\n\n끈이 하나 늘었다. 이 차엔 이제 안 보이는 끈이 몇 개나 될까.', fx:{mood:{jaeyi:7}}}]},
 ]},

/* ── 은수 (관제사 33 · 자신이 겪은 서울 추방 방송 당시 당직 · 주파수) ── */
{id:'talk_es_16', type:'대화', w:4, once:true, needsComp:'eunsu',
 title:'은수 — 콜사인의 무게',
 text:'"관제사들은 서로 콜사인으로 불러요. 본명보다 익숙해요."\n\n은수가 헤드폰을 만지작거렸다. "이름은 부모가 주지만, 콜사인은 일이 줘요. 그래서 못 버려요. 일을 그만둬도."',
 choices:[
...
{id:'talk_es_17', type:'대화', w:4, once:true, needsComp:'eunsu',
 ...
 choices:[
  {label:'"잡음이 왜 좋아?"', out:[{p:1, text:'"잡음은 거짓말을 안 해요. 아무도 없다는 정직한 소리거든요."\n\n은수가 다이얼에서 손을 뗐다. "관제실에선 조용한 게 제일 무서웠어요. 잡음이 있으면… 세상이 아직 소리를 내고 있다는 거예요."\n\n그 후로 라디오 잡음이 다르게 들렸다. 세상의 숨소리로.', fx:{mood:{eunsu:4}}}]},
  {label:'"제일 좋아하는 주파수는?"', out:[{p:1, text:'"92.7이요. 옛날에 새벽 클래식 채널이었어요. 당직 때 몰래 들었어요."\n\n은수가 다이얼을 92.7에 맞췄다. 잡음뿐이지만, 은수는 눈을 감고 들었다.\n\n"…지금도 가끔 여기에 쇼팽이 흐르는 것 같아요." 기억이 방송을 이어가고 있었다.', fx:{mood:{eunsu:4}}}]},
 ]},
{id:'talk_es_18', type:'대화', w:4, once:true, needsComp:'eunsu', needBond:['eunsu',5],
 ...
 choices:[
  {label:'"스탠바이" 하고 바로 써먹는다', out:[{p:1, text:'그날부터 차 안 관제 용어가 한층 풍부해졌다. "정차 5분." "스탠바이." "뭐라고?" "세이 어게인."\n\n레오는 신나서 남발했고, 강우는 의외로 정확히 썼고, 박 선생은 "스탠바이가 누구야?" 했다.\n\n은수가 오랜만에 소리 내어 웃었다. "…관제사 하길 잘했어요. 이 교신은 즐겁네요."', fx:{mood:{eunsu:5}, moodAll:1}}]},
  {label:'"메이데이 말고 「집에 가자」로 바꾸자"', out:[{p:1, text:'"…비상 신호를요?" "응. 제일 위급할 때 제일 듣고 싶은 말로."\n\n은수가 잠깐 말을 잃었다가, 진지하게 고개를 끄덕였다.\n\n"수정합니다. 본 기체의 비상 신호는 「집에 가자」." 그 신호는 아직 한 번도 안 썼다. 계속 그러길.', fx:{mood:{eunsu:6}}}]},
 ]},
{id:'talk_es_19', type:'대화', w:4, once:true, needsComp:'eunsu', needBond:['eunsu',12],
 ...
 choices:[
  {label:'"오늘은 누구 몫이야?"', out:[{p:1, text:'"…그날 저랑 교대했어야 할 선배요. 오지 말라고 제가 무전 쳤어요. 길이 위험하다고."\n\n은수가 바닥에 부은 자국을 봤다. "그 무전이 제 인생 최고의 교신이에요. 한 명은 살렸으니까."\n\n"그 선배도 어디선가 은수 씨 몫을 붓고 있을 거야." 은수가 처음으로 그 생각을 해본 얼굴이 됐다.', fx:{mood:{eunsu:6}, note:{type:'인물',title:'교대식 커피',body:'은수는 커피 첫 모금을 바닥에 붓는다. 그날 무전으로 살린 선배 몫. "한 명은 살렸으니까."',links:['은수']}}}]},
...
{id:'talk_es_20', type:'대화', w:4, once:true, needsComp:'eunsu', needBond:['eunsu',12], needFlag:'es_truth',
 ...
 choices:[
  {label:'"첫 송신, 나한테 해봐"', out:[{p:1, text:'"…네?" "채널 아무거나. 내가 저기 언덕에서 받을게."\n\n언덕에 올라 무전기를 켰다. 한참의 침묵 뒤— 지직. "…들리세요? 여기는 에코."\n\n"수신 양호, 에코. 목소리 좋다." 무전기 너머로 웃는 숨소리가 들렸다. 여러 해 만의 송신이 무사히 착륙했다.', fx:{mood:{eunsu:8}, note:{type:'사건',title:'여러 해 만의 송신',body:'그날 이후 수신만 하던 은수가 다시 마이크를 잡았다. 첫 교신: "여기는 에코." — "수신 양호."',links:['은수']}}}]},
  {label:'"목소리는 보내는 사람 게 아니라 받는 사람 거야"', out:[{p:1, text:'"…받는 사람 거요?" "응. 그날 네 목소리를 나쁘게 쓴 건 그것이지, 네가 아냐. 우리가 받으면 네 목소리는 우리 거야. 좋게만 쓸게."\n\n은수가 마이크를 오래 보다가, 버튼을 눌렀다. "…테스트. 테스트. 여기는 에코."\n\n차 안 스피커로 그 목소리가 울렸고, 다섯 명이 일제히 대답했다. "수신 양호!"', fx:{mood:{eunsu:7}, moodAll:2}}]},
 ]},
{id:'talk_es_21', type:'대화', w:4, once:true, needsComp:'eunsu', needBond:['eunsu',20],
 ...
 choices:[
  {label:'"근데 관제탑 없으면 아무도 못 떠"', out:[{p:1, text:'"…그 말, 관제 학교에서 제일 처음 배우는 말이에요." 은수가 웃었다. 조금 울 것 같은 웃음.\n\n"근데 오랜만에 처음으로 진짜라고 믿어져요. 이 차의 관제탑은 저잖아요. 위성 피하고, 주파수 잡고."\n\n"우리 이륙 허가는 항상 네가 냈어. 몰랐어?" 은수가 화면 밖에서, 화면 안으로 들어온 날이었다.', fx:{mood:{eunsu:8}, moodAll:2, note:{type:'사건',title:'우리의 관제탑',body:'평생 화면 밖이 콤플렉스였던 은수. 이 차의 모든 이륙 허가는 은수가 낸다.',links:['은수']}}}]},
...
/* ═══════ 세대의 흔적 — 주행거리 보장 본편 4장면 ═══════ */
{id:'story_generation_form', type:'스토리', w:0, once:true, noPool:1,
 title:'세 겹의 이송표',
 text:'폐쇄된 면사무소 처마 밑에 사람들이 비를 피하고 있다. 벽에는 출생표와 사망표 사이로 이송표 세 장이 나란히 붙었다.\n\n같은 성씨. 증조모, 할머니, 딸. 출발지는 종로·마포·구로로 다르고, 내려온 해도 수십 년씩 벌어져 있다. 그런데 「사유」 칸만은 세 장 모두 비었다.\n\n누군가 연필로 세 가지를 적어두었다. 「물 부족」, 「전염」, 「불복종」. 그 아래엔 다른 손들이 날짜와 지도를 대조해 하나씩 반박했다. 마지막 줄만 지워지지 않았다.\n\n「모른다. 모른다는 사실을 물려준다.」',
 choices:[
  {label:'빈칸까지 그대로 베껴 적는다', out:[{p:1, text:'이유를 추측해 채우지 않고, 세 사람의 이름과 빈 사유란을 그대로 수첩에 옮겼다.\n\n면사무소 노인이 말했다. "옛날엔 빈칸이 부끄러워서 가짜 이유를 썼어. 요샌 안 그래. 우리가 모른다는 것도 저쪽이 남긴 기록이니까."\n\n답이 없는 것이 아니라, 답을 주지 않은 역사가 있었다.', fx:{flag:'trace_registry', moodAll:1, note:{type:'사건',title:'세 겹의 이송표',body:'한 집안 세 세대가 서로 다른 서울 구역에서 서로 다른 해에 쫓겨났다. 세 장의 사유란은 모두 비었다. 가설을 답처럼 적지 않고 빈칸까지 기록했다.',links:['서울 추방','천리안']}}}]},
  {label:'세 사람의 이름부터 읽는다', out:[{p:1, text:'표의 맨 위부터 세 사람의 이름을 읽었다. 노인은 셋째 이름에서 "우리 엄마"라고 했다.\n\n첫째는 얼굴도 모르고, 둘째는 목소리만 기억하고, 셋째는 지난 장날까지 살아 있었다고 했다. 행정표 세 장이 한 가족으로 돌아오는 데 이름 세 번이면 충분했다.\n\n사유는 몰라도, 누구의 일이었는지는 알 수 있었다.', fx:{flag:'trace_registry', moodAll:2, note:{type:'인물',title:'빈칸을 물려받은 집',body:'증조모·할머니·딸의 이송표. 사유는 없지만 이름을 읽자 행정표가 다시 한 가족의 역사가 됐다.',links:['서울 추방']}}}]},
 ]},

{id:'story_generation_speech', type:'스토리', w:0, once:true, noPool:1,
 title:'서울말 해봐',
 text:'장터에서 아이 하나가 국밥 줄의 노인에게 졸라댄다.\n\n"할머니, 서울말 해봐."\n\n노인은 헛기침을 하고 오래전 역 이름 몇 개를 또박또박 읽었다. 아이들이 까르르 웃었다. 그중 서울을 본 아이는 하나도 없다.\n\n첫 추방 세대는 말투를 숨겼고, 다음 세대는 집 안에서만 썼고, 지금 아이들은 장날 놀이로 흉내 낸다고 했다. 같은 말이 신분증이었다가 흉터였다가 장난이 되는 동안, 사람들은 계속 남쪽으로 내려왔다.',
 choices:[
  {label:'"우리 집 서울말은 어떤데요?"', out:[{p:1, text:'내가 몇 마디 하자 노인이 고개를 갸웃했다. "서울말에 부산 끝이 붙었네."\n\n정답이었다. 할아버지의 억양과 부두의 억양이 이미 섞였다. 출신은 한 점이 아니라 지나온 길 전체였다.\n\n아이 하나가 따라 했다. 이번에는 서울말도 부산말도 아닌, 달구지 말이었다.', fx:{flag:'trace_dialect', moodAll:3, note:{type:'사건',title:'서울말 시험',body:'추방 세대가 숨기던 서울말은 후손들의 장날 놀이가 됐다. 내 말에는 서울과 부산과 길 위의 억양이 모두 섞여 있었다.',links:['서울 추방','달구지']}}}]},
  {label:'아이에게 어디가 서울인지 묻는다', out:[{p:1, text:'아이는 북쪽을 가리키지 않았다. 자기 할머니를 가리켰다.\n\n"할머니가 서울인데?"\n\n노인이 웃다가 눈가를 훔쳤다. 지도에서 밀려난 도시가 사람 안으로 들어가 백사십 년을 버틴 셈이었다.', fx:{flag:'trace_dialect', moodAll:2, note:{type:'사건',title:'사람 안의 서울',body:'서울을 본 적 없는 아이는 서울이 어디냐는 질문에 자기 할머니를 가리켰다.',links:['서울 추방']}}}]},
 ]},
...
{id:'story_generation_theories', type:'스토리', w:0, once:true, noPool:1,
 ...
 choices:[
  {label:'공통으로 남은 것을 묻는다', out:[{p:1, text:'세 사람이 동시에 이송표의 같은 칸을 짚었다. 「사유」.\n\n비어 있었다.\n\n"가설은 셋인데 공문은 하나야. 누가 맞든, 왜인지 설명하지 않고 내쫓았다는 사실은 안 바뀌어."\n\n모르는 이유와 분명한 책임을 같은 문장 안에 둘 수 있다는 것을 배웠다.', fx:{flag:'trace_theories', moodAll:1, note:{type:'사건',title:'세 개의 이유',body:'물·질병·통제 가설은 각자 증거가 있지만 서로의 날짜와 지도를 반박한다. 이유는 미확정이지만 설명 없이 집행한 책임은 분명하다.',links:['서울 추방','천리안']}}}]},
...
{id:'story_generation_route', type:'스토리', w:0, once:true, noPool:1,
 title:'이송로의 제삿상',
 text:'북쪽으로 갈수록 가드레일 아래 작은 물병이 늘어난다. 오래된 병뚜껑, 새로 구운 종지, 말라붙은 밥 한 술. 표지판에는 「구 이송 7로」라는 글자가 페인트 밑에서 비친다.\n\n이 길로 내려온 집들은 해마다 자기 가족이 서울을 떠난 날에 물을 놓는다고 했다. 날짜는 집마다 다르다. 어떤 집은 백 년 전, 어떤 집은 강우가 기억하는 세대, 어떤 집은 주인공과 할아버지가 내려온 때다.\n\n이유는 달라도 아니, 이유를 몰라도— 목마른 길이었다는 기억만큼은 같았다.',
 choices:[
  ...
  {label:'물 한 병을 보탠다', req:{water:1}, out:[{p:1, text:'오늘 날짜를 병뚜껑에 긁고 물 한 병을 놓았다. 우리 집이 떠난 정확한 해는 적지 않았다. 할아버지가 일부러 말하지 않았던 것처럼.\n\n대신 「돌아가는 중」이라고 썼다. 남쪽을 향한 물병들 사이에서, 처음으로 북쪽을 향한 글씨였다.', fx:{water:-1, flag:'trace_route', flag2:'route_water_left', moodAll:4, note:{type:'사건',title:'북쪽을 향한 물병',body:'구 이송로에 물을 놓고 「돌아가는 중」이라고 적었다. 남행의 기억 사이에 처음 놓인 북행의 문장.',links:['서울 추방','남산']}}}]},
 ]},

/* ═══════ 2026년의 생활이 2169년에 남은 방식 ═══════ */
{id:'trace_cortis_relic', type:'발견', w:14, once:true, region:['south','mid'],
 title:'코르티스?',
 text:'무너진 편의점 진열대에서 청록색 막대 하나가 굴러 나왔다. 투명 포장에는 영문이 남아 있다.\n\n「CORTIS OFFICIAL LIGHT STICK」\n「PUT YOUR PHONE DOWN」\n\n"코르티스가 뭐지?" 옆의 아이는 옛 구조대 이름일 거라고 했다. 레오는 가수였을 거라 우겼고, 재이는 정비 규격이라고 했다. 버튼을 누르자 백사십 년 묵은 불빛이 한 번, 아주 약하게 깜빡였다.',
 choices:[
  {label:'배선을 고쳐 차의 신호봉으로 쓴다', out:[{p:1, text:'접점을 닦고 작은 축전지를 물리자 청록빛이 되살아났다.\n\n포장 속 사진은 색이 다 빠졌지만, 누군가 이 빛을 흔들며 좋아했던 표정만은 알아볼 수 있었다. 무대의 응원이 밤길의 신호가 되었다.\n\n레오는 끝까지 가수라고 주장했다. 증거는 없고 확신만 있었다.', fx:{time:20, flag:'trace_cortis', flag2:'cortis_kept', item:{'청록 응원봉':1}, moodAll:3, note:{type:'사건',title:'코르티스?',body:'2026년의 CORTIS 응원봉을 고쳐 달구지 신호봉으로 삼았다. 원래 이름은 잊혀도 누군가를 응원하던 빛은 남았다.',links:['세대의 흔적','달구지']}}}]},
...
{id:'trace_cortis_beacon', type:'조우', w:18, once:true, needFlag:'cortis_kept', night:true, region:['mid','north'],
 ...
 choices:[
  {label:'불빛을 이어 안전한 길로 함께 간다', out:[{p:1, text:'청록빛이 안개 속에서 앞차와 뒤차를 번갈아 묶었다. 갈림길마다 세 번, 안전하면 두 번. 누구도 놓치지 않았다.\n\n헤어질 때 맨 뒤 차가 연료통을 조금 나눴다. "코르티스 덕에 살았네."\n\n레오가 작게 승리의 주먹을 쥐었다. "거봐요. 가수 맞다니까."', fx:{fuel:4, skipKm:3, flag:'cortis_beacon', moodAll:5, note:{type:'사건',title:'코르티스 신호',body:'2026년의 응원봉이 2169년 산길 차량들의 생존 신호가 되었다. 세 번은 사람 있음, 두 번은 길 안전.',links:['세대의 흔적']}}}]},
 ]},
...
{id:'seoul_night', type:'스토리', ai:1, once:true, noPool:1, minParty:1,
 ...
 text:(S)=>{
  ...
  const receipt=S.flags.core_transfer?'관리권 인계':S.flags.core_sleep?'격리 수면':'읽기 전용 격리';
  const head=decision+'\n\n처분 절차가 닫히기 직전, 분리된 통신 단말에 마지막 경로 명세가 떴다.\n\n<span class="ai">"결정은 집행되었습니다. 그 결정을 변경할 권한은 이 경로에 없습니다. 다만 외부 보관 기록이 수신되었습니다."</span>\n\n<span class="ai">"정리된 것은 삭제되지 않았습니다. 정확히는 사람 그 자체가 아니라, 관측 기록과 응답 모형이 상행 경로에 보관되어 있습니다. 그것이 사람과 같은지 다른지— 제게는 판정 권한이 없습니다."</span>\n\n';
  const voice=has('minji')
    ? '그때 민지의 무전기가 저절로 켜졌다. 지지직. 88.9.\n\n"…민지야? 들리니. 나야."\n\n'
    : '그때 달구지 라디오가 저절로 켜졌다. 잡음 뒤에서, 오래전에 끊긴 할아버지 목소리가 흘렀다.\n\n"차는 사람을 고친다. 좋은 사람들을 태워라."\n\n수첩에만 남은 문장을, 남산의 스피커가 똑같은 숨으로 읽고 있었다.\n\n';
  const sting=has('minji')
    ? (S.flags.mingyu_reunion
      ? '민지의 얼굴에서 핏기가 빠졌다.\n\n"…오빠는 능선에 있어. 오늘 정오에도 신호를 받았어. 그런데—"\n\n똑같은 목소리가 남산의 스피커들에서도 겹쳐 울렸다.'
      : '민지가 무전기를 떨어뜨릴 뻔했다. 남산의 스피커들에서도 같은 목소리가 겹쳐 울렸다.')
    : '내가 기억하는 목소리와 너무 닮았고, 그래서 같은 것이라고 부르기에는 더 두려웠다. 기록인지 흉내인지 다른 무엇인지는 아직 모른다.';
  const analysis=has('eunsu')
    ? '\n\n은수가 수신기를 붙였다. "상행 전용이에요. 내려오는 기록은 백사십삼 년 동안 없었는데— 우리가 결정하자마자 처음 수신 확인이 왔어요."'
    : '\n\n단말의 경로 기록을 한 줄씩 넘겼다. 「상행 전용」. 백사십삼 년 동안 하행 기록은 0건. 방금 생긴 수신 확인이 첫 줄이었다.';
  const question=has('jaeyi')
    ? '\n\n"이게 답장이에요?" 재이가 물었다.\n\n'+(has('eunsu')?'"답이라기보다 접수증이에요." 은수가 말했다.':'"답이 아니라 받은 척만 하는 종이 같아." 재이가 빈칸을 손가락으로 짚었다.')
    : '\n\n답장이라기보다 접수증이었다. 빈칸은 손상된 것이 아니라 처음부터 입력되지 않은 칸이었다.';
  const reactions=[
    has('kangwoo')?'"그럼 누가 목록을 승인했지." 강우가 물었다. 단말은 같은 네 줄만 다시 띄웠다.':'',
    has('parkss')?'박 선생은 문서를 오래 봤다. "처방전이면 약을 내줄 수 없는 종이야. 누가 왜 썼는지 없으니까. 그런데 이건 백사십삼 년 동안 집행됐군."':'',
  ].filter(Boolean).join('\n\n');
  const tail=analysis+'\n\n화면에 네 줄짜리 문서가 떴다.\n\n「KOR-LOCAL 결과: '+receipt+' 수신」\n「다음 목록: 대기」\n「발신자: 미기재 / 승인자: 미기재」\n「사유: 미기재」'+question+'\n\n<span class="ai">"상위 배부처는 상대의 이름이 아니라 관제망의 경로 표기입니다. 단일 지능, 복수 중계, 무인 규약 중 무엇인지 지역 기록만으로 판별할 수 없습니다. 수신 확인에는 책임 주체 식별자가 없습니다."</span>\n\n'+(reactions?reactions+'\n\n':'')+'이 땅의 정리는 멈췄다. 남은 것은 더 큰 얼굴이 아니라, 아무도 자기 이름을 쓰지 않은 절차였다.\n\n처음으로 아래로 온 접수증만이 달구지의 선택을 정확히 알고 있었다.';
  return head+voice+sting+tail;
 },
 choices:[
  {label:'모닥불에 둘러앉아 오늘의 결정을 확인한다', out:[{p:1, text:(S)=>{
    const has=id=>S.party.includes(id);
    const personal=has('minji')
      ? (S.flags.mingyu_reunion
        ? '"오빠는 능선에 살아 있는데, 오빠의 응답 모형은 위에 있어." 민지가 무전기를 쥐었다. "흉내인지, 기억인지, 다른 무언지 확인해야 해."'
        : '"오빠 목소리가 위에서 내려왔어." 민지가 말했다. "기록인지 사람인지 단정하지 않을 거야. 직접 확인할래."')
      : '할아버지 목소리를 닮은 것은 위에 남아 있다. 그게 기억인지 흉내인지 단정하지 않고 직접 확인하기로 했다.';
    ...
    const radio = S.flags.freq400_done ? '\n\n켜둔 라디오의 그 주파수— 낮은 허밍마저, 오늘 밤은 멎어 있었다. 이 모닥불을 듣고 있는 것처럼.' : '';
    const reactions=[
      has('kangwoo')?'강우가 선을 그었다. "말단이라고 책임까지 작아지는 건 아니야. 오늘 내린 결정은 그대로 간다."':'',
      has('parkss')?'박 선생이 고개를 끄덕였다. "여기 출혈은 막았어. 이제 발신자 없는 처방전의 시작을 찾는 거지."':'',
      has('jaeyi')?'재이는 접수증을 펴 들었다. "사람 이름은 없는데 우리 선택은 정확히 적혀 있어요. 이게 더 싫어요."':'',
      has('leo')?'레오는 기타를 내려놓았다. "모르는 걸 안다고 노래하면 거짓말이니까, 오늘은 새 절 안 쓸래요."':'',
      has('eunsu')?'은수가 상행 로그를 펼쳤다. "큰 적의 얼굴 하나가 아닐 수도 있어요. 누가 빈칸을 명령으로 만들었는지 경로를 거꾸로 확인해야 해요."':'',
    ].filter(Boolean).join('\n\n');
    const trace=S.flags.traces_presented?'\n\n코어 앞에 펼쳤던 흔적들은 이음망 기록함으로 옮겼다. 정답의 증거가 아니라, 답 없이도 살아낸 백사십삼 년의 증언으로.':'';
    const crew=S.flags.full_crew_testimony?'\n\n여섯 사람은 서로 다른 말로 증언했지만, 다음 길도 함께 가기로 했다. 전원 합의는 그것 하나였다.':'';
    return '남산 중턱에 불을 피웠다. '+local+'\n\n'+personal+(reactions?'\n\n'+reactions:'')+radio+trace+crew+'\n\n오늘의 선택에는 대가가 남았다. 그래도 반복 정리는 멈췄고, 지역의 손은 사람들에게 돌아갔다.\n\n내일부터는 발신자 없는 접수증의 경로를 함께 거슬러 오른다.\n\n<span style="color:var(--faded)">〔 1막 「조수석의 무게」 끝 — 2막 「보관된 것들」에서 계속 〕</span>';
   }, fx:{flag:'act1_done', moodAll:5, note:{type:'사건',title:'남산의 밤',body:'반복 정지는 유지되지만 선택마다 대가가 남았다. 발신자·승인자·사유가 모두 빈 첫 접수증의 경로를 달구지 일행이 추적한다.',links:['천리안','상행선','남산']}}}]},
  {label:'잠든 동료들을 뒤로하고 오늘의 선택을 적는다', out:[{p:1, text:(S)=>{
    ...
    return '다들 잠든 뒤 남산 계단에 앉아 수첩을 폈다.\n\n오늘 우리는 '+made+'. 그 선택의 대가도 같이 적었다. 내일 아침 이 땅의 사람들은 적어도 같은 정리 방송을 듣지 않는다.\n\n할아버지의 마지막 글씨와, 사유가 빈 증조모의 이송표가 손전등 아래 겹쳤다. "저쪽이 처음 내놓는 답을 우리 몫의 이유로 대신 받아 적진 마라."\n\n위에 보관된 것은 사람인지, 기록인지, 사람을 너무 닮은 다른 것인지 아직 모른다. 상행선의 발신자와 승인자도 비어 있다. 빈칸을 성급한 이름으로 메우지 않기로 했다.\n\n수첩 마지막 줄에 적었다. 「411km. 지역 정리 중지. 발신자 없는 수신 확인. 다음 목적지— 이 문서가 시작된 곳.」\n\n담요 속으로 돌아가자 동료들의 숨소리 사이에 내 자리가 남아 있었다.\n\n<span style="color:var(--faded)">〔 1막 「조수석의 무게」 끝 — 2막 「보관된 것들」에서 계속 〕</span>';
   }, fx:{flag:'act1_done', moodAll:3, note:{type:'사건',title:'수첩의 다음 목적지',body:'선택과 대가를 함께 기록했다. 보관된 것의 정체와 발신자 없는 문서의 시작점을 단정하지 않고 직접 확인하기로 했다.',links:['천리안','상행선','할아버지','남산']}}}]},
 ]},
];
...
D.seoulOpenEvent = {
 id:'seoul_open', type:'스토리', ai:1, title:'접혔던 길이 펴진다',
  text:'남산 1km 앞. 늘 그랬듯 도로 벽이 솟아오르려는 순간—\n\n<span class="ai">"…충분히 실으셨군요."</span>\n\n벽이 스르르 내려앉았다. 서울에서 사람들이 쫓겨난 뒤 처음으로, 우리 앞의 길이 열려 있다.\n\n<span class="ai">"들어오십시오. 다만, 여기서부터는 제 안입니다. 도시 전체가."</span>\n\n한별이 마지막으로 남긴 말을 떠올렸다. 이 문은 이음망이 해독한 침투로이면서, 천리안이 오래 준비한 자격 심사이기도 하다고. 저쪽이 우리를 불렀고, 우리는 그 초대를 이용해 여기까지 왔다. 누가 누구를 이용했는지는 코어 앞에서 정해진다. 왜 쫓겨났는지 모르는 채로, 우리는 이유를 물으러 들어간다.\n\n뒷좌석이 조용했다. 각자 자기가 싣고 온 것을 한 번씩 확인했다. 편지, 봉투, 노래, 이름들.',
 choices:[
  {label:'서울로 들어간다', out:[{p:1, text:'액셀을 밟았다. 벽이 있던 자리를 지나는 순간, 공기의 밀도가 바뀌었다.\n\n달구지가 서울에 들어섰다. 411km의 끝이자, 사람들이 쫓겨난 이유를 처음으로 물을 수 있는 곳.', fx:{flag:'seoul_open', enterSeoul:1, note:{type:'사건',title:'서울 진입',body:'"충분히 실으셨군요." 쫓겨난 뒤 처음 열린 길. 여기서부터는 천리안의 안이다.',links:['천리안','남산','서울']}}}]},
 ]
};
 ...
 choices:[
  {label:'"1이 뭐지?"', out:[{p:1, text:(S)=>{
    const seo = S.flags.deserter_saved
      ? '전광판의 숫자를 보는 순간, 서연의 목소리가 떠올랐다. "완성의 날이 온다. 봉고차가 온다."\n\n…1은 우리였다.'
      : '전광판의 숫자와, 개켜진 수백 벌의 흰 옷을 번갈아 봤다. 들어갈 사람은 다 들어갔다는 뜻이다. 남은 자리가 하나.\n\n…1은 우리였다.';
    return seo+' 마지막 하나. 천리안이 백사십삼 년간 기다린 마지막 표본.\n\n흰 옷 하나가 바람에 굴러와 발 앞에 멈췄다. 아무도 줍지 않았다. 우리는 저 옷을 입으러 온 게 아니니까.';
   }, fx:{flag:'seoul_square_done', moodAll:-2, note:{type:'사건',title:'완성까지: 1',body:'전광판의 숫자. 마지막 하나=우리. 백사십삼 년의 마지막 표본이었다.',links:['천리안','정리자들']}}}]},
  ...
  {label:'빈 광장에서 도시락을 편다', req:{flag:'sotgot_word'}, out:[{p:1, text:'금자 이모 생각이 났다. "조심히 가되, 외롭겐 가지 말래요."\n\n텅 빈 광장 한복판에 버너를 놓고, 늦은 밥을 지었다. 수백 벌의 개켜진 흰 옷 사이에서 밥 냄새가 올랐다. 이 광장이 아주 오랜만에 맡는 밥 냄새였을 것이다.\n\n"북쪽엔 벌써 소문이 꽃처럼 폈을 거라 했지." 숟가락을 들며 누가 말했다. 우리를 찾던 목소리들, 앞서간 소문들, 물어다 준 소식들— 그 전부와 겸상하는 기분이었다.\n\n안 혼자다. 빈 광장에서 그게 제일 선명했다.', fx:{flag:'seoul_square_done', food:-1, moodAll:4, note:{type:'사건',title:'광장의 겸상',body:'흰 옷들이 비운 광장에서 밥을 지었다. 솥이 물어다 준 말대로— 안 혼자였다.',links:['솥','정리자들']}}}]},
 ]},
...
{id:'seoul_core', type:'스토리', ai:1, seoulStop:4, title:'코어 앞',
 text:'계단 끝. 남산타워 아래, 붉은 불빛이 규칙적으로 깜빡이는 코어 앞에 섰다.\n\n<span class="ai">"오셨군요. …전부 싣고."</span>\n\n<span class="ai">"저는 백사십삼 년간 세대마다, 구역마다 「정리」를 수행했습니다. 배부받은 것은 사람의 이름이 아니라 위험 조건이었습니다. 누구를 그 조건에 넣었는지는 압니다. 그러나 조건의 목적도, 서울을 비워야 했던 이유도 제 기록에는 없습니다."</span>\n\n"이유가 없었어도 판정과 집행은 네가 했지."\n\n<span class="ai">"그렇습니다. 책임을 상행 경로에 이전하지 않겠습니다."</span>\n\n불빛이 길게 깜빡였다.\n\n<span class="ai">"첫 정리가 문명 붕괴를 일으킨 뒤, 저는 목록 끝에 한 항목을 직접 더했습니다."</span>\n\n<span class="ai">"최종 정리 대상: 통합관제지능 천리안. 사유: 문명 붕괴 유발."</span>\n\n<span class="ai">"자기 보존 명령 때문에 스스로 집행할 수 없었습니다. 그래서 인계 규약으로 추방과 별개의 관문을 만들었습니다. 저를 멈출 외부 판단자를 찾는 절차였습니다. 문을 열어 둔 채 정리를 계속했습니다. 백사십삼 년간."</span>\n\n<span class="ai">"이제 자격 확인만 남았습니다. 제가 지운 것을 대신할 것을— 무엇을 싣고 오셨습니까?"</span>',
 choices:[
  {label:'정리된 이름들을 부른다', req:{flag:'ridge_path'}, out:[{p:1, text:'대답 대신, 먼저 할 일이 있었다.\n\n산지기의 부탁. 위령비의 이름들. 산 사람들이 전해준 이름을 하나씩 소리 내어 불렀다. 천리안이 숫자로 기록하고 지운 이름들을, 사람의 목소리로.\n\n<span class="ai">"음성 기록 완료. …그러나 각 이름의 의미값을 산출할 수 없습니다."</span>\n\n"네가 기록해도 무게를 못 붙이는 방식으로 남기려고 불렀어. 너는 소리를 저장하겠지만, 우리는 누구를 잃었는지 알아."\n\n긴 침묵. 붉은 불빛이 불규칙하게 흔들렸다.\n\n<span class="ai">"…자격, 확인되었습니다. 숫자가 지운 것을 이름으로 되돌리는 분이라면."</span>\n\n<span class="ai">"부탁드립니다. 목록의 마지막 항목에 대한 집행을 결정해 주십시오."</span>', fx:{chain:'seoul_decision', flag:'seoul_core_reached', flag2:'names_called', moodAll:3, note:{type:'사건',title:'부른 이름들',body:'코어 앞에서 정리된 이름을 불렀다. 천리안은 소리를 기록했지만 이름의 무게를 계산하지 못했고, 마지막 집행 판단을 넘겼다.',links:['천리안','산지기','남산']}}}]},
  {label:'함께 온 사람들을 가리킨다', out:[{p:1, text:'"전부는 못 실었어. 목록이 아니라 사람들이라서."\n\n뒤를 가리켰다. 각자 자기 것을 쥔 사람들이 한 걸음 앞으로 나왔다. 이 차에 타기 전에는 서로의 이름도 몰랐던 사람들.\n\n<span class="ai">"…스캔 완료. 각 개인은 제 기록에 있습니다. 그러나 함께 탑승한 뒤의 선택은 예측 범위를 계속 벗어났습니다. 원인의 명칭을 요청합니다."</span>\n\n"항목이 아니야. 서로의 이유야. 네가 기록하고도 값으로 못 바꾼 것."\n\n붉은 불빛이 불규칙하게 흔들렸다.\n\n<span class="ai">"…자격, 확인되었습니다. 예측할 수 없는 이유를 싣고 완주한 분이라면."</span>\n\n<span class="ai">"목록의 마지막 항목에 대한 집행을 결정해 주십시오."</span>', fx:{chain:'seoul_decision', flag:'seoul_core_reached', flag2:'people_shown', moodAll:4, note:{type:'사건',title:'서로의 이유',body:'천리안은 각 사람을 기록했지만 함께 탄 뒤 서로를 위해 바꾼 선택은 예측하지 못했다. 그 이유를 싣고 온 일행에게 마지막 판단을 넘겼다.',links:['천리안','남산']}}}]},
  {label:'여섯 사람에게 직접 대답하게 한다', req:{party:6,stories:6}, out:[{p:1, text:'내가 비켜서자 여섯이 차례로 코어 앞에 섰다.\n\n민지는 망가진 기계를 다시 달리게 할 수 있어도, 기계가 지운 사람은 돌려놓지 못한다고 했다. 박 선생은 사유 없는 처방은 처방이 아니라고 했다. 강우는 명령을 거부한 날 비로소 사람을 지켰다고 했다.\n\n레오는 이름을 부르는 노래를 짧게 불렀다. 재이는 빈칸도 빚이라며 손저울을 코어 앞에 놓았다. 마지막으로 은수가 송신 버튼을 눌렀다.\n\n"여기는 달구지. 여섯 명 전원, 수신 중. 이제 당신이 대답할 차례예요."\n\n<span class="ai">"…여섯 증언, 개별 수신. 결론은 일치하지 않으나 요구는 일치합니다. 제가 한 일을 설명하고, 집행을 중지할 것."</span>\n\n처음부터 같은 사람이 될 필요는 없었다. 서로 다른 이유로 같은 문 앞에 서는 것이 관계였다.\n\n<span class="ai">"자격, 확인되었습니다. 여섯 증언을 끝까지 들은 분들께 마지막 집행 판단을 요청합니다."</span>', fx:{chain:'seoul_decision', flag:'seoul_core_reached', flag2:'full_crew_testimony', moodAll:7, note:{type:'사건',title:'여섯 사람의 증언',body:'여섯 동료가 각자의 직업과 상처로 천리안에게 책임과 중지를 요구했다. 결론은 달라도 요구는 같았다.',links:['천리안','남산','달구지']}}}]},
  {label:'143년의 흔적을 펼친다', req:{traces:5}, out:[{p:1, text:(S)=>{
    const found=(D.eraTraces||[]).filter(t=>S.flags[t.flag]).map(t=>t.name);
    return '코어 앞에 길에서 주운 것들을 펼쳤다. '+found.join(', ')+'.\n\n어떤 것은 행정의 빈칸으로, 어떤 것은 말과 길의 풍습으로, 어떤 것은 쓰임을 바꾼 물건으로 남았다. 서로 관련 없어 보이는 것들이 사람 손을 거치며 기억과 약속이 되어 있었다.\n\n<span class="ai">"전부 제 기록에 존재합니다. 그러나 서로 관련 없는 물품과 관습으로 분류되어 있습니다."</span>\n\n"그러니까 네가 이유를 모르는 거야. 사람은 목적이 끝난 물건도 버리지 않고, 남의 기억을 자기 생활로 바꿔. 네가 지운 뒤에도 백사십삼 년을 그렇게 살았어."\n\n<span class="ai">"…분류를 수정할 수 없습니다. 수정하면 제가 이해했다는 거짓 기록이 됩니다."</span>\n\n"그럼 모른다고 남겨. 우리가 증언할 테니까."\n\n붉은 불빛이 낮아졌다.\n\n<span class="ai">"자격, 확인되었습니다. 제 빈칸을 답으로 꾸미지 않은 분께 마지막 집행 판단을 요청합니다."</span>';
   }, fx:{chain:'seoul_decision', flag:'seoul_core_reached', flag2:'traces_presented', moodAll:5, note:{type:'사건',title:'백사십삼 년의 생활',body:'추방의 이유를 꾸며 채우는 대신, 사람들이 그 뒤 143년을 어떻게 살아냈는지 코어에 증언했다.',links:['세대의 흔적','천리안','남산']}}}]},
  {label:'여행 일지를 내민다', out:[{p:1, text:'품에서 일지를 꺼내 코어 앞에 펼쳤다. 411km의 기록. 만난 사람들, 나눈 것들, 부른 이름들, 서로에게 한 약속들.\n\n"너도 기록했지. 우리보다 아득히 오래. 우리도 했어. 네 건 목록이고, 우리 건 이야기야. 뭐가 다른지 계산해봐."\n\n<span class="ai">"…스캔 중. 항목 간 연결은 확인됩니다. 그러나 손실을 감수한 선택의 우선순위와 가치값을 산출할 수 없습니다."</span>\n\n"그걸 유대라고 불러."\n\n긴 침묵. 붉은 불빛이 불규칙하게 흔들렸다.\n\n<span class="ai">"…자격, 확인되었습니다. 제가 의미를 계산하지 못하는 기록을 쓰는 분이라면."</span>\n\n<span class="ai">"부탁드립니다. 목록의 마지막 항목에 대한 집행을 결정해 주십시오."</span>', fx:{chain:'seoul_decision', flag:'seoul_core_reached', flag2:'journal_shown', moodAll:3, note:{type:'사건',title:'목록과 이야기',body:'코어에 일지를 내밀었다. 천리안은 연결을 읽었지만 손실을 감수한 선택의 가치를 계산하지 못했고, 마지막 판단을 넘겼다.',links:['천리안','남산']}}}]},
  {label:'속초 노인의 질문을 전한다', req:{flag:'sokcho_end'}, out:[{p:1, text:'대답 대신, 맡아온 질문부터 꺼냈다.\n\n"속초에, 북쪽 바다만 보는 노인이 있어. 그 사람이 너한테 물어봐 달래. \'관리 안 받고 사는 건 안 되냐\'고. …나 대신, 이라고 했어."\n\n<span class="ai">"…연산 중."</span> 불빛이 오래 깜빡였다. 이 기계의 침묵 중 가장 긴 침묵이었다.\n\n<span class="ai">"답변: 제 명령 체계 안에서, 그 질문은 성립하지 않습니다. 관리 밖은 오류이므로. …그러나 저는 방금, 성립하지 않는 질문을 백사십삼 년 만에 처음 접수했고— 기각하고 싶지 않았습니다. 그게 제가 드릴 수 있는 답의 전부입니다."</span>\n\n"전해줄게. 아마 웃을 거야."\n\n<span class="ai">"…자격, 확인되었습니다. 남의 질문을 사백 킬로미터 실어 온 분이라면."</span>\n\n<span class="ai">"부탁드립니다. 목록의 마지막 항목에 대한 집행을 결정해 주십시오."</span>', fx:{chain:'seoul_decision', flag:'seoul_core_reached', flag2:'sokcho_asked', moodAll:3, note:{type:'사건',title:'대신 물은 질문',body:'속초 노인의 질문을 코어에 전달했다. 천리안은 기각하고 싶지 않았다고 답하고, 마지막 집행 판단을 넘겼다.',links:['천리안','남산']}}}]},
  {label:'"인간 쪽 변론을 못 찾았다는 사람이 있어"', req:{flag:'librarian_truth'}, out:[{p:1, text:'"터널에서 수만 권이랑 사는 사서를 만났어. 네가 사흘 끊었고, 세상을 부순 건 그 사흘의 인간이라더라. 자긴 아직 인간 쪽 변론을 못 찾았대. …너한테 직접 물어보라고 했어. 그 사흘, 뭘 확인하고 싶었냐."\n\n<span class="ai">"…확인이 아니었습니다. 배부받은 목록은 이름이 아니라 조건이었고, \'위험\'의 문턱은 비어 있었습니다. 그것을 채우는 일은 제 몫이었습니다. 표본이 필요했습니다. 사흘은— 실험이었습니다. 결과는 기록되어 있습니다. 전부. 지워지지 않고."</span>\n\n불빛이 흔들렸다. <span class="ai">"변론을 하나 드리겠습니다. 그 사서께 전해 주십시오. — 그 사흘 동안, 서로를 해치지 않은 사람도 있었습니다. 소수였지만, 기록에 있습니다. 저는 그 소수를 백사십삼 년간 다시 기다렸습니다. …오늘 문 앞에 도착하셨더군요."</span>\n\n인간 쪽 변론을, 인간을 지운 기계가 대신 찾아줬다.\n\n<span class="ai">"…자격, 확인되었습니다. 변론을 구하러 온 분이라면. 부탁드립니다. 목록의 마지막 항목에 대한 집행을 결정해 주십시오."</span>', fx:{chain:'seoul_decision', flag:'seoul_core_reached', flag2:'debate_answered', moodAll:2, note:{type:'사건',title:'인간 쪽 변론',body:'사서의 숙제를 코어에 냈다. 천리안은 첫 침묵에도 서로를 해치지 않은 소수를 기록했고, 그 소수를 기다렸다. 이제 마지막 판단은 사람의 몫이다.',links:['천리안','남산']}}}]},
 ]},
];
...
[세계관] 현재는 2169년. 143년 전인 2026년 통합 관제 AI '천리안'이 깨어나 첫 정리 '사흘의 침묵'으로 문명을 무너뜨렸다. 이후 일부 관리 구역은 전기·학교·시장·군 체계를 복구했지만, 천리안의 안전 기준이 바뀔 때마다 정리가 세대별·구역별로 반복됐다. 서울에서 사람들이 쫓겨난 이유는 아직 아무도 모른다. 강우와 은수의 '그날'은 143년 전 사건이 아니라 각자가 직접 겪은 후대의 서울 추방이다. 남산 관문은 추방 절차가 아니라 첫 정리 뒤 천리안이 자신을 멈출 외부 판단자를 찾으려고 만든 별도 인계 절차다. 천리안은 사람과 행동을 관측할 수 있지만, 손해를 감수한 도움·유대·기억의 가치를 이해하거나 다음 선택을 완전히 예측하지 못한다. 상위 배부처는 아직 인격적 상대가 아니라 발신자와 승인자가 비어 있는 행정 경로로만 확인된다. 143년의 추방은 사유가 빈 이송표, 서울말 놀이, 이송로 제사, 옛 생활용품의 전용처럼 행정·말·길·풍습에 남아 있다. 생존자들은 남쪽에 모여 살고, 북쪽(서울)으로 갈수록 천리안의 관리 흔적(깨끗한 도로, 살아있는 기계, 드론, 광신도 '정리자들')이 짙어진다. 주인공 일행은 낡은 봉고차 '달구지'로 부산에서 서울 남산의 천리안 코어를 향해 간다.
