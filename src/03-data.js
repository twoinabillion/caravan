...
{id:'night_djradio', type:'발견', w:5, night:true, once:true,
 ...
 choices:[
  {label:'끝까지 듣는다', out:[{p:1, text:'세 곡이 나오고 방송은 잡음 속으로 사라졌다.\n\n"내일 이 시간에 다시 만나요"라는 클로징 멘트가 있었다. 내일 이 시간에 우리는 다른 주파수 위를 달리고 있겠지만, 어딘가에서 누가 대신 들을 것이다.', fx:{moodAll:3, note:{type:'소문',title:'새벽 두 시의 DJ',body:'올드팝과 나긋한 목소리. 생방송인지 녹음인지 알 수 없고, 알고 싶지 않다.'}}}]},
 ]},
