...
{id:'meet_postman', type:'조우', w:8, once:true,
 ...
 choices:[
  {label:'명단을 맞춰본다', out:[
   {p:2, text:'우편부가 손때 묻은 명단을 펼쳤다. 아는 이름은 없었다.\n\n대신 우리가 스친 정착지 이야기를 해줬다. 우편부는 세 개를 받아적고 신이 나서 페달을 밟았다.\n\n"삼 년 묵은 편지가 두 통 줄겠네!"', fx:{moodAll:3, note:{type:'인물',title:'자전거 우편부',body:'주소 대신 이름과 얼굴로 배달한다. 수신인 찾아 삼 년째.'}}},
   {p:1, text:'명단 중간쯤에서 우편부의 손가락이 멈췄다.\n\n"이 사람… 남산 쪽으로 갔다는 소문이 마지막이오."\n\n남산. 우리와 방향이 같은 이름이 하나 있다는 것만 적어뒀다.', fx:{note:{type:'소문',title:'남산으로 간 수신인',body:'우편부의 명단 속 한 사람. 마지막 소문은 남산 방향.',links:['남산']}}}]},
  {label:'물 한 잔 대접한다', out:[{p:1, text:'우편부는 물을 반만 마시고 반은 자전거 체인에 부었다. "얘도 목마르거든."\n\n답례로 어느 고개의 지름길을 알려줬다.', fx:{water:-1, moodAll:2, note:{type:'소문',title:'우편부의 지름길',body:'물 반 잔의 답례. 어느 고개의 지름길.'}}}]},
 ]},
...
{id:'meet_seedlady', type:'조우', w:7,
 ...
 choices:[
  {label:'씨앗을 빌린다 (물 2)', out:[{p:1, text:'물 두 통과 상추 씨앗 한 병을 맞바꿨다. 엄밀히는 빌린 거다.\n\n"수확하면 두 배 반납이에요. 어디서든, 누구한테든. 씨앗은 다 연결돼 있으니까."', fx:{water:-2, food:3, moodAll:2, note:{type:'인물',title:'씨앗 도서관',body:'빌려가서 두 배로 반납. 누구한테든. 씨앗은 다 연결돼 있다.'}}}]},
...
{id:'meet_photographer', type:'조우', w:7, once:true, minParty:1,
 ...
 choices:[
  {label:'단체사진을 찍는다', out:[{p:1, text:'달구지 앞에 일렬로 섰다. 보리가 있다면 맨 앞에 앉았다.\n\n"김치— 아니지, 요즘은 뭐라 그러나."\n\n"고철—!" 누가 외쳤고, 셔터가 눌렸고, 다들 진짜로 웃는 순간이 찍혔다.\n\n인화는 못 해주지만 필름은 남는다고 했다. "언젠가 인화소가 다시 생기면 찾으러 오시오."', fx:{time:20, moodAll:6, note:{type:'사건',title:'필름 속의 우리',body:'웨딩홀 앞 단체사진. "고철—!" 인화소가 다시 생기면 찾으러 갈 것.'}}}]},
...
{id:'exp_chalkwall', type:'탐색', w:7, once:true,
 ...
 choices:[
  ...
  {label:'우리도 한 줄 남긴다', out:[{p:1, text:'분필을 집어 들고 잠시 고민하다가 썼다.\n\n"남쪽에서 온 밴. 북쪽으로 감. 다들 무사하시오."\n\n누가 밑에 보리 발바닥을 찍자고 해서, 정말 찍었다. 소식벽 최초의 서명 날인이다.', fx:{time:15, moodAll:4, note:{type:'사건',title:'소식벽에 남긴 한 줄',body:'"남쪽에서 온 밴. 북쪽으로 감. 다들 무사하시오." 보리 발바닥 도장 포함.'}}}]},
 ]},
