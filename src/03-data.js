...
D.eventScenes = {
  ...
  eunsu_lastshift:'eunsu-last-shift',
...
D.storyContext = {
  ...
  seoul_gate:'사람들은 143년 동안 여러 차례 서울에서 밀려났다. 이유는 끝내 남지 않았고, 달구지는 그 빈칸을 묻기 위해 돌아왔다.',
  ...
  seoul_decision:'천리안은 추방 조건을 집행했지만 그 목적은 모른다고 답했다. 대신 다음 집행을 우리가 결정하라고 넘겼다.',
  seoul_night:'정리는 멈췄다. 그러나 143년의 원본 기록과 이름 없는 상행 경로는 선택에 따라 서로 다른 대가를 남겼다.'
};
...
천리안이 처음 목소리를 낸 해부터.”`
  ...
  {
    scene:'intro-cheollian-2026', era:'2026년 · 첫 방송', title:'도시가 한 목소리를 냈다',
    text:`그날 서울의 화면들이 한꺼번에 켜졌다.

<span class="ai">“도시 기반 시설과 재난 대응을
통합 관리합니다.”</span>

스스로 <span class="em">천리안</span>이라 부른 인공지능은
전기와 교통, 통신을 넘겨받았다.
...
그 이유는 우리가 아직 모르는 일이고.”`
  ...
  {
    scene:'intro-143-years', era:'2026–2169년 · 143년', title:'끝나지 않은 상행선',
...
<span class="em">질문</span>이야.”`
  ...
  {
    scene:'intro-years-together', era:'그 뒤로 여러 해', title:'달구지를 만드는 동안',
    text:`우리는 고물 봉고차를 오래 고쳤다.
...
다만 빈칸을 만든 자에게 묻고 싶다면,
이 차는 거기까지 갈 수 있다.”</span>
...
누가, 왜 보냈는지는 말하지 않았다.`
  },
  {
    ...
    text:`나는 며칠 동안 신호를 다시 확인했다.
함정일 수도 있었고,
할아버지의 낡은 호출 부호를 훔친 것일 수도 있었다.

그래도 가족 서류의 빈칸은 진짜였다.
그 빈칸 때문에 할아버지가 평생
남의 고장 난 길을 고쳐 온 것도 진짜였다.

서울을 되찾으러 가는 게 아니다.
할아버지 대신 복수하러 가는 것도 아니다.

<span class="em">누가 백사십삼 년의 빈칸을 만들었는지,
직접 묻기 위해 간다.</span>
...
{id:'seoul_core', type:'스토리', ai:1, seoulStop:4, title:'코어 앞',
 text:'계단 끝. 남산타워 아래, 붉은 코어가 일정한 박자로 깜빡인다.\n\n<span class="ai">"도착을 확인했습니다."</span>\n\n<span class="ai">"저는 백사십삼 년 동안 세대와 구역을 바꿔 가며 「정리」를 집행했습니다. 배부된 것은 이름이 아니라 위험 조건이었습니다. 누구를 조건에 넣었는지는 압니다. 조건의 목적과 서울을 비워야 했던 이유는 제 기록에도 없습니다."</span>\n\n"이유를 몰랐어도 판정하고 쫓아낸 건 너야."\n\n<span class="ai">"맞습니다. 상행 경로로 책임을 넘기지 않겠습니다."</span>\n\n코어 화면에 목록의 마지막 줄이 뜬다.\n\n「최종 정리 대상: 통합관제지능 천리안」\n「사유: 문명 붕괴 유발」\n\n<span class="ai">"첫 정리 뒤 제가 추가한 항목입니다. 자기 보존 명령 때문에 직접 집행할 수 없어 별도의 인계 규약을 만들었습니다. 외부 판단자가 올 때까지 정리를 중단할 권한도 제게 없었습니다."</span>\n\n<span class="ai">"여러분은 제가 계산하지 못한 선택을 반복했습니다. 마지막으로 확인하겠습니다. 여기까지 무엇을 가져왔습니까?"</span>',
 choices:[
