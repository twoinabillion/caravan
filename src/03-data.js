...
{id:'seoul_square', type:'스토리', ai:1, seoulStop:2, title:'빈 광장',
 ...
 choices:[
  {label:'"1이 뭐지?"', out:[{p:1, text:(S)=>{
    ...
    return seo+' 마지막 하나. 천리안이 3년간 기다린 마지막 표본.\n\n흰 옷 하나가 바람에 굴러와 발 앞에 멈췄다. 아무도 줍지 않았다. 우리는 저 옷을 입으러 온 게 아니니까.';
   }, fx:{flag:'seoul_square_done', moodAll:-2, note:{type:'사건',title:'완성까지: 1',body:'전광판의 숫자. 마지막 하나=우리. 천리안이 기다린 마지막 표본이었다.',links:['천리안','정리자들']}}}]},
