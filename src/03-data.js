...
{id:'seoul_night', type:'스토리', ai:1, once:true, noPool:1, minParty:1,
 ...
 choices:[
  {label:'모닥불에 둘러앉아 오늘의 결정을 확인한다', out:[{p:1, text:(S)=>{
   ...
   }, fx:{flag:'story_done', endJourney:1, moodAll:5, note:{type:'사건',title:'남산의 밤',body:'가족 이송 명령은 천리안이 만들었음을 확인했다. 143년의 최초 목적은 미확인으로 남겼고, 서울의 반복 정리와 제7 구역 이송은 끝냈다.',links:['천리안','남산','달구지','부모님의 검증키']}}}]},
