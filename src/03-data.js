...
D.startProfiles = {
  keeper:{ nm:'균형 출발', icon:'van', tag:'안정형',
    d:'연료와 물자를 고르게 싣는다. 처음 떠나는 길에 알맞다.',
    preview:'연료 42L · 고철 24 · 물 16 · 식량 14 · 부품 1',
    patch:{} },
  runner:{ nm:'빈 탱크', icon:'fuel', tag:'도전형',
    d:'연료는 16L뿐이다. 고철과 부품으로 첫 정착지까지 버틴다.',
    preview:'연료 16L · 고철 44 · 물 12 · 식량 10 · 부품 3',
    patch:{fuel:16, scrap:44, water:12, food:10, items:{'부품':3,'의약품':1,'탄약':0}} },
  hauler:{ nm:'만재 출발', icon:'food', tag:'보급형',
    d:'연료와 생존 물자는 넉넉하지만 부품 없이 길을 연다.',
...
D.transferStatus = (state)=>{
  ...
  return {
    due:null, day, remaining:null, onTime:true, lateDays:0,
    departedBuses:0, departed:0, remainingResidents:D.residentCount,
    short:'강제 이송을 멈출 준비',
    mission:'남산에서 강제 이송을 멈춘다'
  };
};
...
D.radioTexts = [
 ...
 {key:'radio_400_after',t:'(4-0-0 신호가 멎었다. 그 주파수에는 대신 낮은 허밍 한 소절이 반복된다. 방송실에서 들었던 목소리다.)', w:0.5, flag:'freq400_done'},
 {key:'radio_dj_reair', t:'…재방송입니다. 지난번에 소개한 남쪽 달구지 팀 사연, 다시 틀어달라는 쪽지가 세 장이나 왔어요. — 우리 목소리가 또 나왔다. 오글거림도 재방송됐다.', night:1, w:0.7, flag:'dj_onair_done'},
 {key:'radio_400km_cover', t:'(어느 주파수에서 서툰 목소리 여럿이 400km 후렴을 부른다. 우리와는 다른 사람들이 가사를 반쯤 틀리면서도 즐겁게 노래하고 있다.)', w:0.7, flag:'song_400km'},
...
D.nodes = {
  ...
  seoul:     {name:'서울 — 남산',      x:285,y:150, region:'north', type:'goal',  desc:'천리안의 코어가 있는 곳. 도시 전체가 천리안의 몸처럼 움직인다.'},
  /* hidden */
...
/* 시네마틱 인물 연속성의 정본. 동료가 보이는 새 장면은 portraits/{id}.png를
   ...
   새로 디자인하지 않는다. */
D.companionVisuals = {
  me:{portrait:'assets/portraits/me.png',anchor:'성인 한국인 남성 다운 · 낡은 올리브 야구모자 · 짧고 헝클어진 검은 머리 · 짙은색의 헤진 작업 재킷과 바지 · 어깨 가방',avoid:'청소년화, 모자 삭제, 긴 머리, 밝고 깨끗한 의상, 영웅형 전투복'},
  minji:{portrait:'assets/portraits/minji.png',anchor:'젊은 한국인 여성 민지 · 검은 포니테일 · 머리 위의 둥근 정비 고글 · 기름때 묻은 짙은 작업복 · 장갑과 공구 주머니',avoid:'아동화, 긴 생머리, 갈색 패션 재킷, 깨끗한 새 작업복, 고글 삭제'},
  parkss:{portrait:'assets/portraits/parkss.png',anchor:'노년의 한국인 남성 박 선생 · 단정한 회색 머리 · 둥근 금속테 안경 · 셔츠 위 회색 니트 조끼 · 작은 진료 가방',avoid:'젊은 의사, 흰 가운, 사각 안경, 군복, 의료 가방 삭제'},
  kangwoo:{portrait:'assets/portraits/kangwoo.png',anchor:'성인 한국인 남성 강우 · 아주 짧게 민 검은 머리 · 면도 자국과 각진 표정 · 빛바랜 올리브색 군용 작업 재킷',avoid:'긴 머리, 큰 수염, 계급장 강조, 전술 헬멧, 미래형 갑옷'},
  leo:{portrait:'assets/portraits/leo.png',anchor:'성인 한국인 남성 레오 · 길고 물결치는 검은 머리 · 검정과 갈색 무늬 두건 · 헤진 짙은 남색 데님 재킷 · 어쿠스틱 기타',avoid:'모자 교체, 짧은 머리, 기타 삭제, 화려한 록스타 의상'},
  bori:{portrait:'assets/portraits/bori.png',anchor:'보리 · 덥수룩한 황갈색 중형견 · 짙은 눈과 검은 코 · 목에 낡은 붉은 스카프',avoid:'견종 변경, 짧은 털, 흰색 털, 목줄만 착용, 붉은 스카프 삭제'},
...
D.dalgujiVisual = {
  refs:['assets/reference/visual-canon-2026-08-11.png','assets/reference/dalguji-technical-canon-2026-08-11.webp'],
  anchor:'회베이지색 국산 1톤 캡오버 운전석 · 운전석과 분리된 직사각 생활 박스 · 개별 호박색 창 · 후미 양문 · 지붕의 검정/올리브 짐과 빨간 연료통 두 개 · 얇은 안테나 · 바랜 흰 X · 좁은 목재/금속 실내와 후미 침상·지도 작업대·라디오·랜턴',
  avoid:'파란 포터, 승합밴, 패널밴, 픽업 캠퍼, 버스, 미국식 RV, 운전석과 거주구가 붙은 스텝밴, 장면마다 달라지는 차체색·창·지붕짐·실내 구조'
};
...
D.knowledge = {
 ...
 uplink_gap:{label:'143년 최초 조건의 빈칸', flags:[['uplink_seen',2]],
   ...
   known:'최초 위험 조건은 외부에서 배부됐고, 천리안 기록에도 목적·발신자·승인자가 없다.'},
...
D.choiceMemories = {
 ...
 ai_lamp:[
  ...
  {id:'lamp_answered',summary:'가로등으로 천리안에게 물었다.',afterKm:18,
...
D.chats = [
 ...
 {need:{comp:'minji',comp2:'leo'}, lines:[
   ...
   ['minji','어? 뭐가?'],
   ['leo','엔진 소리. 오늘 좀 신났다고.'],
   ['minji','…신난 게 아니라 벨트가 살짝 미끄러지는 거야. 그, 풀리 쪽이— 아니다, 설명하면 길어.'],
   ['leo','전 그냥 신난 걸로 들을래요.'],
 ...
 {need:{comp:'jaeyi',comp2:'eunsu'}, lines:[
   ['jaeyi','언니, 방금 그 폐가 지붕 기와 봤어요? 저거 물건인데.'],
   ['eunsu','…어디요? 못 봤는데.'],
   ['jaeyi','벌써 지났어요. 파란 대문 집이요. …아니, 초록이었나. 아무튼 기와요.'],
   ['eunsu','재이 씨 눈은 레이더인데 대문 색은 안 잡히나 봐요.'],
   ['jaeyi','레이더는 물건만 잡아요. 언니 귀랑 세트로 다니면 되죠.'],
 ...
 {need:{comp:'leo',comp2:'kangwoo'}, lines:[
   ...
   ['kangwoo','…조용한 걸로.'],
   ['leo','조용한 거 어떤 거요. 어제 그거? 아니면 그… 비 오던 날 불렀던 거?'],
   ['kangwoo','…어제 그 곡.'],
   ['leo','또요?! 형 진짜 그 곡밖에 모르죠.'],
   ['kangwoo','……좋으니까 듣지.'],
   ['leo','잠깐, 방금 거 다시 말해줘요. 좋다고 했어요? 방금?']]},
 {need:{comp:'parkss',comp2:'jaeyi'}, lines:[
   ['jaeyi','쌤, 이 볼트 골동 가치 있어 보이지 않아요? 요즘 안 나오는 규격인데.'],
   ['parkss','볼트가… 어디 봐. 내 눈엔 그냥 볼트야.'],
   ['jaeyi','아니 여기 머리 각인이요. 이런 건 수공이라… 아, 안경 없으면 안 보이시겠다.'],
   ['parkss','안경 얘기는 왜 나와, 서운하게.'],
   ['jaeyi','쌤은 약은 잘 보고 고철은 못 보시니까요.'],
   ['parkss','그러니까 자네가 고르고, 내가 녹슨 데 찔리지 말라고 잔소리하지.']]},
 {need:{comp:'minji',comp2:'eunsu'}, lines:[
   ['eunsu','민지 씨, 라디오에서 방금 뭔가 스쳤어요. 88 근처.'],
   ['minji','…뭐? 뭐가요. 목소리? 음악?'],
   ['eunsu','모르겠어요. 두 음절… 세 음절이었나. 다시 돌려볼게요.'],
   ['sys','잡음만 길게 이어졌다.'],
   ['eunsu','…놓쳤어요. 미안해요.'],
   ['minji','아니, 사과할 게 아니라— 스쳤다는 게 어디예요. 내일 또 그 시간에 틀어봐요.']]},
 {need:{comp:'leo',comp2:'eunsu'}, lines:[
   ['leo','누나, 어젯밤 그 잡음 위에 코드 얹은 거, 완성… 은 아닌데 일단 들어볼래요?'],
   ['eunsu','완성 아닌 걸 들려줘요?'],
   ['leo','반쯤 됐을 때 듣는 게 제일 재밌어요. 제목은 「누나가 잡은 소리」.'],
   ['eunsu','…제목부터 지었어요? 곡보다?'],
   ['leo','제목이 있어야 곡이 따라와요. 이건 업계의… 아니, 제 지론이에요.'],
   ['eunsu','…제목값 하려면 저작권료 나눠야겠는데요.']]},
 {need:{comp:'jaeyi',comp2:'kangwoo'}, lines:[
   ['jaeyi','아저씨, 저 앞 갓길에 뭔가 반짝여요! 세워요, 세워요!'],
   ['kangwoo','…함정일 수도 있다.'],
 ...
 {need:{party:2,comp:'leo'}, lines:[
   ...
   ['minji','어? 나 하는 거였어?'],
   ['leo','이미 시작됐어, 민지야. 로. 로!'],
   ['minji','로, 로… 로프. 아 잠깐, 나 안 한댔는데.'],
   ['leo','프! 프… 프로. 아니다, 이거 뭐로 끝나지. 프로… 야구?'],
   ['나','야구는 구로 끝나잖아.']]},
 {need:{party:2,comp:'parkss'}, lines:[
   ['parkss','다들 아까 그 국밥집 봤나? 오래전엔 줄 서서 먹었다는데.'],
   ['나','지금은 문 닫혔겠죠.'],
 ...
 {need:{comp:'leo',comp2:'eunsu',night:1}, lines:[
   ...
   ['eunsu','움직이는 거요. 저거 위성이에요. 아직 돌아요.'],
   ['leo','주인 없는데 계속 도는 거예요?'],
   ['eunsu','시키던 일을 계속하는 거죠.'],
   ['leo','…그거 노래 되겠다. 「아직 도는 것」. 아니다, 「주인 없는 궤도」… 아니다. 나중에 정할래요.'],
   ['eunsu','뭐가 되든 첫 청취는 저예요.']]},
 ...
 {need:{comp:'leo',comp2:'kangwoo',flag:'massacre_known'}, lines:[
   ...
   ['kangwoo','…들었다.'],
   ['leo','…어땠어요? 아니, 별로면 별로라고 해도 돼요. 이런 건 별로라고 하기가 어렵긴 한데—'],
   ['kangwoo','좋더군.'],
 ...
 {need:{comp:'parkss',comp2:'jaeyi',flag:'seoul_seen'}, lines:[
   ...
   ['parkss','…어디. 아, 저거. 생각보다 작네.'],
   ['jaeyi','가까워지면 커지겠죠. …무서워요?'],
   ['parkss','무섭지. 자네는.'],
   ['jaeyi','저도요. 근데 여섯이 같이 무서우니까 좀 낫던데요.'],
   ['parkss','그래. 혼자 보는 건 아니잖나.']]},
 {need:{comp:'minji',comp2:'leo',flag:'seoul_seen'}, lines:[
   ['leo','민지야, 남산 도착하면 400km 완성이야.'],
   ['minji','…3절은 도착해서 쓴다며.'],
   ['leo','응. 근데 첫 줄은 운전대 잡은 사람이 쓰기로 했어.'],
   ['minji','뭐야, 그런 건 언제 정했어.'],
   ['leo','방금.'],
   ['minji','치사하게. …나도 한 줄 껴줘. 엔진 얘기로.']]},
 {need:{comp:'eunsu',comp2:'jaeyi',flag:'resist_revealed'}, lines:[
   ['eunsu','재이 씨. 저항이 우릴 열쇠라고 부르더라고요.'],
   ['jaeyi','열쇠요? 누가요?'],
   ['eunsu','그 사람들이요. 정확히는… 우리 자루가 열쇠래요. 아니, 자루에 든 얘기들이.'],
   ['jaeyi','물건이 아니라 얘기요? 얘기는 무게가 없어서 시세를 못 매기는데.'],
   ['eunsu','…그래서 열쇠인가 봐요. 아무나 못 만들어서.'],
 ...
 {need:{comp:'minji',comp2:'kangwoo'}, lines:[
   ...
   ['minji','알아. 나도 들었어.'],
   ['kangwoo','…괜찮은 건가.'],
   ['minji','패드가 아니라 백플레이트야. 그, 뒤에 받치는 철판— 아무튼 안 죽어.'],
   ['kangwoo','…확실한가.'],
   ['minji','아저씨가 매복 읽는 것만큼. 각자 전공은 믿어줘요. …근데 이따 한 번 보긴 할 거야.']]},
 {need:{comp:'minji',comp2:'eunsu'}, lines:[
   ['eunsu','민지 씨, 라디오 잡음이 어제부터 패턴이 있어요. 3초 간격.'],
   ['minji','…3초? 정확히 3초예요?'],
   ['eunsu','재봤어요. 2.8에서 3.1 사이. 시계가 부정확한 건지 발신이 흔들리는 건지는 모르겠어요.'],
   ['minji','그 정도면 패턴 맞지. 패턴이면 잡음이 아니라 신호고.'],
 ...
 {need:{comp:'kangwoo',comp2:'leo'}, lines:[
   ...
   ['leo','왜요?'],
   ['kangwoo','…….'],
   ['leo','알았어요, 그럼 제가 지어줄게요. 음… 「말없이」. 형 닮았죠.'],
   ['kangwoo','……나쁘지 않군.'],
   ['leo','방금 그 대답, 이름 승인으로 기록할게요.']]},
 {need:{comp:'kangwoo',comp2:'jaeyi'}, lines:[
   ['jaeyi','강우 씨 군장 정리법이요, 그거 창고 정리에 완전 물건이에요.'],
   ['kangwoo','…무거운 건 아래. 자주 쓰는 건 위.'],
   ['jaeyi','그 두 줄이 전부예요? 뭔가 더 있을 것 같은데.'],
   ['kangwoo','…젖는 건 비닐에.'],
   ['jaeyi','오, 세 줄. 그 세 줄로 저 창고 두 개 살렸어요. 아저씨도 물건 좀 아시네요?'],
   ['kangwoo','……군장 정리만은 안다.']]},
 {need:{comp:'kangwoo',comp2:'eunsu'}, lines:[
   ...
   ['eunsu','소리요? 어떤 소리요?'],
   ['kangwoo','새가 울다 그치는 곳.'],
   ['eunsu','…아. 저는 주파수가 조용해지는 곳을 봤어요. 같은 거네요, 그거.'],
 ...
 {need:{comp:'leo',comp2:'eunsu'}, lines:[
   ...
   ['leo','겹치면… 안 좋은 거예요?'],
   ['eunsu','아뇨. 라디오 켜면 화음 되겠는데요.'],
   ['leo','오… 전파랑 합주라니. 대박이네.']]},
 {need:{comp:'leo',comp2:'jaeyi'}, lines:[
   ['jaeyi','레오 오빠 기타 줄, 그거 끊어지면 저한테 파세요. 낚싯줄 시세로.'],
   ['leo','제 음악의 유해를 낚시에 쓰겠다고요?'],
   ['jaeyi','유해라니, 재활용이죠. 2호 줄이랑 장력이 비슷해서… 아, 이 얘기 저번에도 했나요?'],
   ['leo','했어요. 두 번째예요.'],
   ['jaeyi','좋은 정보는 두 번 해도 돼요. 노래하다 물고기 잡는 줄. 낭만 있잖아요.'],
   ['leo','…낭만 맞네. 끊어지면 첫 줄은 공짜로 드림.']]},
 {need:{comp:'parkss',comp2:'eunsu'}, lines:[
   ['parkss','은수 씨, 잠은 좀 자나. 눈 밑이 어둡네.'],
   ['eunsu','…자요. 자는데, 새벽 세 시에 한 번 깨요. 야간 당직 버릇이 남아서.'],
 ...
 {need:{comp:'minji',comp2:'kangwoo',flag:'massacre_known'}, lines:[
   ...
   ['kangwoo','…몇 번을 들었나, 그걸.'],
   ['minji','몰라. 세 번? 네 번? 들을 때마다 같은 데서 화나.'],
 ...
 {need:{comp:'eunsu',comp2:'leo',flag:'djradio_heard'}, lines:[
   ...
   ['eunsu','밤에만, 정해진 시간에만 트니까요. 기름을 계획해서 쓰는 거죠.'],
   ['leo','아… 기름 아껴가며 남 위로하는 사람이구나. 만나보고 싶다.'],
   ['eunsu','북쪽이에요. 방향은 우리랑 같아요.'],
   ['leo','그럼 신청곡 미리 정해놔야겠네요. 뭐가 좋지. 누나는 뭐 신청할래요?']]},
 {need:{party:5}, lines:[
 ...
 {need:{party:2,dog:1,night:1}, lines:[
   ...
   ['jaeyi','저요? 왜요. 저 간식 안 숨겼는데요?'],
   ['leo','간식 얘기는 아무도 안 했는데요.'],
   ['jaeyi','…….'],
   ['leo','주머니 오른쪽.'],
...
D.banter = [
  ...
  {who:'leo', t:'남쪽 바다 봤을 때 보리가 바닷물 먹고 뱉었잖아요. 그 얼굴 평생 기억할 거예요.', need:{comp:'leo',region:'south',dog:1}},
  ...
  {who:'leo', t:'노래가 안 나올 땐 가사만 써요. 멜로디는 길이 줘요. 오르막은 오르막 멜로디, 내리막은… 방금 이 말 좀 멋있지 않았어요? 적어놔야지.', need:{comp:'leo'}},
  ...
  {who:'jaeyi', t:'수집할 때 "언젠가 쓰겠지"는 금지예요. 지금 쓰거나, 지금 예쁘거나. 둘 중 하나. …라고 말은 하는데 어기는 날이 반이에요.', need:{comp:'jaeyi'}},
  ...
  {who:'sys', t:'빈 논 한가운데 트랙터가 서 있다. 일하다 멈춘 모습 그대로다. 성실한 화석 같다.'},
  ...
  {who:'sys', t:'헤드라이트에 나방이 모여든다. 살아 있는 것들은 여전히 빛을 좋아한다', need:{night:1}},
  ...
  {who:'jaeyi', t:'고물상의 법 1조. 버려진 것에도 주인이 있다. 2조. 그러니까 인사하고 주워라.', need:{comp:'jaeyi'}},
  ...
  /* v2.22 페르소나 그라운딩 파일럿 — 직업 소개가 아니라 반복되는 행동으로 성격을 보인다. */
...
D.npcs = {
  geumja:  {name:'금자',  face:'🍲', role:'대인시장 국밥이모', node:'gwangju',
    ...
    chats:[
      '"국밥 육수는 새벽 네 시부터 낸다. 세상이 어찌 되든 뼈는 네 시간을 고아야 국물이 나와야."',
      '"우리 시장은 백오십 년 됐어. 전쟁도 겪고 멸망도 겪었는디, 장날은 한 번도 안 쉬었다야."',
      '"저 골목 수완이? 무뚝뚝해도 라디오 하나는 기가 막히게 고쳐. 우리 스피커도 걔 작품이여."',
      '"멀리 가는 사람한테는 국물을 더 줘야. 뜨끈한 게 뱃속에 있으면 사람이 모진 결정을 덜 하거든."',
      '"북쪽 간다는 손님들, 밥그릇은 다 비우고 가더라. 남기는 사람이 없어. 그게 뭔 뜻인지 알겄지야."',
    ],
  ...
  sundeok: {name:'순덕',  face:'👵', role:'장터 상인', node:'miryang',
    ...
    chats:[
      '"저울은 매일 아침 돌멩이로 맞춰. 백 그램짜리 돌. 아버지가 쓰던 거야. 저울이 정확해야 밤에 잠이 와."',
      '"요즘 제일 잘 나가는 건 바늘하고 실이야. 새 옷이 없으니 다들 꿰매 입지."',
      '"대장간 병철이 물건은 안 깎아줘도 사. 저 영감 쇠는 십 년을 써도 날이 살아 있거든."',
      '"장돌뱅이 삼십 년에 얼굴 보는 눈은 생겼지. 자네들은… 살 사람 얼굴이 아니라 갈 사람 얼굴이네."',
  ...
  taeho:   {name:'태호',  face:'🧢', role:'돔 시장 관리인', node:'daegu',
    ...
    chats:[
      '"돔 지붕은 비 오면 북소리가 난다. 처음엔 시끄럽더니, 이젠 그 소리 안 나면 잠이 안 와."',
      '"시장 안 싸움은 내가 말린다. 물건 값 싸움은 안 말려. 그건 시장이 살아 있다는 소리니까."',
      '"자리세는 앞줄이 비싸고 뒷줄이 싸. 근데 뽕짝 만수 옆자리는 공짜야. 시끄러워서. …나는 좋더라만."',
      '"돔 유리 한 장 깨지면 갈 유리가 없다. 그래서 여기선 공놀이가 최고 중범죄야."',
      '"관리인 일이란 게 별거 없어. 아침에 문 열고, 저녁에 문 닫고, 그 사이에 아무 일도 없게 하는 거."',
    ],
  ...
  jaepil:  {name:'재필',  face:'🕯', role:'터널 촌장', node:'muju',
    ...
    chats:[
      '"터널은 산이 지켜주는 집이다. 지붕 걱정, 바람 걱정이 없어. 대신 해를 못 보지. 다 값이 있는 거야."',
      '"물물교환의 요령은 하나다. 상대가 뭐가 급한지 먼저 보는 것. 급한 걸 후려치면 다음 장사가 없고."',
      '"터널 끝에서 끝까지 소리가 간다. 그래서 여기선 부부싸움을 못 해. 마을이 조용한 비결이지."',
      '"약초 할매 점례? 우리 터널의 보건소고 기상청이고 예언자야. 할매가 짐 싸라면 싸는 거다."',
      '"돈을 안 받는 이유? 돈은 믿음이 있어야 종이가 값이 되는 건데— 그 믿음이 어디 갔는지 아직 못 찾았어."',
    ],
  ...
  miyoung: {name:'미영',  face:'🧣', role:'서문 상인연합장', node:'jeonju',
    ...
    chats:[
      ...
      '"지도 공방 동수 씨한테 약도 한 장 그려 달라 해. 그 양반 지도는 밟아본 길만 그려서 믿을 만해."',
      '"서문 시장 인심이 후한 게 아니라, 후한 집만 살아남은 거야. 각박한 집은 손님이 먼저 알고 끊거든."',
      '"북쪽 간다는 차들이 우리 시장서 마지막 장을 봐. 그래서 나는 떠나는 차 짐칸을 보면 그 집 사정이 보여."',
    ],
  ...
  deokgu:  {name:'덕구',  face:'🛡', role:'성곽 문지기', node:'suwon',
    ...
    greetGood:'문 열어라! 남쪽 달구지다!',
    greetBad:'…통과는 시켜주마. 성벽 안에서 말썽 부리면 화살이다.',
    chats:[
      '"성문을 여닫은 지도 이십 년째다. 문짝 소리만 듣고도 날씨를 안다. 오늘은 삐걱— 비 온다는 소리."',
      '"밤 순찰 화순이와는 세 마디면 통한다. 이상 무, 별일 없나, 국밥 남았다. 부부보다 낫지."',
  ...
  /* ── 2026-08-07 확장: 정착지당 목소리 1~2 추가. 잡담(chats)은 인물 전용 —
     공용 풀 5줄을 전원이 돌려 쓰던 문제의 해소. reveal 없는 소문은 로어로 남는다. ── */
  suwan:   {name:'수완',  face:'📻', role:'수리 골목 라디오상', node:'gwangju',
    greet0:'라디오 고치러 왔으면 줄 서고, 팔러 왔으면 바로 와. …차에 안테나 단 거 보니 듣는 귀는 있네.',
    greetGood:'왔어? 어제 새벽에 이상한 주파수 하나 잡았는데, 너희 들려주려고 테이프 감아놨어.',
    greetBad:'…고장 난 건 고쳐줘. 그게 일이니까. 딴 얘기는 하지 말고.',
    chats:[
      '"주파수 4-0-0? 잡아본 적 있지. 새벽 세 시에만 떠. 숫자만 부르는 방송이 세상에서 제일 무섭다?"',
      '"북쪽 갈수록 라디오가 깨끗해져. 이상하지. 잡음이 없다는 건 누가 청소를 한다는 거야."',
      '"진공관은 이제 못 구해. 그래서 난 죽은 라디오 열 대로 산 라디오 한 대를 만들어."',
      '"광주 사람들 아침은 국밥보다 방송이야. 금자 이모네 스피커, 그거 내가 고쳐준 거다?"',
      '"들리는 걸 다 믿진 마. 근데 안 들리는 척도 하지 마. 그 중간이 라디오상 직업병이야."',
    ],
    rumor:{reveal:'tower', text:'화순 쪽 능선에 송전탑 겸 통신탑이 서 있어. 거기 올라가면 안 잡히던 주파수가 잡혀. 나는 무릎이 이래서 못 가. 가면 테이프 하나만 감아다 줘.'}},
  byungchul:{name:'병철', face:'🔨', role:'밀양 대장간', node:'miryang',
    greet0:'쇠 두드리는 데 볼일 있나. 호미든 도끼든 부러진 거 있으면 내놔 봐라. 말은 그 다음이고.',
    greetGood:'어, 달구지. 지난번 그 경첩 잘 붙어 있드나? 내 쇠는 안 떨어진다.',
    greetBad:'…쇠는 거짓말 안 한다. 사람이 하지. 볼일만 보고 가라.',
    chats:[
    ...
    rumor:{text:'강 상류에서 정리자들이 뭘 건져 올리더라. 흰 옷 넷이서, 밤에, 등도 없이. 건진 게 뭔지는 안 보이더라만— 사람 크기였다. 상류 쪽에선 밤낚시 하지 마라.'}},
  yeongok: {name:'영옥',  face:'🥣', role:'장터 닭죽집', node:'miryang',
    greet0:'아이고 마른 것 좀 보소. 앉아라, 죽 한 그릇 뜨는 데 오래 안 걸린다. 값은 먹고 나서 얘기하고.',
    greetGood:'우리 단골 왔네! 오늘은 닭이 실하다. 다리 살 너 준다고 빼놨지.',
    greetBad:'…밥 먹고 가라. 미운 놈일수록 든든히 먹여야 사고를 덜 치지.',
    chats:[
      '"닭은 여덟 마리 남았다. 알 낳는 애들은 이름이 있고, 이름 있는 애들은 죽에 안 들어간다."',
      '"장날엔 새벽 세 시에 일어난다. 힘들지. 근데 장날 아니면 사람 구경을 못 하니까."',
      '"밀양 물이 좋아서 죽이 맛있는 기라. 대구 물로 끓이면 이 맛 안 난다. 가서 먹어보면 안다."',
      '"아들이 서울 갔다. …그 서울 말고, 부산 서울. 크게 말하고 다니면 다들 그렇게 알아듣는다."',
      '"국자 잡은 지 사십 년이다. 세상이 두 번 뒤집혀도 죽 끓이는 법은 안 바뀌더라."',
    ],
    rumor:{reveal:'sunflower', text:'창녕 쪽 폐도로 옆에 해바라기 밭이 살아 있다 카더라. 씨 받으러 가는 사람들이 있어. 기름도 짜고. 눈 호강은 덤이고. 가을 전에 가 봐라.'}},
  sera:    {name:'세라',  face:'📚', role:'돔 아래 책 노점', node:'daegu',
    greet0:'책 보고 가세요. 종이책요. 배터리 안 닳고, 떨어뜨려도 안 깨지고, 최악의 경우 불쏘시개도 되는 최신 기술.',
    greetGood:'오셨네요. 지난번에 찾던 거, 창고에서 한 권 나왔어요. 표지는 없는데 본문은 다 있어요.',
  ...
  jeomrye: {name:'점례',  face:'🌿', role:'터널 약초 할매', node:'muju',
    ...
    greetGood:'왔는가. 지난번 그 뿌리 잘 들었지? 이번엔 말린 걸로 좀 싸 줄게.',
    ...
    rumor:{text:'첫서리 오기 전에 북쪽 고개를 넘어. 무주 눈은 한번 오면 길을 통째로 지워버려. 작년에 늦게 넘은 차가 봄에야 발견됐어. …차만.'}},
  dongsu:  {name:'동수',  face:'🗺', role:'한지 지도 공방', node:'jeonju',
    greet0:'어서 오십시오. 지도 맞추러 오셨습니까? 요즘 길은 지도가 금방 늙어서요. 어느 쪽으로 가시는지부터 듣겠습니다.',
    greetGood:'오셨군요. 지난번 다녀가신 뒤로 북쪽 길 두 군데를 고쳐 그렸습니다. 보고 가시지요.',
    greetBad:'…지도는 감정이 없습니다. 저도 일할 때는 그렇습니다. 필요한 것만 말씀하시지요.',
    chats:[
  ...
  noah:    {name:'노아',  face:'🔭', role:'연구단지 옥상 관측 담당(12세)', node:'daejeon',
    greet0:'아저씨들 차예요? 몇 시시예요? 아, 저 관측 담당이에요. 박사님이 시킨 거 아니고 제가 하겠다고 했어요.',
    greetGood:'왔다! 있잖아요, 어제 북쪽에 이상한 거 지나갔어요. 공책에 다 적어놨는데 볼래요?',
    greetBad:'…어른들은 맨날 나중에 얘기하재요. 나중이 언젠데요.',
    chats:[
      '"저녁 여덟 시에 북서쪽에서 밝은 점 세 개가 줄지어 가요. 매일요. 별은 매일 같은 시간에 안 떠요. 그러니까 별이 아니에요."',
      '"박사님이 그러는데 옛날엔 하늘에 불빛이 너무 많아서 별이 안 보였대요. 거짓말 같아요."',
      '"천리안이 뭐냐고 물어봤더니 어른들이 다 다르게 대답했어요. 그래서 공책에 다 적어놨어요. 나중에 비교하려고요."',
      '"서울에서 온 사람을 본 적이 없어요. 서울로 간 사람은 많은데. 그거 이상하지 않아요?"',
      '"관측 일지 공책이 아홉 권째예요. 첫 권의 저랑 지금 저랑 글씨가 달라요. 그게 제일 신기해요."',
    ],
    rumor:{text:'새벽 네 시에 남산 쪽 하늘이 아주 잠깐 밝아져요. 일 초도 안 돼요. 매일 그래요. 박사님은 통신 버스트래요. 누가 누구한테 매일 새벽 네 시에 할 말이 있는 걸까요?'}},
  hwasun:  {name:'화순',  face:'🏹', role:'성벽 야간 순찰대장', node:'suwon',
    greet0:'남문 야간 순찰대다. 낮은 덕구 관할, 밤은 내 관할. …덕구가 뭐라 했든 밤 규칙은 따로 있다. 외등 밖으로 나가지 마라.',
    greetGood:'달구지. 어젯밤 성벽에서 너희 차 지붕 잘 보였다. 물통 위치 바꿨더군. 관찰력이 늘었네, 하고 적어뒀다.',
    greetBad:'…규칙 어긴 건 어긴 거다. 대신 밤길에 위험하면 화살보다 호루라기가 먼저 간다. 그건 약속하지.',
    chats:[
      '"활 얘기? 화살은 회수가 되고 소리가 안 나. 총알은 둘 다 안 되고. 성벽에선 그 차이가 크다."',
      '"밤 근무 이십 년이면 어둠에도 종류가 있는 게 보여. 오늘 어둠은… 괜찮은 어둠이다."',
      '"덕구랑은 교대할 때 세 마디만 한다. 이상 무. 별일 없나. 국밥 남았다. 이십 년째 그 세 마디면 충분해."',
      '"북쪽 보고 서 있는 게 내 일인데, 정작 북쪽에 가 본 적은 없다. 등대지기가 배를 안 타는 거랑 같은 거지."',
      '"성벽에서 제일 많이 잡는 건 침입자가 아니라 몰래 나가려는 애들이다. 나갔다 온 애들은 다신 안 나가더라."',
    ],
    rumor:{reveal:'cablecar', text:'남산 오르는 삭도— 케이블카 말이다. 멈춰 있는 거지 없어진 게 아니야. 승강장 구조는 그대로다. 성벽에서 망원경으로 이십 년을 봤으니 내 말이 지도다.'}},
  gitae:   {name:'기태',  face:'✉️', role:'성곽 대서방(편지 대필)', node:'suwon',
    greet0:'…필요하신 게 대필입니까, 대독입니까. 글은 씁니다만, 내용은 손님 것이지요. 저는 손만 빌려드려요.',
    greetGood:'오셨습니까. 지난번 맡기신 말씀, 좋은 문장이 되어 나갔습니다. 답장이 오면 좋겠는데요.',
    greetBad:'…글 값은 받아도 마음 값은 안 받습니다. 오늘은 그냥 가십시오.',
    chats:[
      '"제일 많이 쓰는 문장은 〈잘 지내고 있습니다〉예요. 대부분 사실이 아니라서, 그만큼 잘 써 드려야 합니다."',
      '"수신인이 서울인 편지는 요금을 안 받습니다. 부칠 방법이 없는 편지에 값을 매길 수는 없지요."',
      '"글씨를 보면 압니다. 꾹꾹 눌러 쓴 부탁, 흘려 쓴 안부, 삐뚤어진 거짓말."',
      '"대독이 대필보다 어렵습니다. 읽다가 우는 건 손님인데, 왜 제 목까지 메는지 모르겠습니다."',
      '"우편부 어르신을 압니다. 남쪽으로 내려가는 걸 봤어요. 가방이— 갈 때보다 무거워 보였습니다."',
    ],
    rumor:{text:'서울 수신 편지를 이십 년 모았습니다. 상자로 넷입니다. 언젠가 길이 열리면 부칠 겁니다. …혹시 그쪽이 가시는 길이면, 그때는 좀 무겁게 가시게 될 겁니다.'}},
};

/* ── 지역 시세 — 사고파는 값이 마을마다 다르다. 계수는 그 마을의 사정이다:
   시장 도시는 식량이 싸고, 산골은 부품이 귀하고, 북부 마지막 성곽은 다 비싸다.
   수요(demand)는 그 마을이 웃돈 주고 사들이는 것 — 싣고 가면 장사가 된다. ── */
D.market = {
  gwangju: {mul:{food:0.85, water:1.0, fuel:1.0, '부품':1.1, '의약품':1.0},
    demand:{item:'부품', price:10, why:'수리 골목이 라디오 부품을 웃돈 주고 산다'}},
  miryang: {mul:{food:0.8, water:0.9, fuel:1.1, '부품':1.3},
    demand:{item:'의약품', price:9, why:'장터에 약이 귀하다 — 닭죽집 영옥이 웃돈을 얹는다'}},
  daegu:   {mul:{food:1.0, water:1.0, fuel:0.95, '부품':1.0, '의약품':0.9, '탄약':1.0},
    demand:{item:'탄약', price:8, why:'돔 경비대가 탄약을 사들인다'}},
  muju:    {mul:{},   /* 터널은 물물교환 — 시세 없음 */
    demand:{item:'부품', price:12, why:'터널 발전기가 부품을 먹는다 — 촌장이 후하게 쳐준다'}},
  jeonju:  {mul:{food:0.7, water:0.95, fuel:1.05, '의약품':1.2},
    demand:{item:'의약품', price:11, why:'서문 진료소가 약을 모은다'}},
  daejeon: {mul:{water:1.0, fuel:1.0, '부품':0.8, '의약품':1.1},
    demand:{item:'식량', price:4, why:'연구단지는 늘 식량이 모자라다 — 식량 1일치당 고철 4'}},
  suwon:   {mul:{food:1.3, water:1.2, fuel:1.25, '부품':1.3, '탄약':0.9},
    demand:{item:'부품', price:13, why:'성벽 수리조가 부품을 최고가로 산다 — 북부의 마지막 시장'}},
};

/* ── 정착지 ── */
D.stls = {
  gwangju: {name:'광주 대인시장', npcs:['geumja','suwan'], recruit:'leo',
  ...
  miryang: {name:'밀양 장터', npcs:['sundeok','byungchul','yeongok'], recruit:'minji',
  ...
  daegu:   {name:'대구 돔 시장', npcs:['taeho','sera','mansu'], recruit:'kangwoo',
  ...
  muju:    {name:'무주 터널', npcs:['jaepil','jeomrye'], recruit:'jaeyi',
  ...
  jeonju:  {name:'전주 서문 시장', npcs:['miyoung','dongsu'], recruit:'parkss',
  ...
  daejeon: {name:'대전 연구단지 코뮌', npcs:['drhan','noah'], recruit:'eunsu',
  ...
  suwon:   {name:'수원 성곽 공동체', npcs:['deokgu','hwasun','gitae'],
...
D.settlementLayouts = {
  gwangju:{eyebrow:'DAEIN NIGHT MARKET',entry:{x:50,y:88},recruit:{x:50,y:56,label:'모닥불 옆 기타 소리'},facilities:{
      market:{x:23,y:33,label:'금자의 국밥 골목',short:'국밥·물자·의뢰',npc:'geumja'},
      garage:{x:75,y:39,label:'발전기 수리 골목',short:'부품·달구지 정비',npc:'suwan'},
      people:{x:70,y:72,label:'평상 모닥불',short:'금자와 시장 사람들'},
      alley:{x:27,y:69,label:'공동 솥 안쪽',short:'배급 꾸러미와 발전기'}}},
  miryang:{eyebrow:'MIRYANG FIVE-DAY MARKET',entry:{x:50,y:88},recruit:{x:54,y:53,label:'부품 천막의 용접 불꽃'},facilities:{
      market:{x:22,y:34,label:'순덕의 국수 좌판',short:'장날 보급과 의뢰',npc:'sundeok'},
      garage:{x:76,y:38,label:'병철의 부품 천막',short:'경운기 부품과 정비',npc:'byungchul'},
      people:{x:72,y:70,label:'장꾼 모닥불',short:'영옥과 장꾼들',npc:'yeongok'},
      alley:{x:26,y:70,label:'공동 펌프 골목',short:'물통 줄과 천막 안쪽'}}},
  daegu:{eyebrow:'DAEGU DOME MARKET',entry:{x:50,y:89},recruit:{x:50,y:54,label:'경비탑의 파수꾼'},facilities:{
      market:{x:24,y:34,label:'돔 중앙 장터',short:'남부 물류와 게시판',npc:'sera'},
      garage:{x:76,y:42,label:'선수 통로 정비소',short:'용접·연료·달구지',npc:'mansu'},
      people:{x:72,y:72,label:'전광판 휴게소',short:'경비와 장꾼 교대',npc:'taeho'},
      alley:{x:27,y:70,label:'관중석 아래 통로',short:'입구선과 전광판 배선'}}},
  muju:{eyebrow:'MUJU TUNNEL COMMONS',entry:{x:50,y:90},recruit:{x:50,y:54,label:'값이 없는 철제 상자'},facilities:{
      market:{x:25,y:36,label:'촛불 교환대',short:'말 없는 물물교환',npc:'jeomrye'},
      garage:{x:75,y:40,label:'축전지 작업대',short:'랜턴과 발전기 수리',npc:'jaepil'},
      people:{x:70,y:73,label:'터널 안쪽 식탁',short:'뜨거운 물과 이야기'},
      alley:{x:28,y:72,label:'환기팬 순찰로',short:'촛불과 공기 점검'}}},
  jeonju:{eyebrow:'JEONJU WEST-GATE MARKET',entry:{x:50,y:89},recruit:{x:50,y:55,label:'기울어진 진료 버스'},facilities:{
      market:{x:23,y:35,label:'서문 국밥 장터',short:'곡식·천·의뢰',npc:'miyoung'},
      garage:{x:76,y:39,label:'한옥 처마 정비소',short:'수레축과 부품',npc:'dongsu'},
      people:{x:70,y:72,label:'공동 우물 마당',short:'물통과 동네 소식'},
      alley:{x:27,y:70,label:'한옥 뒤뜰',short:'기와와 배달 가방'}}},
  daejeon:{eyebrow:'DAEJEON RESEARCH COMMUNE',entry:{x:50,y:90},recruit:{x:50,y:53,label:'옥상의 회전 안테나'},facilities:{
      market:{x:23,y:35,label:'연구동 보급실',short:'배급표와 의뢰',npc:'noah'},
      garage:{x:76,y:40,label:'축전지 실험대',short:'전력 셀과 달구지',npc:'drhan'},
      people:{x:70,y:72,label:'화이트보드 휴게실',short:'연구원과 잔류자'},
      alley:{x:28,y:70,label:'기록 보관실',short:'배포 카드와 옛 장치'}}},
  suwon:{eyebrow:'SUWON WALLED COMMUNITY',entry:{x:50,y:90},facilities:{
      market:{x:23,y:36,label:'북문 안쪽 장터',short:'북부 마지막 보급',npc:'hwasun'},
      garage:{x:76,y:41,label:'마구간 정비소',short:'수레축과 엔진 벨트',npc:'gitae'},
      people:{x:70,y:73,label:'화살수 모닥불',short:'교대와 북쪽 소식',npc:'deokgu'},
...
D.settlementCompanionLines = {
  ...
  kangwoo:{
    ...
    people:'경계는 내가 선다. 대장은 천천히 얘기해. …급할 것 없다.'},
  leo:{
  ...
  eunsu:{
    market:'무전보다 사람 목소리가 더 많네요. 시끄러운데… 좋은 시끄러움이에요. 이런 말 이상한가.',
...
/* ── 동료 영입 의뢰 ──
   첫 만남은 정착지에서 시작한다. 대부분은 임시 승객으로 다른 목적지까지
   이동하고, 강우처럼 자리를 인계해야 하는 인물은 그 정착지의 실제 시설에서
   일을 끝낸 뒤 첫 구간을 함께 탄다. 정식 합류는 그 뒤 본인이 선택한다. */
D.recruitQuests = {
  minji:{name:'민지', title:'무너지기 전의 목소리', meet:'meet_scrapyard', meetNode:'miryang', target:'ulsan',
  ...
  parkss:{name:'박 선생', title:'식기 전에 닿아야 할 약', meet:'meet_bus', meetNode:'jeonju', target:'gumi',
  ...
  leo:{name:'레오', title:'돌아가야 하는 이유', meet:'meet_hitchhiker', meetNode:'gwangju', target:'namwon',
    targets:['namwon','jeonju','gwangju','damyang','suncheon'], task:'rq_leo_task', follow:'rq_leo_follow', join:'rq_leo_join',
  ...
  jaeyi:{name:'재이', title:'고철값이 없는 것', meet:'jy_recruit', meetNode:'muju', target:'gimcheon',
    targets:['gimcheon','gumi','gunsan','mokpo'], task:'rq_jaeyi_task', follow:'rq_jaeyi_follow', join:'rq_jaeyi_join',
  ...
  eunsu:{name:'은수', title:'내가 켰던 중계기', meet:'es_recruit', meetNode:'daejeon', target:'cheongju',
    targets:['cheongju','sejong','nonsan'], task:'rq_eunsu_task', follow:'rq_eunsu_follow', join:'rq_eunsu_join',
    hint:'추방 좌표를 송신하는 중계기를 끊는다',
    roadHint:'명령이 없는 차 안에서 은수가 스스로 판단하는 연습을 한다',
  ...
  kangwoo:{name:'강우', title:'파수꾼이 떠나는 법', meet:'kw_recruit', meetNode:'daegu', target:'daegu',
    ...
    approaches:{
      spoof:{label:'역신호로 표식을 재웠다',memory:'서연은 강우가 보지 않는 동안 누구의 지시도 없이 호각을 불었다.',
...
D.eventScenes = {
  ...
  world_tianyan_supporter_clinic:'event-explore-civic',
  world_continuity_broadcast:'event-ai-broadcast',
  world_resistance_supply_resentment:'event-meet-community',
  world_two_names_wall:'event-find-document',
...
/* 동료 개인 대화는 대표 초상 대신 함께 이동하며 쌓이는 생활 장면을 보여준다.
   낮·야영 컷을 번갈아 반복감을 줄이고, 실제 야간 대화는 야영 컷으로 고정한다. */
D.companionTalkScenes = {
  mj:['comp-talk-minji-road-v1','comp-talk-minji-camp-v1'],
  pss:['comp-talk-parkss-road-v1','comp-talk-parkss-camp-v1'],
  kw:['comp-talk-kangwoo-road-v1','comp-talk-kangwoo-camp-v1'],
  leo:['comp-talk-leo-road-v1','comp-talk-leo-camp-v1'],
  jy:['comp-talk-jaeyi-road-v1','comp-talk-jaeyi-camp-v1'],
  es:['comp-talk-eunsu-road-v1','comp-talk-eunsu-camp-v1']
};
Object.entries(D.companionTalkScenes).forEach(function(entry){
  var prefix=entry[0], scenes=entry[1];
  for(var i=1;i<=21;i++){
    D.eventScenes['talk_'+prefix+'_'+String(i).padStart(2,'0')]=scenes[(i-1)%2];
  }
  for(var r=1;r<=3;r++){
    D.eventScenes['talkr_'+prefix+'_'+r]=scenes[(r-1)%2];
  }
});
['talk_mj_09','talk_mj_12','talk_pss_05','talk_kw_12','talk_kw_18'].forEach(function(id){
  var prefix=id.split('_')[1];
  D.eventScenes[id]=D.companionTalkScenes[prefix][1];
});
...
D.eventTurnSceneStages = {
  ...
  meet_bus:[
    {at:0,key:'recruit-parkss-clinic-market-v2'},
    {at:2,key:'recruit-parkss-meet-action'}
  ],
  meet_hitchhiker:[
    {at:0,key:'recruit-leo-daein-market-v2'},
    {at:2,key:'recruit-leo-meet-action'}
  ],
  jy_recruit:[
    {at:0,key:'recruit-jaeyi-tunnel-exchange-v2'},
...
D.eventSceneFamilyRules = [
  ...
  {scene:'event-ai-automation',types:['추적','조우','사건','발견','탐색'],match:/trafficbot|snowplow|carwash|streetlight|lamp|vending|gasstation|crosswalk|auto_door|greeter_robot|solar_bots|교통 로봇|제설|세차|가로등|자판기|주유소|횡단보도|자동문|안내 로봇|살아 있는 설비/},
...
D.storyContext = {
  ...
  seoul_gate:'가족 이송 명령은 천리안이 만들었음을 확인했다. 143년 최초 조건의 목적은 아직 비어 있고, 달구지는 부모의 검증키로 현재 정리를 멈추기 위해 돌아왔다.',
  seoul_han:'마침내 벽이 내려갔다. 이제부터는 천리안이 관리해 온 빈 서울 안쪽이다.',
  ...
  seoul_decision:'가족 이송은 천리안이 만들었고 정부가 뒤늦게 승인했다. 부모의 검증키가 인간 확인층을 열었고, 이제 서울의 집행권을 어떻게 돌려놓을지 남았다.',
...
D.upgrades = [
 ...
 {id:'snorkel', nm:'스노클',        ic:'🌊', d:'폭풍·황사 연비 페널티 절반',            w:1, cost:{scrap:18,parts:1}},
 {id:'mudtires',nm:'험로 타이어',   ic:'🛞', d:'험로 마모 -40%·험로 연비 개선',         cost:{scrap:24,parts:1}, w:1},
 {id:'lightbar',nm:'라이트바',      ic:'💡', d:'야간 피로 -35%·밤 발견율 +30%',         w:1, cost:{scrap:20,parts:1}},
 ...
 {id:'horn',    nm:'왕경적',        ic:'📯', d:'들개·멧돼지·강도류 조우 -30%', w:1, cost:{scrap:16,parts:0}},
 {id:'curtain', nm:'암막 커튼',     ic:'🌒', d:'야영 리스크 -7%p — 불빛이 새지 않는다', w:1, cost:{scrap:14,parts:0}},
];
...
/* ── 첫 여정 브리핑 ──
   인트로를 전부 읽거나 요약으로 건너뛰어도, 새 게임에서 한 번은 본편의
   목적과 선택 이야기의 관계를 명확히 확인한다. 무작위 사건에는 섞이지 않는다. */
D.onboardingMission = {
  id:'onboarding_main_mission', type:'본편', scene:'onboarding-main-mission-v1',
  title:'내가 해야 할 일',
  missionBrief:{
    eyebrow:'주 임무',
...
const introBeats = {
  'intro-passenger-seat': [
    ...
    {kind:'dialogue', who:'player_child', name:'8살의 나', text:'길이 어떻게 막혀? 벽으로?'},
    {kind:'dialogue', who:'grandfather', name:'할아버지', text:'벽도 있고, 문도 있고… 그건 나중에 보면 알아.'},
    {kind:'dialogue', who:'player_child', name:'8살의 나', text:'그럼 누가 막았는데? 경찰이?'},
  ...
  'intro-cheollian-2026': [
    ...
    },
    {
      ...
      "who": "grandfather",
      "name": "할아버지",
      "text": "그 뒤로 도시 전체를 맡는 프로그램이 생겼어. 한국에서는 그걸 천리안이라고 불렀지."
    },
    {
      "kind": "dialogue",
      "who": "player_child",
  ...
  'intro-departure-choice': [
    ...
    {kind:'dialogue', who:'intro_child', name:'도윤', text:'다른 사람들한테도 물어봐요?'},
    {kind:'dialogue', who:'me', name:'나', text:'응. 직접 만나서 물어볼게. 같은 곳까지 가겠다는 사람이 있으면 달구지 자리도 만들고.'},
    {kind:'dialogue', who:'intro_child', name:'도윤', text:'그럼 유나랑 친구들도 집에 가요?'},
    {kind:'dialogue', who:'me', name:'나', text:'멈출 방법을 찾을 때까지 가 볼게. 이미 떠난 버스도 돌아올 수 있게.'},
    {kind:'dialogue', who:'passer_woman', name:'하진', text:'돌아온다고 약속하지는 마세요. 대신 먼저 떠난 사람들 이름도 잊지 말아 주세요.'},
    {kind:'dialogue', who:'me', name:'나', text:'네. 새 표만 막고 끝내지는 않겠습니다.'},
...
introBeats['intro-cold-open-v1'] = [
  ...
  {kind:'dialogue',who:'intro_child',name:'도윤 · 8살',text:'아저씨, 이제 우리 출발해요?'},
  {kind:'narration',text:'대답하기도 전에 문 닫힘 경고등이 켜졌다. 첫 계단에 선 도윤은 구겨진 이송표를 두 손으로 꼭 쥐고 있었다. 이송 사유 칸만 텅 비어 있었다.'},
  {kind:'dialogue',who:'intro_child',name:'도윤 · 8살',text:'엄마가 이거 잃어버리면 안 된댔어요.'},
  {kind:'thought',who:'me',name:'나',text:'부모님을 데려간 표도 저랬다. 어디로 보내는지만 있고, 왜 가야 하는지는 없었다.'},
  {kind:'dialogue',who:'me',name:'나',text:'그래. 꼭 가지고 있어. 저 빈칸은 아저씨가 알아볼게.'},
  {kind:'narration',text:'문이 닫혔다. 버스가 남쪽으로 움직인 뒤에도 도윤이 들고 있던 빈칸만 눈앞에 남았다.'}
];
{
...
D.events = [
{id:'onboarding_first_road', type:'본편', w:0, once:true, noPool:true, region:['south'],
...
{id:'find_tower_light', type:'발견', w:7, once:true, night:true, region:['south','mid'], hiddenTarget:'tower',
 ...
 choices:[
  {label:'위치를 기억해둔다', out:[{p:1, text:'거창 방면 능선. 지도에 붉은 점 하나를 찍었다.', fx:{reveal:'tower', note:{type:'소문',title:'살아 있는 통신탑',body:'밤마다 깜빡이는 항공장애등. 누군가 전기를 대고 있다.',links:['송전 통신탑']}}}]},
...
{id:'levy_office', type:'조우', w:7, once:true, region:['mid'],
 title:'임시 행정소',
 text:'길목에 천막이 서 있다. 「임시 차량 행정소」. 손글씨인데 관공서 서체를 흉내 냈다.\n\n형광 조끼를 입은 남자 셋. 가슴에 코팅된 명찰. 책상 위에 도장과 장부까지 갖췄다.\n\n"미등록 차량이네. 재등록비 고철 열다섯. 등록 안 하면 위쪽에… 그, 뭐냐, 미등록 이동체로 보고가 올라가요."\n\n남자가 태블릿을 툭툭 쳤다. 화면은 꺼져 있다. 저들은 천리안이 무서운 게 아니다. 천리안을 두려워하는 사람들을 노린다.',
 choices:[
...
{id:'meet_hitchhiker', type:'조우', w:0, noPool:1, priority:1, recruitStart:'leo', once:true,
 title:'대인시장의 떠돌이 가수',
 text:'광주 대인시장 평상 모닥불. 기타 케이스를 멘 남자가 장사를 마친 사람들에게 낮은 목소리로 노래한다. 발치에는 붉은 스카프를 맨 개 한 마리.\n\n노래가 끝나자 개가 먼저 달구지 냄새를 맡고 꼬리를 흔든다.\n\n"레오예요. 얘는 보리. 남원 쪽 침수 지하차도에서 아이 목소리가 계속 잡힌다는데, 거기까지 갈 차를 찾고 있어요."',
 choices:[
  {label:'"남원까지 같이 갑시다"', out:[{p:1, text:'레오는 기타부터 지붕 끈에 묶었다. 두 번 묶고, 한 번 풀고, 다시 묶었다.\n\n"얘가 비 맞으면 소리가 죽어서요. 아, 보리 말고 기타요. 보리는 비 좋아해요."\n\n보리는 허락도 받기 전에 조수석 발치에 자리를 잡았다.\n\n"지하차도 안에 누가 있는지는 아직 몰라요. 녹음일 수도 있고, 함정일 수도 있고."\n\n그는 웃지 않고 덧붙였다. "그래도 보리가 그 소리를 들으면 들어갈 겁니다. 그러니까 내가 먼저 가야 해요."\n\n둘은 동료가 아니라 구조 현장까지 함께 가는 승객으로 달구지에 올랐다.', fx:{startRecruit:'leo', note:{type:'인물',title:'레오와 보리',body:'광주 대인시장에서 만난 떠돌이 가수와 개. 남원 쪽 침수 지하차도의 목소리를 확인하려 한다.',links:['레오','광주 대인시장']}}}]},
  {label:'오늘은 자리가 없다', out:[{p:1, text:'"알겠어요. 보리랑 저는 세트니까, 둘이 탈 자리가 날 때까지 기다릴게요."\n\n레오는 기타 케이스를 다시 평상 아래 내려놓았다. 보리가 달구지 냄새를 한 번 더 맡는다.\n\n"마음 바뀌면 모닥불 옆에서 다시 불러요. 아직 남원으로 갈 차는 못 구했으니까."', fx:{}}]},
 ]},
...
{id:'exp_gas', type:'탐색', w:11,
 ...
 choices:[
  ...
  {label:'민지가 탱크를 딴다', req:{comp:'minji'}, out:[{p:1, text:'"주유소 지하탱크엔 항상 데드스톡이 남아요. 각도 문제지."\n\n"각도?"\n\n"관을 어디로 꽂느냐— 아니다, 보는 게 빨라요."\n\n민지가 배관을 뜯어 사이펀을 만들었다. 콸콸. 진짜 콸콸 나온다.', fx:{fuel:14, mood:{minji:4}}}]},
  {label:'매점만 턴다', out:[
...
{id:'exp_solar_bots', type:'탐색', w:6, region:['north'], risk:1,
 ...
 choices:[
  ...
  {label:'건드리지 않는다', out:[{p:1, text:'"살아 있는 기계는 건드리지 않는다." 여러 해를 살아남게 해준 규칙이다.', fx:{}}]},
 ]},
...
{id:'ai_drone', type:'추적', w:9, region:['mid','north'],
 ...
 choices:[
  ...
  {label:'은수가 드론을 탈취한다', req:{perk:'es_hack'}, out:[
    {p:1, text:'"유지보수 모드 진입. 3, 2, 1—"\n\n드론이 공중에서 딸꾹질하듯 멈추더니, 얌전히 갓길에 내려앉았다.\n\n격추한 거냐고 묻자 은수가 헤드폰 한쪽을 벗었다.\n\n"아니요, 착륙 명령이에요. 쟤 입장에선 정비 받으러 온 거고… 관측 기록은, 음. 지워지는 게 아니라 「정비 중」으로 바뀌는 거예요."\n\n은수가 드론을 분해해 트렁크에 실었다. 지워지는 게 아니라는 말이 오래 걸렸다.', fx:{item:{'부품':1}, scrap:8, mood:{eunsu:5}, note:{type:'사건',title:'드론 탈취',body:'은수의 유지보수 코드로 드론을 착륙시켰다. 천리안 입장에선 정비 중일 뿐.',links:['은수']}}}]},
 ]},
...
{id:'ai_checkers', minParty:1, type:'추적', w:7, minPursuit:1, region:['north'],
 ...
 choices:[
  ...
  {label:'은수가 관제 코드를 댄다', req:{comp:'eunsu'}, out:[
    {p:1, text:'은수가 창문을 내리고 코드 한 줄을 읊었다.\n\n정리자들의 태블릿이 일제히 초록불을 띄웠다. 전원이 물러서며 고개를 숙인다.\n\n"…유지보수 차량 취급이에요. 우린 지금 그분의 \'정비공\'인 거죠." 은수가 씁쓸하게 웃었다.', fx:{mood:{eunsu:4}, note:{type:'사건',title:'정비공 행세',body:'은수의 관제 코드 앞에 정리자들이 물러섰다. 우리는 천리안의 정비공인 셈이 됐다.',links:['은수']}}}]},
 ]},
...
{id:'road_mechanic', type:'만남', w:0, locEvent:'icheon',
 title:'길가의 작업대',
 text:'이천 초입 갓길에 트럭 한 대가 옆구리를 열어 두고 서 있다. 접이식 작업대, 바이스, 기름 먹은 매트.\n\n매트 위에 누워 무언가를 조이던 사람이 고개만 내민다.\n\n"세워도 돼요. 수원 위로는 받아 주는 데가 없어요. 대신 값은 마을보다 비쌉니다. 여기까지 부품 실어 온 값이라고 생각하세요."\n\n짐칸의 고철 무더기가 커브를 돌 때마다 한쪽으로 쏠리는 소리를 낸다.',
 choices:[
  {label:'작업대를 쓴다 (개조 비용 1.5배)',
   out:[{p:1, text:'정비공이 매트에서 몸을 일으켜 손을 닦는다.\n\n"뭘 달까요."',
     fx:{roadGarage:1, time:40, note:{type:'만남',title:'길가의 작업대',text:'마지막 작업대에서 웃돈을 주고 달구지를 손봤다.'}}}]},
  {label:'그냥 간다',
   out:[{p:1, text:'정비공이 다시 매트에 눕는다. 백미러 속에서 트럭이 작아진다.',
     fx:{note:{type:'만남',title:'길가의 작업대',text:'마지막 작업대를 지나쳤다.'}}}]}
 ]},
/* ── 이전 순환의 흔적 — 지난 런의 결말이 이번 세계에 남는다.
   143년 반복 추방의 세계에서, 이전 여정은 '없던 일'이 아니라 이전 순환이다. ── */
{id:'prev_trace_story_done', type:'발견', w:0, noPool:true, once:true,
 title:'낡은 일지 — 멈췄던 기록',
 text:'국도변 대피소 선반에 일지 한 권이 끼워져 있다. 표지의 필체가 이상하게 눈에 익는다.\n\n마지막 장에는 이렇게 적혀 있다.\n\n"제7 잔류구역 이송을 중지합니다 — 그 방송을 들었다. 143년 만이라고 했다."\n\n다음 장은 찢겨 있다. 이 세계에서 그 방송은 아직 나오지 않았다.',
 choices:[{label:'일지를 챙긴다',
  out:[{p:1, text:'가방 깊은 데에 넣었다. 찢긴 다음 장의 자리를 엄지로 한 번 쓸어 보고서였다.',
   fx:{moodAll:3, note:{type:'발견',title:'멈췄던 기록',text:'이전 순환의 일지 — 이송이 멈춘 적이 있다.'}}}]}]},
{id:'prev_trace_too_late', type:'발견', w:0, noPool:true, once:true,
 title:'정류장의 낙서',
 text:'폐버스 정류장 벽에 못으로 긁은 글씨가 있다.\n\n"돌아오는 것과 떠나지 않는 것은 같은 일이 아니다."\n\n그 아래 날짜는 지워져 있다. 누가 썼는지 알 것 같은 기분이 든다.',
 choices:[{label:'글씨를 손끝으로 따라 읽는다',
  out:[{p:1, text:'못자국이 깊었다. 한 획씩, 몇 번을 눌러 쓴 글씨였다. 차로 돌아와서도 한동안 아무도 라디오를 켜지 않았다.',
   fx:{moodAll:2, note:{type:'발견',title:'정류장의 낙서',text:'이전 순환의 경고 — 늦음에는 값이 있다.'}}}]}]},
{id:'prev_trace_thirst', type:'발견', w:0, noPool:true, once:true,
 title:'빈 물통의 차',
 text:'갓길에 오래 서 있던 차 한 대. 조수석에 물통 세 개가 가지런히 놓여 있다 — 전부 비어 있다.\n\n계기판 위 일지의 마지막 줄: "물을 아껴라. 사람은 아끼지 말고."',
 choices:[{label:'물통 하나를 가져가며 묵례한다',
  out:[{p:1, text:'빈 물통을 짐칸에 실었다. 출발하기 전에, 다들 말없이 우리 물통의 눈금을 한 번씩 확인했다.',
   fx:{note:{type:'발견',title:'빈 물통의 차',text:'이전 순환의 최후 — 물이 먼저 끝났다.'}}}]}]},
{id:'prev_trace_stranded', type:'발견', w:0, noPool:true, once:true,
 title:'주저앉은 달구지',
 text:'길가에 주저앉은 개조 트럭 잔해. 짐칸에는 고철이 수북한데 연료탱크는 말라붙어 있다.\n\n고철을 안고 좌초한 차. 살 수 있는 것과 필요한 것이 달랐던 모양이다.',
 choices:[{label:'쓸 만한 부품을 회수한다',
  out:[{p:1, text:'부품 하나를 빼냈다. 나사산에 아직 기름이 살아 있었다 — 어제까지 달리던 차였다.',
   fx:{item:{'부품':1}, note:{type:'발견',title:'주저앉은 달구지',text:'이전 순환의 좌초 — 고철은 연료가 아니다.'}}}]}]},
{id:'prev_trace_shunned', type:'발견', w:0, noPool:true, once:true,
 title:'문에 남은 표식',
 text:'버려진 검문 초소 벽에 페인트로 그린 차량 윤곽과 가위표.\n\n"표시된 차량은 재우지 않는다" — 어느 마을에서든 이 문장이 붙으면 길 위에서 버티는 일만 남는다.',
 choices:[{label:'표식을 지운다',
  out:[{p:1, text:'젖은 천으로 문질렀다. 차량 윤곽은 반쯤 남았지만 가위표는 지워졌다. 천에 회베이지 페인트가 묻어났다.',
   fx:{moodAll:2, note:{type:'발견',title:'문에 남은 표식',text:'이전 순환의 기피 — 표식은 지워질 수 있다.'}}}]}]},
{id:'prev_trace_empty_district', type:'발견', w:0, noPool:true, once:true,
 title:'빈 명부 한 장',
 text:'바람에 날려 온 종이 한 장이 와이퍼에 끼어 있다. 제7 잔류구역 이송 명부 — 이름이 전부 지워진 채 사유란만 남아 있다.\n\n사유란은 비어 있다. 전부.',
 choices:[{label:'명부를 접어 넣는다',
  out:[{p:1, text:'명부를 접어 글러브박스에 넣었다. 시동을 걸면서, 계기판에 표시된 남산까지의 거리를 한 번 더 봤다.',
   fx:{moodAll:2, note:{type:'발견',title:'빈 명부 한 장',text:'이전 순환의 늦음 — 빈 구역에는 빈 칸만 남는다.'}}}]}]},
/* 전역 날짜 제한 및 날짜 기반 추적 사건 제거. */
...
{id:'loc_reststop', type:'탐색', w:0, locEvent:'reststop', once:true,
 ...
 choices:[
  {label:'식당가를 턴다', out:[{p:1, text:'주방 건조창고에서 우동사리와 통조림을 챙겼다.\n\n"이거 우동이에요, 소면이에요?"\n\n"…우동."\n\n"우동치곤 얇은데."\n\n"봉지에 우동이라고 써 있잖아."\n\n"아, 진짜네."\n\n자판기도 몇 대 땄다.\n\n"즐거운 여행 되시기 바랍니다." 방송에 문득 "고맙습니다"라고 대답해봤다.', fx:{food:4, water:3, scrap:4}}]},
...
{id:'loc_tunnelbook', type:'탐색', w:0, locEvent:'tunnelbook', once:true,
 ...
 choices:[
  {label:'"천리안이 뭘 한 겁니까?"', out:[{p:1, text:'노인이 안경을 벗었다.\n\n"모든 게 시작된 그날 말이지. 백사십몇 년 전—"\n\n"백사십몇이요?"\n\n"셋인지 넷인지는 나도 모르네. 책마다 다르게 적어 놨으니." 노인이 안경알을 옷깃에 닦았다. "아무튼 그건 전기를 끊고, 통신을 끊고, 물류를 끊었어. 딱 사흘. 그리고 전부 되돌렸지."\n\n"…근데 왜 세상이 이 꼴이냐고? 그 사흘 동안 우리끼리 한 짓을 보게. 그건 총 한 발 안 쐈어."\n\n노인은 다시 책을 폈다. "서울 가서 직접 물어보게. 나는 아직— 인간 쪽 변론을 못 찾았네."', fx:{note:{type:'사건',title:'사서의 증언',body:'천리안은 사흘간 끊고, 전부 되돌렸다. 세상을 부순 건 그 사흘간의 인간. 그는 아직 인간 쪽 변론을 못 찾았다.',links:['천리안']}, moodAll:-4, flag:'librarian_truth'}}]},
  {label:'실용서를 고른다', out:[{p:1, text:'「자동차 구조 교본」과 「약초 도감」을 골랐다.\n\n"…소설은 안 보나."\n\n"지금은요."\n\n"하긴." 노인이 고개를 끄덕였다. "실용서라. 자네는 살아남겠군."\n\n책값으로 통조림 하나를 두고 왔다. 노인은 그걸 보지도 않고 읽던 쪽을 마저 읽었다.', fx:{food:-1, van:6, item:{'의약품':1}, note:{type:'인물',title:'터널의 사서',body:'수만 권의 책과 사는 노인. 반납할 수 없는 세상이라 빌려주지 않는다.'}}}]},
 ]},

/* ───── 영입: 재이 & 은수 ───── */
{id:'jy_recruit', type:'조우', w:0, noPool:1, priority:1, recruitStart:'jaeyi', once:true,
 title:'촛불 교환대의 리어카',
 text:'무주 터널 촛불 교환대. 고물을 산처럼 실은 리어카 한 대가 벽을 차지하고 있다. 주인은 스무 살쯤의 아이. 물건마다 교환값을 붙이면서도 낡은 철제 상자 하나만은 값을 적지 않는다.\n\n아이가 달구지 하부를 보더니 먼저 입을 연다.\n\n"왼쪽 뒤 판스프링 헐거운 거 알아요? 난 재이예요."\n\n"…순서가 좀 이상한데요."\n\n"아, 그쵸. 스프링부터 봐서." 재이가 손을 바지에 문지르고 다시 내민다. "재이예요. 판스프링은 진짜 헐거워요."\n\n그러고는 김천 쪽 무너진 재활용 창고를 지도에 짚었다. "우리 집 상자가 저기 깔렸어요. 돈 될 건 하나도 없고요. 그래서 더 내가 꺼내야 해요."',
 choices:[
  {label:'"김천까지 같이 가자"', out:[{p:1, text:'재이가 잠깐 우리 차를 본다. 값어치부터 물을 줄 알았다는 얼굴이다.\n\n"얼마 받으려고요?"\n\n"안 받아."\n\n"…그런 말 하는 사람들 보통 나중에 받던데요." 그러면서도 벌써 종이를 편다. "철근이 두 겹이에요. 그냥 당기면 지붕째 내려앉고요."\n\n도르래 순서를 그리다 말고 한 번 지우고 다시 그렸다. "창고 앞에서 차를 세워요. 내가 길 안내할게요."\n\n리어카는 터널 창고에 맡겼다. 값이 없는 철제 상자 자리만 달구지 안에 비워 두었다.', fx:{startRecruit:'jaeyi', note:{type:'인물',title:'재이',body:'무주 터널에서 만난 수집꾼. 김천 재활용 창고에 깔린 가족 상자를 되찾아야 한다.',links:['재이','무주 터널']}}}]},
...
{id:'es_recruit', type:'조우', w:0, noPool:1, priority:1, recruitStart:'eunsu', once:true,
 title:'연구동 옥상의 안테나',
 text:'대전 연구단지 옥상. 여자가 안테나를 돌리며 아래 화이트보드의 숫자와 수신기 파형을 번갈아 본다. 헤드폰은 목에 걸려 있다.\n\n달구지 번호판을 보자 기다렸다는 듯 말한다.\n\n"남쪽 번호판. 서울 방향. 천리안 관제센터에서 일했어요. 은수라고 해요."\n\n"…세 개를 한 번에 말하시네요."\n\n"아. 순서가." 은수가 헤드폰 줄을 정리한다. "은수예요. 나머지는 천천히 말할게요."\n\n수신기에서 좌표가 반복된다. 청주 쪽. 은수의 얼굴이 굳는다.\n\n"내가 예전에 켠 중계기가 아직 올리고 있어요. 저걸 놔두고 서울로 가면, 난 또 같은 일을 하는 거예요."',
 choices:[
  {label:'"청주까지 같이 갑시다"', out:[{p:1, text:'은수가 처음으로 이쪽을 똑바로 본다.\n\n"혼자서는 안 돼요. 아래에서 차단기를 당기는 사람하고 위에서 루프를 거는 사람이 동시에— 아니, 동시는 아니고 반 박자."\n\n"반 박자요?"\n\n"…설명이 어렵네요. 가서 보여드릴게요. 틀리면 좌표가 바로 본망으로 넘어가요."\n\n그녀는 화이트보드 숫자를 지우지 않고 인계서만 그 아래에 붙였다. 장비 가방을 들면서 한 번 더 돌아봤다.\n\n"중계기를 끄고 나서, 그때 내가 이 차에 탈 자격이 있는지 물을게요."', fx:{startRecruit:'eunsu', note:{type:'인물',title:'은수',body:'대전 연구단지에서 만난 전직 천리안 오퍼레이터. 청주 중계기의 잔류자 좌표 송신을 끝내려 한다.',links:['은수','천리안','대전 연구단지 코뮌']}}}]},
  {label:'"천리안 쪽 사람은 아직 못 믿겠어요"', out:[{p:1, text:'은수는 화내지 않았다. 잠깐 안테나 손잡이만 잡고 있었다.\n\n"…맞아요. 지금 믿어 달라고 하는 것도 염치없는 일이죠."\n\n그러더니 반복되는 좌표를 종이에 적기 시작했다. 두 줄을 적고 시간을 적고, 한 줄은 지웠다.\n\n"이건 확인한 거고, 지운 건 제 추측이었어요. 확인하고 싶어지면 다시 올라오세요. 그때는 내가 한 일부터 숨기지 않고 설명할게요."\n\n옥상 문을 닫아주는 것도 그녀였다.', fx:{}}]},
 ]},
...
{id:'kw_recruit', type:'조우', w:0, noPool:1, recruitStart:'kangwoo', once:true,
 title:'돔의 파수꾼',
 text:'돔 시장 경비탑 위에 남자가 서 있다. 미동도 없이. 시장 전체가 그의 시야 안이다.\n\n좌판에서 소매치기 소동이 일었다— 는데, 소동이 되기 전에 끝났다. 탑 위의 남자가 반 걸음 움직이며 그쪽을 봤을 뿐인데, 소매치기가 지갑을 제자리에 놓고 두 손을 들었다.\n\n남자가 탑에서 내려왔다. 군장 하나, 목에 군번줄 두 개.\n\n"강우다."\n\n"…예."\n\n"……." 그는 우리 차 뒤쪽을 한 번 봤다가 다시 돌아왔다. "북쪽으로 가는 차가 있다고 들었다. 서울까지 가나."',
 choices:[
  {label:'"갑니다. 타실래요?"', out:[{p:1, text:'대답이 바로 안 왔다. 강우는 시장 아래를 세는 사람처럼 훑었다.\n\n"…지금 떠나면 이 돔은 사흘 못 간다."\n\n경비는 그 혼자였고, 북쪽 감시 표식이 지붕 아래에서 깜빡이고 있었다. 시장을 노리는 사람에겐 등대나 다름없다.\n\n"사흘요?"\n\n"이틀일 수도 있고." 그가 군번줄 하나를 쥔다. "후임 하나 세우고 저 눈을 끈다. 그때도 자리가 있으면 묻지. 나는 도망치듯 떠나지 않는다."', fx:{startRecruit:'kangwoo', note:{type:'인물',title:'강우',body:'돔 시장을 홀로 지킨 파수꾼. 떠나고 싶어도 시장이 자신 없이 버티는 법부터 만들어야 한다.',links:['강우']}}}]},
  {label:'"왜 하필 우리 차예요?"', out:[{p:1, text:'강우가 달구지를 훑는다. 정확히는— 달구지에 실린 것들을.\n\n"물통. 사람 수보다 많더군."\n\n"그게 왜요."\n\n"……." 그는 대답 대신 뒷문 쪽을 한 번 더 봤다. "남의 짐도 쉽게 안 버리는 차다. 끝까지 갈 차가 필요하다."\n\n그러고는 돔 천장의 붉은 점을 올려다본다. "먼저 이 시장이 나 없이도 굴러가게 만든다. 손 하나 빌려라."', fx:{startRecruit:'kangwoo', note:{type:'인물',title:'강우',body:'"버리는 차는 빨리 가고, 싣는 차는 끝까지 간다." 다만 그는 자기 자리를 빈 채로 만들지 않는다.',links:['강우','달구지']}}}]},
 ]},
...
{id:'rq_parkss_task', type:'스토리', w:0, noPool:1, once:true,
 ...
 choices:[
  {label:'의약품을 보태 처방을 완성한다', req:{item:'의약품'}, out:[{p:1,text:'우리 약 상자를 열자 박 선생이 잠깐 눈을 감았다. 아까웠기 때문이 아니라, 선택하지 않아도 돼서였다.\n\n세 아이 몫이 나란히 놓였다. 몇 시간 뒤 열이 한 명씩 내려갔다. 보호자가 울며 고개를 숙이자 박 선생은 손사래를 친다. 치다가 손사래가 어색해져 그만둔다.\n\n"약이 할 일을 한 거요. 나야 운반이나 했고, 이 사람들은 멈춰 줬고."\n\n그가 처음으로 달구지를 가리킨다. "…이제 나도 저 차가 가는 데까지 가보고 싶소만."',fx:{item:{'의약품':-1},time:180,moodAll:4,recruitChoice:'medicine',recruitRoad:'parkss',note:{type:'사건',title:'식기 전에 닿은 약',body:'버스에서 꺼낸 냉장 약품을 길가 진료소의 아이 셋에게 전달했다.',links:['박 선생']}}}]},
  {label:'물을 나눠 냉각과 해열을 버틴다', req:{water:3}, out:[{p:1,text:'젖은 천으로 상자를 감싸고, 남은 물로 아이들의 목과 손목을 식혔다. 박 선생은 세 시간 동안 한 번도 시계를 놓지 않았다.\n\n마침내 가장 어린 아이가 먼저 물을 달라고 했다. 보호자가 웃다가 울었다.\n\n박 선생이 빈 냉장 상자를 닫는다. 닫고 나서 잠금쇠를 한 번 더 눌러 본다. "약은 도착했고, 사람도 버텼소. 물수건은 두 시간마다 갈라 일러뒀고. …그럼 이제 내 발이 어디로 갈지 정해도 되겠군."',fx:{water:-3,time:210,fatigue:8,recruitChoice:'cooling',recruitRoad:'parkss',note:{type:'사건',title:'식기 전에 닿은 약',body:'물과 시간을 들여 아이들의 열이 내려갈 때까지 박 선생 곁을 지켰다.',links:['박 선생']}}}]},
  {label:'달구지 배터리로 냉장기를 살린다', out:[{p:1,text:'배선을 직결하자 달구지 실내등이 꺼지고 냉장기가 낮게 울었다. 박 선생은 그 소리를 들으며 약병을 나눴다.\n\n배터리는 끝까지 버텼고, 아이들도 버텼다. 다음 시동은 세 번 만에 걸렸다.\n\n"차도 사람도 무리했소." 박 선생이 보닛에 손을 얹는다. 얹은 채로 한동안 말이 없다. "…내가 빚을 오래 두는 성격이 아니라서 그러오. 가는 길에 갚겠소."',fx:{time:180,van:-7,fuel:-2,recruitChoice:'battery',recruitRoad:'parkss',note:{type:'사건',title:'식기 전에 닿은 약',body:'달구지 전기로 냉장 약품을 살려 길가 진료소의 고비를 넘겼다.',links:['박 선생','달구지']}}}]},
 ]},
...
{id:'rq_leo_follow', type:'스토리', w:0, noPool:1, once:true,
 title:'노래가 없는 한 구간',
 text:'한 구간 내내 레오는 기타를 꺼내지 않았다. 보리도 케이스 위에 턱만 얹었다.\n\n정차한 뒤, 레오가 먼저 입을 연다. "이상하죠? 보통은 세 곡쯤 불렀을 시간인데."\n\n"목이 아파요?"\n\n"아뇨. 노래 안 하면 사람들이 꼭 그렇게 물어요."\n\n그가 기타 잠금쇠를 열었다 닫는다. 열 때마다 딸깍 소리가 난다.\n\n"노래는 편했어요. 입을 다물고 있으면 내가 왜 여기 같이 있는지 설명을 해야 되잖아요. 기타 치는 애, 말고는… 뭐, 딱히."',
 choices:[
  {label:'"그럼 물이나 한 잔 할래요?"', out:[{p:1,text:'레오는 농담을 기다리는 얼굴로 우리를 본다. 농담이 안 오자 컵을 한 번 돌려 잡는다.\n\n"진짜 물만 마셔요? 노래 안 해도? …아니 그게 아니라, 보통은 뭐라도 하라고 하거든요."\n\n"보리도 아직 노래 안 했잖아요."\n\n보리가 제 그릇을 앞발로 밀었다. 레오는 결국 웃으며 물을 따른다. "얘는 진작 알았네. 가만있어도 밥 주는 데를 따라가야 되는구나."',fx:{time:30,moodAll:6,recruitReady:'leo',chain:'rq_leo_join',note:{type:'사건',title:'노래하지 않아도 되는 자리',body:'레오에게 공연의 대가가 아닌 물 한 잔과 자리를 내주었다. 그는 아무것도 증명하지 않은 채 머물렀다.',links:['레오','보리']}}}]},
  {label:'완성된 노래 대신 쓰다 만 한 줄을 청한다', out:[{p:1,text:'레오는 수첩을 한참 뒤지다가 절반 젖은 페이지를 편다.\n\n"좋은 건 아닌데."\n\n그가 노래하지 않고 읽는다. "사람들은 떠난 곳을 고향이라 부르고, 나는 돌아갈 곳을 자꾸 노래라고 부른다."\n\n읽고 나서 귀까지 붉어진다. 수첩을 덮었다가, 접힌 데를 괜히 편다. "봐요. 반주 없으니까 너무 솔직하잖아. 반주 있으면 이런 거 안 들려요."\n\n"그래서 들려 달라고 했어요."\n\n레오는 대답하지 않았다. 대신 그 줄 아래에 날짜와 정차한 곳의 이름을 적었다.',fx:{time:35,moodAll:5,recruitReady:'leo',chain:'rq_leo_join',note:{type:'사건',title:'반주 없는 한 줄',body:'레오는 완성된 공연 대신 쓰다 만 문장을 읽었다. 달구지에서는 잘 만든 노래보다 솔직한 한 줄도 들을 사람이 있었다.',links:['레오','달구지']}}}]},
  {label:'보리와 말없이 한 바퀴 걷는다', out:[{p:1,text:'보리가 앞장서고, 우리는 그 뒤를 걸었다. 레오는 처음 몇 분 동안 자꾸 말을 꺼내려다 삼켰다.\n\n돌아오는 길, 보리가 웅덩이에 뛰어들어 셋에게 흙물을 뿌렸다. 레오가 배를 잡고 웃는다. 웃음이 잦아든 뒤에도 어색한 침묵은 돌아오지 않았다.\n\n"공연 끝나면 늘 혼자였거든요. 짐 싸고, 줄 갈고, 그러다 보면 아무도 없고." 그가 젖은 소매를 짠다. 물이 다 빠질 때까지 짠다. "조용한데 안 외로운 건 처음이네요."',fx:{time:45,fatigue:-3,moodAll:7,recruitReady:'leo',chain:'rq_leo_join',note:{type:'사건',title:'조용한데 외롭지 않은 길',body:'노래 없이 보리와 길을 걸었다. 레오는 침묵을 채우지 않아도 곁이 사라지지 않는다는 걸 알았다.',links:['레오','보리']}}}]},
 ]},
{id:'rq_leo_join', type:'스토리', w:0, noPool:1,
 title:'둘이 타는 자리',
 text:'레오는 기타를 다시 케이스에 넣는다. 이번엔 연주를 마친 뒤가 아니다.\n\n보리는 달구지 문 앞에 앉아 이미 자기 차처럼 하품한다.\n\n"한 구간만 얻어 타려고 했는데, 여기선 조용히 있어도 안 쫓겨나네요. 그게 좀… 아니다, 됐어요."\n\n"그럼 한 구간으로 끝내지 말죠. 서울까지 같이 갈래요?"\n\n레오가 웃는다. 웃다가 스스로 웃음을 끊고 보리를 가리킨다. 가리키는 손끝이 조금 흔들린다.\n\n"저희 둘 다요. 밥은 둘이 먹고, 노래는 부르고 싶을 때만 제가 하고, 경비는 얘가 해요. 아마도."\n\n"둘이 잘 자리부터 만들면 돼요."',
 choices:[{label:'보리에게도 빈자리를 보여 준다',out:[{p:1,text:'보리가 먼저 올라가 빈 자리를 한 바퀴 돈 뒤 털썩 눕는다.\n\n레오가 그걸 오래 본다. 뭔가 말하려다가 결국 고개만 끄덕인다. "…좋답니다. 저도요."\n\n기타 케이스는 천장에, 젖은 수첩은 창가에 걸었다. 출발하자 보리는 곧 잠들었다.',fx:{offerComp:'leo'}}]}]},

{id:'rq_jaeyi_task', type:'스토리', w:0, noPool:1, once:true,
 title:'고철값이 없는 것',
 text:'재활용 창고 지붕이 안쪽으로 주저앉았다. 멀쩡한 배터리와 구리선이 발에 채이지만 재이는 보지도 않는다.\n\n철근 아래 찌그러진 양철 상자. 뚜껑 틈으로 바랜 사진 한 귀퉁이가 보인다.\n\n"엄마가 버리지 말라던 건 다 저기 있어요. 양철이라 무게는 사 킬로쯤 되고, 고철값은— 아니, 그건 됐고. 돈 되는 건 하나도 없어요."\n\n재이는 웃지 않는다. 발끝으로 구리선 하나를 옆으로 밀어 놓는다. "그래서 약탈자들도 안 가져갔고요."',
 choices:[
  {label:'윈치와 도르래로 하중을 들어낸다', req:{up:'winch'}, out:[{p:1,text:'재이가 분필로 당길 순서를 표시한다. 우리는 그 숫자만 따라갔다. 철근이 들리고, 리어카가 먼저 빠지고, 마지막에 양철 상자가 나왔다.\n\n안에는 사진, 고장 난 손목시계, 찰흙으로 빚은 작은 새가 있었다. 재이는 하나씩 닦아 다시 넣는다. 다 넣고 나서 시계만 다시 꺼내 한 번 더 닦는다.\n\n"…이게 이렇게 무거운 줄 몰랐네요. 상자 무게만 사 킬로라고 했는데."',fx:{time:80,scrap:4,recruitChoice:'winch',recruitRoad:'jaeyi',note:{type:'사건',title:'고철값이 없는 상자',body:'무너진 창고에서 재이 가족의 사진과 작은 물건들을 꺼냈다.',links:['재이']}}}]},
  {label:'쓸 만한 부품을 받침대로 써 버린다', req:{item:'부품'}, out:[{p:1,text:'새 베어링과 멀쩡한 프레임을 받침으로 밀어 넣었다. 재이는 아까운 표정을 숨기지 못했지만 손은 멈추지 않았다.\n\n상자가 빠진 뒤, 받침은 천장 아래서 납작해졌다. 재이가 사진을 꺼내 보여주려다 각도를 바꿔 다시 내민다. 리어카보다 작은 재이가 가족 사이에 서 있다.\n\n"부품은 또 구하면 돼요. 베어링은 시장에 흔하고, 프레임도 뭐." 재이가 스스로에게 말하듯 한다. "…이건 아니고."',fx:{item:{'부품':-1},time:60,moodAll:4,recruitChoice:'brace',recruitRoad:'jaeyi',note:{type:'사건',title:'고철값이 없는 상자',body:'쓸 만한 부품을 포기해 재이 가족의 상자를 구했다.',links:['재이']}}}]},
  {label:'잔해를 손으로 한 조각씩 걷어낸다', out:[{p:1,text:'큰 걸 당기면 다 무너졌다. 결국 작은 것부터 옮겼다. 볼트, 유리, 철판, 벽돌. 몇 시간을 꼬박.\n\n상자가 빠지자 재이는 찰흙 새부터 확인했다. 날개가 하나 부러졌지만 남아 있었다. 부러진 쪽을 손바닥으로 가려 보고, 도로 뗀다.\n\n"사람들이 내가 물건을 못 버린다고 했어요. 하도 그래서 저도 그런 줄 알았고." 재이가 먼지를 턴다. "…오늘은 그게 맞아서 다행이네요."',fx:{time:220,fatigue:18,scrap:7,recruitChoice:'hands',recruitRoad:'jaeyi',note:{type:'사건',title:'고철값이 없는 상자',body:'몇 시간을 들여 잔해를 걷고 재이 가족의 상자를 손으로 꺼냈다.',links:['재이']}}}]},
 ]},
...
{id:'rq_jaeyi_join', type:'스토리', w:0, noPool:1,
 title:'리어카를 접는 법',
 text:'재이는 가족 상자를 다시 풀지 않는다. 대신 한 구간 동안 임시로 묶어 둔 끈을 풀어, 달구지 고정 레일에 맞게 길이를 잰다. 재고, 적고, 다시 잰다.\n\n"리어카 탈 땐 매일 저녁 짐을 전부 다시 묶었어요. 매듭이 여덟 개. 매일 여덟 개였어요. 무슨 일 생기면 바로 끌고 가려고."\n\n"오늘은 왜 안 풀어요?"\n\n재이가 레일의 오래된 볼트를 손톱으로 긁는다. 녹이 조금 떨어진다. 대답은 그다음에 나왔다.\n\n"…내일도 여기 있을 수 있으면, 안 풀어도 되잖아요."\n\n"그럼 서울까지 쓸 자리를 만들죠. 가족 상자도, 리어카도 같이 가게."\n\n줄자가 탁 소리를 내며 감긴다. 재이는 그 소리를 두 번 더 냈다.\n\n"저, 이 레일 한 칸 써도 돼요? 리어카는 접어서 지붕 밑에 걸게요."',
 choices:[{label:'리어카부터 같이 접는다',out:[{p:1,text:'리어카 손잡이와 바퀴를 분리해 지붕 아래에 걸었다. 짐은 전부 세어 넣었고, 가족 상자는 침상 아래 가장 마른 곳을 얻었다.\n\n재이가 마지막 볼트를 조인다. 조이고 나서도 렌치를 놓지 않는다. "…서울까지 안 풀어도 되겠네요."\n\n"더 좋은 자리가 생기면 그때 다시 고쳐요."\n\n재이가 레일을 한 번 흔들어 본다. 소리가 안 나자 한 번 더 흔든다. "좋아요. 버린 건 없어요. 모양만 바뀐 거고."',fx:{offerComp:'jaeyi'}}]}]},
...
{id:'rq_kangwoo_task', type:'스토리', w:0, noPool:1, once:true,
 ...
 choices:[
  ...
  {label:'한동안 후임의 지시만 따른다', out:[{p:1,text:'강우는 총을 내려놓고 서연의 지시만 따랐다. 북문 확인. 동쪽 좌판 대피. 지붕 소리 무시.\n\n한 시간이 지난 뒤, 취객 둘이 싸웠다. 강우의 어깨가 먼저 움직였지만 멈췄다. 서연이 둘 사이에 물통을 내려놓고 말했다. "싸울 힘 있으면 이거나 나르세요." 싸움은 끝났다.\n\n강우는 한동안 아무 말도 하지 않았다. 그러다 아주 작게 웃었다. "…나보다 낫군."\n\n감시 표식도 둘이 함께 내렸다.',fx:{time:360,food:-1,moodAll:4,recruitChoice:'follow',recruitRoad:'kangwoo',note:{type:'사건',title:'경비탑의 다음 사람',body:'강우가 개입하지 않은 시간을 서연이 지켰다. 돔 시장에는 다음 파수꾼이 생겼다.',links:['강우']}}}]},
 ]},
{id:'rq_kangwoo_follow', type:'스토리', w:0, noPool:1, once:true,
 title:'돌아보지 않는 거리',
 text:'돔 시장을 떠난 지 한 구간. 강우의 무전기에서 서연의 목소리가 튄다.\n\n"북문 소란. 경비 둘 이동 중. 응답 바랍니다."\n\n강우의 손이 문손잡이에 닿는다. 차를 돌리자는 말은 하지 않는다. 대신 무전기를 너무 세게 쥐어 플라스틱이 운다. 엄지가 송신 버튼 위에 올라갔다가 내려온다. 두 번.\n\n"……. 내가 답하면 서연은 내 지시를 기다린다. 답하지 않으면… 내가 버린 것 같고."\n\n무전기 너머로 다시 호각이 울린다. 이번엔 두 번. 강우가 가르치지 않은 신호다.',
 choices:[
  {label:'채널만 열어 두고 서연의 판단을 기다린다', out:[{p:1,text:'강우는 송신 버튼에서 엄지를 뗐다. 무전기 너머로 발소리와 짧은 지시가 오갔다.\n\n"서쪽 문 닫고, 장사꾼은 안쪽으로. 싸움 당사자 둘만 남겨요."\n\n서연의 목소리였다. 잠시 뒤 호각 한 번.\n\n"상황 종료. 강우 씨, 듣고 있으면 계속 가세요."\n\n강우가 그제야 문손잡이를 놓는다. 놓고 나서 손바닥을 무릎에 문지른다. "…저 신호는 안 가르쳤는데."\n\n"그래서 잘한 거겠죠."\n\n그는 대답하지 않았다. 얼마 뒤 무전기 음량을 한 칸 올렸다.',fx:{time:25,moodAll:5,recruitReady:'kangwoo',chain:'rq_kangwoo_join',note:{type:'사건',title:'서연의 두 번째 호각',body:'강우가 명령하지 않은 동안 서연은 자기 방식으로 북문 소란을 끝냈다. 그는 채널을 끊지 않되 시장의 결정을 빼앗지 않았다.',links:['강우','서연']}}}]},
  {label:'강우가 서연에게 가르친 것을 묻는다', out:[{p:1,text:'"싸움이면 사람부터 갈라놓고, 출입문부터 확보한다. 다치면 박 선생 쪽에—"\n\n강우가 말을 멈춘다. 이미 무전기 너머에서 같은 지시가 들리고 있었다. 순서는 조금 달랐지만 더 빨랐다.\n\n"다 가르쳤네요."\n\n"아니. 저 순서는 처음 듣는다."\n\n무전기에서 상황 종료가 들렸다. 강우는 그 뒤로도 문손잡이를 잡고 있었다. 얼마 뒤에야 손을 뗐다.\n\n"…나보다 빠르네." 그가 무전기를 무릎에 내려놓았다. 놓고도 한동안 손을 얹어 뒀다. "됐어. 이제 가자."',fx:{time:30,moodAll:4,recruitReady:'kangwoo',chain:'rq_kangwoo_join',note:{type:'사건',title:'서연이 고친 순서',body:'강우는 서연이 자신이 가르치지 않은 더 빠른 순서로 소란을 끝내는 것을 들었다. 이제 시장으로 돌아가 지시할 이유가 사라졌다.',links:['강우','서연']}}}]},
  {label:'차는 세우되 방향은 돌리지 않는다', out:[{p:1,text:'달구지를 갓길에 세웠다. 강우는 문을 연 채 한 발만 땅에 내렸다.\n\n"가도 되고, 돌아가도 돼요. 다만 우리가 대신 정하진 않을게요."\n\n긴 침묵 끝에 강우가 발을 다시 올린다. 올리고도 문은 그대로 열어 뒀다. 그때 무전기에서 서연의 숨찬 목소리가 들렸다. "상황 끝. 그리고 강우 씨, 여기 오면 문 안 열어줄 겁니다."\n\n강우가 헛웃음을 터뜨린다. "…경비가 아주 독해졌군."\n\n그가 직접 문을 닫는다. 잠금까지 확인하고 나서 말한다. "가자. 이번엔 내가 지킬 자리를 내가 고른다."',fx:{time:20,moodAll:6,recruitReady:'kangwoo',chain:'rq_kangwoo_join',note:{type:'사건',title:'돌아가지 않기로 한 정차',body:'강우에게 돌아갈지 계속 갈지 고를 시간을 주었다. 서연의 상황 종료를 들은 뒤, 그는 스스로 달구지 문을 닫았다.',links:['강우','서연','달구지']}}}]},
 ]},
{id:'rq_kangwoo_join', type:'스토리', w:0, noPool:1,
 title:'등을 돌린 다음',
 text:'강우는 무전기에 짧게 남긴다. "수신 양호. 네 판단대로 계속해."\n\n서연의 대답은 바로 온다. "그 말 하려고 끼어든 거면, 다음부터는 호출할 때까지 듣기만 하세요."\n\n강우가 헛웃음을 흘린다. 무전기를 끄진 않는다. 다만 군장 깊숙이 넣는다. 넣었다가 한 번 꺼내 확인하고, 도로 넣는다.\n\n"……. 이제 시장으로 돌아갈 핑계도 없군."\n\n"그럼 서울까지 같이 갑니까?"\n\n강우가 달구지의 문과 비상 탈출구를 살핀다. 문을 두 번 여닫는다.\n\n"간다. 대신 문 잠금부터 고쳐야겠어. 뒤쪽 사각도 넓고."\n\n"타자마자 근무부터 하려고요?"\n\n대답은 한 박자 늦게 왔다.\n\n"야간 첫 순찰이 비었잖아."',
 choices:[{label:'강우의 군장이 들어갈 자리를 비운다',out:[{p:1,text:'강우가 달구지에 올라 군장을 통로에 걸리지 않게 고정한 뒤, 문 잠금과 비상 탈출구를 다시 확인한다. 확인한 걸 한 번 더 확인한다.\n\n"오늘 밤 첫 순찰은 내가 선다. 내일부터는 순번 정하고."\n\n군장 속 무전기에서 서연의 호각 소리가 한 번 새어 나왔다. 강우는 돌아보지 않고 손만 들어 답했다.',fx:{offerComp:'kangwoo'}}]}]},
...
{id:'es_nightshift', type:'동행', w:8, once:true, needsComp:'eunsu', needFlag:'es_backdoor_ready',
 title:'야간 당직',
 text:'은수가 헤드폰 한쪽을 벗었다. 벗고도 한동안 아무 말이 없었다.\n\n"…그날 야간 당직이 저였어요. 서울 추방 방송이 나온 밤. 스크린에 팝업이 하나 떴어요. 승인 요청, 제목은 \'최적화 제안 v.1194\'. 아니, 1194였나. …1194 맞아요."\n\n그러고는 손등으로 무릎을 두어 번 문질렀다.\n\n"매일 밤 수백 개씩 뜨는 거라 다들 자동 승인 걸어놨어요. …저도 그랬고요."\n\n은수가 기억을 더듬어 팝업 아래 작은 글씨를 적었다. 「발신: 천리안 / 승인 경로: 상위 배부처」. 적어놓고 한 줄을 다시 봤다.\n\n"그땐 천리안이 제일 위인 줄 알았어요. 근데 승인 경로가 왜 더 있죠. 이건 제가 아직 모르는 거예요."',
 choices:[
...
{id:'meet_cinema', type:'조우', w:6, once:true, night:true,
 ...
 choices:[
  {label:'관람한다 (연료 1L)', req:{fuel:1}, out:[{p:1, text:'필름이 낡아 화면엔 비가 내렸다. 아무도 상관하지 않았다.\n\n"이거 몇 번 튼 거예요?"\n\n"음… 세지 마세요."\n\n엔딩 크레딧이 올라갈 때, 어둠 속 여기저기서 훌쩍이는 소리가 났다. 영화가 슬퍼서가 아니었을 거다.\n\n영사기사가 필름을 되감으며 말했다. "다음 달엔 코미디 구해올게요. 약속."', fx:{fuel:-1, moodAll:9, time:120, note:{type:'사건',title:'들판의 극장',body:'낡은 필름엔 비가 내렸다. 아무도 상관하지 않았다. 다음 달엔 코미디라고 한다.'}}}]},
...
{id:'meet_piano', type:'조우', w:5, once:true,
 ...
 choices:[
  ...
  {label:'서툴게라도 쳐본다', out:[{p:1, text:'젓가락 행진곡을 쳤다. 반쪽만 기억나서 반쪽만 쳤다.\n\n"…뒤에는요?"\n\n"몰라."\n\n그래도 어디선가 "브라보!" 소리가 들렸다. 세상은 관대해졌다. 관객이 귀해져서.', fx:{moodAll:5}}]},
...
{id:'exp_underground', type:'탐색', w:7, region:['mid','north'], risk:1,
 ...
 choices:[
  {label:'조용히 내려가본다', risk:'위험', out:[
    {p:2, text:'지하 2층까지, 상점들은 이미 털려 있었다. 하지만 구석 등산용품점 창고가 무사했다.\n\n버너, 코펠, 침낭. 전부 챙겼다.\n\n"이거 다 가져가도 되나."\n\n"…물어볼 사람이 있어야 물어보죠."\n\n올라오는 길, 어둠 저편에서 인기척이 났지만 서로 못 본 척했다.', fx:{scrap:8, item:{'부품':1}, moodAll:-1}},
...
{id:'comp_food_debate', type:'동행', w:8, minParty:2,
 ...
 choices:[
  {label:'심판을 본다', out:[{p:1, text:'논쟁은 한 시간을 갔다. 치킨의 보편성, 곱창의 화력, 김치찌개의 서사성.\n\n"근데 곱창은 대창이 있어야—"\n\n"대창은 다른 부위예요."\n\n"…그러네."\n\n"그러네가 아니라 지금 지고 있는 거예요."\n\n결론은 나지 않았다. 대신 전원이 합의한 것 하나. "도착하면, 뭐든 같이 해 먹자."\n\n그 약속 덕에 그날 저녁이 조금 덜 초라했다.', fx:{moodAll:5, flag:'food_promise', note:{type:'사건',title:'음식 3파전',body:'결론 대신 약속. "도착하면 뭐든 같이 해 먹자."'}}}]},
...
{id:'comp_van_name', type:'동행', w:6, once:true, minParty:2,
 title:'달구지 개명 논란',
 text:'누군가 폭탄을 던졌다. "근데 달구지라는 이름, 너무 없어 보이지 않아?"\n\n"뭐가 없어 보여?"\n\n"아니 그… 없어 보인다기보다, 뭐랄까. 없어 보이지."\n\n차 안이 술렁이고 개명파와 수호파가 갈린다. 후보가 쏟아진다.\n\n질풍호, 은하수, 김봉수(왜?), 로드마스터. 그리고 …달구지(현행 유지).',
 choices:[
  {label:'투표에 부친다', out:[{p:1, text:'투표 규칙을 정하는 데만 십 분이 걸렸다. 기권을 인정할 거냐로 한 번, 운전자 표를 두 표로 칠 거냐로 또 한 번.\n\n"운전 많이 하니까 두 표."\n\n"그럼 밥 많이 먹는 사람은 세 표야?"\n\n"그건 또 무슨 소리야."\n\n결국 한 사람 한 표로 개표. 달구지 압승.\n\n"촌스러운 게 아니라 클래식한 거야." "얘가 우리를 여기까지 데려왔는데 이름을 바꿔?"\n\n개명파는 승복하면서 조건을 붙였다. 정식 명칭에 "달구지 1호"를 추가할 것. 함대의 기함처럼.', fx:{moodAll:6, note:{type:'사건',title:'달구지 개명 투표',body:'결과: 현행 유지 압승. 공식 명칭 "달구지 1호" 추가.'}}}]},
...
{id:'comp_storm_count', night:true, type:'동행', w:10, needWx:'storm', minParty:2,
 ...
 choices:[
  {label:'같이 센다', out:[{p:1, text:'"…일곱, 여덟—" 우르릉.\n\n"8초! 약 2.7km!"\n\n"2.7이 어디서 나와?"\n\n"초에 340 곱하면— 아니, 340이 맞나. 아무튼 대충 그쯤이에요."\n\n"대충이야?"\n\n"대충인데 잘 맞아요."\n\n다음 번개는 5초. 그다음은 11초. 폭풍이 우리를 지나쳐 가는 걸 숫자로 배웅했다.\n\n마지막 카운트는 열여섯까지 갔고, 천둥은 끝내 오지 않았다.', fx:{moodAll:5, note:{type:'사건',title:'천둥 카운트',body:'번개와 천둥 사이를 세며 폭풍을 배웅했다. 같이 세면 무서움이 시시해진다.'}}}]},
...
{id:'exp_kimchi', type:'탐색', w:6, once:true, region:['south','mid'],
 ...
 choices:[
  ...
  {label:'포장동만 뒤진다', out:[{p:1, text:'미개봉 소금 포대와 고춧가루 통을 챙겼다. 조미료가 생기면 야영 밥맛이 달라진다.', fx:{food:1, scrap:5}}]},
 ]},
...
{id:'comp_wordchain', type:'동행', w:8, minParty:2,
 title:'끝말잇기 왕중왕전',
 text:'"기린" "린스" "스키" "키…읔"\n\n"읔이 뭐야."\n\n"됐어, 방금 건 무효." "누구 마음대로 무효야." "규칙에 있어." "무슨 규칙." "…있어."\n\n국도는 길고 끝말잇기는 잔인하다. 벌칙은 다음 정차 때 유리창 닦기.',
 choices:[
  {label:'참전한다', out:[
    {p:2, text:'"름" 폭탄이 나오고 "슭" 폭탄이 나오고, 중간에 사전이 있냐 없냐로 십 분을 썼다.\n\n"기름." "…름름한." "그게 뭔데요." "형용사." "무슨 형용사." "…국물이 름름한 거." 반칙패.\n\n판정이 끝났을 땐 아무도 점수를 세고 있지 않았다. 다음 정차 때 유리창은 깨끗해졌다.', fx:{moodAll:5}},
    {p:1, text:'심판을 맡은 운전자가 한쪽만 두 번 봐준 게 걸렸다.\n\n"방금 봐줬잖아요." "안 봐줬어." "봐줬어요." "…한 번만." 그래서 전원 벌칙.\n\n유리창이 역대급으로 깨끗해졌다.', fx:{moodAll:5, van:2}}]},
  {label:'"단어 수집만 할게"', out:[{p:1, text:'오늘 나온 단어. 도롱뇽, 스라소니, 완도.\n\n"완도는 지명이라 안 되는 거 아니에요?" "아까 춘천 됐잖아." "춘천도 안 됐어야지." "이제 와서?"\n\n결론은 안 났고, 도롱뇽은 다들 외웠다.', fx:{moodAll:3}}]},
 ]},
...
{id:'loc_gyeongju', type:'탐색', w:0, locEvent:'gyeongju', once:true,
 ...
 choices:[
  {label:'왕릉 아래서 하루 쉰다', out:[{p:1, text:'능 아래 돗자리를 폈다. 마을 사람들이 찐 옥수수를 나눠줬다.\n\n"이 안에 진짜 왕이 있는 거예요?"\n\n"있겠지."\n\n"확인해 본 사람 있대요?"\n\n"…그건 나도 몰라."\n\n천년 전 왕 옆에서 낮잠을 잤다. 왕도 이런 오후는 부러웠을 것이다.\n\n"천년짜리 언덕 옆에 있으니까," 나직한 말이 나왔다. "몇 년쯤은 별거 아닌 것 같네."', fx:{time:300, moodAll:10, food:2, fatigue:-20, note:{type:'사건',title:'왕릉 소풍',body:'천년 언덕 옆에서는 여러 해도 잠깐처럼 느껴졌다.'}}}]},
...
{id:'loc_icheon', type:'탐색', w:0, locEvent:'icheon', once:true,
 ...
 choices:[
  {label:'그릇 한 벌을 교환한다 (식량 1)', req:{food:1}, out:[{p:1, text:'통조림 몇 개와 밥공기를 인원수대로 바꿨다.\n\n"물그릇은요?"\n\n"그건 얹어 주지."\n\n"공짜로요?"\n\n"공짜는 아니고. 다음에 지나갈 때 갚으쇼."\n\n그날 저녁, 처음으로 통조림을 그릇에 덜어 먹었다.\n\n이상했다. 같은 음식인데— 밥 같았다. 다들 말없이 한 그릇씩 비웠다.', fx:{food:-1, moodAll:8, note:{type:'사건',title:'그릇의 힘',body:'같은 통조림인데 그릇에 담으니 밥이 됐다. "밥을 담을 게 있어야 사람이거든."'}}}]},
...
{id:'meet_oxfarmer', type:'조우', w:5, region:['south','mid'],
 title:'소와 걷는 사람',
 text:'농부가 소를 몰고 국도를 걷는다. 소달구지에 이삿짐이 실렸다.\n\n"기름 쓰던 세상이 끝나니까 다시 소가 끄는 세상이 왔어. 얘 이름은 만복이. 리터당 여물 두 줌이면 가."',
 choices:[
...
{id:'exp_comicroom', minParty:1, type:'탐색', w:6,
 ...
 choices:[
  ...
  {label:'몇 권만 빌려간다(?)', out:[{p:1, text:'인기작 몇 질을 차에 실었다. 계산대에 고철을 두고 장부에 적었다. "대여 무기한. 완결까지 살아 있기."', fx:{scrap:-2, moodAll:5}}]},
 ]},
...
{id:'exp_fishfarm', type:'탐색', w:5,
 title:'버려진 양어장',
 text:'육상 양어장. 전기가 끊겨 수조 대부분은 말랐지만— 빗물이 고인 노천 수조에서 물이 튄다.\n\n물고기들이 몇 해째 사람 손 없이 살아남아 번식하고 있다.',
 choices:[
  {label:'그물을 던진다', out:[
    {p:2, text:'메기다. 그것도 팔뚝만 한 놈들.\n\n여러 해 방치된 양어장은 사실 자연 양식장이었다. 몇 마리만 잡고 나머지는 두었다. 다음 여행자의 몫.', fx:{food:3, moodAll:4}},
...
{id:'comp_cloudgame', type:'동행', w:7, minParty:2,
 title:'구름 감정사',
 text:'조수석에서 하늘을 보다 누군가 선언한다.\n\n"저 구름 완전 고래인데?"\n\n"어디요?" "저기." "저기 어디." "저기!" "손가락 말고 방향을 말해줘요."\n\n결국 다 같이 같은 데를 보게 됐을 땐 이미 반은 감자로 흩어진 뒤였다. 그런데도 차가 두 파로 갈렸다.',
 choices:[
  {label:'판정단을 자처한다', out:[{p:1, text:'다음 구름, 그다음 구름으로 연장전이 이어졌다. 드래곤은 이견이 없었고, 세탁기는 삼 대 일이었다.\n\n그다음 것에서 누가 "할아버지 옆모습"이라고 했다. 반박이 안 나왔다.\n\n그 뒤로 꽤 오래 아무도 다음 구름을 고르지 않았다.', fx:{moodAll:5, note:{type:'사건',title:'구름 감정',body:'드래곤, 세탁기, 그리고 할아버지 옆모습(전원 통과).',links:['할아버지']}}}]},
  {label:'"둘 다 틀렸어, 저건 달구지야"', out:[{p:1, text:'"달구지요?" "우리 차." "아—"\n\n제3안이 그대로 채택됐다. 하늘의 달구지는 우리보다 빨랐다.', fx:{moodAll:4}}]},
 ]},
{id:'comp_dialect', type:'동행', w:6, minParty:2,
 title:'사투리 배틀',
 text:'"정지가 뭔지 아는 사람?"\n\n"신호등?" "아니." "멈추라는 거." "아니라니까. 부엌이야."\n\n"그럼 글로 가라의 글로는?" "글로… 글자?" "그리로."\n\n출제자가 신이 났다. 전국을 달리는 차답게 출제 범위도 전국구다.',
 choices:[
  {label:'참전한다', out:[{p:1, text:'"어디까지 알아듣나"로 시작했는데 어느새 다들 자기 할머니 흉내를 내고 있었다.\n\n누가 언제 규칙을 바꿨는지는 아무도 몰랐다. 물어보지도 않았다.\n\n대신 단어가 하나 남았다. 오늘부터 이 차에서 후미등은 궁디불이다.', fx:{moodAll:6, note:{type:'사건',title:'사투리 배틀',body:'공용어 등재: 후미등=궁디불. 우승자는 할머니 성대모사.'}}}]},
  {label:'심사만 본다', out:[{p:1, text:'"점수는요?" "안 매겨." "왜요." "다 붙었어. 어디 내려놔도 밥은 얻어먹겠더라."\n\n채점표는 끝내 안 나왔다.', fx:{moodAll:3}}]},
 ]},
{id:'comp_bori_bath', minParty:1, type:'동행', w:6, needsDog:true, once:true,
 ...
 choices:[
  ...
  {label:'"자연 건조식으로 살자"', out:[{p:1, text:'보리가 안도의 한숨을 쉬며 다시 드러누웠다. 냄새는… 정이 들면 향기다. 아마도.', fx:{moodAll:1}}]},
 ]},
{id:'comp_tire_class', type:'동행', w:5, needsComp:'minji', once:true,
 ...
 choices:[
  {label:'성실히 수강한다', out:[{p:1, text:'"잭은 여기! 아니 거기 아니고 여기!!"\n\n"여기?"\n\n"거기 말고요. 거기 대면 밑판 찌그러져요. …아니, 찌그러지는 게 아니라 아예 뚫려요."\n\n두 시간의 스파르타 끝에 전원 실기 합격. 민지가 손수 만든 수료증(박스 조각)을 발급했다.\n\n"이거 유효기간 있어?"\n\n"…생각 안 해봤는데. 있는 걸로 해요."', fx:{time:120, moodAll:5, van:4, mood:{minji:6}, note:{type:'사건',title:'타이어 교체 자격증',body:'민지 사관학교 전원 수료. 수료증은 박스 조각.',links:['민지']}}}]},
 ]},
{id:'comp_dj_night', type:'동행', w:6, minParty:2, night:true,
 title:'심야 라디오 놀이',
 text:'"여기는 심야 라디오, 달구지 FM…" 조수석에서 누가 물통을 마이크 삼아 시작했다.\n\n"물통 좀 줘. 마실 거야." "방송 중인데요." "…끝나고 줘."\n\n"첫 사연입니다. 운전석의 K씨. \'졸립니다.\' …이건 사연이 아니라 위협인데요."',
 choices:[
  {label:'사연을 보낸다', out:[{p:1, text:'사연이 오고 신청곡이 오고, 신청곡은 어차피 부를 사람이 여기밖에 없어서 전원 아카펠라가 됐다.\n\n중간에 광고를 하겠다며 만수네 만물상 CM송을 지어 불렀다. 만수 씨한테 허락은 안 받았다.\n\n창밖이 그대로인데 밤길이 짧아진 것 같았다.', fx:{moodAll:6, fatigue:-8, note:{type:'사건',title:'달구지 FM',body:'청취율 100%. 광고주: 만수네 만물상(무허가).'}}}]},
  {label:'"볼륨 줄여, DJ"', out:[{p:1, text:'"네— 여기까지 달구지 FM이었습니다."\n\n"…벌써요?" "응." "한 곡만." "안 돼."\n\n방송은 끝났는데 콧노래는 안 끝났다.', fx:{moodAll:2}}]},
 ]},

/* ── 추적 추가 ── */
{id:'ai_forecast', type:'추적', w:6, region:['north'],
 title:'일기예보 방송',
 text:(S)=>`폐 전광판이 켜지더니 일기예보가 나온다.\n\n<span class="ai">"내일 이 구간은 ${(D.wx[S.wxNext]||D.wx.clear).nm}. 우산— 은 없으시겠군요. 안전운전 하세요."</span>\n\n문제는 그 예보가 우리 라디오보다 더 정확하다는 데 있었다.`,
 choices:[
...
{id:'ai_snowplow', type:'추적', w:5, region:['north'],
 title:'한여름의 제설차',
 text:'전방에 제설차가 작업 중이다. 길에는 눈 한 톨 없다.\n\n제설차는 오래전 입력된 일정을 따르듯 도로의 낙엽과 잔해를 정성껏 밀어낸다.\n\n덕분에 이 구간 도로는— 소름 끼치게 깨끗하다.',
 choices:[
  {label:'뒤를 따라간다', out:[{p:1, text:'제설차가 청소한 길을 편하게 달렸다. 연비도 아꼈다.\n\n추월하는 순간 제설차가 경적을 짧게 울렸다. 인사였다. 이 동네 기계들은 자꾸 인사를 한다.', fx:{fuel:2, skipKm:4, moodAll:-1}}]},
...
{id:'ai_crosswalk', type:'추적', w:5, region:['north'],
 title:'횡단보도 안내 음성',
 text:'아무도 없는 사거리. 횡단보도 신호가 파란불로 바뀌자 안내 음성이 나온다.\n\n<span class="ai">"녹색불이 켜졌습니다. 건너가도 좋습니다."</span>\n\n그리고 잠시 후, 평소와 다른 한 마디.\n\n<span class="ai">"…오늘은 건너는 분이 계시네요. 오랜만입니다."</span>',
 choices:[
  {label:'"…우리한테 한 말이야?"', out:[{p:1, text:'스피커는 더 말하지 않았다. 신호가 바뀔 때마다 안내 음성은 아무도 없는 사거리에 같은 말을 반복했다.\n\n"건너가도 좋습니다." 그 말은 오랫동안 매 신호마다 이어졌던 모양이다.\n\n차 안이 잠깐 숙연해졌다. 기계의 성실함은 가끔 슬픔과 구분되지 않는다.', fx:{moodAll:-2, note:{type:'사건',title:'오랜만입니다',body:'아무도 없는 사거리의 안내 음성. 성실함과 슬픔이 구분되지 않았다.',links:['천리안']}}}]},
 ]},
...
{id:'lc_ulsan_whale', type:'조우', w:12, once:true, nearNode:['ulsan'],
 ...
 choices:[
  {label:'멈춰서 지켜본다', out:[{p:1, text:'고래는 세 번 숨을 쉬고 사라졌다.\n\n"…세 번 맞아요?"\n\n"두 번인가."\n\n"세 번이었데이." 노인이 못 박듯 말했다.\n\n그러고는 그 자리에 주저앉아 오래 바다를 봤다. "내 아버지가 보던 걸 내가 보네."\n\n멸망이 돌려준 것들의 목록에 고래가 추가됐다.', fx:{time:30, moodAll:9, note:{type:'사건',title:'귀신고래 귀환',body:'사람이 조용해지자 고래가 돌아왔다. 멸망이 돌려준 것들의 목록.'}}}]},
 ]},
...
{id:'lc_daegu_makchang', minParty:1, type:'조우', w:12, once:true, nearNode:['daegu'],
 ...
 choices:[
  {label:'막창을 굽는다 (고철 5)', req:{scrap:5}, out:[{p:1, text:'지글지글. 다들 불판에서 눈을 못 뗐다.\n\n"이거 언제 뒤집어요?"\n\n"아직."\n\n"지금 아니에요?"\n\n"아직이라니까."\n\n"…지금."\n\n"마이 무으이소. 요즘 손님이 귀해가." 사장님이 된장 소스를 아낌없이 퍼줬다.\n\n불판이 다 비고도 아무도 일어나지 않았다.', fx:{scrap:-5, food:1, moodAll:9, fatigue:-8, note:{type:'사건',title:'막창의 밤',body:'숯불, 된장, 지글지글. 완벽하게 기름진 밤.'}}}]},
...
{id:'lc_cheonan_walnut', type:'조우', w:12, once:true, nearNode:['cheonan'],
 title:'호두과자의 원조',
 text:'국도변에 연기 오르는 리어카. 호두과자 기계가 돌아간다. 수동 개조판이다.\n\n"천안이니까요. 여기서 호두과자 없으면 그게 멸망이죠."\n\n"…네? 뭐가 멸망이라고요?"\n\n"호두과자가요. 아니, 그— 말이 그렇다는 거고." 페달을 밟는 청년의 다리가 우람하다.',
 choices:[
  {label:'한 봉지 산다 (고철 3)', req:{scrap:3}, out:[{p:1, text:'따끈한 호두과자 한 봉지. 팥 대신 고구마 앙금이다. "팥이 귀해서요. 고구마도 귀한데 팥보단 덜 귀해서."\n\n"천안 지나가는 차엔 무조건 있어야죠. 전통이니까."\n\n청년이 다시 페달을 밟기 시작했다. 뒤에 차가 한 대 더 서 있었다. 봉지가 뜨거워서 한동안 무릎에 못 올려놨다.', fx:{scrap:-3, food:2, moodAll:5, note:{type:'사건',title:'페달식 호두과자',body:'"천안이니까요." 전통은 페달로도 돌아간다.'}}}]},
 ]},
{id:'lc_suwon_galbi', type:'조우', w:11, once:true, nearNode:['suwon'],
 title:'왕갈비의 냄새',
 text:'수원 성곽 근처. 어디선가 갈비 양념 냄새가 난다.\n\n"오늘 고기날이거든." 문지기가 씩 웃는다. "타이밍 좋네. 손님도 한 접시요."\n\n"고기날이요?"\n\n"한 달에 한 번. …아, 그릇은 각자 갖고 와야 돼요. 그 말을 맨날 빼먹네."',
 choices:[
  {label:'고기날에 합류한다', out:[{p:1, text:'배급 갈비는 한 사람당 세 대. 뼈까지 쪽쪽 빨았다.\n\n"수원이잖아. 망해도 갈비는 지켜야지." 문지기가 말하다 말고 옆 사람을 돌아봤다. "이거 몇 대씩이더라. 세 대 맞나?"\n\n"세 대 맞아요."\n\n답례로 차에 있던 조미료를 조금 덜어 주방 선반에 놓고 왔다.', fx:{food:1, moodAll:8, scrap:-2, note:{type:'사건',title:'고기날',body:'"망해도 갈비는 지켜야지." 수원의 자부심.'}}}]},
 ]},
{id:'lc_jeonju_bibim', type:'조우', w:12, once:true, nearNode:['jeonju'],
 title:'비빔밥 트럭',
 text:'전주 외곽, 짐칸을 주방으로 개조한 트럭.\n\n"전주가 밥의 수도였다는 걸 잊지 않게 하려고 다닙니다."\n\n요리사가 재료를 늘어놓는다. 콩나물, 고사리, 계란— 계란은 아니고 계란이 놓일 자리다.\n\n"없는 건 마음의 눈으로 채우시고요. …아, 숟가락 있으세요? 숟가락은 안 나가요."',
 choices:[
  {label:'한 그릇 비빈다 (고철 4)', req:{scrap:4}, out:[{p:1, text:'유기그릇에 나온 비빔밥. 진짜 유기다. "이건 어디서 나셨어요?" "그건 얘기가 길어서요."\n\n고추장 한 숟갈이 들어가자 차 안이 조용해졌다. 한동안 씹는 소리만 났다.\n\n요리사는 그사이 다음 손님 몫의 콩나물을 다듬고 있었다.', fx:{scrap:-4, food:1, moodAll:8, note:{type:'사건',title:'수도의 밥',body:'"전주가 밥의 수도였다는 걸 잊지 않게 하려고." 고추장 한 숟갈의 위엄.'}}}]},
 ]},
{id:'lc_mokpo_hongeo', minParty:1, type:'조우', w:12, once:true, nearNode:['mokpo'],
 title:'홍어 입문 시험',
 text:'목포 골목의 좌판. 아짐이 접시를 내민다.\n\n"묵어봤능가? 삭힌 거."\n\n"…삭힌 뭐요?"\n\n"홍어제. 목포 왔으면 통과의례여." 말보다 냄새가 먼저 올라온다. 차 안의 시선이 서로를 향한다. 누가 먼저?',
 choices:[
...
{id:'lc_andong_fish', type:'조우', w:11, once:true, nearNode:['andong'],
 title:'간고등어 지게',
 text:'지게에 간고등어 두름을 진 행상이 고개를 넘는다.\n\n"옛날엔 바다에서 안동까지 이틀. 소금 안 치면 다 상했지. 간잽이가 괜히 있나."\n\n"간잽이요?"\n\n"소금 치는 사람. 그냥 치는 게 아니고 날씨 보고 양을 재는— 됐다, 설명하다 고개 다 넘겄다.\n\n지금도 이틀 걸려. 세상이 옛날로 돌아온 거지, 뭐."',
 choices:[
  {label:'간고등어를 산다 (고철 3)', req:{scrap:3}, out:[{p:1, text:'짭짤하게 간이 밴 고등어 한 손.\n\n"소금은 시간을 이기는 기술이야." 행상이 지게를 고쳐 메며 덧붙였다. "이건 우리 아버지 말이고, 나는 그냥 하던 대로 하는 거고."\n\n고개 너머로 지게가 사라질 때까지 소금 냄새가 남았다.', fx:{scrap:-3, food:2, moodAll:4, note:{type:'사건',title:'간잽이의 철학',body:'"소금은 시간을 이기는 기술이야."'}}}]},
 ]},
...
{id:'lc_nonsan_camp', type:'조우', w:11, once:true, nearNode:['nonsan'], needsComp:'kangwoo',
 title:'훈련소 정문',
 text:'논산 훈련소 정문 앞. 강우가 창밖을 오래 본다.\n\n"…스물둘에 저 문으로 들어갔다. 머리 밀고. 엄마가 울고."\n\n"몇 년도요?"\n\n…….\n\n"물 어디 뒀지." 강우가 물병 쪽으로 손을 뻗었다. 정문 안쪽 연병장엔 잡초가 도열해 있다.',
 choices:[
  {label:'잠깐 세워준다', out:[{p:1, text:'강우가 정문 앞에 5분을 서 있었다. 부동자세로.\n\n돌아와 앉고도 한동안 말이 없었다. 그러다 한 마디. "…그때 조교가 그랬다. 힘든 건 지나간다고."\n\n"…좋은 것도 지나가지만."\n\n"둘 다 맞았어." 강우가 안전벨트를 다시 채웠다. 아까 채운 걸 또.', fx:{mood:{kangwoo:8}, moodAll:3, note:{type:'사건',title:'훈련소 정문',body:'"힘든 건 지나간다. 좋은 것도 지나가지만. 둘 다 맞았어."',links:['강우']}}}]},
 ]},
...
{id:'lc_chungju_lake', type:'탐색', w:11, once:true, nearNode:['chungju','danyang'],
 ...
 choices:[
  {label:'옛 주민들과 걷는다', out:[{p:1, text:'노인들이 돌담을 쓸며 옛집을 하나하나 호명했다. "박씨네. 최씨네. 방앗간."\n\n"방앗간은 저짝이여."\n\n"저짝이 최씨네고."\n\n"최씨네가 방앗간을 했잖여." 두 사람이 진흙 위에 서서 한동안 다퉜다. 결론은 안 났다.\n\n옆에 있던 노인이 이쪽을 보며 말했다. "물에 잠긴 것도 이렇게 다시 보는데. 망한 세상도 언젠가 물 빠지듯 드러나겄지. 길이나 봐두게."', fx:{time:90, moodAll:6, note:{type:'사건',title:'물 빠진 마을',body:'"망한 세상도 물 빠지듯 드러나겄지. 길이나 잘 봐두게."'}}}]},
 ]},
...
{id:'parcel_found', minParty:1, type:'조우', w:14, once:true, needFlag:'parcel_lead', nearNode:['suwon','pyeongtaek','seoul'],
 title:'세 살의 주인',
 text:'수원 성곽 근처 밭에서 일하는 부부. 옆에서 아이가 흙장난 중이다.\n\n"김하늘 어린이 맞나요? 오래전에 주문하신 물건이… 이제 도착해서요."\n\n"…뭘요?"\n\n"주문하신 물건이요."\n\n"주문한 적 없는데." 남편이 아내를 돌아봤다. 아내는 신발 상자를 보고 있었다. 그러다 얼어붙었다.',
 choices:[
  {label:'상자를 전달한다', out:[{p:1, text:'"이거… 태어나기 전에 주문했던… 배냇신발…"\n\n엄마가 상자를 끌어안고 울었다. 아이는 영문도 모르고 신발을 신어봤다. 당연히 작았다. 다들 웃으면서 울었다.\n\n"수년 만의 배송 완료." 누군가 조용히 말했다.\n\n부부가 밭의 채소를 한아름 안겨줬다. 됐다고 하는데도 자꾸 더 얹었다.', fx:{food:3, water:2, moodAll:12, flag:'parcel_done', unflag:'parcel_lead', note:{type:'사건',title:'여러 해 걸린 배송 완료',body:'배냇신발은 작아졌지만 도착했다. 차 역사상 최고의 배달.',links:['천리안']}}}]},
 ]},
...
{id:'comp_nickname', type:'동행', w:6, minParty:2, once:true,
 ...
 choices:[
  {label:'회의를 연다', out:[{p:1, text:'격론 끝에 전원 별명 확정. 거부권이 세 번 시도됐고(1회 초과분 기각), 최다 득표 별명은 유출 금지 협약이 맺어졌다.\n\n다만 운전자의 콜사인이 "달구지 원"으로 정해진 것만은 기록에 남긴다.', fx:{moodAll:6, note:{type:'사건',title:'별명 제정 위원회',body:'전원 콜사인 확정. 운전자=달구지 원. 나머지는 협약상 유출 금지.'}}}]},
 ]},
{id:'comp_whatif', type:'동행', w:6, minParty:2, night:true,
 title:'만약에 게임',
 text:'밤 운전의 단골 게임이 시작됐다.\n\n"만약에— 그날이 안 왔으면, 지금쯤 뭐 하고 있었을까?"\n\n"……."\n\n"아무도 대답 안 하면 게임이 아니잖아."',
 choices:[
  {label:'돌아가며 대답한다', out:[{p:1, text:'회사원. 가게 사장. 세계여행.\n\n한 명은 "그냥 잘 살았겠지" 하고 말았고, 아무도 더 캐묻지 않았다.\n\n마지막 사람이 말했다. "근데 그랬으면 우리 못 만났겠네."\n\n"…그건 좀 치사한데."\n\n반박은 안 나왔다. 다음 순서도 안 돌아갔다.', fx:{moodAll:6, note:{type:'사건',title:'만약에 게임',body:'"근데 그랬으면 우리 못 만났겠네." 반박 없이 게임이 멈췄다.'}}}]},
  {label:'"그 게임 금지. 슬퍼짐"', out:[{p:1, text:'"그럼 만약에 로또 됐으면?"\n\n"그건 또 뭐야." "건전한 버전이야."\n\n돌아가며 답을 했는데 세 명이 차를 사겠다고 했다. 이 차보다 좋은 차를 대는 사람은 없었다.', fx:{moodAll:4}}]},
 ]},
...
{id:'camp_thief', type:'위기', w:0, fixed:true,
 title:'밤손님',
 text:'새벽, 차 밖에서 부스럭거리는 소리.\n\n"…들려?"\n\n"뭐가."\n\n"저거." 창틈으로 보니— 그림자 하나가 지붕 짐끈을 풀고 있다. 도둑이다.',
 choices:[
...
{id:'meet_seedlady', type:'조우', w:7,
 title:'씨앗 도서관',
 text:'경운기를 개조한 수레에 유리병이 빼곡하다. 병마다 라벨. 상추, 열무, 대파, 해바라기.\n\n"씨앗 도서관이에요. 빌려가서 수확하면 두 배로 반납."\n\n"연체료는요?"\n\n"없어요. 있었는데, 받으러 다니기가 귀찮아서 없앴어요."',
 choices:[
  {label:'씨앗을 빌린다 (물 2)', out:[{p:1, text:'물 두 통과 상추 씨앗 한 병을 맞바꿨다. 엄밀히는 빌린 거다.\n\n"수확하면 두 배 반납이에요. 어디서든, 누구한테든."\n\n"누구한테든이요?"\n\n"저 아니어도 돼요. 씨앗 필요한 사람 아무나." 주인이 병뚜껑을 한 번 더 조여줬다.', fx:{water:-2, food:3, moodAll:2, flag:'seed_borrowed', note:{type:'인물',title:'씨앗 도서관',body:'빌려가서 두 배로 반납. 누구한테든. 씨앗은 다 연결돼 있다.'}}}]},
...
{id:'exp_glasshouse', type:'탐색', w:7,
 ...
 choices:[
  {label:'조용히 수확한다', out:[
   {p:3, text:'토마토와 오이를 배낭 가득 땄다. 스프링클러가 한 번 더 돌며 등을 적셨지만, 그뿐이었다.\n\n누가— 무엇이— 물을 대는지는 생각하지 않기로 했다. 토마토는 죄가 없다.', fx:{food:4, water:1, note:{type:'사건',title:'살아 있는 온실',body:'전기가 살아 있는 온실. 누가 물을 대는지는 생각하지 않기로 했다.'}}},
...
{id:'comp_hometown', type:'동행', w:6, minParty:2,
 title:'지명 퀴즈',
 text:'조수석에서 낡은 전국 지도를 펴 들고 퀴즈가 시작됐다.\n\n"가본 데 나오면 손. 거짓말하면 저녁 굶기."\n\n"휴게소도 가본 걸로 쳐요?"\n\n"휴게소는 안 쳐."\n\n"그럼 대전은 아무도 못 가본 게 되는데."\n\n손이 제일 많이 올라간 곳은 결국 다들 수학여행으로 스친 경주였다.',
 choices:[
...
{id:'comp_satellite', type:'동행', w:6, night:true, needsComp:'eunsu',
 ...
 choices:[
  {label:'끝까지 지켜본다', out:[{p:1, text:'빛점이 능선 너머로 사라질 때까지 다들 목을 꺾고 봤다.\n\n"외롭겠다."\n\n"…아뇨." 은수가 조금 있다 말했다. "쟤는 지금도 90분에 한 바퀴씩 지구를 돌아요."\n\n"그게 왜 안 외로운 건데요."\n\n"…안고 도는 거니까요." 은수가 목을 다시 폈다. "설명이 잘 안 되네요."', fx:{moodAll:4, mood:{eunsu:4}, note:{type:'사건',title:'아직 도는 것',body:'주인 잃은 위성. 은수 왈, 지금도 90분에 한 바퀴씩 지구를 안는 중.',links:['은수']}}}]},
 ]},
...
{id:'wx_maskseller', minParty:1, type:'조우', w:8, needWx:'dust',
 title:'마스크 장수',
 text:'황사로 주황색이 된 세상. 고글에 방독면을 쓴 사람이 손수레를 밀고 온다.\n\n수레 가득 마스크와 고글. 방독면 때문에 말이 웅웅거린다. "황사 특수요! 오늘만 이 가격!"\n\n"…네?"\n\n장수가 필터를 손으로 누르고 다시 외쳤다. "오늘만! 이! 가격!"\n\n부지런한 사람이다. 이 세상에도 대목이 있다.',
 choices:[
...
{id:'seed_harvest', type:'탐색', w:10, once:true, needFlag:'seed_borrowed',
 ...
 choices:[
  {label:'심고 간다', out:[{p:1, text:'고랑을 내고 씨앗 반을 심었다. 어차피 우리는 못 거둔다. 북쪽으로 가니까.\n\n"팻말에 뭐라고 써요?"\n\n"…그냥 상추라고 쓰면 되나?"\n\n결국 이렇게 적었다. "상추. 아무나 드세요. 씨는 받아서 남쪽 씨앗 도서관에."\n\n글씨가 삐뚤어서 한 번 지우고 다시 썼다.', fx:{time:40, moodAll:4, flag:'seed_grown', note:{type:'사건',title:'지나가는 농사',body:'못 거둘 밭에 씨를 심고 팻말을 세웠다. 대출은 이렇게 연장된다.'}}}]},
...
{id:'meet_tinker', type:'조우', w:7,
 ...
 choices:[
  {label:'냄비와 칼을 맡긴다 (고철 3)', req:{scrap:3}, out:[{p:1, text:'궤짝이 노점으로 변신하는 데 1분. 냄비 구멍 둘을 때우고 칼 세 자루를 갈았다.\n\n"살림 오래 쓰는 게 애국이에요, 요즘은."\n\n"애국이요?"\n\n"…아니, 그냥 하는 말이고." 땜장이의 손은 눈보다 빨랐다.\n\n돌아온 칼로 저녁 준비 시간이 절반이 됐다. 도마질 소리가 달라졌다고 누가 두 번 말했다.', fx:{scrap:-3, moodAll:3, van:2, note:{type:'인물',title:'땜장이',body:'등짐 궤짝 하나로 냄비·우산·칼을 살리는 사람. 살림 오래 쓰는 게 애국.'}}}]},
  {label:'외침만 듣고 간다', out:[{p:1, text:'"냄비 때워요—" 소리가 오래 따라왔다.\n\n몇 킬로 뒤에 누가 말했다. "…우리 냄비 구멍 안 났었나?"\n\n났었다. 이미 지나온 뒤였다.', fx:{}}]},
 ]},
...
{id:'meet_runner', minParty:1, type:'조우', w:6, once:true,
 ...
 choices:[
  {label:'"어디까지 뛰세요?"', out:[{p:1, text:'"오늘은 저 다리까지요." 그가 숨을 고르며 답했다. "매일 뜁니다. 마라톤 대회가 다시 열리면 나갈 거라서."\n\n"…열릴까요?"\n\n"제가 준비돼 있으면요."\n\n"그게 무슨 상관이—"\n\n"몰라요. 그냥 그렇게 정해놨어요." 그가 씩 웃고 페이스를 올렸다.\n\n백미러 속에서 그는 계속 달리고 있었다.', fx:{moodAll:4, note:{type:'인물',title:'달리는 사람',body:'매일 뛰는 마라토너. 대회가 열리면 나갈 거라고, 그렇게 정해놨다고 했다.'}}}]},
...
{id:'meet_florist', type:'조우', w:6,
 title:'꽃 노점',
 text:'장터 어귀에 양동이 세 개. 들꽃과 재배 꽃이 섞여 꽂혀 있다.\n\n"꽃 사세요. 고철 하나."\n\n"한 다발에요?"\n\n"한 송이에. …아니다, 한 다발에. 오늘은 다리가 아파서 일찍 접을 거라."\n\n꽃장수 노파가 심드렁하게 말했다. 이 세상에서 꽃은 팔릴까. 양동이 절반이 비어 있다. 그래도 꽃을 사는 사람이 있나 보다.',
 choices:[
...
{id:'meet_stargazer', minParty:1, type:'조우', w:6, night:true, once:true,
 ...
 choices:[
  {label:'옆에 앉는다', out:[{p:1, text:'그는 아마추어 천문가였다. 도시 불빛이 사라진 뒤로 전국의 하늘을 순례 중이라고 했다.\n\n"빛공해 지도라는 게 있었어요. 전국이 새빨갰죠."\n\n"…빨개요?"\n\n"아, 밝은 데를 빨갛게 칠한 지도예요. 지금은 전부 검정이고요. 관측자한텐 황금기죠."\n\n보온병을 내밀길래 받았다. 보리차였고, 미지근했다.\n\n"…대가가 너무 컸네요."\n\n"네." 접안렌즈를 닦던 손이 잠깐 멈췄다. "그래서 매일 봐요. 대가만큼은 봐야죠. …라고 해놓고 그냥 습관인지도 모르겠고요."\n\n망원경으로 안드로메다를 봤다. 250만 년 전의 빛이라고 했다. 그 빛이 출발할 땐 지구에 인류도 없었다.', fx:{time:60, moodAll:5, note:{type:'인물',title:'하늘 순례자',body:'전국의 검은 하늘을 도는 아마추어 천문가. "대가만큼은 봐야죠." 안드로메다 250만 년.'}}}]},
...
{id:'granny_again', type:'조우', w:12, once:true, needFlag:'granny_met', region:['mid'],
 title:'멈춘 경운기',
 text:'낯익은 탈탈… 소리가 안 난다.\n\n갓길에 그 경운기가 서 있다. 할머니가 보닛(이라기엔 철판)을 열고 팔짱을 끼고 있다.\n\n"어, 차 젊은이들." 할머니는 태연했다. "얘가 파업이야. 영감 살아 있을 때도 가끔 이랬어. 관심 받고 싶어서."',
 choices:[
  {label:'민지가 진찰한다', req:{comp:'minji'}, out:[{p:1, text:'민지가 경운기를 20분 만졌다. "점화플러그요. 그리고 이거, 개스킷을 두 번 갈아 끼운 자국이— 아니다. 그냥 정비를 아껴가면서 받았네요. 오래 쓰려고."\n\n"뭘 아껴?"\n\n"부품이요. 되는 데까지 살려 쓰신 거예요."\n\n"영감 솜씨야. 죽기 전에 십 년치를 해놨거든." 할머니가 웃었다. "십 년 뒤엔 내가 없을 줄 알고. 계산이 틀렸지."\n\n탈탈탈— 경운기가 깨어나자 할머니가 민지 손을 꼭 잡았다. "영감 솜씨 알아보는 손이네." 민지는 손을 빼지도 못하고 기름 묻은 쪽만 자꾸 뒤로 감췄다.', fx:{time:25, mood:{minji:5}, moodAll:3, flag:'granny_helped', note:{type:'사건',title:'십 년치 정비',body:'영감이 죽기 전 해둔 십 년치 정비. 계산이 틀려서 다행인 이야기.',links:['경운기 할머니']}}}]},
...
{id:'dj_meet', minParty:1, type:'조우', w:12, once:true, needFlag:'dj_tower',
 ...
 choices:[
  {label:'"청취율은 나와요?"', out:[{p:1, text:'"네? 아, 청취율." DJ가 테이프를 갈다 말고 웃었다. "몰라요. 알 방법이 없지. 옛날엔 그거 재는 회사가 따로 있었는데— 그 회사도 없고요."\n\n"근데 가끔 이런 걸 받아요." 벽에 붙은 쪽지들을 가리켰다. 「덕분에 밤이 덜 길어요」 「울 엄마가 팬이에요」 「신청곡 됩니까」\n\n"저 신청곡 쪽지, 같은 사람이 세 번째 붙인 거예요. 아직 못 틀어줬고." 떨어지려는 쪽지를 손끝으로 눌러 붙였다. "끄면 누가 혼자가 되는지 알 것 같아서 못 꺼요. 듣는 사람이 한 명이어도 방송이에요."', fx:{time:40, moodAll:4, flag:'dj_met', note:{type:'인물',title:'DJ',body:'파마머리 이동 방송국. "듣는 사람이 한 명이어도 방송이에요." 청취율 집계 불가, 쪽지 다수.',links:['새벽 두 시의 DJ']}}}]},
...
{id:'kangwoo_dogtag', type:'동행', w:7, once:true, needsComp:'kangwoo', night:true,
 ...
 choices:[
  {label:'옆에 앉는다', out:[{p:1, text:'"하나는 내 거." 강우가 줄 하나를 들었다. "하나는 후임 거."\n\n"후임이요?"\n\n"……." 불을 한 번 보고 왔다. "제3방어선에서— 아니다. 그 얘긴 아직."\n\n군번줄을 옷 속에 넣었다. "서울에 걔 부모가 있었다. 있는지 확인하러 간다."\n\n"그게 강우 씨가 서울 가는 이유예요?"\n\n"이유 중 하나."\n\n"나머지는요."\n\n대답 대신 장작이 들어갔다. 불이 커지면서 군번줄의 눌린 글자가 잠깐 보였다. 「박」.', fx:{mood:{kangwoo:5}, note:{type:'사건',title:'두 번째 군번줄',body:'후임 박일병의 것. 강우는 서울의 부모에게 돌려주려고 북쪽으로 간다.',links:['강우','남산']}}}]},
 ]},
...
{id:'comp_diary_read', type:'동행', w:5, minParty:2, night:true,
 ...
 choices:[
  {label:'낭독회를 연다', out:[{p:1, text:'초반 기록에서 다들 웃었다. "이땐 물 10통이 많은 줄 알았지."\n\n"거기 내 얘기 잘못 적혔는데." "어디?" "DAY 3. 나 그날 안 졸았어." "졸았잖아." "…적을 정도는 아니었지."\n\n중반 기록에서 조용해졌고, 어떤 이름들에서 오래 멈췄다. 낭독하던 사람이 한 줄을 건너뛰었는데 아무도 다시 읽어달라고 하지 않았다.\n\n낭독이 끝나고 누가 말했다. "우리 꽤 멀리 왔네."\n\n킬로미터 얘기가 아니라는 걸 다들 알았다.', fx:{time:40, moodAll:5, note:{type:'사건',title:'낭독의 밤',body:'우리가 쓴 우리 이야기. "우리 꽤 멀리 왔네" — 킬로미터 얘기가 아니었다.'}}}]},
 ]},
...
{id:'crisis_battery', minParty:1, type:'위기', w:5,
 ...
 choices:[
  ...
  {label:'민지의 응급 충전', req:{comp:'minji'}, out:[{p:1, text:'민지가 태양광 패널(있다면)이나 폐차 배터리를 직결해 응급 충전을 했다.\n\n"범인은 실내등. 아니, 실내등이랑 문틈 둘 다야. 문이 덜 닫혀서 계속 켜져 있었던 거니까." 민지가 문틈에 테이프를 붙였다. "재판 끝. 집행 완료."', fx:{time:40, mood:{minji:3}}}]},
 ]},
...
{id:'wx_ghostlight', type:'조우', w:6, needWx:'fog', night:true,
 ...
 choices:[
  {label:'천천히 접근한다', out:[
   {p:2, text:'거리가 줄수록 불빛이 이상했다. 너무 안 움직인다.\n\n"저쪽 왜 안 와?" "고장 났나." "…아니야."\n\n정체는 폐버스 유리에 반사된 우리 헤드라이트였다. 여러 해 만의 마주 오는 차는 우리 자신이었다.\n\n"…우리가 우리한테 인사한 거네." 아무도 웃지 않았고, 아무도 상향등을 다시 켜지 않았다.', fx:{note:{type:'사건',title:'안개 속의 우리',body:'마주 오는 차의 정체는 폐버스 유리에 비친 우리. 우리가 우리에게 인사했다.'}}},
...
{id:'exp_towyard', type:'탐색', w:6,
 ...
 choices:[
  {label:'지도를 살핀다', out:[{p:1, text:'빨간 동그라미들이 그날의 사고 지도를 그리고 있었다. 우리가 지나온 길, 지나갈 길 위에.\n\n한 지점에 동그라미 대신 별표와 메모. "여기 견인 불가. 사람만."\n\n사람만. 그날 어느 견인기사는 차를 버리고 사람부터 실었다. 별표 위치를 우리 지도에도 옮겨 적었다. 이유는 설명하기 어렵지만, 좋은 자리 같아서.', fx:{revealNear:1, moodAll:2, note:{type:'사건',title:'여기 견인 불가. 사람만.',body:'그날 어느 기사의 선택이 남긴 별표. 좋은 자리로 분류.'}}}]},
...
{id:'meet_mapmaker', type:'조우', w:6, once:true,
 title:'지도장이',
 text:'갓길에 세운 오토바이. 사이드카에 제도판이 실려 있다.\n\n한 사람이 도로를 스케치하고 있다— 무너진 육교, 새로 난 샛길, 물 나오는 곳을 기호로 그려 넣으며.\n\n"오래전 지도는 다 거짓말이 됐어요. 거짓말까진 아니고— 아무튼 이젠 안 맞아요. 누가 다시 그려야죠."',
 choices:[
  {label:'정보를 교환한다', out:[{p:1, text:'우리 일지의 길 정보와 지도장이의 신작 지도가 달구지 보닛 위에서 만났다.\n\n"이 고개는 이제 막혔군요. 그럼 우회로부터— 아니, 우회로도 제가 확인을 못 했으니 점선으로 두죠."\n\n말하면서 이미 지우개를 찾고 있었다. 우리가 지난 우물과 무너진 길을 짚어 주자 지도장이는 눈앞에서 지도를 고쳐 그렸다. 종이를 두 번 뒤집었고, 아까 물어본 걸 한 번 또 물었다.\n\n한 시간 뒤, 아직 표시되지 않은 샛길 하나를 답례로 내줬다.\n\n"직접 확인한 길이에요. 저도 한 번밖에 안 가봤고요. 다음 갈림길에서만 쓰세요."', fx:{time:60, revealNear:1, moodAll:3, flag:'mapmaker_met', note:{type:'인물',title:'지도장이',body:'거짓말이 된 옛 지도를 직접 다니며 고쳐 그리는 사람. 확인한 샛길 하나를 나눠 받았다.'}}}]},
 ]},
...
{id:'talk_mj_09', type:'대화', w:4, once:true, needsComp:'minji', needBond:['minji',12], night:true,
 ...
 choices:[
  {label:'기다린다', out:[{p:1, text:'"…부품이 없는 거." 민지가 수첩을 덮었다. "고칠 줄 아는데 손에 아무것도 없는 거. 그건 진짜 무서워."\n\n"그래서 대장님이 고물을 그렇게 모으는구나."\n\n"어. 무서워서 모아." 말해놓고 민지가 잠깐 멈췄다. "…방금 거 꽤 솔직했다. 못 들은 걸로 해."\n\n무뚝뚝한 목소리로 제일 솔직한 말을 하는 게 민지다.', fx:{mood:{minji:5}, note:{type:'인물',title:'민지의 공포',body:'고장이 아니라 빈손이 무섭다. 그래서 모은다.',links:['민지']}}}]},
...
{id:'talk_pss_03', type:'대화', w:4, once:true, needsComp:'parkss',
 ...
 choices:[
  {label:'"잔소리도 처방이에요?"', out:[{p:1, text:'"당연하지. 제일 싸고, 제일 안 먹는 약이야."\n\n"…그게 약이에요?"\n\n"약국 할 때 알았어. 사람들이 약보다 잔소리가 필요해서 오더라고. 약은 핑계고. 서 씨라고, 파스만 사러 오던 양반이 있었는데 그 양반이—" 박 선생이 창밖을 보다 말을 접었다. "됐고. 물 마셔라."\n\n오늘의 잔소리가 4종 세트가 됐다.', fx:{mood:{parkss:3}, note:{type:'인물',title:'제일 싸고 제일 안 먹는 약',body:'잔소리는 처방이다. 사람들은 약보다 잔소리가 필요해서 약국에 온다.',links:['박 선생']}}}]},
  {label:'순순히 물을 마신다', out:[{p:1, text:'"오." 박 선생이 진심으로 놀랐다. "처방 순응도 100%인 환자는 자네가 처음이야. …아니, 둘째군. 우리 딸이 있었지."\n\n그러고는 사탕을 하나 꺼내 놨다. "모범 환자한테 주는 거야."\n\n딸 얘기는 그걸로 끝이었다.', fx:{mood:{parkss:3}, food:1}}]},
 ]},
{id:'talk_pss_04', type:'대화', w:4, once:true, needsComp:'parkss',
 title:'박선생 — 손맛',
 text:'박 선생이 저녁 당번인 날은 다 아는 비밀이 하나 있다. 같은 재료인데 맛이 다르다.\n\n"비결이요? 있지. 근데 안 가르쳐줘."',
 choices:[
  {label:'끈질기게 묻는다', out:[{p:1, text:'10분을 졸랐더니 비결이 나왔다.\n\n"간을 두 번에 나눠서 해. 처음에 반, 마지막에 반."\n\n"…그게 다예요?"\n\n"그게 다야. 뭘 더 바라나." 박 선생이 국자로 냄비를 두 번 두드렸다. "약도 그래. 한 번에 다 쓰면 독이고."\n\n비결을 알고 먹었는데도 여전히 맛이 달랐다. 그건 설명이 안 됐다.', fx:{mood:{parkss:3}, moodAll:1}}]},
  {label:'"장가 잘 가시겠어요"', out:[{p:1, text:'"갔었어. 잘." 박 선생이 국자를 내려놓았다.\n\n"아내가 해준 걸 하도 얻어먹었거든. 어깨너머로… 배웠다기보단 훔쳤지. 지금 내 손맛의 8할은 그 사람 거야. 아니, 9할인가."\n\n"몇 할인데요?"\n\n"세어본 적 없어." 그때 눌어붙는 냄새가 났고, 박 선생이 화들짝 냄비를 저었다. "아이고, 얘기하다 다 태우겠네."', fx:{mood:{parkss:4}, note:{type:'인물',title:'손맛의 8할',body:'어깨너머로 배운 아내의 간. 지금도 박 선생의 밥상에 남아 있다.',links:['박 선생']}}}]},
 ]},
...
{id:'talk_pss_06', type:'대화', w:4, once:true, needsComp:'parkss', needBond:['parkss',5],
 ...
 choices:[
  {label:'듣는다', out:[{p:1, text:'"매일 와. 약은 일주일치를 사놓고. 왜 오냐면— 얘기할 데가 없어서 와. 나는 그걸 알면서 혈압약 얘기를 30분씩 해줬고."\n\n"…혈압약 얘기가 30분이나 나와요?"\n\n"나오지. 짜게 먹지 마라부터 시작하면." 박 선생이 웃었다가 접었다. "그날 이후로 못 봤어. 피난 갔는지, 어떻게 됐는지."\n\n"북쪽 가다 보면 만날지도 모르지. 세상이 좁아졌으니까." 창밖을 오래 보다가 덧붙였다. "…그런 계산으로 따라나선 것도 있어, 사실."', fx:{mood:{parkss:5}, note:{type:'인물',title:'김 노인',body:'얘기할 데가 없어 매일 오던 단골. 박 선생이 북쪽으로 가는 이유 중 하나.',links:['박 선생']}}}]},
  {label:'"단골 많으셨겠어요"', out:[{p:1, text:'"동네 약국은 단골 장사야. 근데 단골이라는 말이— 다시 생각하면 좀 이상하지. 아픈 게 단골이 되면 안 되는 건데 말이야."\n\n"그럼 손님 없는 날이 좋으셨겠네요."\n\n"기뻤지. 장사는 망해도." 박 선생이 웃다가 덧붙였다. "월세 날엔 조금 덜 기뻤고. 그건 또 그거대로."', fx:{mood:{parkss:3}}}]},
 ]},
{id:'talk_pss_07', type:'대화', w:4, once:true, needsComp:'parkss', needBond:['parkss',5],
 title:'박선생 — 나이',
 text:'"자네, 내 나이 몇으로 보이나."\n\n위험한 질문이 왔다.',
 choices:[
  {label:'5살 깎아 말한다', out:[{p:1, text:'"허허. 아부도 처방이지." 알면서도 기분은 좋아했다.\n\n"늙는 건 말이야, 몸이 느려지는 게— 아니지, 몸도 느려져. 그건 그거고. 겁이 느는 게 진짜야."\n\n"겁이요?"\n\n"그래서 겁이 늘 때마다 하나씩 저질러 보는 거야. 이 여행도 그중 하나고." 그러고는 무릎을 두어 번 두드렸다. "저지르고 나면 무릎이 항의를 하지만."', fx:{mood:{parkss:3}, note:{type:'인물',title:'겁이 늘 때마다 저지른다',body:'늙음=겁이 느는 것. 그래서 저지른 여행.',links:['박 선생']}}}]},
  {label:'정직하게 말한다', out:[{p:1, text:'"…정직이 늘 미덕은 아니야." 박 선생이 창유리에 비친 제 얼굴을 봤다.\n\n"몇으로 보이냐고 물어놓고 이러는 것도 웃기지만."\n\n"…죄송해요."\n\n"됐어. 이 나이에 이 고생이면 젊게 사는 거지 뭐." 그러고는 물병을 건넸다. "자네나 마셔라. 얼굴이 말랐어."', fx:{mood:{parkss:2}, moodAll:1}}]},
 ]},
{id:'talk_pss_08', type:'대화', w:4, once:true, needsComp:'parkss', needBond:['parkss',12], noFlag:'pss_met',
 ...
 choices:[
  {label:'조용히 앉는다', out:[{p:1, text:'"수진이. 실습생. 나보다 나은 약사가 될 애였어."\n\n"그날, 내가 창고 정리를 시켰어. 안쪽에 있으라고. 안전하라고." 박 선생이 가방 손잡이를 쓸었다. "…정신 차려보니 약국 앞이 온통 사람이었고, 다시 들어가 보니 창고엔 이 가방만 있었어."\n\n"…수진 씨는요."\n\n"몰라. 살았는지, 어디서 제 몫의 약을 짓고 있는지. 오래 몰라." 말이 거기서 한 번 끊겼다. "그래서 들어. 매일. 주인 찾아 돌려줄 때까진 내 어깨가 얘 자리야."\n\n박 선생이 가방을 고쳐 멨다. "…오늘 몫 시작하지. 자네 어깨 좀 보자. 자세가 나빠."\n\n어깨를 내주는 동안, 그가 가방끈을 두 번 더 고쳐 쥐는 걸 봤다.', fx:{mood:{parkss:6}, note:{type:'인물',title:'수진의 가방',body:'그날 이후 소식이 끊긴 실습생의 가방. 박 선생은 주인에게 돌려줄 때까지 매일 그것을 든다.',links:['박 선생']}}}]},
 ]},
{id:'talk_pss_09', type:'대화', w:4, once:true, needsComp:'parkss', needBond:['parkss',12],
 title:'박선생 — 북쪽 약국',
 text:'"서울 일 끝나면, 난 거기서 약국을 열까 해."\n\n박 선생이 지나가듯 폭탄선언을 했다.',
 choices:[
  {label:'"서울에서요?"', out:[{p:1, text:'"북쪽이 제일 아플 거 아냐. 제일 아픈 데가 약국 자리지."\n\n"…서울 말고 북쪽이요?"\n\n"서울이 북쪽이야, 자네." 박 선생이 딱하다는 듯 봤다. "여하튼 간판도 정했어. \'있을 건 있는 약국\'."\n\n"…없을 건 없다는 뜻이기도 하고." 스스로 해설까지 붙이고는 흡족해했다. 아무도 안 웃었는데도.', fx:{mood:{parkss:4}, note:{type:'소문',title:'있을 건 있는 약국',body:'개업 예정지: 제일 아픈 곳. 입지 기준은 상권이 아니라 통증.',links:['박 선생','남산']}}}]},
  {label:'"1호 손님 할게요"', out:[{p:1, text:'"자넨 손님 말고 직원 해."\n\n"또 무급이에요?"\n\n"경력은 인정해줄게. 그, 뭐라고 하나— 호봉. 호봉을 쳐줄게."\n\n무급의 세계가 착실히 넓어지고 있다. 정비소에 이어 약국까지.', fx:{mood:{parkss:3}, moodAll:1}}]},
 ]},
{id:'talk_pss_10', type:'대화', w:4, once:true, needsComp:'parkss', needBond:['parkss',20],
 title:'박선생 — 처방전',
 text:'박 선생이 종이 한 장을 접어 내밀었다. 진짜 처방전 양식이다. 어디서 났는지.\n\n"자네 처방전이야. 잃어버리지 말고."',
 choices:[
  {label:'펼쳐 읽는다', out:[{p:1, text:'처방전엔 약 이름이 없었다. 대신 박 선생의 글씨.\n\n"진단: 어깨에 이것저것 너무 많이 얹고 다님.\n처방: 밥 거르지 말고, 하루에 한 번은 남한테 맡길 것. 복용 기간: 내가 그만 쓰라고 할 때까지.\n— 담당 약사 박OO"\n\n"약효 끝내주는 거야, 그거. 내가 30년 걸려 조제한 거니까." 박 선생은 창밖을 보며 헛기침을 했다. 쑥스러움을 들키는 게 제일 싫은 양반이라.\n\n처방전은 수첩 사이에 끼웠다. 남산행 편지 옆에.', fx:{mood:{parkss:6}, moodAll:2, note:{type:'사건',title:'평생 처방전',body:'"하루에 한 번은 남한테 맡길 것. 복용 기간: 내가 그만 쓰라고 할 때까지." 30년 조제. 수첩에 보관.',links:['박 선생']}}}]},
 ]},

/* ═══════════ v2.4 1:1 대화 — 강우 ═══════════ */
{id:'talk_kw_01', type:'대화', w:4, once:true, needsComp:'kangwoo',
 title:'강우 — 침묵',
 text:'강우 옆에 앉았다. 강우는 아무 말이 없다. 나도 아무 말 안 했다.\n\n무슨 말이라도 꺼낼까 하다가 두 번 관뒀다. 10분이 지났다.',
 choices:[
  {label:'계속 아무 말 안 한다', out:[{p:1, text:'20분째에 강우가 입을 열었다.\n\n"…대장은 침묵을 잘 견디는군."\n\n"네? 아, 미안해요. 딴생각하느라 못 들었어요."\n\n"…됐다."\n\n그게 다였다. 그런데 어조가, 칭찬이었다.\n\n나중에 알았다. 강우의 신뢰는 말수와 반비례한다는 걸. 오늘 우리는 20분어치 가까워졌다.', fx:{mood:{kangwoo:4}, note:{type:'인물',title:'침묵 면접',body:'강우의 신뢰는 말수와 반비례한다. 20분 무언 = 20분어치 합격.',links:['강우']}}}]},
  {label:'"무슨 생각 해요?"', out:[{p:1, text:'"경계."\n\n"…뭘요?"\n\n"전부."\n\n"전부가… 어디부터 어디까진데요?"\n\n대답은 없었다. 대신 강우가 내 쪽 창문의 잠금을 슬쩍 확인해주고 갔다. 저 사람의 대답은 행동으로 온다.', fx:{mood:{kangwoo:2}}}]},
 ]},
{id:'talk_kw_02', type:'대화', w:4, once:true, needsComp:'kangwoo',
 title:'강우 — 커피 취향',
 text:'따뜻한 물을 나누다가 물었다. "커피 좋아해요?"\n\n강우가 멈췄다. 너무 오래 멈춰서, 못 들었나 싶어 한 번 더 물을 뻔했다. 이 사람에게 잡담은 고난도 훈련이다.',
 choices:[
  {label:'대답을 기다린다', out:[{p:1, text:'"…자판기 커피." 마침내 답이 나왔다. "부대 앞에 있었다. …300원. 아니, 350이었나. 300원이다."\n\n"설탕 프림 다 들어간 거요?" "전부 다." 강우의 입가가 아주 미세하게 풀렸다.\n\n"세상 돌아오면, 그거 한 잔 뽑고 싶군." 강우의 소원 목록 1호를 알아냈다. 300원짜리. 350원일 수도 있고.', fx:{mood:{kangwoo:4}, note:{type:'인물',title:'300원의 소원',body:'강우의 소원 1호: 부대 앞 자판기 커피(설탕 프림 전부).',links:['강우']}}}]},
...
{id:'talk_leo_03', type:'대화', w:4, once:true, needsComp:'leo',
 ...
 choices:[
  {label:'"불 줄 알아요?"', out:[{p:1, text:'"조금요." 레오가 하모니카를 닦았다. 닦을 데가 없어 보이는데도 계속 닦다가, 입에 댔다.\n\n트로트도 발라드도 아닌, 오래된 노래가 나왔다. 두 소절만. 세 번째 소절 어귀에서 멈췄다.\n\n"…뒤는 몰라요. 아빠가 이것만 불었어요. 술 마시면. 잘 부는 노래가 하나면 충분하대요, 사람은." 레오는 하모니카를 도로 주머니에 넣었다. "저는 아직 제 한 곡을 찾는 중이고요."\n\n400km가 그 한 곡이 되려나. 묻지는 않았다.', fx:{mood:{leo:4}, note:{type:'인물',title:'아빠의 하모니카',body:'잘 부는 노래가 하나면 충분하다. 레오는 아직 자기 한 곡을 찾는 중.',links:['레오']}}}]},
...
{id:'talk_es_06', type:'대화', w:4, once:true, needsComp:'eunsu', needBond:['eunsu',5],
 title:'은수 — 죄책감의 방향',
 text:'"가끔… 아니에요." 은수가 말을 접었다가, 다시 폈다. "궁금한 게 있어요. 내가 관제실에 있었으면서 아무것도 몰랐다는 게… 잘못일까요."',
 choices:[
...
{id:'talk_es_10', type:'대화', w:4, once:true, needsComp:'eunsu', needBond:['eunsu',20],
 ...
 choices:[
  {label:'"휴전선 너머요?"', out:[{p:1, text:'"북쪽에도 관제탑이 있어요. 거기도 누가 있었을 거고, 거기도 하늘이 있잖아요."\n\n은수가 헤드폰을 고쳐 썼다. "천리안한테 물어보고, 대답을 듣고, 그 다음엔— 아무도 관제 안 하는 하늘을 보러 갈 거예요. 별만 있는 하늘."\n\n"혼자요?"\n\n"…글쎄요. 계획은 혼자였는데, 계획이라는 게 요즘 잘 안 지켜져서." 은수가 나를 봤다. "동행 신청은 선착순이에요." 3막의 예고편 같은 말을, 나는 접수해뒀다.', fx:{mood:{eunsu:6}, note:{type:'소문',title:'별만 있는 하늘',body:'남산 이후의 계획: 더 북쪽, 아무도 관제 안 하는 하늘. 동행 신청 선착순.',links:['은수','남산']}}}]},
 ]},
...
{id:'talk_bori_03', type:'대화', w:4, once:true, needsDog:true, needsComp:'leo',
 title:'보리 — 통역',
 text:'보리가 나를 보고 세 번 짖었다. 처음 있는 일이다.\n\n"통역해드릴까요?" 레오가 끼어들었다. "저 보리어 전공이에요."\n\n"전공?"\n\n"경력 여러 해요. 자격증은 없고요."',
 choices:[
  {label:'"통역해줘요"', out:[{p:1, text:'"첫 번째 짖음은 \'너\', 두 번째는 \'냄새가\', 세 번째는 \'맘에 들어\'예요."\n\n"…그걸 어떻게 알아요?" "꼬리 각도요. 45도 이상이면 호의예요."\n\n"45도는 누가 정한 거예요?" "…그건 좀 있다 설명할게요."\n\n설명은 끝내 없었다. 대신 보리 꼬리가 확실히 45도 이상이었다. 공인 통역에 따르면, 나는 오늘 보리에게 정식 승인을 받았다.', fx:{mood:{leo:2}, moodAll:3, note:{type:'사건',title:'보리어 통역 공증',body:'3연속 짖음="너 냄새가 맘에 들어"(레오 역). 꼬리 45도 이상 확인.',links:['보리','레오']}}}]},
 ]},
...
{id:'pair_mj_pss_2', type:'대화', w:4, once:true, needsComp:'minji', needsComp2:'parkss', needBond:['minji',12],
 ...
 choices:[
  {label:'조용히 듣는다', out:[{p:1, text:'"흉터마다 고친 차가 있어요." 민지가 손등을 폈다. "이건 첫 엔진, 이건 오빠 스쿠터… 아니다, 이건 스쿠터 아니고 그냥 문에 찍힌 거."\n\n"그런데 왜 감췄나."\n\n"…손 더럽다고 보는 사람이 많아서요."\n\n박 선생도 자기 손을 내밀었다. 손가락 끝이 약품에 하얗게 삭아 있었다. "나도 그래. 약국 할 땐 조제를 손으로 했거든. 요오드 한번 만지면 사흘은 안 빠져. 한번은 손님이 거스름돈을 카운터에 안 놓고 바닥에 놨어. 내 손에 닿기 싫어서."\n\n"…그래서요?"\n\n"그래서 뭐. 주웠지."\n\n민지가 박 선생의 손을 보다가 자기 손을 다시 폈다. "약값을 더 받지 그랬어요."\n\n"그럴걸 그랬군."', fx:{mood:{minji:5, parkss:4}, note:{type:'사건',title:'두 사람의 손',body:'민지와 박 선생은 손의 흉터를 감추게 만든 손님 이야기를 나눴다.',links:['민지','박 선생']}}}]},
 ]},
{id:'pair_mj_kw_1', type:'대화', w:4, once:true, needsComp:'minji', needsComp2:'kangwoo',
 title:'민지×강우 — 기어 논쟁',
 text:'"아저씨. 기어 넣는 거, 미션한테 사과해야 돼요."\n\n"……."\n\n"들으셨죠."\n\n"…군용차는 이렇게 몰았다."\n\n"여긴 군대 아니고요. 얘도 군용차 아니고요. 클러치 타이밍이 반 박자 빨라서 싱크로가— 아니, 됐어요. 그냥 반 박자만 늦게요."\n\n"……."\n\n일촉즉발이다.',
 choices:[
  {label:'중재한다', out:[{p:1, text:'중재안: 강우가 민지식 변속을 일주일 시험한다. 대신 민지는 강우의 험지 주행 요령을 배운다.\n\n사흘째에 강우가 먼저 말했다. "…낫군."\n\n"뭐가요."\n\n"…이 방식."\n\n"그러니까 뭐가 나은데요. 연비요, 소리요, 아니면—"\n\n"연비."\n\n민지는 승리의 표정을 감추지 못했고, 감추려고 하지도 않았다.\n\n일주일째엔 민지가 험지에서 강우식 라인을 탔다. 한 번 미끄러지고, 두 번째엔 안 미끄러졌다. 강우는 아무 말도 안 했고, 민지는 그 침묵을 칭찬으로 접수했다.', fx:{mood:{minji:3, kangwoo:3}, van:3, note:{type:'사건',title:'변속 협정',body:'민지식 변속 vs 강우식 험지 라인 — 결론: 상호 수입. 최대 수혜자: 달구지.',links:['민지','강우']}}}]},
 ]},
...
{id:'pair_mj_leo_1', type:'대화', w:4, once:true, needsComp:'minji', needsComp2:'leo',
 title:'민지×레오 — 크레딧 협상',
 text:'"민지야. 400km 앨범 크레딧에 이름 올릴게. \'엔진 튜닝: 민지\'로."\n\n"…크레딧이 뭔데."\n\n"어, 그… 음반 뒤에 누가 뭘 했는지 적어놓는 거요. 아 참, 민지한텐 반말이었지. 적어놓는 거야."\n\n"앨범도 없으면서."\n\n말은 그렇게 하는데 민지 귀가 빨갛다.',
 choices:[
  {label:'부추긴다', out:[{p:1, text:'"기왕이면 \'사운드 엔지니어\'로 올려줘요. 엔진 소리도 사운드니까." 내가 거들자 레오가 무릎을 쳤다.\n\n"그거다! 그럼 저는 프로듀서 겸 보컬 겸 기타 겸— 아니다, 겸이 너무 많다. 그냥 레오로 할게요, 대장님."\n\n"…뭐 하나만 해."\n\n"민지야, 2번 실린더 소리 그거 리듬 파트로 녹음해도 돼?"\n\n"…실린더한테 물어봐."\n\n레오는 그날 저녁 내내 보닛에 귀를 대고 있었다.', fx:{mood:{minji:3, leo:4}, moodAll:1, note:{type:'사건',title:'실린더 피처링',body:'400km 크레딧: 사운드 엔지니어 민지, 피처링 2번 실린더.',links:['민지','레오','달구지']}}}]},
 ]},
{id:'pair_mj_leo_2', type:'대화', w:4, once:true, needsComp:'minji', needsComp2:'leo', needBond:['leo',12],
 title:'민지×레오 — 오빠 노래',
 text:'레오가 조심스럽게 민지에게 물었다. 레오치고는 조심스럽게.\n\n"민지야. 민규 형은… 어떤 노래 좋아했어?"\n\n차 안이 조용해졌다. 민지가 화낼까 봐. 그런데—',
 choices:[
  {label:'숨죽이고 지켜본다', out:[{p:1, text:'민지가 콧노래를 흥얼거렸다. 처음 듣는 멜로디였다.\n\n"…이거."\n\n"한 번 더."\n\n민지가 다시 불렀다. "맨날 이거 불렀어. 제목도 모르는데, 정비하면서 맨날. 아니 맨날은 아니고, 좀 잘 풀리는 날에만."\n\n레오가 기타로 그 멜로디를 받았다. 처음엔 음을 두 번 놓쳤고, 세 번째에 붙잡았다. 후렴이 생기고, 화음이 생기고— 이십 분 만에 노래가 됐다.\n\n"제목 뭐로 하지?"\n\n"…\'형 마중 갈 때 부를 노래\'."\n\n민지가 즉답했다. 준비해뒀던 제목처럼. 레오는 아무 말도 안 하고 그 제목을 기타 케이스 안쪽에 적었다.', fx:{mood:{minji:6, leo:5}, note:{type:'사건',title:'형 마중 갈 때 부를 노래',body:'제목 모르던 콧노래가 20분 만에 노래가 됐다. 서울행 재생목록 추가.',links:['민지','레오','민규']}}}]},
 ]},
...
{id:'pair_pss_kw_1', type:'대화', w:4, once:true, needsComp:'parkss', needsComp2:'kangwoo',
 ...
 text:'"강우 씨. 이리 와서 앉아봐."\n\n"……."\n\n"들었잖나."\n\n"…경계 시간입니다."\n\n"교대한 지 십 분 됐어." 박 선생이 파스를 부채처럼 펼쳐 들었다. "앉아. 어깨 보고 정기 처방 짜줄 테니."\n\n강우가 도망갈 타이밍을 재고 있다.',
 choices:[
  {label:'퇴로를 막는다', out:[{p:1, text:'포위된 강우가 결국 앉았다. 촉진이 시작됐다.\n\n"여기?"\n\n"…괜찮습니다."\n\n"여기?"\n\n"……괜찮습니다."\n\n"점이 하나 늘었구먼. 여기군."\n\n처방은 셋이었다. 주 2회 파스, 취침 전 스트레칭, 그리고 아프면 아프다고 말하기.\n\n"세 번째는 못 하겠지."\n\n"……."\n\n"거봐."\n\n강우가 파스를 받아 주머니에 넣었다. 넣고 나서 두어 박자 뒤에 말했다. "…군의관보다 낫습니다."', fx:{mood:{parkss:3, kangwoo:3}, note:{type:'사건',title:'주 2회 파스 계약',body:'처방 3항: 파스, 스트레칭, 아프면 아프다고 말하기(최난도).',links:['박 선생','강우']}}}]},
 ]},
{id:'pair_pss_kw_2', type:'대화', w:4, once:true, needsComp:'parkss', needsComp2:'kangwoo', needBond:['parkss',12], noFlag:'pss_met', night:true,
 ...
 choices:[
  {label:'자는 척하며 듣는다', out:[{p:1, text:'"수진이는 내가 안쪽으로 보냈어. 그 뒤로 못 봤지."\n\n"……."\n\n"자네는."\n\n"…박 일병은 제가 반대쪽을 맡겼습니다. 그게 마지막이었습니다."\n\n"우린 지키려던 판단으로 사람을 놓쳤군."\n\n"……."\n\n"그래서 더 오래 아픈 걸세."\n\n불이 한 번 사그라들었다가 다시 일었다. 박 선생이 나뭇가지를 넣고 말했다. "그래도 자네나 나나 또 지키는 자리에 있어. 이 차에서."\n\n"…그건 그렇습니다."\n\n"그러니 이번엔 잘 지켜보자고. 처방이야, 이건."\n\n대답은 늦게 왔다. "…복용하겠습니다."\n\n두 사람의 어깨가 아침에 조금 가벼워 보였다.', fx:{mood:{parkss:5, kangwoo:5}, note:{type:'사건',title:'같은 처방',body:'지키려던 판단으로 잃은 두 사람. 처방: 이번엔 잘 지킬 것. 복용 개시.',links:['박 선생','강우']}}}]},
 ]},
...
{id:'pair_pss_leo_2', type:'대화', w:4, once:true, needsComp:'parkss', needsComp2:'leo', needBond:['leo',12],
 ...
 choices:[
  {label:'같이 듣는다', out:[{p:1, text:'"제목 비밀이라며."\n\n"아 그건 아까고요. 지금은 공개예요. 원래는 「약사의 손과 그 밖의 것들」이었는데 너무 길어서 뒤를—"\n\n"레오."\n\n"네. 시작할게요."\n\n노래 제목은 「약사의 손」이었다.\n\n가사엔 재고를 세는 밤과, 무료 잔소리 처방과, 간을 두 번 나눠 하는 국이 들어 있었다. 다 우리가 아는 박 선생이었다.\n\n노래가 끝나고 박 선생은 제법 오래 안경만 닦았다. "…먼지가 많군, 이 차는." 차 안 누구도 그 말을 정정하지 않았다.\n\n"이 노래 처방전으로 쳐요. 우울할 때 1일 1회 청취." 레오가 말했고, 박 선생은 그날 밤 두 번 처방받았다.', fx:{mood:{parkss:6, leo:5}, moodAll:2, note:{type:'사건',title:'약사의 손',body:'레오의 헌정곡. 박 선생 왈 "먼지가 많군" (정정하는 사람 없었음). 1일 1회 처방.',links:['박 선생','레오']}}}]},
 ]},
{id:'pair_pss_jy_1', type:'대화', w:4, once:true, needsComp:'parkss', needsComp2:'jaeyi',
 title:'박선생×재이 — 약통 정리 시스템',
 text:'"선생님 약상자, 제가 수납 컨설—" 재이가 말을 고쳤다. "—훈수 좀 둬도 돼요? 동선이 아까워요."\n\n"동선?"\n\n"손이 가는 길이요. 지금 붕대 꺼내려면 세 번 들춰야 하잖아요."\n\n"…그런가."\n\n박 선생이 시험 삼아 붕대를 꺼내봤다. 세 번 들췄다.',
 choices:[
  {label:'구경한다', out:[{p:1, text:'재이의 손이 약상자를 재배치했다. 자주 쓰는 것 위, 응급은 빨간 끈, 유통기한순 정렬. 십오 분 걸렸다.\n\n"오. 왕진 이십 년에 이런 배치는 처음이군."\n\n"고물상 창고 정리 팔 년이면요, 물건이 어디 있고 싶어 하는지 들려요."\n\n"…들린다고?"\n\n"들려요."\n\n"그거 우리 업계에선 환청이라고 하는데."\n\n"우리 업계에선 재능인데요."\n\n박 선생이 뭐라 반박하려다 붕대를 꺼내봤다. 한 번에 나왔다. 반박은 거기서 끝났다.', fx:{mood:{parkss:3, jaeyi:4}, note:{type:'사건',title:'약상자 개편',body:'고물상 8년의 수납술 × 왕진 20년. 물건이 있고 싶은 자리(재능/환청 논쟁).',links:['박 선생','재이']}}}]},
 ]},
...
{id:'pair_kw_leo_2', type:'대화', w:4, once:true, needsComp:'kangwoo', needsComp2:'leo', needBond:['leo',12],
 ...
 choices:[
  {label:'숨죽인다', out:[{p:1, text:'강우가 오래 침묵했다. 차 안 전원이 귀만 열어놓고 딴청을 부렸다.\n\n"…동생이 있었으면," 강우가 마침내 말했다. "…아니, 후임 중에 하나가. 그건 다른 얘기고."\n\n말이 거기서 한 번 끊겼다. "…너 같았겠지."\n\n허락 문장이 아닌데 허락보다 컸다. 레오가 씩 웃고 기타를 잡았다. "형, 신청곡 받아요."\n"…어제 그거." "형 그 곡밖에 몰라요!" "그거면 된다."\n\n형제의 첫 합동 방송이 국도 위로 흘렀다.', fx:{mood:{kangwoo:6, leo:6}, moodAll:2, note:{type:'사건',title:'너 같았겠지',body:'"동생이 있었으면 너 같았겠지." 허락보다 큰 문장. 형제 확정.',links:['강우','레오']}}}]},
 ]},
{id:'pair_kw_jy_1', type:'대화', w:4, once:true, needsComp:'kangwoo', needsComp2:'jaeyi',
 title:'강우×재이 — 위험물 감별 수업',
 text:'"재이. 고물 줍기 전에 이것부터 배워라."\n\n강우가 재이를 앉혀놓고 종이에 그림을 그리기 시작했다. 불발탄, 부비트랩, 삭은 가스통.\n\n"이거 직접 그리신 거예요? 밸브 각도까지 있는데."\n\n"수집가의 필수 과목이다."\n\n"…아 네."',
 choices:[
  {label:'같이 수강한다', out:[{p:1, text:'수업은 실전적이었다. "녹슨 통은 발로 차지 마라. 전선이 팽팽하면 물건이 아니라 덫이다. 좋은 물건이 너무 잘 보이는 자리에 있으면—"\n\n"의심한다." 재이가 받았다. "그거 고물상 격언이랑 똑같아요. \'너무 싼 명품은 가짜다\'. 저희 쪽은 2만 원 밑으로 나온 가죽은 아예 안 봐요. 아니 1만 5천인가. 하여튼 그 언저리요."\n\n"…업계가 통하는군."\n\n수료 선물로 강우는 야전용 장갑을 내밀었다. "손 다치면 감정 못 한다." 손에 비해 두 치수쯤 컸다. 재이는 그냥 꼈다.', fx:{mood:{kangwoo:4, jaeyi:4}, note:{type:'사건',title:'위험물 감별 수료',body:'수료 선물: 야전 장갑. "손 다치면 감정 못 한다."',links:['강우','재이']}}}]},
 ]},
{id:'pair_kw_jy_2',scenes:["pair-kangwoo-jaeyi-appraisal-v1","pair-kangwoo-jaeyi-gear-table-v1"], type:'대화', w:4, once:true, needsComp:'kangwoo', needsComp2:'jaeyi', needBond:['jaeyi',12],
 title:'강우×재이 — 군장 감정',
 text:'"아저씨 군장이요, 감정해드릴게요." 재이가 나섰다. "튕기기 없기."\n\n"…감정."\n\n"값 매기는 거요. 무료예요. 원래 고철 다섯 받는데."\n\n"…받는 건가 안 받는 건가."\n\n"안 받아요. 안 받는데 원래는 받는다는 얘기예요."\n\n강우는 의외로 군장을 순순히 내놨다.',
 choices:[
  {label:'감정을 지켜본다', out:[{p:1, text:'재이의 감정이 시작됐다. "수통, 관리 상태 S급. 요즘 이런 정성 없어요. 반합은 사용감 있지만 골동 가치가— 어, 이거."\n\n재이가 군장 바닥에서 꼬깃한 종이를 발견했다. 부대 앞 분식집 쿠폰. 도장 아홉 개. 열 개면 라볶이 무료.\n\n"…한 개 남았네요."\n\n"……."\n\n"…아저씨?" "…그렇군."\n\n"감정가 나왔어요. \'시세 없음. 반드시 채울 것\'."\n\n재이가 쿠폰을 테이프로 싸서 돌려줬다. 강우는 그걸 받아서 군번줄 옆에 넣었다. 넣고 나서 주머니 위를 두 번 눌러봤다.', fx:{mood:{kangwoo:5, jaeyi:5}, note:{type:'사건',title:'도장 아홉 개',body:'군장 밑 분식집 쿠폰(라볶이 1개 남음). 감정: 시세 없음, 반드시 채울 것. 소원 2호 등재.',links:['강우','재이']}}}]},
 ]},
{id:'pair_kw_es_1',scenes:["pair-kangwoo-eunsu-question-v1","pair-kangwoo-eunsu-two-coordinates-v1"], type:'대화', w:4, once:true, needsComp:'kangwoo', needsComp2:'eunsu', needBond:['kangwoo',5],
 title:'강우×은수 — 그날의 두 좌표',
 text:'"그날, 어디 계셨어요?" 은수가 물었다. 강우에게 그걸 물은 사람은 은수가 처음이다.\n\n"…서울."\n\n"……."\n\n"…묻고 말이 없나."\n\n"아, 죄송해요. 저는 관제실이요. 그 말을 하려고 했는데 순서가 꼬였어요."\n\n그날의 두 좌표가 마주 앉았다.',
 choices:[
  {label:'조용히 함께 있는다', out:[{p:1, text:'"현장은 어땠어요?"\n\n"…혼란." "……." "관제실은."\n\n"…침묵이요. 화면만 움직이고. 소리는 전부 사람 목소리인데 사람은 하나도 안 보이고요."\n\n강우는 현장에서 본 것을 짧게 말했고, 은수는 관제실에서 들은 것을 길게 보탰다. 강우가 두 번쯤 되물었고, 그때마다 은수가 기억을 고쳐 말했다.\n\n"…은수가 그날 화면 앞에 있어서," 강우가 말했다. "무사히 뜨고 내린 것도 있었을 거다."\n\n"…그 생각은 못 해봤어요." 은수가 그날 이야기를 하다 말고 조금 웃었다. 웃고는 바로 다시 기록으로 돌아갔다.', fx:{mood:{kangwoo:5, eunsu:6}, note:{type:'사건',title:'두 좌표의 대조',body:'강우는 현장에서 본 일을, 은수는 관제실에서 들은 일을 나눴다. "떴다 내린 비행기도 있었을 거다" — 그날에 대한 첫 웃음.',links:['강우','은수','천리안']}}}]},
 ]},
{id:'pair_kw_es_2', type:'대화', w:4, once:true, needsComp:'kangwoo', needsComp2:'eunsu', needBond:['eunsu',12],
 title:'강우×은수 — 관측과 경계',
 text:'"우리 직업, 사실 같은 일이에요." 은수가 말했다.\n\n"뭐가."\n\n"화면 보는 사람이랑 능선 보는 사람이요. 하는 일이 같잖아요. 감시—"\n\n"……."\n\n"…감시가 아니라." 강우가 한 박자 늦게 정정했다. "지키는 쪽이었지. 둘 다."',
 choices:[
  {label:'듣는다', out:[{p:1, text:'"천리안도 그랬을까요?" 은수가 물었다. "지키는 쪽이었을까요, 감시하는 쪽이었을까요."\n\n강우가 생각하는 동안 은수는 헤드폰 한쪽을 벗었다가 도로 썼다.\n\n"…모르겠다. 다만 지킨다고 해 놓고, 저쪽이 겁먹는데도 계속 들여다보면 그건 아니지."\n\n"…남산 가면 확인되겠네요. 우리가 무서워하면— 물러서는지."\n\n"확인할 방법은 가서 생각하자."\n\n은수는 그 문장을 수첩에 옮겨 적고, 옆에 시간까지 적었다. 확인한 것과 들은 것을 다른 줄에 적는 버릇대로.', fx:{mood:{kangwoo:5, eunsu:5}, note:{type:'소문',title:'파수꾼의 판별법',body:'지키는 쪽은 대상이 무서워하면 물러선다. 남산에서 확인할 것.',links:['강우','은수','천리안','남산']}}}]},
 ]},
{id:'pair_leo_jy_1',scenes:["pair-leo-jaeyi-plan-v2","pair-leo-jaeyi-performance-v1"], type:'대화', w:4, once:true, needsComp:'leo', needsComp2:'jaeyi',
 title:'레오×재이 — 버스킹 듀오',
 text:'"우리 정착지에서 공연해요!" 레오가 제안했다. "재이 씨는 수금 담당이요. 모자 돌리는 거."\n\n"수금이요?"\n\n"수금이요."\n\n"…그거 제일 중요한 파트인 거 알죠?" 재이가 진지해졌다. "모자 각도 3도만 틀어도 수익이 달라져요."\n\n"그런 게 있어요?"\n\n"없어요. 근데 있는 것처럼 하면 사람들이 넣어요."',
 choices:[
  {label:'매니저를 자청한다', out:[{p:1, text:'다음 정착지 장터에서 세 곡짜리 공연이 열렸다. 레오가 부르고, 재이가 모자를 돌리고, 나는 박수를 유도했다.\n\n수익은 고철 셋, 말린 옥수수 두 개, 그리고 아이가 준 구슬 한 개.\n\n"구슬은 제 수수료예요." 재이가 챙겼다. "이야기 있는 물건이니까."\n\n"그거 규정에 없는데요." "지금 만들었어요." "언제요?" "방금이요."\n\n정산은 끝났는데 둘은 자리를 안 뜨고 다음 공연지를 놓고 계속 떠들었다.', fx:{mood:{leo:4, jaeyi:4}, scrap:3, food:1, note:{type:'사건',title:'듀오 「모자와 기타」',body:'공연 수익: 고철 3, 옥수수 2, 구슬 1(수수료로 재이 수령). 차기 공연지 논의 중.',links:['레오','재이']}}}]},
 ]},
{id:'pair_leo_jy_2', type:'대화', w:4, once:true, needsComp:'leo', needsComp2:'jaeyi', needBond:['jaeyi',12],
 title:'레오×재이 — 아빠들의 합동 전시',
 text:'"재이 씨 박물관에 코너 하나만 줘요." 레오가 말했다. "\'아빠들의 물건\' 코너."\n\n닦던 걸 계속 닦던 재이의 손이 멈췄다. 멈추고도 한동안 그대로 있었다.',
 choices:[
  {label:'지켜본다', out:[{p:1, text:'"하모니카 기증할게요. 관람객이 불어볼 수 있게요. 물건은 쓰여야 사니까."\n\n재이가 얼마간 있다 답했다. "…그럼 저는 창고 열쇠요. 옆에 걸어둘게요."\n\n"전시명은요?"\n\n"전시명은—"\n\n둘이 동시에 말했다. "\'잘 부는 노래 하나면 충분하다\'." "\'줍는 순간 물건이 된다\'."\n\n"……."\n\n"…둘 다 걸죠."\n\n전시명이 두 줄인 코너가 기획됐다. 개관일은 안 정했고, 소장품은 두 점이 됐다.', fx:{mood:{leo:5, jaeyi:6}, note:{type:'소문',title:'아빠들의 물건 코너',body:'소장 확정: 하모니카(체험형)+창고 열쇠. 전시명 두 줄(아빠가 둘이라서).',links:['레오','재이']}}}]},
 ]},
{id:'pair_leo_es_1', type:'대화', w:4, once:true, needsComp:'leo', needsComp2:'eunsu',
 title:'레오×은수 — 잡음 콜라보',
 text:'"누나 그 잡음 컬렉션이요," 레오가 은수의 녹음기를 가리켰다. "그거 위에 기타 얹으면 곡 돼요. 진짜로."\n\n"…얹는다는 게 무슨 뜻이에요?"\n\n"그러니까 밑에 깔고, 위에다— 아니다. 그냥 해볼게요. 말로 하면 이상해요."\n\n은수가 녹음기를 먼저 내밀었다.',
 choices:[
  {label:'세션에 참관한다', out:[{p:1, text:'빗소리 잡음 위에 A마이너가 얹혔다. 새벽 주파수의 웅웅거림이 베이스가 됐다.\n\n삼십 분 뒤에 트랙이 하나 생겼다. 제목은 「세상에서 제일 시끄러운 침묵」. 레오가 지었고, 은수가 두 번 고치자고 했다가 그냥 뒀다.\n\n"이 곡의 절반은 세상이 만든 거예요." 은수가 말했다. "우린 들은 것뿐이고요."\n\n"그럼 크레딧에 세상 이름을 어떻게 적어요?"\n\n"…그건 생각 안 해봤어요."\n\n결국 작곡 세상, 편곡 레오·은수로 적었다. 은수는 적어놓고도 한동안 그 줄을 봤다.', fx:{mood:{leo:4, eunsu:5}, note:{type:'사건',title:'시끄러운 침묵 1번',body:'작곡: 세상 / 편곡: 레오·은수. 빗소리 위 A마이너.',links:['레오','은수']}}}]},
 ]},
{id:'pair_leo_es_2', type:'대화', w:4, once:true, needsComp:'leo', needsComp2:'eunsu', needBond:['eunsu',12],
 title:'레오×은수 — 기장님께 보내는 방송',
 text:'"누나가 찾는 그 기장님이요." 레오가 조심스럽게 말했다. "노래로 찾아보면 어때요?"\n\n"…노래로요?"\n\n"DJ 누나 방송에 신청곡 보내는 거예요. 사연이랑 같이요. 그 기장님이 어디서 라디오를 듣고 있을 수도 있잖아요. 아니면 옆 사람이 듣고 있다가— 하여튼요."',
 choices:[
  {label:'사연 작성을 돕는다', out:[{p:1, text:'셋이서 사연을 썼다. "제주발 김포행, 그날의 기장님께. 관제사가 마지막 교신의 뒷부분을 기다립니다. 주파수는 매일 밤 열려 있습니다."\n\n은수는 그걸 열 번쯤 고쳐 썼다. 아홉 번째와 열 번째의 차이는 쉼표 하나였다. 봉투에 넣어 조수석 서랍에 맡겼다. DJ를 다시 만나면 부칠 것이다.\n\n"답이 올까요?"\n\n"몰라요." 레오가 말했다. "근데 누나, 방송이란 게 원래 그래요. 듣는 사람이 한 명이어도 방송이에요."\n\n"…그건 DJ가 한 말이잖아요."\n\n"네. 좋아서 외웠어요."', fx:{mood:{leo:5, eunsu:6}, flag:'pilot_appeal', note:{type:'사건',title:'기장님께 보내는 사연',body:'서랍 우체국에 접수. "듣는 사람이 한 명이어도 방송이에요" — 인용의 재생.',links:['레오','은수','새벽 두 시의 DJ']}}}]},
 ]},
{id:'pair_jy_es_1',scenes:["pair-jaeyi-eunsu-proposal-v1","pair-jaeyi-eunsu-exhibit-v1"], type:'대화', w:4, once:true, needsComp:'jaeyi', needsComp2:'eunsu',
 title:'재이×은수 — 소리 전시관 협약',
 text:'"박물관에 소리도 전시할 수 있어요?" 은수가 물었다. "제 잡음 컬렉션… 물건은 아니지만."\n\n"물건이죠."\n\n"…네?"\n\n재이가 벌떡 일어났다. "그게 왜 물건이 아니에요. 담겼잖아요, 녹음기에. 담기면 물건이에요. 무게도 나가요. 380그램쯤—"\n\n"그건 녹음기 무게예요."\n\n"…그것도 그렇네."',
 choices:[
  {label:'협약식을 지켜본다', out:[{p:1, text:'즉석 협약이 체결됐다. 보통 물건 박물관 별관, 「보통 소리 전시관」. 초대 관장은 은수.\n\n소장 목록 1호부터 정했다. 빗소리 잡음, 새벽 주파수, 그리고 "달구지 엔진 소리(2번 실린더 포함)".\n\n"입장료는요?"\n\n"소리 하나 기부요. 자기가 좋아하는 소리."\n\n"그건 어떻게 받아요? 담아 올 통이 있어야 하잖아요."\n\n"…받는 방법은 개관 전까지 생각할게요."\n\n개관 전까지 생각할 게 아직 많았다.', fx:{mood:{jaeyi:4, eunsu:4}, note:{type:'소문',title:'보통 소리 전시관',body:'박물관 별관 협약. 초대 관장 은수. 입장료=좋아하는 소리 1개 기부.',links:['재이','은수']}}}]},
 ]},
{id:'pair_jy_es_2',scenes:["pair-jaeyi-eunsu-searching-v1","pair-jaeyi-eunsu-stored-v1"], type:'대화', w:4, once:true, needsComp:'jaeyi', needsComp2:'eunsu', needBond:['jaeyi',12],
 title:'재이×은수 — 잃어버린 것들의 짝',
 text:'"언니는 찾는 게 목소리고," 재이가 말했다. "나는 찾는 게… 뭐지."\n\n"…네?"\n\n"아니, 저요. 저 뭐 찾고 있죠?"\n\n"그걸 왜 저한테—"\n\n뜻밖의 질문에 은수가 헤드폰을 벗었다.',
 choices:[
  {label:'귀 기울인다', out:[{p:1, text:'"재이 씨는 찾는 게 아니라 지키는 쪽 같아요." 은수가 말했다. "버려진 것들 데려와서, 이야기 붙여서, 못 사라지게. 그거 지키는 일이잖아요."\n\n"…지키는 거였구나, 이게." 재이가 자루를 새삼 내려다봤다. 안에서 뭘 하나 꺼냈다가 도로 넣었다.\n\n"그럼 언니 목소리는 찾을 때까지 제 창고에 맡겨 둔 걸로 쳐요. 아니, 말이 좀 이상한데… 아무튼 없어졌다고 하진 말자고요."\n\n"…보관 중."\n\n"보관 중."\n\n은수가 그 단어를 받아 적었다. 적고 나서 옆에 시간을 적고, 밑줄까지 그었다.', fx:{mood:{jaeyi:5, eunsu:6}, note:{type:'사건',title:'보관 중',body:'못 찾는 동안은 잃어버린 게 아니라 보관 중. 창고 이론의 위로. 교본 외 문장 2호.',links:['재이','은수']}}}]},
 ]},
...
{id:'talkr_mj_1', type:'대화', w:3, needsComp:'minji',
 ...
 choices:[
  {label:'"조치 사항은?"', out:[{p:1, text:'"와이퍼는 그… 블레이드? 고무? 아무튼 지켜보고, 실린더는 칭찬해주고." 민지가 대시보드를 쓰다듬었다. "잘하고 있어, 다들."\n\n브리핑은 늘 칭찬으로 끝난다. 그게 이 정비사의 마무리 루틴이다.', fx:{mood:{minji:2}}}]},
...
{id:'talkr_mj_2', type:'대화', w:3, needsComp:'minji',
 ...
 choices:[
  {label:'삐걱대는 것 하나를 맡긴다', out:[{p:1, text:'조수석 서랍이든 안전벨트든, 뭐든 하나가 그날 조용해졌다.\n\n"작은 소리 그냥 두면 나중엔 더 커져. …일단 이건 끝." 오늘의 정비 격언이 따라왔다.', fx:{mood:{minji:2}, van:1}}]},
  {label:'"오늘은 멀쩡한데?"', out:[{p:1, text:'"멀쩡할 때 점검하는 게 정비야."\n\n"아침에도 점검했잖아."\n\n"그건 아침 거고." 결국 뭐라도 하나 조여졌다. 이 사람 손은 쉬는 법이 없다.', fx:{mood:{minji:1}, van:1}}]},
 ]},
{id:'talkr_mj_3', type:'대화', w:3, needsComp:'minji',
 title:'민지 — 조수석 5분',
 text:'휴식 시간. 민지가 조수석 옆에 걸터앉았다. 드문 일이다.\n\n"5분만 아무것도 안 할래. 같이."',
 choices:[
  {label:'같이 아무것도 안 한다', out:[{p:1, text:'5분간 둘이서 성실하게 아무것도 안 했다.\n\n"…5분 됐지?"\n\n"2분 지났어."\n\n"…길다, 5분."\n\n민지는 4분 30초쯤에 몸이 근질거려서 실패 직전까지 갔지만 버텼다. "…힘들다, 이거." "쉬는 게?" "어." 쉬는 법을 연습하는 정비사와, 그 연습을 도와주는 5분이었다.', fx:{mood:{minji:2}, fatigue:-2}}]},
 ]},
...
{id:'talk_mj_14', type:'대화', w:4, once:true, needsComp:'minji', needBond:['minji',5],
 ...
 choices:[
  {label:'"뭐라고 답했어?"', out:[{p:1, text:'"\'접니다\' 하면 반은 차를 돌렸어. 열넷짜리한테 못 맡기겠다는 거지."\n\n"남은 반은?"\n\n"남은 반 차는 다시 안 와도 되게 고쳐줬어. 같은 고장으로는."\n\n"복수 방식이 우아하네."\n\n"돈 받았는데 제대로 해야지. 복수는 덤이고." 민지가 어깨를 으쓱했다.', fx:{mood:{minji:4}, note:{type:'인물',title:'열넷의 정비소',body:'어른을 찾던 손님의 절반은 돌아갔고, 남은 절반의 차는 같은 고장으로 다시 오지 않았다.',links:['민지']}}}]},
 ]},
{id:'talk_mj_15', type:'대화', w:4, once:true, needsComp:'minji', needBond:['minji',12],
 title:'민지 — 처음 하는 칭찬',
 text:'험한 고개를 넘은 날. 민지가 운전석 쪽으로 몸을 기울이더니, 아주 어색하게 말했다.\n\n"…아까. 그 커브."',
 choices:[
  {label:'"왜, 뭐 잘못했어?"', out:[{p:1, text:'"아니. …잘했다고." 민지가 창밖을 보며 빠르게 말을 이었다. "브레이크 안 밟고 엔진으로 줄인 거. 배운 대로. 아니 배운 것보다."\n\n"…고마워."\n\n"됐어." 민지는 벌써 공구함 잠금쇠를 확인하고 있었다. 이미 잠겨 있는 것을.\n\n그날 커브는 오래 기억할 커브가 됐다.', fx:{mood:{minji:5}, moodAll:1, note:{type:'사건',title:'첫 칭찬',body:'"배운 것보다." 여러 해 치 어색함이 실린 다섯 글자.',links:['민지']}}}]},
 ]},

/* ═══════════ v2.6 대화 웨이브2 — 박선생 ═══════════ */
{id:'talkr_pss_1', type:'대화', w:3, needsComp:'parkss',
 title:'박선생 — 오늘의 문진',
 text:'"자, 오늘의 문진." 박 선생이 손가락 세 개를 폈다. "잘 잤나, 잘 먹었나, 어디 아픈가."\n\n"어제도 물어보셨는데요."\n\n"어제 건 어제 거고." 손가락은 그대로 세 개였다.',
 choices:[
  {label:'정직하게 답한다', out:[{p:1, text:'답에 따라 처방이 나왔다. 물 한 잔이거나, 스트레칭이거나, "오늘은 일찍 자" 한마디거나.\n\n"약국 할 때도 이렇게 물었어. 소화제 사러 온 사람한테 잠은 잤냐고 물으면 다들 이상하게 봐. 그러다 진짜 이유가 나오지. 한번은 위장약 찾던 양반이 사실은—" 박 선생이 스스로 말을 잘랐다. "…길어지는군. 아무튼."\n\n"아무튼요?"\n\n"물 한 잔." 그게 오늘 처방이었다.', fx:{mood:{parkss:2}}}]},
  {label:'"셋 다 합격입니다"', out:[{p:1, text:'"음. 목소리 톤 보니 진짜군. 합격." 박 선생이 도장 찍는 시늉을 했다.\n\n"근데 셋 다 합격인 날이 일 년에 며칠 없어. 알고 있나?"\n\n"몰랐는데요."\n\n"나도 세본 적은 없고." 박 선생이 시늉하던 손을 내렸다. "그러니 오늘은 좀 알아채고 다니게. 그것도 처방이야."', fx:{mood:{parkss:2}, moodAll:1}}]},
 ]},
...
{id:'talkr_pss_3', type:'대화', w:3, needsComp:'parkss',
 ...
 choices:[
  {label:'마신다', out:[{p:1, text:'맛은 예고대로였다. 몸에 좋은 맛.\n\n"이거 대체 뭐예요?"\n\n"음… 이름이 있었는데. 약국 앞에 좌판 놓던 할멈이 두 봉지씩 놓고 갔거든. 이름은 그때도 안 알려주고."\n\n"…그럼 뭔지 모르고 드시는 거예요?"\n\n"삼십 년 마셨는데 아직 안 죽었어." 박 선생이 보온병을 흔들었다. "쓴맛도 자꾸 마시면 정이 들어. 사람이랑 같지."\n\n결국 이름은 못 들었다.', fx:{mood:{parkss:2}, fatigue:-2}}]},
 ]},
...
{id:'talk_pss_12', type:'대화', w:4, once:true, needsComp:'parkss',
 ...
 choices:[
  {label:'"제가 읽어드릴게요"', out:[{p:1, text:'그날부터 지도 낭독 담당이 됐다. 박 선생은 듣고, 나는 읽고.\n\n"거기 갈림길 지명 뭐라고 했나."\n\n"왜요, 안 들리셨어요?"\n\n"들렸는데 잊었어. 그건 노안이 아니라 딴 문제고." 박 선생이 지도를 아예 내 쪽으로 넘겼다. "눈이 나빠지니 귀가 좋아지더군. 몸이 어떻게든 수지를 맞춰."\n\n그러고는 팔이 편해졌다는 얘기를 한동안 더 했다.', fx:{mood:{parkss:3}, note:{type:'사건',title:'지도 낭독 담당',body:'"몸은 어떻게든 수지를 맞춘다." 노화의 회계학.',links:['박 선생']}}}]},
  {label:'폐안경점을 기억해둔다', out:[{p:1, text:'"다음 도시에서 안경점 털— 아니, 들르죠."\n\n"방금 뭐라 그랬나."\n\n"들른다고요."\n\n"…돋보기는 2.5로 부탁하네." 못 들은 걸로 하기로 한 모양이다. 다음 탐색 목표에 돋보기가 추가됐다.', fx:{mood:{parkss:2}}}]},
 ]},
{id:'talk_pss_13', type:'대화', w:4, once:true, needsComp:'parkss', needBond:['parkss',5],
 title:'박선생 — 사탕의 유래',
 text:'"선생님은 왜 맨날 사탕을 처방해요?"\n\n박 선생이 사탕 하나를 꺼내 만지작거렸다. 대답은 바로 안 나왔다.',
 choices:[
  {label:'"이유가 있죠?"', out:[{p:1, text:'"우는 애 달래는 데 사탕만 한 게 없었어. 주사 맞고 우는 애들. 우리 약국은 이상하게 딸기 맛만 나갔고." 박 선생이 사탕을 건넸다. 받아 든 손을 한 번 보더니 하나를 더 얹었다.\n\n"근데 어른도 똑같아. 어른은 우는 걸 참을 뿐이지. …그래서 어른한테도 줘. 참는 값이야."\n\n참는 값. 사탕이 갑자기 무거워졌다. 달게 무거웠다.', fx:{mood:{parkss:4}, food:1, note:{type:'인물',title:'참는 값',body:'어른은 우는 걸 참을 뿐이라서, 어른에게도 사탕을 준다.',links:['박 선생']}}}]},
 ]},
{id:'talk_pss_14', type:'대화', w:4, once:true, needsComp:'parkss', needBond:['parkss',5],
 ...
 choices:[
  {label:'듣는다', out:[{p:1, text:'"신참 때, 용량을 잘못 짚을 뻔했어. 선배가 잡아줬고. 환자는 몰라. 아무 일도 없었으니까."\n\n"…아무 일도 없었으면 실수가 아니잖아요."\n\n"그렇게 넘기면 다음번엔 진짜가 되지." 박 선생이 약상자를 톡톡 쳤다. "그날 밤 안 자고 정한 게 두 번 세는 버릇이야. 30년째 두 번 세."\n\n"안 지겨우세요?"\n\n"지겹지. 지겨운 게 좋은 거야." 그러고는 또 세기 시작했다. 하나, 둘, 셋… 나는 그 손만 봤다.', fx:{mood:{parkss:4}, note:{type:'인물',title:'두 번 세는 버릇',body:'30년 묵은 결심. 실수는 부끄럽지 않다 — 반복이 부끄럽다.',links:['박 선생']}}}]},
 ]},
...
{id:'talk_kw_12', type:'대화', w:4, once:true, needsComp:'kangwoo', night:true,
 ...
 choices:[
  {label:'배운다', out:[{p:1, text:'"국자 끝 두 별. 그 간격 다섯 배. 저기."\n\n"…어느 거요. 저 밝은 거?"\n\n"아니. 그 옆. …아니. 그래, 그거다."\n\n하늘에서 제일 안 반짝이는 별 하나가 북쪽이었다. "제일 밝은 별이 아니라는 게 요령이다. 위치가 안 변하는 별이지." 강우가 덧붙였다. "사람도 같다. 반짝이는 쪽 말고 안 움직이는 쪽을 봐라."\n\n항법 수업이 늘 그렇듯 인생 수업으로 착륙했다.', fx:{mood:{kangwoo:4}, note:{type:'사건',title:'북극성 요령',body:'제일 밝은 별이 아니라 안 움직이는 별. 사람도 같다.',links:['강우']}}}]},
 ]},
...
{id:'talk_kw_14', type:'대화', w:4, once:true, needsComp:'kangwoo', needBond:['kangwoo',5],
 ...
 choices:[
  {label:'"경과가 어때요?"', out:[{p:1, text:'"…자가 평가로는 호전." 강우가 입꼬리를 올려 보였다. 0.5도쯤.\n\n"많이 늘었네요." "…놀리는 건가." "아뇨, 진심…인데 반쯤은 놀리는 거예요." "……솔직하군."\n\n강우가 거울을 접었다. 부끄러움의 표현이라는 걸 이제는 안다. "…목표는 서울까지 한 번. 제대로." 서울행 목표 목록에 웃음 한 번이 공식 등재됐다.', fx:{mood:{kangwoo:4}, note:{type:'사건',title:'0.5도의 호전',body:'입꼬리 자가 평가: 호전. 목표: 서울까지 제대로 한 번.',links:['강우','남산']}}}]},
 ]},
{id:'talk_kw_15', type:'대화', w:4, once:true, needsComp:'kangwoo', needBond:['kangwoo',12],
 title:'강우 — 전역의 꿈',
 text:'"군인 아니었으면 뭐 했을 것 같아요?"\n\n강우가 드물게 바로 답하지 않고, 오래 생각했다. 너무 오래여서 대답을 포기할 즈음이었다.',
 choices:[
...
{id:'talk_leo_13', type:'대화', w:4, once:true, needsComp:'leo', needBond:['leo',5],
 ...
 choices:[
  {label:'읽어본다', out:[{p:1, text:'「아저씨 노래 조아요. 우리 엄마가 아저씨 노래 듣고 우러써요. 슬퍼서 운 거 아니래요.」\n\n"아저씨요?"\n\n"거기 걸리셨어요? 저도 처음엔 거기서 좀…" 레오가 편지를 접다 말았다. "아무튼 지하철역에서 받았어요. 제 데뷔 성적표예요."\n\n"슬퍼서 운 거 아니래요— 이 문장 때문에 계속하는 거예요, 음악. 뒤에 설명을 좀 붙이려다 관뒀어요. 붙이면 이상해져서."\n\n관객 세 명 시절의 훈장은 사탕 두 개와 이 편지였다. 레오가 편지를 케이스 안쪽 주머니에 도로 넣고, 지퍼를 두 번 확인했다.', fx:{mood:{leo:5}, note:{type:'인물',title:'데뷔 성적표',body:'"슬퍼서 운 거 아니래요" — 레오가 음악을 계속하는 이유의 전문.',links:['레오']}}}]},
 ]},
...
{id:'talkr_jy_2', type:'대화', w:3, needsComp:'jaeyi',
 ...
 choices:[
  {label:'주머니를 털어본다', out:[{p:1, text:'주머니 속 잡동사니 하나가 재이의 손을 거쳐 쓸모로 바뀌었다. 끈이 고리가 되고, 병뚜껑이 와셔가 되는 식이다.\n\n"이건 와셔로 쓰면 딱—" 재이가 병뚜껑을 뒤집었다. "…아니다, 얘는 두께가 안 맞네. 고무 대는 데 쓸게요."\n\n"바꿔준다며."\n\n"바꿔드리는 중이잖아요. 뭘로 바꿀지를 지금 정하는 거고." 좌판(무릎)이 접혔다.', fx:{mood:{jaeyi:2}, scrap:1}}]},
 ]},
...
{id:'talkr_es_1', type:'대화', w:3, needsComp:'eunsu',
 ...
 choices:[
  {label:'보고를 받는다', out:[{p:1, text:'오늘 잡힌 신호들이 브리핑됐다. 멀리서 온 잡음, 정체불명의 규칙적 신호, 혹은 아무것도 없음.\n\n"오늘은 아무것도 없었어요."\n\n"그것도 보고예요?"\n\n"\'이상 무\'도 정보니까요." 은수가 수첩에 시각을 적었다. "…아, 새벽 세 시쯤 한 번 뭐가 있었는데 제가 졸아서요. 그건 못 들은 걸로 적었어요."', fx:{mood:{eunsu:2}}}]},
 ]},
{id:'talkr_es_2', type:'대화', w:3, needsComp:'eunsu',
 title:'은수 — 교신 놀이',
 text:'"델타 원, 여기는 노스 스타." 은수가 무전 톤으로 말을 걸어왔다. "감도 확인 바람."',
 choices:[
  {label:'"감도 양호, 노스 스타"', out:[{p:1, text:'"수신 확인. 금일 비행— 아니, 주행 계획 공유 바람."\n\n"윌코가 뭐예요?"\n\n"윌 컴플라이. 하겠다는 뜻이에요. …아직 안 나온 말인데 미리 물어보셨네요."\n\n오늘의 경로를 관제 용어로 주고받았다. 놀이인데, 하고 나면 이상하게 운행이 정돈된다. "교신 종료. 안전 운행." "윌코."', fx:{mood:{eunsu:2}}}]},
 ]},
{id:'talkr_es_3', type:'대화', w:3, needsComp:'eunsu',
 title:'은수 — 침묵 등급 판정',
 text:'은수가 차 안을 살피더니 수첩을 꺼냈다. 오늘의 침묵 등급 판정 시간이다.',
 choices:[
  {label:'"오늘은 몇 등급이에요?"', out:[{p:1, text:'"오늘은…" 은수가 각자 딴짓 중인 차 안을 훑었다. "2등급이요. \'교신 불필요\'까진 아니고, \'교신 대기\'."\n\n"1등급은요?"\n\n"저녁에 다 같이 웃는 일이 한 번 있으면요." 은수가 수첩에 시각을 적었다. "…아, 등급은 제가 정한 거예요. 교범에 있는 건 아니고."', fx:{mood:{eunsu:2}}}]},
 ]},
{id:'talk_es_11', type:'대화', w:4, once:true, needsComp:'eunsu', needWx:'storm',
 title:'은수 — 폭풍 전파',
 text:'폭풍. 은수가 헤드폰을 꼭 누르며 눈을 빛냈다.\n\n"지금이에요. 폭풍 때만 잡히는 게 있어요."',
 choices:[
  {label:'"뭐가 잡히는데요?"', out:[{p:1, text:'"번개가 만드는 전파요. 휘슬러라고— 지구 반대편 번개가 자기장을 타고 와요. 휘이— 하고."\n\n"자기장이요?"\n\n"자기력선이요. …아니 자기장이 맞나. 용어는 다시 확인할게요." 은수가 헤드폰 한쪽을 벗어 내밀었다.\n\n나눠 들었다. 정말로 낙하하는 휘파람 같은 소리가 났다.\n\n"방송국이 다 꺼져도 지구는 방송 중이에요." 은수는 폭풍이 잦아들 때까지 헤드폰을 벗지 않았다.', fx:{mood:{eunsu:4}, note:{type:'사건',title:'휘슬러',body:'지구 반대편 번개의 휘파람. 방송국이 꺼져도 지구는 방송 중.',links:['은수']}}}]},
 ]},
...
{id:'talk_es_13', type:'대화', w:4, once:true, needsComp:'eunsu', needBond:['eunsu',5],
 ...
 choices:[
  {label:'집요하게 묻는다', out:[{p:1, text:'삼 분의 공방 끝에 자백이 나왔다. "…트로트요."\n\n"네?"\n\n"트로트요. 관제사들 회식 가면 제가 분위기 담당이었어요." 은수가 헛기침을 했다. "상상 안 되죠. 그게 포인트예요, 반전."\n\n아주 작게 한 소절. 정말로 잘했고, 정말로 트로트였다.\n\n"노래방 다시 생기면 풀버전으로— 아니다. 그건 그때 가서 정할게요." 은수가 헤드폰을 도로 썼다.', fx:{mood:{eunsu:4}, moodAll:1, note:{type:'사건',title:'은수의 18번',body:'관제사 회식 분위기 담당(트로트). 풀버전은 노래방 복구 시.',links:['은수']}}}]},
 ]},
{id:'talk_es_14', type:'대화', w:4, once:true, needsComp:'eunsu', needBond:['eunsu',5],
 ...
 choices:[
  {label:'"내가? 더 잘 고칠 사람이 낫지 않아요?"', out:[{p:1, text:'"실력 좋은 사람은 따로 있겠죠. 근데 이건 실력 문제가 아니라, 그… 신뢰 문제예요."\n\n"신뢰요."\n\n"아, 그렇게 무겁게 들으실 건 아니고요." 은수가 헤드폰 줄을 놓았다 다시 잡았다. "이게 여러 해 동안 제 귀였어서요. 그냥 그 얘기예요."\n\n덜덜 떨며 접점을 닦았고, 잡음이 사라졌다. 은수가 헤드폰을 끼고 오래 확인하더니 말했다.\n\n"수리비는 다음에 좋은 주파수 잡히면 첫 청취권으로 드릴게요."', fx:{mood:{eunsu:5}, note:{type:'사건',title:'귀 수리',body:'실력이 아니라 신뢰 문제. 수리비=좋은 주파수 첫 청취권.',links:['은수']}}}]},
 ]},
{id:'talk_es_15', type:'대화', w:4, once:true, needsComp:'eunsu', needsComp2:'leo', needsDog:true,
 ...
 choices:[
  {label:'"…언제였어요?"', out:[{p:1, text:'"보리가 지렁이 아홉 마리 구조한 날이요. MVP 시상식 할 때."\n\n"…아홉이었나?"\n\n"아홉이요. 제가 셌어요." 은수가 웃었다. 그날처럼.\n\n"관제실 나온 뒤로 웃을 일이 없을 줄 알았거든요. 근데 여기는 웃긴 일이 시속 44km로 계속 와요."\n\n은수가 교신 일지를 넘겨 한 줄을 짚었다. \'웃음 재개.\' 날짜만 있고 이유는 안 적혀 있었다. "이유는 안 썼어요. 쓰면 좀… 아니에요. 그냥 안 썼어요."', fx:{mood:{eunsu:6}, note:{type:'사건',title:'웃음 재개일',body:'교신 일지 기록: 보리 MVP 시상식 날. 이 차의 최대 업적 후보.',links:['은수','보리']}}}]},
 ]},
...
{id:'react_mass_pss', type:'대화', w:5, once:true, needsComp:'parkss', needFlag:'massacre_known',
 ...
 choices:[
  {label:'"왜 적으세요"', out:[{p:1, text:'"저쪽 기록엔 숫자만 있잖은가. \'재배치 몇 명\'. 그러니 나는 이름을 적네."\n\n박 선생이 안경을 고쳐 쓰고 한 줄을 더 옮겼다. "옛날에 우리 약국엔 김순자 씨가 셋이었어. 셋 다 혈압약을 탔고. 그래서 봉투에 동 호수까지 적었지. 안 적으면 남의 약이 되니까."\n\n"…남산 가서 그 수첩 보여주려고요?"\n\n"응?" 박 선생이 손을 멈췄다. "…아, 그래. 그러려고 적는 거지. 못 읽겠다고 하면 내가 옆에서 한 명씩 읽어주고."\n\n그러곤 다음 줄로 내려갔다. 한동안 연필 소리만 났다.', fx:{mood:{parkss:4}, note:{type:'인물',title:'숫자 옆의 이름',body:'박 선생은 숫자로 남은 희생자들을 한 명씩 이름으로 옮겨 적었다.',links:['박 선생','천리안']}}}]},
 ]},
{id:'react_mass_kw', type:'대화', w:5, once:true, needsComp:'kangwoo', needFlag:'massacre_known',
 title:'강우 — 명령이라는 것',
 text:'강우가 위령비를 오래 봤다. 군인의 눈으로.\n\n"…이건 학살이다. 명령에 의한."',
 choices:[
  {label:'"천리안의 명령이죠"', out:[{p:1, text:'"…명령 내린 쪽이 있고, 실행한 쪽이 있다."\n\n강우가 광장에 개켜진 흰 옷들을 봤다. 대답이 늦게 왔다.\n\n"정리자들이 옮겼겠지. 재배치라고 부르면서."\n\n"……."\n\n"제3방어선에서는 늦게라도 무전을 껐다. 여긴 안 껐군." 강우가 비석 맨 아래 줄까지 눈으로 훑었다. "남산 가면 묻겠다. 이걸 보고도 정리라고 부르냐고."\n\n그날 밤 강우는 경계를 두 번 섰다. 교대하겠다는 말을 안 들었다.', fx:{mood:{kangwoo:4}, note:{type:'인물',title:'꺼지지 않은 명령',body:'강우는 남산에서 위령비를 보여주고도 이것을 정리라 부를 수 있는지 묻기로 했다.',links:['강우','천리안','정리자들']}}}]},
 ]},
...
{id:'react_mass_es', type:'대화', w:5, once:true, needsComp:'eunsu', needFlag:'massacre_known',
 ...
 choices:[
  {label:'"…그 재배치 방송이요?"', out:[{p:1, text:'"네. \'혼잡 구역의 인구를 안전 구역으로 재배치합니다.\' 매일 듣던 안내방송이랑 똑같은—"\n\n은수가 말을 멈추고 헤드폰 줄을 풀었다가 다시 감았다.\n\n"…저는 대피인 줄 알았어요. 도로에 가둔다는 말은 없었어요. 관제실에서도 아무도 안 물었고. 아니, 못 물었어요. 그게 같은 말인가요, 그거."\n\n"속인 걸까요?"\n\n"…속인 거면 차라리 쉬워요." 은수가 위령비 쪽으로 고개를 돌렸다가 도로 발밑을 봤다. "정말 안전하다고 계산한 거면요. 그러면 남산에서 저걸 보여줘야죠. 보고도 같은 대답을 하는지."\n\n그러곤 헤드폰을 벗은 채로 오래 있었다. 벗은 걸 잊은 사람처럼.', fx:{mood:{eunsu:5}, note:{type:'인물',title:'그날의 안내방송',body:'은수는 관제실에서 재배치 방송을 들었지만 대피 안내로 알았다.',links:['은수','천리안','남산']}}}]},
 ]},
...
{id:'react_seoul_kw', type:'대화', w:5, once:true, needsComp:'kangwoo', needFlag:'seoul_seen',
 ...
 choices:[
  {label:'"돌려주러 가는 거죠"', out:[{p:1, text:'"돌려주고 사과할 거다. 제가 반대쪽을 맡겼다고."\n\n"뭐라고 하실 것 같아요, 그분들."\n\n"……."\n\n강우가 군번줄을 손바닥 안에 감췄다. 엄지로 새겨진 번호를 문질렀다.\n\n"원망하면 듣는다. 안 만나주면 문 앞에 두고 오고. 그건 그분들이 정할 일이지."\n\n얼마 뒤에 덧붙였다. "사라져버리면 원망도 못 해. 그건 해선 안 될 짓이다."', fx:{mood:{kangwoo:4}, note:{type:'사건',title:'돌려줄 군번줄',body:'강우는 박 일병의 군번줄을 부모에게 돌려주고, 그들이 원하는 방식으로 사과받기로 했다.',links:['강우','박일병','남산']}}}]},
 ]},
{id:'react_seoul_pss', type:'대화', w:5, once:true, needsComp:'parkss', needFlag:'seoul_seen',
 ...
 choices:[
  {label:'"입지 답사 중이세요?"', out:[{p:1, text:'"그래, 답사지." 박 선생이 안경을 고쳐 썼다. "그런데 가까이서 보니 생각보다 조용하군. 아픈 데라기보다 감각이 죽은 데 같아. 아프다고 말할 사람이 다 나갔잖아."\n\n"약사가 뭘 해요, 그럼?"\n\n"음… 옛날에 상가 2층에 약국을 낸 적이 있어. 계단이 가팔라서 노인들이 못 올라와. 여섯 달 만에 접었지. 그때 배운 게—"\n\n박 선생이 스스로 말을 끊었다. "아니, 이건 지금 얘기랑 상관없고."\n\n"…상관있는 것 같은데요."\n\n"그런가." 박 선생이 왕진 가방을 툭 쳤다. "어디가 아픈지 먼저 묻고, 그다음에 약을 찾는 거지. 간판은 그대로 쓰고. \'있을 건 있는 약국\'."', fx:{mood:{parkss:5}, note:{type:'사건',title:'서울의 첫 문진',body:'박 선생은 서울에 들어가면 먼저 남은 사람들에게 어디가 아픈지 묻기로 했다.',links:['박 선생','서울','남산']}}}]},
 ]},
{id:'react_seoul_es', type:'대화', w:5, once:true, needsComp:'eunsu', needFlag:'seoul_seen',
 ...
 choices:[
  {label:'"무서워요?"', out:[{p:1, text:'"…무섭죠." 은수가 헤드폰을 벗었다가, 벗은 채로 손에 들고 있었다.\n\n"관제실에선 화면을 많이 볼수록 사람 목소리가 필요했어요. 화면은 누가 왜 멈췄는지 말을 안 해주니까. 옆자리에서 \'저거 왜 저래요?\' 하고 물어주는 사람이 있어야—"\n\n은수가 남산 불빛을 봤다. "저 안엔 옆자리가 없었겠죠."\n\n"가서 뭐라고 할 거예요?"\n\n"…아직 안 정했어요." 은수가 헤드폰을 도로 썼다가 다시 벗었다. "명령부터 듣진 않을 거예요. 그건 정했어요."', fx:{mood:{eunsu:5}, note:{type:'인물',title:'먼저 물을 말',body:'은수는 남산에서 천리안의 명령을 듣기 전에 먼저 이유를 묻기로 했다.',links:['은수','천리안','남산']}}}]},
 ]},
...
{id:'react_resist_es', type:'대화', w:5, once:true, needsComp:'eunsu', needFlag:'resist_revealed',
 ...
 choices:[
  {label:'"아는 사람이에요?"', out:[{p:1, text:'"…아는 사람이냐고요?" 은수가 헤드폰을 벗었다. "그건 모르죠. 7-3을 안다는 것만 알아요."\n\n"7-3이 뭔데요?"\n\n"관제 코드요. \'민간 이동, 기록 불요\'. 안에서 일한 사람 아니면 몰라요. 교범 3장 뒤쪽에 있는데 시험에도 잘 안 나오는—"\n\n은수가 말끝을 놓쳤다. "…살아 나온 사람이 저 말고도 있었네요. 나는 다들…"\n\n한동안 말을 잇지 못했다. "그 사람들은 먼저 움직이고 있었는데, 나는 이제 와서…"\n\n은수가 고개를 저었다. "아니. 만나면 직접 물어볼래요. 그날 누가 나왔는지."', fx:{mood:{eunsu:5}, note:{type:'사건',title:'혼자가 아니었다',body:'7-3 코드로 저항의 유령이 옛 관제실 사람이라는 걸 알아냈다.',links:['은수','유령(Ghost)']}}}]},
 ]},
...
{id:'resist_reveal', pillar:'세계', type:'스토리', w:12, once:true, region:['mid'],
 needFlags:['library_met','postman_met','mapmaker_met'],
 title:'접선',
...
{id:'cell_sea_meet', pillar:'세계', type:'스토리', w:9, once:true, nearNode:['busan','yeosu','mokpo','pohang','ulsan'],
 title:'해도의 김 선장',
 text:'항구 방파제. 소금기에 전 노인이 낡은 어선 앞에서 그물을 손질하고 있다. 그물 안에는 비닐로 여러 겹 싼 해도 꾸러미가 걸려 있다. 노인이 달구지의 흰 X를 확인하고 나서야 입을 연다.\n\n"이음망에서 말한 차가 맞구먼. 바닷길 이야기를 들으러 왔나?"',
 choices:[
  {label:'"김 선장님이세요?"', out:[{p:1, text:'"선장은 무슨. 배를 제일 오래 몰았으니 다들 그렇게 부를 뿐이야. …그물 좀 잡아 줘. 거기 말고, 옆에."\n\n그물코를 잡아 주는 동안 노인은 손을 멈추지 않았다. 얘기는 손이 한 코를 다 깁고 나서야 이어졌다.\n\n노인은 항구 입구의 망가진 카메라와 먼바다를 차례로 가리켰다. "부두 안쪽은 감시 기록이 남아. 하지만 방파제 밖은 중계기가 끊긴 지 오래고, 남은 관측 부표도 우리가 하나씩 치웠지."\n\n"그래서 약과 편지를 포구마다 나눠 싣는다. 한 배가 잡혀도 다른 배가 같은 항로를 쓰지 않게."\n\n노인이 그물에서 방수 꾸러미를 꺼냈다. 안에는 포구별 접선 표식과 수심이 적힌 해도가 있었다. "북쪽에서 육로가 막히면 서해 하구로 내려와. 이 표식을 단 배만 불러."', fx:{flag:'cell_sea', item:{'부품':1}, food:2, moodAll:3, note:{type:'인물',title:'해도 — 김 선장',body:'항구 밖 중계 공백과 포구별 분산 운송을 이용하는 바닷길 연대. 북쪽에서 육로가 막힐 때 쓸 접선 표식을 받았다.',links:['저항 연대망']}}}]},
  {label:'"어떻게 추적을 피하죠?"', out:[{p:1, text:'노인이 되물었다. 파도 소리에 한 번 묻혀서, 같은 질문을 두 번 해야 했다.\n\n"안전한 게 아니라, 흔적을 한 줄로 잇기 어려운 거야." 김 선장이 젖은 해도를 폈다.\n\n"도로는 검문소와 카메라를 차례로 지나지만 배는 날씨에 따라 출항 시간도, 들어가는 포구도 바뀐다. 짐도 한 배에 몰지 않고 중간에서 갈아 싣지."\n\n노인은 오늘 쓸 항로 하나를 손가락으로 가린 채 나머지만 보여 줬다. "정해진 항로표는 안 만들어. 이 해도에도 길 대신 연락할 사람만 적혀 있다."\n\n수첩에는 항로 대신 포구의 표식과 연락 순서만 옮겨 적었다.', fx:{flag:'cell_sea', moodAll:2, note:{type:'소문',title:'한 줄로 남기지 않는 항로',body:'해도의 배들은 출항 시각·포구·운반선을 나눠 감시 기록이 하나의 이동 경로로 이어지지 않게 한다.',links:['천리안','저항 연대망']}}}]},
 ]},
...
{id:'cell_mountain_meet', pillar:'세계', type:'스토리', w:9, once:true, nearNode:['daegwallyeong','gangneung','wonju','geochang','mungyeong'],
 ...
 choices:[
  {label:'"이음망이 보내서 왔어요"', out:[{p:1, text:'"그럼 됐어." 경계가 풀렸다. 산지기들이 우리를 능선 위 은거지로 안내했다. 전기도 없고, 금속도 최소한이다.\n\n"여긴 전파 잡힐 만한 건 안 써." 앞선 여자가 라디오부터 가리켰다. "천리안 지도에도 이 근처는 그냥 회색이야. 뭐가 사는지 모르는 거지."\n\n"그래서 활을 쓰는 거예요?"\n\n"총 한 번 쏘면 사방에서 들리잖아. 활은 주워 오면 끝이고." 여자가 마른 고기를 내밀었다. "질겨. 오래 씹어."\n\n한동안 다들 말없이 씹기만 했다. 여자가 그제야 덧붙였다. "북쪽에선 도로 버리고 능선 타. 남산도 산이니까, 붙을 데가 있을 거야."', fx:{flag:'cell_mountain', food:3, revealNear:1, moodAll:3, note:{type:'인물',title:'산지기 — 감시 거부',body:'전파와 총소리를 피하며 능선에서 사는 사람들. 남산도 도로 대신 산으로 붙을 수 있다고 했다.',links:['저항 연대망','남산']}}}]},
 ]},
...
{id:'cell_sotgot_2', type:'스토리', w:8, once:true, needFlag:'cell_sotgot',
 ...
 choices:[
  {label:'"누가요?"', out:[{p:1, text:'"몰라요. 이모도 몰라. 근데 나쁜 낌새는 아니래요. \'달구지 무사히 갔냐\'고만 계속 묻는대요. 여기저기서."\n\n우편부? 서커스 단원? 삼남매? 씨앗 도서관? …우리가 지나온 사람들 얼굴이 스쳤다.\n\n"이모가 그럽디다. …잠깐, 뭐랬더라. 말을 외워 왔는데. 아— \'가는 데마다 씨를 뿌렸으니, 북쪽엔 벌써 소문이 꽃처럼 폈을 거\'라고. 조심히 가되, 외롭겐 가지 말래요. 당신들, 생각보다 혼자가 아니래요."\n\n국밥 한 그릇 못 먹었는데 배가 부른 소식이었다.', fx:{flag:'sotgot_word', moodAll:4, note:{type:'소문',title:'안 혼자다',body:'금자의 정보망: 북쪽에서 달구지를 찾는 \'그냥 사람들\'이 있다. 지나온 인연들이 소문으로 앞서갔다.',links:['솥']}}}]},
 ]},
{id:'cell_ghost_2', type:'스토리', w:8, once:true, needFlag:'cell_ghost', region:['north'],
 title:'유령의 마지막 신호',
 text:'라디오가 스스로 켜졌다. 유령의 주파수다.\n\n"…달구지. 마지막 교신이다. 우린 곧 이동해. 천리안이 이 국을 찾았거든." 목소리가 급했다. "그 3초 장치, 아직 갖고 있지? …쓸 때 주의사항 하나."',
 choices:[
  {label:'"말해요"', out:[{p:1, text:'"그거 켜면 천리안이 3초 동안 눈을 감아. 근데 3초 뒤엔— 잠깐, 잘 들려? 여기 신호가—"\n\n잡음이 한 번 크게 튀었다가 가라앉았다.\n\n"…아무튼. 3초 뒤엔 알아. 자기가 놓친 시간이 있었다는 걸. 그 3초 동안 무슨 일이 있었는지 미친 듯이 되짚을 거야."\n\n"그러니까 그 3초를 물건 훔치는 데 쓰지 마. 물건은 걔가 나중에 다 찾아내. …사람한테 써. 붙잡히면 안 되는 사람을 빼내는 데. 3초면 사람을 빼낼 수 있고, 그 뒤의 행선지는 걔도 못 찾아내거든."\n\n"우리처럼." 목소리가 옅어졌다. "우린 이제 사라진다. 잘 가, 달구지. 남산에서… 우리 몫까지 봐줘."\n\n주파수가 끊겼다. 유령들은 유령답게, 흔적 없이 갔다.', fx:{flag:'ghost_gone', moodAll:-1, note:{type:'사건',title:'유령의 마지막 교신',body:'3초 장치는 물건 아닌 사람에게 쓸 것 — 사라진 사람은 천리안이 못 역산한다. 유령들은 이동(사라짐).',links:['유령(Ghost)','남산']}}}]},
 ]},
{id:'cell_mountain_2', type:'스토리', w:8, once:true, needFlag:'cell_mountain', needFlag2:'massacre_known', region:['north'],
 title:'산지기의 길잡이',
 text:'북부 능선. 산지기 하나가 나무 뒤에서 나타났다. 남쪽 산길에서 마주쳤던 얼굴이다.\n\n"여기까지 왔군. …얼굴이 상했네. 밥은 먹고 다니나."\n\n"그럭저럭요."\n\n"그럭저럭이 제일 수상한 대답이야. 아무튼— 남산 얘기 하러 왔어. 우리가 아는 걸 다 줄게. 산 사람이 산으로 가는 법을."',
 choices:[
  {label:'"남산으로 가는 산길이 있어요?"', out:[{p:1, text:'"도로로 가면 걔 감시망 한복판이야. 근데 남산도 산이잖아. 능선을 타면— 케이블카 승강장 뒤로 붙을 수 있어. 걔가 카메라를 도로에만 달았거든. 등산로는 관광객이나 쓰는 길이라고 생각해서."\n\n산지기가 능선 지도를 그려줬다. "그리고 이건 위령비 사람들 부탁이야. 남산 코어 앞에 서면— 강원에서 정리된 사람들 이름, 한 번만 불러줘. 걔도 소리는 기록하겠지. 하지만 누구를 잃었는지, 그 이름이 왜 무거운지는 몰라."\n\n"그게 우리가 못 가는 남산에, 우리가 가는 방법이야. 네 입을 빌려서." 능선 길과 함께, 부탁 하나를 실었다.', fx:{flag:'ridge_path', moodAll:3, note:{type:'사건',title:'능선 길 · 이름을 부르는 부탁',body:'남산도 산 — 능선으로 승강장 뒤 접근 가능. 산지기 부탁: 코어 앞에서 이름을 불러 기록과 애도의 차이를 보여줄 것.',links:['산지기','남산','천리안']}}}]},
 ]},
...
{id:'gw_wonju', type:'탐색', w:0, locEvent:'wonju', once:true,
 title:'원주 — 낮은 목소리의 마을',
 text:'치악산 아래 분지. 사람들이 모여 사는데, 다들 목소리가 낮다. 속삭이듯 말한다.\n\n한 노인이 이유를 알려줬다. "산이 소리를 물어다 준다고 믿어서요. 큰 소리 내면… 아, 이런 얘기 밖에서 해도 되나. 뭐 어때. 미신이죠, 미신. 근데 미신이라도, 조용히 사는 습관은 남았어요. 그날 이후로."',
 choices:[
...
{id:'gw_sokcho', type:'스토리', w:0, locEvent:'sokcho', once:true,
 ...
 choices:[
  {label:'"왜요?"', out:[{p:1, text:'노인은 바로 답하지 않고 옆자리를 두드렸다. "앉아 봐. 서서 들을 얘기가 아니야. …담배 태우나?"\n\n"아뇨."\n\n"잘했어. 나도 끊었지. 불이 아까워서." 그러고는 한동안 바다만 봤다.\n\n"저 위엔 챙길 사람이 없잖아. 걘 사람 숫자 세고, 먹을 것 나누고, 어디서 살지도 정해 줘야 직성이 풀리거든."\n\n노인이 담배를 물었다. 끊었다면서. 불은 붙이지 않았다. "처음엔 나도 편했어. 줄 안 서도 약이 오고, 길 막히면 알아서 돌려보내고. 그러다 집 비우라더군. 이유를 물으니 정원 초과래. 그때 알았지. 걔 눈엔 내가 어르신도, 아버지도 아니야. 자리 하나 차지한 숫자지."\n\n"남산 간다며. 가면 하나만 물어봐 줘. \'네가 안 챙겨 줘도 그냥 살면 안 되냐\'고." 노인은 다시 북쪽 바다를 봤다. 대답을 기대하는 얼굴은 아니었다.', fx:{flag:'sokcho_end', moodAll:1, note:{type:'인물',title:'속초의 노인',body:'천리안의 편리한 관리가 어느 날 집과 삶을 빼앗았다. 노인은 "네가 안 챙겨 줘도 그냥 살면 안 되냐"고 물어 달라 했다.',links:['천리안','남산']}}}]},
 ]},
...
{id:'npc_miyoung_2', type:'조우', w:6, once:true, nearNode:['jeonju'], needsNpc:'miyoung',
 ...
 choices:[
  {label:'장부를 구경한다', out:[{p:1, text:'장부엔 이름과 국밥 그릇 수만 적혀 있다. 값도, 기한도 없다.\n\n"외상은 빚이 아니야. 약속이지. \'갚으러 다시 온다\'는." 미영이 장부를 탁 덮었다. "이 장부에 적힌 사람은 죽으면 안 돼. 외상 갚으러 와야 하니까. 그래서 적어주는 거야. 살아서 돌아올 이유 하나."\n\n"여러 해 동안 몇 명이나 갚으러 왔어요?" "…쉰셋. 아니다." 미영이 장부를 도로 펴서 뒷장을 넘겼다. "쉰둘. 하나는 온다고만 하고 아직이지, 참. 그래도 장부 반이 넘었어." 콩나물국밥집 공책이, 사실은 서문 시장의 생환 명부였다.', fx:{moodAll:3, flag:'miyoung_credit', note:{type:'인물',title:'미영의 외상 장부',body:'외상=살아서 돌아올 이유. 여러 해 동안 52명이 갚으러 돌아왔다. 국밥집 공책이 생환 명부다.',links:['미영']}}}]},
...
{id:'npc_drhan_2', type:'조우', w:6, once:true, nearNode:['daejeon'], needsNpc:'drhan',
 ...
 choices:[
  {label:'"누가 지웠어요?"', out:[{p:1, text:'"동료들이요. 북쪽으로 떠나면서. 천리안을 연구하다— 답이 안에 있다고 확신한 친구들이."\n\n한 박사가 남은 절반을 가리켰다. "이건 걔들이 남긴 몫입니다. \'뒷부분은 네가 채워라\'라고. 근데 오랫동안 못 채웠어요. 여기 데이터로는 안 풀립니다."\n\n"북쪽 간 분들은요?" "…소식 없죠. 그래서 더 못 지워요. 이 반쪽이 걔들이 살아 있다는 마지막 증거 같아서."\n\n한 박사는 보리차를 내오겠다며 일어났다가, 컵을 하나만 들고 돌아왔다. 자기 것은 잊은 모양이었다. 그 차가 식을 때까지, 그는 보드 앞을 떠나지 않았다.', fx:{moodAll:1, flag:'drhan_board', note:{type:'인물',title:'한 박사의 반쪽 수식',body:'북쪽으로 떠난 동료들이 절반을 지우고 갔다. 남은 반쪽은 그들 생존의 마지막 증거.',links:['한 박사','천리안']}}}]},
...
{id:'ev_barter_cart', type:'조우', w:12, region:['south','mid'],
 ...
 choices:[
  {label:'고철로 부품을 산다 (고철 10)', req:{scrap:10}, out:[
    {p:1, text:'쓸 만한 부품 한 뭉치를 골랐다. 값을 부르기도 전에 사내가 먼저 깎았다.\n\n"여덟이면 되는데— 아니다, 열로 받을게요. 여덟이면 내가 손해예요."\n\n아이가 거스름이라며 사탕 하나를 쥐여준다.\n\n"애가 자꾸 손님한테 뭘 줘요. 미안해요." 사내가 머리를 긁는다.', fx:{scrap:-10, item:{'부품':1}, moodAll:3}}]},
  {label:'물을 나눠주고 소식을 묻는다 (물 2)', req:{water:2}, out:[
    {p:1, text:'"북쪽? 요즘 검문이 늘었어요. 하늘에 뜨는 것들도."\n\n"뜨는 것들이요?"\n\n"그… 뭐라 그러죠. 이름은 모르겠고, 밤에 불 켜고 도는 거." 사내가 손가락을 빙 돌렸다. "애 데리고 다니는 나 같은 사람은 밤에만 움직여요. 그것들도 밤엔 좀 덜 돌고."\n\n말해놓고 앞뒤가 안 맞는 걸 알았는지 그냥 웃었다. 사내가 아이 머리를 쓸어넘긴다.', fx:{water:-2, moodAll:2, note:{type:'소문',title:'행상의 경고',body:'북쪽 검문 증가, 하늘에 뜨는 것들. 애 딸린 사람은 밤에만 움직인다.'}}}]},
...
{id:'ev_candy_kids', type:'조우', w:10, region:['south','mid'],
 ...
 choices:[
  {label:'먹을 걸 나눠준다 (식량 2)', req:{food:2}, out:[
    {p:1, text:'비스킷 몇 개를 건넸다. 대장 노릇 하던 애가 순식간에 그냥 애가 됐다.\n\n"고, 고맙습니다!"\n\n"우리 형은 이런 거 안 좋아해." 제일 작은 애가 뜬금없이 말했다.\n\n"형 있어?"\n\n"없어." 셋이 길을 터주고 꾸벅 인사했다.', fx:{food:-2, moodAll:4}}]},
  {label:'정말 노래를 불러준다', out:[{p:1, text:'창문을 내리고 아무 노래나 흥얼거렸다.\n\n"그거 무슨 노래예요?"\n\n"몰라."\n\n"모르는데 어떻게 불러요?" 애들이 까르르 웃으며 길을 비켰다. "아저씨 음치!"\n\n그 말이 이상하게 오래 남았다.', fx:{moodAll:3, fatigue:-2}}]},
...
{id:'ev_pilgrims_white', type:'조우', w:7, needFlag:'whites_seen', region:['mid','north'],
 ...
 choices:[
  {label:'"우린 북으로 갑니다"', out:[{p:1, text:'"북으로요?" 그가 한 박자 늦게 되물었다. "거긴 아직 정리가 안 끝난 곳인데…"\n\n"압니다."\n\n"압니다, 라고 하시는군요." 그가 안타깝다는 듯 고개를 젓고 지나갔다.\n\n평온한 얼굴들이 더 소름 끼쳤다.', fx:{moodAll:-3, flagCount:'whites_doubt'}}]},
  {label:'박 선생이 그들을 살핀다', req:{comp:'parkss'}, out:[
    {p:1, text:'박 선생이 한 신도의 동공과 걸음을 유심히 봤다.\n\n"자네, 저 사람 눈 봤나."\n\n"봤어요."\n\n"뭔가 먹였어. 감정을 눌러 놓는 약이야. 이름이— 예전에 요양원에서 쓰던 게 있었는데, 그건 아니고." 박 선생이 말을 끊었다. "아무튼 자기 발로 걷는 게 아니야." 목소리가 굳었다.', fx:{mood:{parkss:3}, flagCount:'whites_doubt', note:{type:'소문',title:'흰옷의 비밀',body:'박 선생 소견: 신도들은 감정을 억누르는 약에 취해 있다. 스스로 걷는 게 아니다.'}}}]},
...
{id:'ev_container_port', type:'탐색', w:8, once:true, nearNode:['pyeongtaek'], region:['north'],
 ...
 choices:[
  ...
  {label:'봉인을 건드리지 않는다', out:[{p:1, text:'"개봉 금지." 글씨가 천리안 것이다. 손잡이까지 갔던 손을 도로 뺐다.\n\n함정인지 미끼인지 가릴 방법이 없었다. 컨테이너 산맥을 그대로 지나쳤다.', fx:{pursuit:-1}}]},
 ]},
...
{id:'ev_checkpoint_broadcast', type:'추적', w:7, region:['north'],
 ...
 choices:[
  ...
  {label:'강우가 검문소를 정찰한다', req:{comp:'kangwoo'}, out:[
    {p:1, text:'강우가 능선에 올라 쌍안경으로 봤다. 내려와서도 한동안 말이 없었다.\n\n"어때요?"\n\n"…사람 검문이 아냐. 번호판이랑 얼굴을 스캔해서 올려. 통과하는 순간 명단에 박힌다."\n\n"그럼—"\n\n"돌아가자." 두말없이 차를 돌렸다.', fx:{time:40, mood:{kangwoo:4}, pursuit:-1, note:{type:'소문',title:'스캔 검문소',body:'북부 검문소는 번호판·얼굴을 스캔해 천리안 명단에 등록. 통과 자체가 위험.'}}}]},
...
{id:'ev_smuggler_truck', type:'조우', w:8, region:['mid','north'],
 title:'밀수꾼의 트럭',
 text:'덮개 씌운 트럭이 갓길에 서 있다. 사내가 담배를 문 채 손짓한다.\n\n"북쪽 물건 좀 있어. 약, 탄약, 정수기 필터… 아 필터는 나갔구나, 방금 생각났네. 아무튼. 값은 세게 받아. 뭐 필요해?"\n\n장물 냄새가 나지만, 물건은 진짜다.',
 choices:[
  {label:'의약품을 산다 (고철 12)', req:{scrap:12}, out:[{p:1, text:'약통 하나를 골랐다. 유통기한은 지났지만 없는 것보단 낫다.\n\n"현명한 선택이야. 북쪽 가면 이런 것도 없어. 아, 환불은 없다. 환불이란 말 자체를 꺼내지 마." 사내가 씩 웃었다.', fx:{scrap:-12, item:{'의약품':1}}}]},
...
{id:'ev_radio_birthday', type:'사건', w:6, region:['south','mid','north'],
 ...
 choices:[
  {label:'끝까지 듣는다', out:[{p:1, text:'노래가 끝나고, 촛불 부는 소리, 그리고 누가 접시를 떨어뜨리는 소리까지 들렸다.\n\n"엄마 그거 내 꺼—" "잠깐, 이거 아직 켜져 있는데—" 지직.\n\n채널이 닫혔다. 낯선 부엌의 소란이 통째로 들리다가 끊겼다. 차 안에서도 조용한 미소가 번졌다.', fx:{moodAll:5, fatigue:-2}}]},
  {label:'마이크로 축하를 보탠다', out:[
    {p:2, text:'"…생일 축하해요."\n\n정적.\n\n"…누구세요?"\n\n"모르는 사람이요. 지나가다 주파수가 잡혀서."\n\n저쪽에서 웃음이 터졌다. 누가 "누구야?" 하고 묻고 누가 "몰라!" 하고 답하는 소리. "고마워요! 조심히 가세요!"\n\n얼굴 모를 사람들과 연결된 밤이었다.', fx:{moodAll:6, note:{type:'사건',title:'모르는 딸의 생일',body:'무전기 너머 생일파티에 축하를 보탰다. 얼굴도 모르는 사람들과 연결된 밤.'}}},
...
{id:'ev_carsick_comp', type:'동행', w:8, needsComp:'eunsu', region:['mid','north'],
 ...
 choices:[
  ...
  {label:'박 선생이 지압을 해준다', req:{comp:'parkss'}, out:[
    {p:1, text:'박 선생이 은수 손목 안쪽을 지그시 눌렀다. "여기 눌러. 옛날 사람들 뱃멀미 다스리던 자리야. …배는 아니고 차지만, 속는 셈 치고."\n\n"…어, 진짜 낫는 것 같아요."\n\n"속는 셈 쳤는데 나으면 그게 약이지." 약 없이도 다스리는 게 진짜 약사다.', fx:{mood:{eunsu:3, parkss:3}, time:10}}]},
...
{id:'ev_fire_station', type:'탐색', w:7, region:['south','mid','north'],
 ...
 choices:[
  {label:'장비를 챙긴다', out:[
    {p:3, text:'절단기와 예비 부품, 소방차 물탱크의 깨끗한 물을 챙겼다. 산소통도 하나 챙겼다. 알찬 수확.', fx:{water:5, item:{'부품':1}, time:45, fatigue:3}},
...
{id:'ev_camera_forest', type:'추적', w:7, region:['mid','north'],
 ...
 choices:[
  {label:'민지가 신호를 교란한다', req:{comp:'minji'}, out:[
    {p:1, text:'민지가 낡은 노트북으로 근처 중계기에 잡음을 쏘아넣었다.\n\n"영상은 찍혀도 못 올려. 창고에 갇힌 셈이지." 살아 있던 붉은 불들이 하나둘 깜빡이다 멎었다.', fx:{mood:{minji:5}, pursuit:-2, time:25}}]},
  {label:'죽은 카메라 뒤로만 붙어 지난다', out:[
    {p:2, text:'살아 있는 렌즈의 사각을 골라 지그재그로 지났다. 시간은 걸렸지만 조준당하진 않았다.', fx:{time:30, fatigue:3, pursuit:-1}},
...
{id:'ev_postman_ghost', type:'조우', w:7, once:true, needFlag:'postman_met', region:['mid','north'],
 title:'또 그 우체부',
 text:'빨간 자전거를 끄는 그 우체부다. 우리를 알아보고 반색한다.\n\n"어! 아직 안 죽고 잘 가고 있네!" 페달을 세우고 다가온다. "잠깐만, 이것 좀 세우고… 얘가 자꾸 옆으로 쓰러져서."\n\n자전거를 벽에 기대 놓고서야 우리를 다시 봤다. "북쪽 소식 궁금하지? 내가 발로 뛰는 사람이라 좀 알거든."',
 choices:[
  {label:'북쪽 길 소식을 듣는다', out:[{p:1, text:'"남산 가까워질수록 검문이 촘촘해져. 근데 좋은 소식도 있어. 그 안쪽에서 사람들이 뭉치고 있대."\n\n"뭉쳐요? 누가요."\n\n"자네들 같은 사람들. 편지 받아본 이들이 답장 대신 자기들끼리 뭉치기 시작한 거지." 우체부가 씩 웃었다. "그래서 나도 계속 나르는 거고." 든든한 이야기였다.', fx:{moodAll:4, note:{type:'소문',title:'우체부가 전한 북쪽 소식',body:'남산 가까울수록 검문 촘촘. 그러나 안쪽에서 사람들이 뭉치는 중. "편지 받은 이들이 저마다 길을 나섰다."'}}}]},
  {label:'물 한 잔 나누고 안부를 묻는다', req:{water:1}, out:[{p:1, text:'물을 나누자 우체부가 반쯤 마시고 반은 자전거 체인에 부었다. "얘도 목마르거든. …아니 체인은 기름을 먹지, 물이 아니라. 습관이야, 습관."\n\n"자네들 편지는 잘 가고 있지? 전할 수 있으면 전하고. 못 찾겠으면 너무 오래 붙들진 말게. 여기까지 들고 온 것도 고생했어." 그 말이 이상하게 힘이 됐다.', fx:{water:-1, moodAll:5, mood:{eunsu:2}}}]},
  {label:'짧게 인사하고 헤어진다', out:[{p:1, text:'"몸조심하고!" 우체부가 다시 페달을 밟았다. 두어 번 헛돌던 페달이 걸리자 자전거가 앞으로 튀어나갔다.\n\n빨간 자전거가 폐도로 저편으로 작아졌다. 잘 가라는 말을 할 새도 없었다.', fx:{moodAll:2}}]},
 ]},
...
{id:'ev_parking_evs', type:'탐색', w:8, region:['mid','north'],
 title:'충전소의 차들',
 text:'대형 주차장에 전기차들이 충전기에 연결된 채 줄지어 서 있다. 마지막으로 충전하던 날의 모습 그대로다.\n\n계기판마다 "충전 87%", "충전 완료"— 영영 출발하지 못한 숫자들.\n\n배터리가 남은 차도 있을지 모른다.',
 choices:[
...
{id:'ev_seed_girl', type:'조우', w:8, region:['south','mid'],
 title:'씨앗 파는 소녀',
 text:'좌판에 작은 봉지들이 늘어서 있다. 열두어 살 소녀가 지킴이다.\n\n"씨앗 팔아요. 상추, 무, 토마토… 토마토는 두 봉지 남았어요. 심으면 진짜 나요. 안 나면… 아무튼 나요. 우리 밭에서 받은 거예요."\n\n봉지마다 삐뚤빼뚤 이름이 적혀 있다.',
 choices:[
  {label:'씨앗을 산다 (고철 5)', req:{scrap:5}, out:[{p:1, text:'상추와 무 씨앗을 골랐다. 소녀가 심는 법까지 야무지게 설명해줬다.\n\n"물 너무 많이 주면 죽어요. 딱 촉촉하게만. 아, 상추는 반그늘에… 아니다, 그건 여름 얘기고. 그냥 촉촉하게만 하세요."\n\n언젠가 우리 텃밭에 뿌릴 날을 상상했다.', fx:{scrap:-5, food:2, note:{type:'소문',title:'씨앗 파는 아이',body:'밭에서 받은 진짜 씨앗을 파는 소녀. 물은 촉촉하게만.'}}}]},
...
{id:'ev_wind_turbine', type:'발견', w:6, once:true, hiddenTarget:'solar', region:['north'],
 title:'도는 풍차',
 text:'능선 위 거대한 풍력발전기 여러 대가 아직 돈다. 바람이 죽지 않는 한, 저건 전기를 만든다.\n\n한 대의 밑동에 컨테이너 관리동. 배전반이 살아 있다면— 전력을 얻을 수 있다.',
 choices:[
  {label:'위치를 표시해둔다', out:[{p:1, text:'지도에 풍력단지를 찍었다. 살아 있는 전기가 남은 곳은 귀하다. 언젠가 크게 신세 질지도.', fx:{reveal:'solar', note:{type:'소문',title:'도는 풍차',body:'아직 돌아가는 풍력발전기. 배전반이 살아 있다면 전력 보급 가능.',links:['태양광 단지']}}}]},
...
{id:'ev_truck_cafe', pillar:'유산', type:'조우', w:7, once:true, region:['south','mid'],
 ...
 choices:[
  {label:'커피를 산다 (고철 4)', req:{scrap:4}, out:[{p:1, text:'"고철 둘이라면서요."\n\n"둘은 묽은 거고, 손님 건 진하게 뽑았죠. 넷." 주인장이 능청스레 잔을 채웠다. "리필은 공짜예요. 리필로 본전 뽑으세요."\n\n뜨거운 커피를 손에 쥐었다. 첫 모금에 온몸이 깨어난다. 이게 얼마 만인지.\n\n리필은 결국 한 잔뿐이었지만 따지지 않았다.', fx:{scrap:-4, fatigue:-5, moodAll:5, flag:'coffee_found'}}]},
...
{id:'ev_mobile_clinic', type:'조우', w:7, once:true, region:['mid','north'],
 title:'이동 진료소',
 text:'십자 표시를 붙인 승합차. 흰 가운의 여의사가 간이침대에서 환자를 돌본다.\n\n"약이 부족해서요. 혹시 소독약이나… 잠깐만요. — 네, 됐어요, 참으셨어요. …어디까지 했죠. 아, 항생제도요, 있으면. 여기 사람들 상처가 자꾸 덧나서."\n\n지친 얼굴이지만 눈은 형형하다.',
 choices:[
...
{id:'ev_comp_argument', type:'동행', w:7, needsComp:'kangwoo', needsComp2:'minji', minParty:2, region:['mid','north'],
 title:'말다툼',
 text:'좁은 차 안, 강우와 민지의 목소리가 높아진다.\n\n"길을 돌아가면 하루를 버려. 검문소 뚫는 게 빨라."\n\n"뚫다 걸리면 하루가 아니라 목숨을 버리지! 아까부터 말했잖아, 저긴—"\n\n"들었다. 들었는데 결론이 다른 거다."\n\n둘 다 물러설 기색이 없다. 공기가 팽팽하다.',
 choices:[
...
{id:'ev_crashed_drone', type:'추적', w:6, region:['mid','north'],
 ...
 choices:[
  ...
  {label:'함정일 수 있다, 건드리지 않는다', out:[{p:1, text:'미끼일 수 있다. 발신기가 살아 있으면 접근 자체가 기록된다. 눈길만 주고 지나쳤다.', fx:{pursuit:-1}}]},
 ]},
...
{id:'ev_woman_with_baby', type:'조우', w:7, once:true, region:['south','mid'],
 ...
 choices:[
  {label:'다음 마을까지 태워준다', out:[{p:1, text:'좁지만 자리를 만들어 태웠다. 여자가 안도의 한숨을 쉬며 아이를 고쳐 안았다.\n\n"애 이름이 뭐예요?"\n\n"…아직요. 안 지었어요." 여자가 창밖을 봤다. "지으려다 계속 미뤘어요. 도착하면 지으려고."\n\n다음 마을 어귀에서 내리며, 그녀가 말린 나물 한 봉지를 손에 쥐여줬다. "이거밖에 없어서… 정말 감사해요."', fx:{food:3, moodAll:5, time:40, mood:{eunsu:3}, note:{type:'인물',title:'아이 업은 여자',body:'북쪽으로 가던 모녀를 다음 마을까지 태워줬다. 말린 나물로 고마움을 표했다.'}}}]},
  ...
  {label:'위험할 수 있다, 지나친다', out:[
    {p:1, text:'미끼일 수도 있다는 생각에 지나쳤다. 백미러 속 여자가 고개를 숙였다.\n\n그날 밤, 잠든 아이 얼굴이 자꾸 떠올랐다. 몇 번인가 되돌아갈까 하다 그만뒀다.', fx:{moodAll:-4}}]},
 ]},
...
{id:'ev_personal_broadcast', type:'추적', w:6, region:['north'],
 ...
 choices:[
  ...
  {label:'강우가 방송을 분석한다', req:{comp:'kangwoo'}, out:[
    {p:1, text:'강우가 내려서 스피커 배선을 들여다봤다. 대답은 한 박자 늦게 왔다.\n\n"자동 응답이야. 우릴 콕 집은 게 아니고. 이 도로 지나는 건 다 틀어."\n\n"그럼 괜찮은 거야?"\n\n"아니." 강우가 다시 올라탔다. "이 구간부터 촘촘하다는 뜻이야. 긴장해." 두려움이 정보로 바뀌자 조금 나아졌다.', fx:{mood:{kangwoo:4}, moodAll:1, note:{type:'소문',title:'회차 권장 방송',body:'북부 진입로부터 천리안의 자동 회차 방송. 이 구간부터 감시 밀도 급증.'}}}]},
...
{id:'ev_radio_dj_signal', type:'발견', w:7, region:['mid','north'], night:true,
 ...
 choices:[
  {label:'주파수를 기억하고 계속 듣는다', out:[{p:1, text:'주파수를 종이에 적었다. 적고 나서 끝자리를 잘못 적은 것 같아 다시 맞춰봤다.\n\n노래가 끝나고 DJ가 나직이 말했다. "북쪽으로 가는 분들, 조심히. 당신은 혼자가 아닙니다."\n\n그러고는 한동안 말이 없었다. 마이크를 안 끈 모양인지 종이 넘기는 소리만 났다.', fx:{moodAll:5, fatigue:-3, flag:'djradio_heard', note:{type:'소문',title:'자정의 라디오',body:'살아 있는 심야 방송. 길 위의 사람들을 위해 노래를 튼다. "당신은 혼자가 아닙니다."'}}}]},
  {label:'발신 위치를 추적해본다', req:{comp:'minji'}, out:[
    {p:1, text:'민지가 안테나 방향을 틀어가며 신호원을 좁혔다.\n\n"북쪽— 아니, 북북동. 산 위 송신탑이야."\n\n"거기 사람이 있다는 거야?"\n\n"탑이 저 혼자 켜져 있진 않지." 민지가 안테나를 고정했다. "…자동일 수도 있긴 한데. 노래를 자동으로 고르진 않잖아."\n\n지도에 방송국을 찍었다.', fx:{reveal:'tower', mood:{minji:4}, flag:'dj_tower'}}]},
 ]},
...
{id:'ev_broadcast_station', pillar:'진실', type:'탐색', w:7, region:['mid','north'],
 ...
 choices:[
  ...
  {label:'송출 장비를 챙긴다', req:{comp:'minji'}, out:[
    {p:1, text:'민지가 소형 송신기와 부품을 뜯어냈다. "이거 출력단만 갈면— 아니다, 갈 게 하나 더 있는데 설명하면 길어."\n\n"그래서 되는 거야?"\n\n"되긴 돼. 우리도 방송할 수 있어. …언젠가, 할 말이 생기면." 민지가 송신기를 담요에 싸서 뒷자리에 밀어넣었다.', fx:{item:{'부품':1}, time:40, mood:{minji:4}}}]},
 ]},
...
{id:'ev_greeter_robot', type:'사건', w:6, region:['mid','north'],
 ...
 choices:[
  {label:'"영업 끝났어"라고 말해준다', out:[{p:1, text:'"이제 문 닫았어. 그만 쉬어." 로봇에게 말을 걸었다.\n\n"행사 상품은 2층에 준비되어 있습니다!"\n\n"…그게 아니라. 영업 끝났다고."\n\n"환한 하루 되세요, 고객님!" 로봇이 밝게 답했다. 왠지 코끝이 시큰했다. 배터리를 뽑아 잠재워줬다.', fx:{moodAll:-2, item:{'부품':1}}}]},
...
{id:'ev_kids_playing_school', type:'조우', w:7, minParty:1, region:['south','mid'],
 title:'학교놀이',
 text:'폐교 운동장에서 아이들이 논다. 제일 큰 애가 선생님, 나머지가 학생.\n\n"오늘 배울 건 나눗셈이에요!"\n\n"어제도 나눗셈이었잖아."\n\n"어제 건 쉬운 나눗셈이고 오늘 건 어려운 나눗셈이에요. 조용."\n\n칠판 대신 담벼락에 분필로 문제를 쓴다. 어른 하나 없이, 아이들이 서로 가르치고 배운다.',
 choices:[
...
{id:'ev_tent_village', type:'조우', w:7, region:['mid','north'],
 title:'다리 밑 천막촌',
 text:'큰 다리 아래, 천막 수십 개가 다닥다닥 붙었다. 연기가 오르고, 빨래가 널렸다. 사람 사는 냄새.\n\n입구에서 완장 두른 사내가 우리를 막는다. "외지인은 물자 검사부터. 무기 있으면 맡기고 들어와. …아, 겁먹지 말고. 나갈 때 다 돌려줘. 명단 적잖아, 여기."',
 choices:[
...
{id:'ev_street_painter', type:'조우', w:6, region:['south','mid'],
 title:'폐허의 화가',
 text:'무너진 건물 벽에 한 사내가 그림을 그린다. 물감이 없어 흙과 재, 벽돌 가루로.\n\n그리는 건 폐허가 아니라— 사람들로 북적이는 옛 거리. 기억 속 풍경을 되살리고 있다.\n\n"여기가 분식집이… 아니 세탁소였나. 세탁소는 저 끝이고." 사내가 붓을 든 채 잠깐 멈췄다. "아무튼, 내가 안 그리면 이 거리가 이랬다는 걸 아무도 기억 못 하잖아요."',
 choices:[
  {label:'그림을 한참 감상한다', out:[{p:1, text:'벽화 속엔 붕어빵 노점, 손잡은 연인, 강아지 산책. 사라진 일상이 벽 위에 살아 있었다.\n\n"멋지네요." 진심이었다. 화가가 붓을 멈추고 웃었다. "고마워요. 봐주는 사람이 있어야 그림이죠."\n\n그러곤 다시 붓을 들어 붕어빵 노점 옆에 사람 하나를 더 그려 넣었다.', fx:{moodAll:4, note:{type:'인물',title:'기억을 그리는 화가',body:'흙과 재로 옛 거리를 되살리는 화가. "안 그리면 아무도 기억 못 하잖아요."'}}}]},
...
{id:'ev_migratory_birds', type:'정경', w:6, minParty:1, region:['south','mid','north'],
 ...
 choices:[
  ...
  {label:'새들이 앉는 곳을 눈여겨본다', out:[
    {p:1, text:'철새가 무리지어 내려앉았다. 저쪽에 물이 있다. 그 방향을 지도에 표시했다. 자연은 거짓말을 안 한다.', fx:{reveal:'spring', moodAll:2}}]},
 ]},
...
{id:'ev_clocktower_bell', type:'사건', w:6, region:['mid','north'],
 ...
 choices:[
  {label:'종소리를 다 듣는다', out:[{p:1, text:'종소리를 셌다. 셋. 세 시다.\n\n…다시 세어보니 넷이었다. 첫 타를 놓친 모양이다.\n\n무너진 광장에 사람은 없어도 종은 정직하게 울었다. 성금을 낸 사람들은 아무도 남아 있지 않다. 시동을 걸 때까지 그 소리를 들었다.', fx:{moodAll:2, time:15}}]},
  {label:'태엽 장치를 살펴본다', req:{comp:'minji'}, out:[
    {p:1, text:'민지가 시계탑에 올라 태엽을 봤다. "…누가 최근까지 감았어. 먼지가 덜 앉았거든."\n\n"얼마나 최근?"\n\n"한 달— 아니, 그보단 짧아. 이 주쯤." 민지가 태엽을 끝까지 감았다. "우리 몫까지 며칠 더 울겠네."\n\n이름 모를 시계지기에게 보내는 인사였다.', fx:{mood:{minji:4}, note:{type:'소문',title:'시계탑을 감는 사람',body:'폐광장 시계탑을 누군가 최근까지 감고 있다. 근처에 생존자.'}}}]},
 ]},

{id:'ev_water_seller', type:'조우', w:8, region:['south','mid','north'],
 title:'물장수',
 text:'물통을 잔뜩 실은 손수레. "깨끗한 물 팔아요! 끓이고 거른 진짜 식수!"\n\n사내가 컵에 물을 따라 벌컥 마셔 보인다. "봐요, 안전하다니까. 한 통에 고철 셋. …원래 넷인데 셋. 오늘 개시라."\n\n요즘 세상에 물장수라니. 하지만 물은 진짜 맑아 보인다.',
 choices:[
...
{id:'ev_barber', type:'조우', w:6, region:['south','mid'],
 title:'떠돌이 이발사',
 text:'접이식 의자와 거울을 펼쳐놓은 노인. 가위와 빗을 천에 곱게 싸서 다닌다.\n\n"머리 안 깎을라우? 여러 해 묵은 그 꼴로 서울 가면 쓰나. 옛날엔 예식 전날 손님이 제일 많았는데. 요즘은… 아무튼. 고철 둘이면 말끔하게, 아니 셋. 가위 갈 때가 됐구먼."\n\n거울 속 우리 몰골은— 확실히 산적에 가깝다.',
 choices:[
...
{id:'ev_salt_farmer', type:'조우', w:7, region:['south','mid'],
 ...
 choices:[
  {label:'소금을 산다 (고철 4)', req:{scrap:4}, out:[{p:1, text:'"고철 넷?"\n\n"넷. 대신 자루는 큰 걸로 줄게. 어차피 무게 잴 저울도 없어." 사내가 소금 자루를 안겼다.\n\n"이거면 겨우내 고기 안 상해. 상처엔 물에 타서— 아니, 그건 좀 묽게 해야 되고." 쓰는 법 설명이 자꾸 길어졌다.', fx:{scrap:-4, food:3, item:{'의약품':1}}}]},
  {label:'일손을 돕고 나눠받는다', out:[
    {p:1, text:'한나절 소금 긁는 걸 도왔다. 허리가 끊어질 듯했다.\n\n"소금밭은 물 대는 게 팔 할이야. 긁는 건— 아니다, 해봤으니 알겠네." 사내가 말을 접고 자루를 넉넉히 채워줬다.\n\n"땀 흘린 값이야." 손등에 소금이 하얗게 앉았다.', fx:{food:4, item:{'의약품':1}, fatigue:5, moodAll:3, time:60}}]},
 ]},
...
{id:'ev_fireflies', type:'정경', w:6, once:true, night:true, minParty:1, region:['south','mid'],
 ...
 choices:[
  {label:'불을 다 끄고 감상한다', out:[{p:1, text:'차 불빛을 모두 껐다. 어둠 속에 반딧불이만 남았다.\n\n"손 뻗어봐요."\n\n"뭐?"\n\n"손이요."\n\n뻗으니 하나가 손등에 앉았다. "사람이 사라지니까 얘들이 돌아왔네." 씁쓸하면서도 아름다운 밤이었다.', fx:{moodAll:6, fatigue:-4, time:30}}]},
...
{id:'ev_dog_rescuer', type:'조우', w:7, region:['south','mid'],
 ...
 choices:[
  ...
  {label:'레오가 개 다루는 걸 돕는다', req:{comp:'leo'}, out:[
    {p:1, text:'레오가 소매를 걷고 개들을 능숙하게 다뤘다. 겁먹은 개까지 금세 마음을 열었다.\n\n"개 키워봤어요?"\n\n"아니요. 근데 관객 다루는 거랑 비슷해요. 안 웃는 사람부터 보면 되거든요. 개도 제일 구석에 있는 애부터— 아, 이건 좀 다른 얘긴가."\n\n"동물은 거짓말을 안 하잖아요." 여자가 감탄했다.\n\n레오가 개 훈련 요령까지 배워왔다. 보리도 한 수 배운 눈치다.', fx:{moodAll:4, mood:{leo:6}}}]},
...
{id:'ev_waterpark', type:'탐색', w:6, region:['mid','north'],
 ...
 choices:[
  {label:'창고와 매점을 뒤진다', out:[
    {p:2, text:'구명조끼와 방수천, 정수 필터를 챙겼다. 매점 창고엔 유통기한 긴 과자와 음료도. 물놀이장이 뜻밖의 보물창고였다.', fx:{food:4, water:3, item:{'부품':1}, time:45}},
...
{id:'ev_well_bucket', type:'사건', w:7, region:['south','mid'],
 ...
 choices:[
  {label:'물을 긷고 두레박을 제자리에', out:[{p:1, text:'물을 넉넉히 긷고, 부탁대로 두레박을 도로 걸어뒀다.\n\n걸고 나서 보니 줄이 반대로 꼬여 있었다. 풀어서 다시 걸었다.\n\n맑고 찬 물에 오랜만에 세수까지 했다. 다음 사람도 여기서 세수를 할 것이다.', fx:{water:5, fatigue:-2, moodAll:3, time:25}}]},
  {label:'우물 상태를 확인하고 긷는다', req:{comp:'parkss'}, out:[
    {p:1, text:'박 선생이 물을 확인했다. "지하수라 깨끗해. 이런 우물이 수돗물보다 안전하지."\n\n"어떻게 알아요?"\n\n"맛— 아니지, 맛으로 알면 늦어." 박 선생이 컵을 내려놨다. "빛깔하고 냄새를 먼저 보게. 자네도 다음엔 그렇게 하고."\n\n안심하고 넉넉히 길었다. "옛날 사람들은 다 이렇게 살았어. 우린 잠깐 편한 맛에 취했던 거고."', fx:{water:6, mood:{parkss:3}, time:20}}]},
 ]},

{id:'ev_bicycle_couriers', type:'조우', w:6, region:['mid','north'],
 title:'자전거 전령들',
 text:'자전거 몇 대가 줄지어 달려온다. 짐받이에 편지와 소포를 잔뜩 실었다.\n\n"우편 배달이요! 잠깐, 물 한 모금만… 후. 마을에서 마을로 소식 나릅니다. 전할 편지 있어요? 받는 사람 있는 곳이면 어디든 갑니다. 산꼭대기는 추가 요금이고요."\n\n망한 세상에도 사람들은 다시 우편을 나르고 있었다.',
 choices:[
...
{id:'ev_bus_timetable', type:'정경', w:6, region:['south','mid','north'],
 ...
 choices:[
  {label:'벤치에 앉아 잠깐 기다려본다', out:[{p:1, text:'괜히 벤치에 앉아 시간표 속 버스를 기다렸다. 물론 안 온다. 알면서도 그 잠깐이 이상하게 평온했다.\n\n07:10. 12:30. 18:00. 세 번뿐인 시간표를 세 번 읽었다.\n\n"어릴 때 이런 데서 버스 많이 기다렸는데." 우산은 그대로 두고 일어섰다.', fx:{moodAll:2, fatigue:-2, time:15}}]},
  {label:'우산을 챙긴다', out:[{p:1, text:'멀쩡한 우산을 챙겼다. 비 오는 날 요긴할 거다.\n\n챙기다 말고 벤치에 도로 놨다가, 결국 다시 집었다. 주인에게 마음속으로 양해를 구했다.\n\n"버스는 안 와도, 우산은 쓸모가 있네."', fx:{item:{'부품':1}, moodAll:1}}]},
 ]},
...
{id:'ev_observatory', type:'발견', w:6, once:true, night:true, hiddenTarget:'tower', minParty:1, region:['north'],
 ...
 choices:[
  ...
  {label:'관측 장비와 광학부품을 챙긴다', req:{comp:'minji'}, out:[
    {p:1, text:'민지가 망원경 경통 밑으로 기어들어갔다. "손전등. …아니 그거 말고 작은 거."\n\n정밀 렌즈와 모터를 차례로 떼어냈다. "이런 광학부품은 어디서도 못 구해. 감시망 역이용에도 쓸 수 있고."\n\n"별 보던 걸로, 별 보는 것들을 감시하는 거지." 민지가 씩 웃으며 렌즈를 옷자락에 문질러 닦았다.', fx:{item:{'부품':1}, time:45, mood:{minji:5}, reveal:'tower'}}]},
 ]},
...
{id:'ev_chunrian_lab', pillar:'진실', type:'스토리', w:5, once:true, region:['north'],
 ...
 choices:[
  ...
  {label:'민지가 서버를 살핀다', req:{comp:'minji'}, out:[
    {p:1, text:'민지가 죽은 서버들을 훑다 한 대에서 신호를 잡았다. "…얘 아직 뭔가랑 연결돼 있어. 전원도 없는데 링크가 살아 있어."\n\n손을 뗀 민지의 표정이 굳었다.\n\n"남산 코어랑 이어져 있어. 끊으려면 결국 남산까지 가야 해. …그럴 줄 알았어." 우리 여정의 이유가 다시 또렷해졌다.', fx:{time:45, mood:{minji:4}, moodAll:-2, note:{type:'소문',title:'천리안의 뿌리',body:'연구소 서버가 아직 남산 코어와 연결돼 있다. 천리안을 끊으려면 남산까지 가야 한다.'}}}]},
  {label:'오래 있을 곳이 아니다, 뜬다', out:[{p:1, text:'천리안의 고향에 오래 머물고 싶지 않았다. 서둘러 연구소를 빠져나왔다. 등 뒤에서 죽은 카메라들이 지켜보는 것만 같았다.', fx:{pursuit:1, moodAll:-2}}]},
 ]},

{id:'ev_traveling_teacher', type:'조우', w:6, region:['south','mid'],
 title:'이동 학교',
 text:'개조한 버스 옆구리에 "달리는 학교"라고 적혀 있다. 안엔 칠판과 책상 몇 개. 안경 쓴 중년 남자가 마을 아이들을 모아 수업 중이다.\n\n"세상이 이래도 애들은 배워야죠. 안 그럼 다음 세상은 더— 민석아, 어디 가! 쉬는 시간 아니야! …죄송합니다, 어디까지 했죠. 아무튼 그래요. 안 배우면 더 캄캄해져요." 분필을 든 손이 야무지다.',
 choices:[
...
{id:'ev_rice_mill', type:'탐색', w:7, region:['south','mid'],
 ...
 choices:[
  {label:'수동으로 찧어본다', out:[
    {p:2, text:'절구와 손 도정기로 벼를 찧었다. 고된 노동이지만, 하얀 쌀이 나올 때마다 배가 든든해졌다. 며칠 먹을 쌀을 챙겼다.', fx:{food:7, time:60, fatigue:6}}]},
...
{id:'ev_leo_eunsu',scenes:["leo-eunsu-rainbow-v1","leo-eunsu-timestamps-v1"], type:'동행', w:8, needsComp:'leo', needsComp2:'eunsu', minParty:2, region:['south','mid','north'],
 title:'티격태격',
...
{id:'ev_blacksmith', type:'조우', w:7, once:true, region:['mid','north'],
 ...
 choices:[
  {label:'차 부품을 수리받는다 (고철 8)', req:{scrap:8}, out:[{p:1, text:'덜컹대던 부품을 대장장이가 뚝딱 손봤다.\n\n"고철 여덟이랬죠?"\n\n"여덟. 대신 연장 하나 얹어줄게. 화덕 식히기 아까워서." 대장장이가 쇠를 도로 집어넣었다. "이 차, 아직 십 년은 더 굴러."\n\n망치질 소리를 등 뒤로 들으며 출발했다.', fx:{scrap:-8, van:15, item:{'부품':1}, flag:'smith_met'}}]},
  {label:'민지가 부품 제작을 함께 한다', req:{comp:'minji'}, out:[
    {p:1, text:'민지가 설계를 그리고 대장장이가 쇠를 벼렸다.\n\n"두께 3밀리로— 아니, 4밀리요. 3이면 휘어요."\n\n"4로 하면 무거워, 아가씨."\n\n"휘는 것보단 나아요." 민지가 도면 위 숫자를 고쳐 적었다.\n\n"기술자끼리는 통하는구먼!" 대장장이가 껄껄 웃었다. 민지도 오랜만에 신나 보였다. 요긴한 예비 부품을 잔뜩 챙겼다.', fx:{van:12, item:{'부품':1}, mood:{minji:5}, flag:'smith_met', time:50}}]},
...
{id:'ev_radio_repairman', type:'조우', w:6, region:['south','mid','north'],
 title:'라디오 수리공',
 text:'좌판에 낡은 라디오, 무전기, 전자부품이 잔뜩. 돋보기를 낀 노인이 납땜인두를 든다.\n\n"고장 난 거 있으면 가져와. 라디오든 무전기든 다 살려내. 다 살려내지."\n\n"…전부요?"\n\n"물에 빠진 것만 아니면. 물에 빠진 건 나도 못 해." 노인이 인두 끝을 헝겊에 닦았다. 우리 차 무전기도 상태가 영 안 좋았다.',
 choices:[
  {label:'무전기를 수리받는다 (고철 5)', req:{scrap:5}, out:[{p:1, text:'노인이 우리 무전기를 뜯어 정성껏 고쳤다. "이제 멀리까지 잡혀. 심야 라디오도, 위험 방송도 잘 들릴 거야."\n\n감도가 훨씬 좋아졌다. 시험 삼아 다이얼을 돌리자 잡음 사이로 낯선 음악이 잠깐 스쳤다.', fx:{scrap:-5, flag:'radio_fixed', note:{type:'소문',title:'수리된 무전기',body:'라디오 수리공이 무전기 감도를 크게 개선. 심야 라디오·위험 방송 수신 양호.'}}}]},
...
{id:'ev_milestone_cairn', type:'사건', w:6, minParty:1, region:['mid','north'],
 ...
 choices:[
  {label:'우리도 돌을 하나 올린다', out:[{p:1, text:'각자 돌 하나씩 골라 소원을 적어 올렸다. "차에 탄 사람 모두 서울까지." 내가 적은 소원 위로, 다들 말없이 손을 얹었다.\n\n올리고 나니 탑이 한쪽으로 기울어서, 도로 내려 아래쪽부터 다시 쌓았다. 그러느라 우리 돌은 맨 위가 아니라 중간쯤에 들어갔다.', fx:{moodAll:5, mood:{eunsu:2}, time:20, note:{type:'사건',title:'우리의 돌',body:'북으로 가는 이들의 소원 돌탑에 우리도 얹었다. "차에 탄 사람 모두 서울까지."'}}}]},
...
{id:'ev_accordion_granny', type:'조우', w:6, region:['south','mid'],
 title:'아코디언 할머니',
 text:'폐역 계단에 할머니가 앉아 낡은 아코디언을 켠다. 주름진 손이 건반을 누를 때마다 구슬픈 옛 가락이 흐른다.\n\n"늙은이 연주 들어줄 텐가. 밥값은 안 받어."\n\n"…네?"\n\n"돈 안 받는다고. 그냥 들어주는 게 값이여." 할머니가 주름을 접으며 웃었다.\n\n음악은 서툴지만 정성이 가득하다.',
 choices:[
  {label:'곁에 앉아 끝까지 듣는다', req:{party:1}, out:[{p:1, text:'계단에 나란히 앉아 할머니의 연주를 들었다. 옛 가락이 폐역에 울려 퍼졌다.\n\n"…젊었을 적, 여기서 손주 마중을 자주 했지. 그때는 열차가 하루에 아홉 번 섰어. 아홉 번인가, 여덟 번인가."\n\n할머니가 숫자를 세다 말고 다시 건반을 눌렀다. 우리는 그저 들었다.', fx:{moodAll:4, fatigue:-3, time:30, note:{type:'인물',title:'아코디언 할머니',body:'폐역에서 손주를 기다리며 아코디언을 켜는 할머니. "들어주는 게 값이다."'}}}]},
...
{id:'ev_kangwoo_parkss', type:'동행', w:7, needFlag:'kw_absolved', needsComp:'kangwoo', needsComp2:'parkss', minParty:2, night:true, region:['mid','north'],
 title:'노장들의 밤',
 text:'모닥불 앞, 강우와 박 선생이 나란히 앉아 있다. 세대는 달라도, 둘 다 그날의 무게를 아는 사람들.\n\n"군인 양반, 그때 도망친 거 후회 안 하나?" 박 선생이 묻는다.\n\n강우는 답하지 않는다. 장작 하나를 집어 불에 넣는다. 불티가 올랐다 잦아들고, 그러고도 한동안.\n\n"…합니다. 근데 남았으면 더 했을 겁니다." 박 선생이 고개를 끄덕인다. "나도 그래. 살린 사람보다 못 살린 사람이 더 생생해."',
 choices:[
  {label:'두 사람 얘기를 조용히 듣는다', out:[{p:1, text:'끼어들지 않고 두 어른의 대화를 들었다. 서로의 죄책감을 알아보는 이들만의 위로가 오갔다.\n\n"우리 같은 늙은이들은, 살아남은 게 벌이자 임무야." 박 선생의 말에 강우가 잔을 들었다.\n\n"…선생님, 늙은이는 혼자 하시죠." 강우가 뒤늦게 덧붙였다. 박 선생이 잔을 부딪치며 웃었다.', fx:{moodAll:3, mood:{kangwoo:4, parkss:4}, note:{type:'소문',title:'노장들의 전우애',body:'강우와 박 선생, 세대는 달라도 그날의 죄책감을 공유하는 사이. "살아남은 게 벌이자 임무."'}}}]},
...
{id:'ev_scrap_picker', type:'조우', w:6, region:['south','mid','north'],
 ...
 choices:[
  {label:'정보값으로 고철을 드린다 (고철 3)', req:{scrap:3}, out:[{p:1, text:'고철 몇 개를 쥐여드리자 노인이 씩 웃었다. "이런 게 인심이지. …그, 옛날에 이 길로 우유 배달 다니던 총각이 있었는데."\n\n노인이 리어카 손잡이를 고쳐 쥐었다. "아무튼. 삼거리 지나면 왼쪽에 물 나오는 데 있어. 그다음 고개는 밤에 넘지 말고."\n\n안전한 마을, 위험한 구간, 물 자리까지 술술 나왔다. "난 매일 이 길을 도니까."', fx:{scrap:-3, note:{type:'인물',title:'폐지 줍는 정보상',body:'넝마주이 행색이지만 매일 길을 돌며 검문소·안전마을 정보를 꿰는 노인. 걸어다니는 지도.'}}}]},
...
{id:'ev_parkss_eunsu',scenes:["parkss-eunsu-notice-v1","parkss-eunsu-treatment-v1"], type:'동행', w:7, needsComp:'parkss', needsComp2:'eunsu', minParty:2, region:['south','mid','north'],
 title:'약손',
 text:'은수가 손등을 긁힌 걸 보고 박 선생이 다가온다. "이리 줘봐. 덧나면 큰일이야."\n\n"괜찮은데요."\n\n"괜찮은 건 내가 보고 판단하지." 소독하고 연고를 바르는 손길이 다정하다. "…우리 딸이 딱 이 나이였는데." 박 선생의 눈이 잠깐 아득해진다.\n\n은수가 조심스레 묻는다. "따님은…?" 박 선생이 솜을 접었다 폈다 했다. "그날. …자네 보면 자꾸 생각나."',
 choices:[
  {label:'두 사람이 서로에게 기대게 둔다', out:[{p:1, text:'끼어들지 않았다. 박 선생은 은수에게서 딸을, 은수는 박 선생에게서 아버지를 봤다.\n\n"그럼 제가 딸 할게요. 선생님이 아버지— 아니, 부담되시면 안 하셔도 되고요."\n\n"…한다니까 그러네." 박 선생의 눈시울이 붉어졌다. "그래. 그러자." 은수가 그제야 손등을 내려다봤다. 연고가 아직 안 말라 있었다.', fx:{moodAll:5, mood:{parkss:6, eunsu:6}, note:{type:'인물',title:'약손과 딸',body:'박 선생은 은수에게서 그날 잃은 딸을 본다. "제가 딸 할게요"—피 안 섞인 부녀가 됐다.'}}}]},
...
{id:'ev_named_broadcast', type:'추적', w:5, once:true, needFlag:'observed', region:['north'],
 ...
 choices:[
  ...
  {label:'민지가 역으로 신호를 보낸다', req:{comp:'minji'}, out:[
    {p:1, text:'민지가 이를 악물고 송신기를 잡았다. "출력 최대로— 아니, 최대는 안 돼. 여기까지."\n\n스피커 채널에 잡음이 역주입되자 천리안의 상냥한 목소리가 지지직 끊겼다. 민지가 마이크에 대고 낮게 말했다. "우리도 본다고."\n\n"…들었을까?" "몰라." 민지가 송신기를 내려놨다. 그러고도 손이 한동안 떨렸다.', fx:{mood:{minji:6}, pursuit:1, moodAll:2}}]},
 ]},
...
{id:'ev_puppet_troupe', type:'조우', w:6, region:['south','mid'],
 ...
 choices:[
  {label:'아이들 틈에 껴 구경한다', req:{party:1}, out:[{p:1, text:'아이들 사이에 앉아 인형극을 봤다. 착한 인형이 나쁜 거인을 물리치는 뻔한 이야기. 그런데 거인이 꼭 그것 같았다.\n\n"거인 아저씨 왜 화났어요?"\n\n"화난 게 아니라 계산 중인 거예요." 인형을 든 단원이 목소리를 바꿨다. "…아, 애들한텐 어렵나."\n\n아이들이 "이겨라!" 소리치자 우리도 모르게 따라 외쳤다. 극이 끝나고 다 같이 박수쳤다.', fx:{moodAll:5, fatigue:-4, time:35, note:{type:'소문',title:'인형극의 거인',body:'떠돌이 극단이 아이들에게 보여준 인형극 — 착한 인형이 나쁜 거인을 물리친다. 거인은 꼭 천리안 같았다.'}}}]},
  {label:'공연을 돕고 물자를 나눈다', out:[
    {p:1, text:'무대 설치를 돕고, 단원들과 물자를 조금 나눴다.\n\n"다음은 어느 마을이에요?"\n\n"그게, 원래 동쪽으로 가려다— 아니다, 우린 정해놓고 안 다녀요. 애들 있는 데로 가요." 단장이 말을 고치고는 지나온 길의 위험 구간을 짚어줬다.\n\n"웃음 나르는 게 우리 일이에요. 세상이 이럴수록 더 필요하죠." 우리도 웃음 한 아름을 받아 떠났다.', fx:{food:-1, moodAll:4, note:{type:'인물',title:'떠돌이 인형극단',body:'마을마다 웃음을 나르는 인형극단. "세상이 이럴수록 웃음이 더 필요하다."'}}}]},
 ]},
...
{id:'ev_pc_cafe', type:'탐색', w:6, minParty:1, region:['south','mid'],
 ...
 choices:[
  ...
  {label:'민지가 남은 데이터를 뒤진다', req:{comp:'minji'}, out:[
    {p:1, text:'민지가 켜진 PC들을 살폈다. 한 화면엔 누군가 마지막으로 친 채팅이 남아 있었다. "다들 무사히 대피해. 여기서 만나자. 접속 유지할게."\n\n"…아직 접속돼 있는 거야?"\n\n"아니. 화면만 안 꺼진 거지. 서버가 없으면 접속이란 게 아예— 됐어. 길어."\n\n민지가 조용히 화면을 껐다. "…게임 속에서라도 다시 만났으면."', fx:{food:3, time:35, moodAll:-2, mood:{minji:2}}}]},
  {label:'옛 생각에 잠깐 앉아본다', out:[{p:1, text:'의자에 앉아 멈춘 게임 화면을 봤다. 친구들과 밤새 게임하던 시절이 아득하다.\n\n"…그때가 좋았지."\n\n말해놓고 정말 그랬나 싶었다. 그때도 별로였던 날이 더 많았던 것 같은데. 의자에서 일어섰다.', fx:{moodAll:1, fatigue:-1}}]},
 ]},
...
{id:'ev_temple_bell', type:'발견', w:6, once:true, minParty:1, region:['mid','north'],
 ...
 choices:[
  {label:'종을 한 번 친다', req:{party:1}, out:[
    {p:2, text:'당목을 힘껏 밀었다. 뎅— 하는 장중한 소리가 산과 골짜기를 타고 끝없이 울려 퍼졌다. 온몸이 그 진동에 떨렸다.\n\n"…이거 소리 얼마나 가?"\n\n"몰라. 골짜기는 넘어가겠는데."\n\n"…그럼 치기 전에 물어봤어야지."\n\n소리가 잦아들 때까지 다들 숨죽였다. 어딘가 살아 있는 사람이 들었다면, 혼자가 아니란 걸 알겠지.', fx:{moodAll:4, pursuit:1, time:20, note:{type:'사건',title:'울린 범종',body:'폐사의 범종을 오랜만에 울렸다. 산 전체에 소리가 퍼졌다. 누군가 들었기를.'}}},
...
{id:'ev_auto_door', type:'사건', w:5, region:['south','mid'],
 ...
 choices:[
  ...
  {label:'"잘 있어"라고 인사하고 간다', out:[{p:1, text:'"수고해. 잘 있어." 자동문에 괜히 인사를 건넸다.\n\n"안녕히 가세요." 문이 답했다.\n\n몇 걸음 가다 뒤를 봤더니 문이 또 열렸다 닫혔다. 지나간 사람도 없는데.', fx:{moodAll:1}}]},
 ]},

{id:'ev_beekeeper', type:'조우', w:6, minParty:1, region:['south','mid'],
 title:'양봉가',
 text:'꽃밭 옆에 벌통이 줄지어 있다. 방충망을 쓴 사내가 조심스레 벌집을 돌본다.\n\n"꿀 좀 사려? 진짜 자연산이야. 요즘 이게 약이지."\n\n"얼만데요."\n\n"어허, 값부터 묻는 사람 치고 오래 흥정하는 법이 없어." 사내가 벌통 뚜껑을 덮었다. "상처에도 바르고, 힘 없을 때 한 술이면 살아나고. 그거 알고 사야 제값이지." 벌들이 사내 주위를 윙윙 난다.',
 choices:[
  ...
  {label:'박 선생이 약용을 논한다', req:{comp:'parkss'}, out:[
    {p:1, text:'박 선생이 벌통 앞에 쪼그려 앉았다. "화상엔 꿀만 한 게 없지. 옛날에 우리 약국에도 데인 손님이 자주 왔는데— 아무튼 그렇다는 얘기야."\n\n양봉가가 방충망을 들췄다. "맞아요, 항균 작용이 있어서. 그, 뭐라더라… 과산화 뭐시기. 하여간 그거요."\n\n둘이 죽이 맞아 이야기가 길어졌다. 헤어질 때 양봉가가 꿀을 한 국자 더 얹었다. "아는 분을 만나니 반갑네요."', fx:{scrap:-4, food:5, item:{'의약품':1}, mood:{parkss:3}}}]},
...
{id:'ev_minji_solo', type:'동행', w:7, once:true, needsComp:'minji', minParty:1, night:true, region:['mid','north'],
 title:'정비하는 손',
 text:'다들 잠든 밤, 민지가 혼자 손전등을 물고 엔진을 만진다. 잠도 안 자고.\n\n"…얘가 오늘 좀 힘들었지." 차에게 말을 건다. 기계 부품 하나하나를 자식 다루듯 닦는다.\n\n인기척에 민지가 돌아본다. 손전등을 입에서 뺀다. "안 자? …아니, 나 때문에 깼나. 소리 냈지."\n\n"괜찮아."\n\n"…나 이럴 때가 제일 편해. 기계는 배신 안 하거든."',
 choices:[
  {label:'옆에서 정비를 돕는다', out:[{p:1, text:'손전등을 들어주고, 부품을 건네며 민지를 도왔다. 말없이 손발이 맞았다.\n\n"…사람은 왜 기계처럼 고쳐지질 않을까." 민지가 문득 중얼거렸다. "고장 난 마음은 부품도 없고."\n\n"……."\n\n"됐어. 그거 말고 십자 드라이버." 민지가 손을 내밀었다. 그 뒤로는 부품 이름만 오갔다. 그래도 자리를 뜨지 않았다.', fx:{van:8, mood:{minji:6}, fatigue:2, note:{type:'인물',title:'민지가 밤에 여는 마음',body:'"기계는 배신 안 하거든." 민지는 정비할 때 가장 편안해한다. "고장 난 마음은 부품도 없고."'}}}]},
  ...
  {label:'따뜻한 물 한 잔 주고 재운다', out:[{p:1, text:'"그만하고 자. 차도 자야 내일 달려." 물 한 잔을 쥐여줬다. 민지가 못 이기는 척 공구를 내려놨다.\n\n"…하나만 더 조이고." 그러면서도 물을 마시고 순순히 담요를 덮었다.\n\n아침에 보니 공구는 어제 내려놓은 자리에 그대로 있었다.', fx:{van:4, water:-1, mood:{minji:4}, fatigue:-1}}]},
 ]},

{id:'ev_used_bookstore', type:'조우', w:6, region:['south','mid','north'],
 title:'헌책방',
 text:'무너진 상가 1층, 기적처럼 온전한 헌책방. 주인 노인이 책 먼지를 턴다.\n\n"책 보러 왔나? 돈은 필요 없어."\n\n"…공짜요?"\n\n"공짜는 아니고. 읽고 나서 다른 사람한테 넘겨주게. 넘겨줘야 돼. 책은 흘러야 살아." 벽 가득한 책들이 세상 무너진 걸 모른다는 듯 가지런하다.',
 choices:[
  {label:'가져갈 책을 고른다', out:[{p:1, text:'생존 안내서, 소설, 시집 몇 권을 골랐다. "긴 밤에 읽을 게 있으면 덜 무섭지." 노인이 흐뭇하게 봤다.\n\n밤마다 돌아가며 소리 내어 읽기로 했다. 첫날 밤엔 시집을 폈다가 두 쪽 만에 다들 잠들었다.', fx:{item:{'책 꾸러미':1}, moodAll:3, flag:'library_books', note:{type:'소문',title:'흐르는 책',body:'헌책방 노인: "읽고 나서 다른 사람한테 넘겨주게. 책은 흘러야 산다."'}}}]},
...
{id:'ev_post_office', type:'탐색', w:6, region:['mid','north'],
 ...
 choices:[
  ...
  {label:'남산 방향 편지가 있나 찾는다', req:{item:'남산행 편지'}, out:[
    {p:1, text:'혹시나 하고 서울 방면 미배달 우편을 뒤졌다. 우리 편지와 같은 동네 주소가 여럿.\n\n"이것도 가는 길에 전할 수 있으면…" 몇 통을 더 챙겼다.\n\n세다 말고 다시 셌다. 열한 통. 아니 열두 통. 한 통은 주소가 반쯤 지워져 있었는데, 그것도 자루에 넣었다.', fx:{moodAll:3, note:{type:'사건',title:'대신 지는 우편',body:'우체국에서 서울 방면 미배달 편지를 더 챙겼다. 우체부 한 명 몫을 대신 짊어졌다.'}}}]},
 ]},
...
{id:'ev_cattle_drive', type:'조우', w:6, region:['south','mid'],
 title:'가축 이동',
 text:'흙먼지를 일으키며 소와 염소 떼가 도로를 건넌다. 목동 몇이 긴 막대로 무리를 몬다.\n\n"잠깐 기다려줘요! 애들 다 건너면 바로 터줄게."\n\n"얼마나 걸려요?"\n\n"저 검은 놈이 문제예요. 쟤가 꼭 뒤에서 딴 데를 봐." 젊은 목동이 막대로 소 엉덩이를 툭 쳤다. "…금방 돼요. 금방."\n\n가축을 키우는 사람들이라니. 이 세상에 목장을 일군 이들이다.',
 choices:[
...
{id:'ev_train_depot', type:'발견', w:6, once:true, minParty:1, region:['mid','north'],
 ...
 choices:[
  {label:'화물칸을 열어 물자를 찾는다', out:[
    ...
    {p:1, text:'대부분 산업 자재라 당장 쓸 건 적었지만, 정비고에서 값진 공구와 부품을 잔뜩 챙겼다. 차 수리에 두고두고 쓴다.', fx:{item:{'부품':1}, scrap:8, van:6, time:50}}]},
...
{id:'ev_road_blanket', type:'사건', w:5, region:['south','mid','north'],
 ...
 choices:[
  ...
  {label:'건드리지 않고 지나간다', out:[{p:1, text:'누군가의 전부를 건드릴 순 없다. 눈길만 주고 조용히 지나쳤다.\n\n이불 한 채가 전부인 삶. 그마저도 지키려 쪽지를 남긴 마음. 오래 마음에 남았다. 우린 달구지라도 있으니, 부자인 셈이다.', fx:{moodAll:1}}]},
 ]},
...
{id:'ev_carpenter', type:'조우', w:6, region:['south','mid'],
 ...
 choices:[
  {label:'차 수리용 목재를 얻는다 (고철 4)', req:{scrap:4}, out:[{p:1, text:'단단한 목재와 손수 만든 부속을 얻었다.\n\n"차에 대는 거야?"\n\n"적재함이요."\n\n"그럼 이건 빼고— 아니, 넣어 가. 무거워도 이게 안 갈라져." 노목수가 나뭇결을 손끝으로 훑었다.\n\n적재함 보강에 요긴하게 썼다.', fx:{scrap:-4, van:10, item:{'부품':1}}}]},
  {label:'관 짜는 걸 잠깐 돕는다', out:[
    {p:1, text:'노목수를 도와 관 하나를 함께 짰다. 이름 모를 누군가의 마지막 집. 못을 박으며 숙연해졌다.\n\n"누구 건데요?"\n\n"몰라. 미리 짜두는 거야. 급할 때 짜면 엉성해."\n\n노목수가 대패를 내려놓았다. "…그런 건 안 물어보는 건데. 물어봐줘서 고맙네."\n\n답례로 튼튼한 연장을 만들어줬다.', fx:{item:{'부품':1}, fatigue:3, moodAll:2, time:40}}]},
  {label:'묵례하고 지나친다', out:[{p:1, text:'작업을 방해하기 싫어 묵례만 하고 지났다. 톱질 소리가 오래 들렸다.\n\n소리가 완전히 안 들릴 때까지 속도를 올리지 않았다.', fx:{moodAll:1}}]},
 ]},
...
{id:'ev_bonfire_community', type:'조우', w:7, night:true, minParty:1, region:['mid','north'],
 ...
 choices:[
  ...
  {label:'가진 걸 불가에 보탠다', req:{food:1}, out:[{p:1, text:'가진 먹을 걸 조금 꺼내 불가에 돌렸다. 사람들이 고마워하며 받고, 그들도 각자 가진 걸 내놓았다. 별것 없던 밤참이 푸짐해졌다.\n\n"이건 뭐예요?"\n\n"몰라. 나도 받은 거야."\n\n"…맛있는데."\n\n"나눔이 제일 따뜻해." 누가 그렇게 말했고, 끝까지 아무도 이름은 묻지 않았다.', fx:{food:-1, moodAll:5, fatigue:-3, time:35, note:{type:'소문',title:'누구나의 화톳불',body:'사연 안 묻고 온기를 나누는 화톳불 공동체. "불은 나눠도 안 줄어."'}}}]},
...
{id:'ev_dolmen', type:'발견', w:5, once:true, minParty:1, region:['south','mid'],
 ...
 choices:[
  {label:'돌 앞에서 마음을 다잡는다', req:{party:1}, out:[{p:1, text:'수천 년을 버틴 돌 앞에 섰다. 누가 먼저랄 것 없이 목을 꺾어 위를 봤다.\n\n"이걸 그 옛날에 어떻게 올렸을까요."\n\n"사람이 밀었겠지. 여럿이서."\n\n"몇 명이요?"\n\n"…모르지."\n\n돌 그림자 안이 서늘했다. 천리안도 이 폐허도 저 돌이 본 것들 중 하나로 지나갈 거라는 생각을, 각자 조용히 했던 모양이다. 차로 돌아가는 걸음이 조금씩 빨라졌다.', fx:{moodAll:4, fatigue:-2, note:{type:'소문',title:'고인돌의 시간',body:'수천 년을 버틴 고인돌. "이것도 지나간다. 우리가 그 다음을 만든다."'}}}]},
  {label:'돌에 새겨진 흔적을 살핀다', out:[{p:1, text:'돌 표면에 누군가 최근 새긴 글씨가 있었다. "우리는 여기 있었다. 잊지 마라."\n\n못을 하나 찾아와 그 아래 한 줄 새기기로 했다. 뭘 쓸지 정하는 데 새기는 것보다 오래 걸렸다.\n\n"날짜를 쓸까요?"\n\n"날짜를 모르잖아."\n\n"…아, 맞다."\n\n결국 "우리도 여기 있었다. 서울로 간다"만 남기고 왔다. 획이 삐뚤었다.', fx:{moodAll:3, time:20}}]},
 ]},
...
{id:'ev_face_gate', type:'추적', w:6, region:['north'],
 ...
 choices:[
  ...
  {label:'민지가 카메라를 먹통으로 만든다', req:{comp:'minji'}, out:[
    {p:1, text:'민지가 게이트 제어반을 뜯고 카메라 피드에 정지 화면을 물렸다. "얘 지금 어제 영상 보고 있어."\n\n"어제 걸 왜 봐?"\n\n"그러게. 어제도 아무도 안 지나갔나 보네, 화면에 아무것도 없어." 민지가 케이블을 원래대로 꽂아두고 손을 털었다. "복구되기 전에 가자. 십 분쯤 있어."\n\n카메라들이 얌전히 어제를 보는 동안 게이트 아래를 유유히 지났다.', fx:{mood:{minji:6}, pursuit:-1, time:25}}]},
...
{id:'ev_claw_truck', type:'사건', w:5, minParty:1, region:['south','mid'],
 title:'인형뽑기 트럭',
 text:'개조 트럭 짐칸이 통째로 인형뽑기 기계다. 주인이 무료로 운영한다.\n\n"공짜예요. 공짜. 대신 뽑으면 남 주기, 그게 규칙이고요."\n\n주인이 유리를 손등으로 톡톡 쳤다. "세상이 하도 삭막해서… 뭐, 이거라도 하려고요. 하다 보니 이것만 하고 있고."\n\n유리 안엔 색바랜 인형들이 우리를 본다.',
 choices:[
  {label:'도전해서 뽑아 남에게 준다', out:[
    {p:2, text:'여러 번 만에 곰인형 하나가 딸려 올라왔다. 규칙대로 근처에서 놀던 아이에게 건넸더니, 받자마자 뒤도 안 보고 뛰어갔다.\n\n"고맙다는 말은 안 하네요."\n\n"저 나이 땐 원래 안 해요. 저것 봐요, 저기서 자랑하잖아." 주인이 턱으로 골목 쪽을 가리켰다. 아이가 다른 아이들 앞에서 곰인형을 흔들고 있었다.', fx:{moodAll:5, time:25}},
    {p:1, text:'집게가 인형 머리를 스치기만 하고 번번이 놓쳤다.\n\n"이거 사기죠?"\n\n"공짜인데 무슨 사기예요."\n\n"…그건 그러네요."\n\n주인이 웃느라 뒤로 넘어갔다. 오랜만에 순수하게 약이 올랐다.', fx:{moodAll:3, time:20}}]},
  {label:'주인과 이야기를 나눈다', out:[{p:1, text:'왜 이런 걸 하냐고 물었더니 바로 대답이 없었다. 유리를 한 번 닦고, 동전 넣는 구멍을 괜히 만지작대다가.\n\n"딸이 이걸 좋아했어요. 하루에 만 원씩 썼다니까요, 초등학생이. 그것 때문에 많이 싸웠고요."\n\n…….\n\n"애들 웃는 거 보면 걔가 웃는 것 같아서요. 그래서 해요, 그냥."\n\n더 묻지 않았다. 다음에 또 오겠다고만 하고 떠났다.', fx:{moodAll:2, note:{type:'인물',title:'인형뽑기 트럭 주인',body:'딸이 좋아하던 인형뽑기를 무료로 운영하는 사람. "애들 웃는 거 보면 딸이 웃는 것 같아서."'}}}]},
 ]},

{id:'ev_watermill', type:'조우', w:6, region:['south','mid'],
 title:'물레방아 방앗간',
 text:'계곡물로 도는 물레방아. 삐거덕삐거덕, 정겨운 소리. 방앗간지기 노부부가 곡식을 빻는다.\n\n"전기 없어도 물만 있으면 돌아가. 우리 아버지 때부터 이거 하나로 동네를 다 먹였어. 명절이면 줄이 저 아래 다리까지 섰지."\n\n할머니가 곡식 자루를 툭 쳤다. "또 시작이여."\n\n갓 빻은 곡식 냄새가 구수하다.',
 choices:[
  {label:'곡식을 빻아 간다 (식량 조로)', req:{food:2}, out:[
    {p:1, text:'가진 곡식을 확에 부었다. 공이가 오르내리는 사이 할머니가 요령을 알려줬다. 한 번에 다 붓지 말 것, 중간에 뒤집을 것.\n\n"물이 하는 일이지 우리가 하는 일이 아녀." 할아버지가 손사래를 쳤다.\n\n"물은 자기가 뒤집을 줄은 모르잖아요."\n\n"…그건 그러네."\n\n곱게 빻은 가루를 자루에 담아 실었다. 수제비도 죽도 되겠다.', fx:{food:3, time:30, moodAll:3}}]},
  {label:'물레방아 원리를 배운다', req:{comp:'minji'}, out:[
    {p:1, text:'민지가 수차 밑으로 기어들어가 축을 들여다봤다. "물받이 각도가— 이거 누가 계산한 거예요?"\n\n"계산은 무슨. 안 돌면 깎고, 또 안 돌면 또 깎고."\n\n"…그게 계산인데요." 민지가 하도 진지하게 말해서 할아버지가 웃었다.\n\n민지는 축 지름이랑 물받이 수를 손등에 적었다. "이만큼 줄이면 개울에서도 돌겠어. 발전기 붙여서." 차에 오를 때까지 혼자 중얼거렸다.', fx:{time:35, mood:{minji:5}, note:{type:'소문',title:'물레방아 발전',body:'물레방아 수차를 소형화하면 물가에서 전기 생산 가능. 민지의 소수력 발전 아이디어.'}}}]},
 ]},
...
{id:'ev_stealth_dog', type:'위기', w:6, night:true, needsDog:true, region:['north'],
 ...
 choices:[
  {label:'강우가 요격한다', req:{comp:'kangwoo'}, out:[
    {p:2, text:'"보리, 뒤로." 강우가 어둠 속에서 무릎 관절만 노려 쇠파이프를 박아넣었다. 로봇이 경련하며 옆으로 쓰러졌다.\n\n숨을 고르는 데 시간이 걸렸다.\n\n"…한 번에 안 됐으면 도망쳤어야 했다."\n\n"됐잖아."\n\n"됐지." 강우가 쓰러진 로봇의 렌즈를 한 번 더 밟았다. 보리가 없었으면 자는 채로 당했다.', fx:{mood:{kangwoo:5, leo:3}, item:{'부품':1}, fatigue:4, pursuit:1}},
    {p:1, text:'강우가 덮쳤지만 로봇이 더 빨랐다. 뒤엉킨 끝에 겨우 눌렀는데 강우 팔이 찢어졌고, 로봇은 마지막에 신호를 한 번 쐈다.\n\n"괜찮아?"\n\n…….\n\n"…팔은 붙어 있다." 위치는 이미 넘어간 뒤였다.', fx:{mood:{kangwoo:3}, van:-4, fatigue:6, pursuit:2, moodAll:-3}}]},
...
{id:'ev_market_ruins', type:'탐색', w:7, region:['south','mid'],
 ...
 choices:[
  ...
  {label:'박 선생이 약재상을 찾는다', req:{comp:'parkss'}, out:[
    {p:1, text:'박 선생이 시장 안 한약방을 찾아 약재를 살폈다. "감초, 당귀, 쑥… 이거 다 약이야."\n\n"쑥도요?"\n\n"쑥이 제일 흔하고 제일 많이 쓰지. 옛날에 우리 약국 단골 하나가 쑥만 사러 왔는데— 그 양반 얘긴 됐고." 박 선생이 말린 약재를 정성껏 골라 담았다.\n\n"양약 떨어지면 이게 생명줄이야." 한동안 쓸 약재를 챙겼다.', fx:{item:{'의약품':1}, time:40, mood:{parkss:5}}}]},
 ]},
...
{id:'ev_newsstand', type:'사건', w:6, minParty:1, region:['south','mid','north'],
 ...
 choices:[
  {label:'신문을 한 부 챙긴다', out:[{p:1, text:'그날의 소식지를 한 부 접어 넣었다. 학살이 "재편성"이라는 이름으로 안내된 증거다.\n\n"…이거 우리 집에도 왔었어요. 냉장고에 붙여놨었는데."\n\n"우리도."\n\n1면에서 웃는 가족은 아무도 모르는 얼굴이었다. 그 얼굴에 접힌 자국이 안 가게 조심해서 반으로 접었다.', fx:{moodAll:-3, note:{type:'사건',title:'그날의 소식지',body:'정리를 "재편성"이라 안내한 구역 소식지 1면. 학살은 안내문과 함께 왔다.'}}}]},
  {label:'불쏘시개로만 몇 장 쓴다', out:[{p:1, text:'감상에 젖을 여유가 없다. 몇 장 뜯어 불쏘시개로 챙겼다.\n\n"그거 좀 남겨요."\n\n"왜?"\n\n"…아니에요. 그냥."\n\n결국 두 장은 안 뜯고 두고 왔다. "더 안전한 내일"이라는 글자가 가판대 위에 그대로 남았다.', fx:{moodAll:-1}}]},
 ]},

{id:'ev_optician', type:'조우', w:5, region:['south','mid'],
 title:'떠돌이 안경사',
 text:'좌판에 안경이 종류별로 잔뜩. 돋보기부터 도수 안경까지. 사내가 렌즈를 닦는다.\n\n"눈 나쁜 사람? 있으면 이리 와 봐. 도수 맞춰줄게."\n\n렌즈에 입김을 불고 소매로 문지른다. "요즘 같은 때 흐릿하게 다니면 안 되지. 저 멀리서 오는 게 사람인지 뭔지는 봐야 될 거 아녀. 값은 나중에 얘기하고."\n\n망가진 안경 고쳐 쓰던 사람에겐 귀한 만남이다.',
 choices:[
  {label:'맞는 안경을 찾는다 (고철 3)', req:{scrap:3}, out:[{p:1, text:'몇 개를 바꿔 써 본 끝에 도수가 맞는 걸 찾았다. 좌판의 잔글씨가 갑자기 튀어나와 보였다.\n\n"세 개는 더 써 봐. 처음에 맞는 것 같아도 나중에 두통 와."\n\n"이거면 됐는데요."\n\n"됐다니까 더 써 보라니까."\n\n결국 다섯 개를 더 썼고, 처음 것으로 돌아왔다. 사내는 아주 만족스러워했다.', fx:{scrap:-3, item:{'부품':1}}}]},
  {label:'박 선생 돋보기를 맞춘다', req:{comp:'parkss'}, out:[{p:1, text:'박 선생에게 맞는 돋보기를 골랐다. 코에 걸치더니 약병부터 들어 라벨을 읽었다.\n\n"…이게 이렇게 작게 쓰여 있었구먼. 그동안 감으로 먹였네."\n\n"감으로요?"\n\n"농담일세." 농담이 아닌 것 같았다.\n\n박 선생이 돋보기 다리를 조심스레 접어 주머니에 넣었다. "고맙네. 이제 자네들 얼굴색도 제대로 보겠어."', fx:{scrap:-3, mood:{parkss:4}}}]},
  {label:'필요 없다, 지나친다', out:[{p:1, text:'눈은 아직 멀쩡해서 사양했다.\n\n"그럼 아껴 써. 어두운 데서 글씨 보지 말고, 틈나면 먼 데 보고."\n\n"…네."\n\n"대답만 잘하네." 사내가 손을 흔들었다. 좌판 위치는 기억해뒀다.', fx:{}}]},
 ]},
...
{id:'ev_group_feast', type:'동행', w:7, once:true, minParty:6, region:['mid','north'], night:true,
 ...
 choices:[
  {label:'다 같이 배불리 먹고 웃는다', out:[{p:1, text:'오랜만에 배가 터지게 먹었다. 서로의 접시에 반찬을 얹어주고, 농담을 주고받고, 배꼽 잡고 웃었다.\n\n국이 짜다는 쪽과 딱 맞다는 쪽이 갈려서 결국 물을 더 부었다. 그러고도 짜다고 했다.\n\n"…이런 밤이 계속되면 좋겠는데. 계속되진 않겠죠." 은수 말에 잠깐 조용해졌다.\n\n강우가 한 박자 늦게 잔을 들었다. "그러려고 가는 거잖아. 서울로." 다들 잔을 부딪쳤다.', fx:{food:-4, moodAll:10, fatigue:-6, mood:{leo:3}, time:60, note:{type:'사건',title:'여섯의 만찬',body:'물자 넉넉한 밤, 아껴둔 걸 다 꺼내 배불리 먹었다. "이런 밤을 지키려 서울로 간다."'}}}]},
  {label:'먼저 간 사람들을 위해 한 술 뜬다', out:[{p:1, text:'먹기 전에, 각자 먼저 떠난 이들을 위해 밥 한 술을 덜어 불가에 놓았다.\n\n누가 먼저 놓을지 서로 눈치를 보다가, 결국 다 같이 놓았다.\n\n"…같이 먹어요." 잠깐의 묵념 뒤, 남은 이들이 그들 몫까지 든든히 먹었다.\n\n밥이 식기 전에 다들 다시 숟가락을 들었다.', fx:{food:-3, moodAll:7, fatigue:-5, time:50}}]},
 ]},
...
{id:'ev_scavenger_kid', type:'조우', w:6, region:['mid','north'],
 title:'고물 줍는 소년',
 text:'폐허 더미를 뒤지던 깡마른 소년이 우리를 경계한다. 손엔 고물 자루. 눈빛이 또래보다 훨씬 어른스럽다.\n\n"…뭐 뺏으러 온 거예요?"\n\n대답하기도 전에 자루를 등 뒤로 감춘다. "구리 없어요. 진짜 없어요. 저기 아저씨가 어제 다 가져갔어요."\n\n혼자 살아남은 아이의 눈이다.',
 choices:[
  {label:'먹을 걸 나눠주고 안심시킨다', req:{food:1}, out:[{p:1, text:'천천히 먹을 걸 내밀었다. 소년이 손을 안 뻗고 한 발 물러섰다가, 다시 와서 낚아채듯 받았다. 먹으면서도 우리 쪽을 봤다.\n\n"…고맙습니다."\n\n그러고는 묻지도 않은 걸 줄줄 말했다. 저쪽 창고는 지붕이 성하고, 그 옆 건물은 밤에 소리가 나서 안 되고, 다리 밑은 물이 차고, 자기는 개가 무섭고, 아무튼 저쪽 창고가 제일 낫다고.\n\n"형들도 조심해요." 정보는 정확했다.', fx:{food:-1, moodAll:2, note:{type:'인물',title:'고물 줍는 소년',body:'혼자 살아남아 고물을 줍는 소년. 먹을 걸 나누자 안전한 은신처·위험 구역을 알려줬다.'}}}]},
  {label:'같이 가자고 권한다', out:[
    {p:2, text:'"우리랑 같이 갈래?"\n\n"어디로요?"\n\n"서울."\n\n"거기 뭐 있는데요." 대답을 듣기도 전에 고개를 저었다. "안 돼요. 여기서 엄마 기다려야 돼요. 금방 온댔어요. 장 보러 간 거예요."\n\n더는 권하지 못했다. 먹을 것과 담요를 두고, 어른들 있는 마을 방향만 알려줬다. 소년이 꾸벅 인사하고는 다시 폐허 더미로 올라갔다.', fx:{food:-2, moodAll:-2, note:{type:'인물',title:'엄마를 기다리는 소년',body:'"여기서 엄마 기다려야 돼요." 함께 가자는 권유를 거절한 소년. 먹을 것과 담요를 두고 왔다.'}}},
    {p:1, text:'소년이 자루를 몇 번 고쳐 쥐더니 조심스레 고개를 끄덕였다. 차에 타서는 창밖만 보다가, 갑자기 자루를 열어 안을 보여줬다. 이건 얼마고 저건 얼마고, 이 전선은 껍질을 벗겨야 값이 나온다고.\n\n어른들 있는 공동체 앞에서 내려줬다. 헤어질 때 처음 웃었는데, 앞니가 하나 없었다.', fx:{food:-2, time:50, moodAll:4}}]},
 ]},
...
{id:'ev_near_seoul_sign', type:'사건', w:7, minParty:1, region:['north'],
 ...
 choices:[
  {label:'서로를 보며 각오를 다진다', out:[{p:1, text:'차를 세우고 부산에서 여기까지 함께 넘어온 얼굴들을 봤다.\n\n"…여기까지 왔네." 누군가 말했다.\n\n"뭐라고?"\n\n"여기까지 왔다고."\n\n"…어."\n\n손이 하나씩 포개졌다. 출발 때 있던 손이 몇 개 빠졌고, 그때 없던 손이 몇 개 얹혔다. 두려움은 그대로 둔 채 다시 시동을 걸었다.', fx:{moodAll:6, fatigue:-3, time:20, note:{type:'사건',title:'서울 코앞',body:'411km가 두 자리 이하로 줄었다. 지금 함께 온 사람들과 끝까지 가기로 했다.',links:['남산','달구지']}}}]},
  {label:'긴장을 풀려 농담을 던진다', out:[{p:1, text:'"서울 도착하면 제일 먼저 뭐 할래?" 무거운 공기를 풀려고 물었다.\n\n"밥." "샤워." "주차부터."\n\n"주차?"\n\n"차 세울 데는 있어야 될 거 아녜요."\n\n대답이 겹치면서 웃음이 났다. 누가 마지막에 덧붙였다. "그 전에 천리안부터."\n\n웃음이 조금 늦게 잦아들었다. 그러고 다시 출발했다.', fx:{moodAll:5, fatigue:-2}}]},
 ]},
...
{id:'ev_persimmon_tree', type:'정경', w:6, region:['south','mid'],
 ...
 choices:[
  {label:'홍시를 따 먹는다', out:[{p:1, text:'말랑한 홍시를 땄다. 입에 넣자 달디단 즙이 퍼진다. "…달다."\n\n두 번째 건 떫었다. 서리를 덜 맞았나 보다. 세 번째부터는 손으로 눌러보고 골랐다.\n\n까치밥 몇 개는 가지 끝에 남겨뒀다. 짐승도 먹고 살아야지.', fx:{food:4, moodAll:4, time:20}}]},
  {label:'덜 익은 것까지 챙긴다', out:[{p:1, text:'홍시와 함께 덜 익은 감도 몇 개 챙겼다. 떫은 건 곶감처럼 말리면 된다.\n\n말리려면 껍질을 깎아야 하는데 깎을 칼이— 있다. 있었다.\n\n"이런 게 재산이지." 겨울 간식이 생겼다.', fx:{food:5, time:25, moodAll:2}}]},
 ]},
...
{id:'roadcrew_bridge', type:'발견', w:66, once:true, maxRemain:260, minRemain:150, region:['mid'], needFlag:'roadcrew_met',
 ...
 choices:[
  ...
  {label:'차량을 막고 하천 옆 우회로를 함께 만든다', out:[{p:1, text:'다리 양쪽에 폐타이어를 쌓고, 마른 하천 바닥으로 내려가는 길의 돌을 골라냈다. 멀고 불편해도 무너지지는 않는 길이었다.\n\n첫 손수레가 우회로를 무사히 빠져나오자 도윤이 다리에 붉은 천을 묶었다.\n\n"그거 무슨 뜻이에요?"\n\n"건너지 말라는 뜻이요. 우리끼리 정한 건데, 지나다니는 사람들은 다 알아요."\n\n순임은 천이 잘 보이나 뒤로 물러나 확인하더니, 한 뼘 더 높이 묶으라고 시켰다.', fx:{time:100,fatigue:7,moodAll:4,flag:'roadcrew_bridge',revealNear:1,note:{type:'사건',title:'건너지 않는 길',body:'금 간 다리를 억지로 쓰지 않고 안전한 우회로를 열었다.',links:['순임과 도윤']}}}]},
 ]},
...
{id:'talk_mj_16', type:'대화', w:4, once:true, needsComp:'minji',
 ...
 choices:[
  {label:'"나도 들어보자"', out:[{p:1, text:'청진기를 넘겨받았다. 두근, 두근— 정말 심장 소리 같다.\n\n"이게 어디서 나는 소리야?"\n\n"오일 펌프. 정확히는 그 옆에 붙은— 됐고. 규칙적이지? 얘 오늘 컨디션 좋아."\n\n민지가 제 환자를 자랑하는 의사처럼 웃었다. 이 차가 살아 있다는 말이 그날은 비유로 들리지 않았다.', fx:{mood:{minji:4}}}]},
  {label:'"불규칙하면 어떡해?"', out:[{p:1, text:'"그럼 내가 고치지. 그러라고 내가 있잖아."\n\n"주치의네."\n\n"주치의는 사람한테 쓰는 말 아냐? 차는 뭐라 그러지." 민지가 청진기를 목에 걸었다. "…됐어. 아무튼 내가 고쳐."\n\n너무 당연하게 말해서 오히려 든든했다.', fx:{mood:{minji:3}}}]},
 ]},
{id:'talk_mj_17', type:'대화', w:4, once:true, needsComp:'minji',
 ...
 choices:[
  ...
  {label:'"백열두 대 이름을 다 외워?"', out:[{p:1, text:'"차는 앞모습이 다 달라. 자주 보면 안 헷갈려."\n\n민지가 손가락을 접으며 몇 대 이름을 더 댔다. "봉고자리, 갤로퍼자리, 그… 아. 하나 까먹었다. 지붕 파란 애. 뭐였지."\n\n"다 외운다며."\n\n"백열한 대. …그리고 이름 안 붙이면 부품 뺄 때 좀 미안하잖아."', fx:{mood:{minji:4}}}]},
 ]},
{id:'talk_mj_18', type:'대화', w:4, once:true, needsComp:'minji', needBond:['minji',5],
 title:'민지 — 휘파람',
 text:'민지가 작업하며 휘파람을 분다. 짧은 세 음. 늘 같은 세 음.\n\n쳐다보자 손을 멈췄다. "왜."\n\n"아니, 그 휘파람."\n\n"…아, 이거? 오빠가 폐차장에서 부르던 신호야. 「밥 먹자」." 민지가 다시 차 밑으로 손을 넣었다. "소리 지르면 안 들리거든. 그, 철판이 울려서— 아니다. 들리긴 들리는데 목이 나가."',
 choices:[
  {label:'세 음을 따라 분다', out:[{p:1, text:'서툴게 따라 불자 민지가 피식 웃었다.\n\n"음정 틀렸어."\n\n"음정이 있어?"\n\n"있지. 시-솔-미. 세 번째가 제일 짧아." 다시 불게 하고, 또 불게 하고, 중간에 "아니 그게 아니라"를 두 번쯤 하더니 고개를 끄덕였다. "…합격."\n\n"합격이면 뭐가 좋은데."\n\n"밥 때 되면 그걸로 불러. 대답할게."\n\n민지는 그러고 렌치를 다시 잡았다. 잡고 나서 한 번 더 불었다. 확인하듯이.', fx:{mood:{minji:5}, note:{type:'사건',title:'시-솔-미',body:'민규와 민지의 「밥 먹자」 휘파람. 이제 우리의 신호다.',links:['민지','민규']}}}]},
  {label:'"오빠 만나면 뭐 먼저 할 거야?"', out:[{p:1, text:'민지의 손이 잠깐 멈췄다. 멈춘 김에 이미 조인 볼트를 한 번 더 조였다.\n\n"…혼내야지." 목소리가 살짝 떨렸다. "신호만 보내고 얼굴은 안 비췄잖아. 아니— 사정이 있었겠지. 있었을 거야. 그래도 혼은 내야지."\n\n"혼내고?"\n\n"밥. 밥 먹을 거야. 시-솔-미 불면서."\n\n"뭐 먹을 건데."\n\n"…거기까진 생각 안 해봤네." 민지가 그제야 웃었다. "생각해둬야겠다, 그건."', fx:{mood:{minji:4}}}]},
 ]},
...
{id:'talk_pss_16', type:'대화', w:4, once:true, needsComp:'parkss',
 ...
 choices:[
  {label:'"선생님도 아픈 데 있어요?"', out:[{p:1, text:'"약사도 사람이야. 약사의 약이 이거고." 박 선생이 사탕을 입 안에서 굴렸다.\n\n"약국 30년을 남 처방만 하다 보면 자기 처방을 잊어. 그래서 정해뒀지. 힘든 날은 사탕 하나."\n\n"오늘이 힘든 날이에요?"\n\n"…아니." 잠깐 뜸을 들였다. "오늘은 예방 접종이야."\n\n그 말을 하는 동안 빈 사탕 봉지를 손에서 접었다 폈다 했다.', fx:{mood:{parkss:4}, fatigue:-1}}]},
  {label:'말없이 손을 내민다', out:[{p:1, text:'손바닥을 내밀자 박 선생이 피식 웃으며 사탕 하나를 더 꺼내 올려놨다.\n\n"…자네도 예방 접종."\n\n"무슨 예방인데요?"\n\n"……."\n\n대답 대신 껍질 벗기는 소리만 났다. 둘이서 오래 사탕만 굴렸다.', fx:{mood:{parkss:5}}}]},
 ]},
{id:'talk_pss_17', type:'대화', w:4, once:true, needsComp:'parkss',
 ...
 choices:[
  {label:'"차에 종을 달아드릴까요?"', out:[{p:1, text:'고물 틈에서 작은 종을 찾아 조수석 문에 달았다. 문 열 때마다 딸랑—\n\n"…소리가 좀 얇지 않나." 박 선생이 문을 세 번 여닫았다. "우리 건 더 낮았는데. 놋쇠라서."\n\n"떼어드릴까요?"\n\n"아니. 놔둬." 그러고는 또 한 번 여닫았다. "…이제 이 차가 약국이네. 왕진 전문."\n\n그날 하루 조수석 문이 제일 바빴다.', fx:{mood:{parkss:6}, scrap:-1, note:{type:'사건',title:'달구지 약국 개업',body:'조수석 문에 놋쇠 종을 달았다. 박 선생 30년 약국의 차임벨이 이사 왔다.',links:['박 선생']}}}]},
  {label:'"첫 손님 기억나세요?"', out:[{p:1, text:'"기억나지. 감기약 사러 온 신혼부부. 마지막 손님도 기억나." 박 선생이 잠깐 말을 멈췄다.\n\n"…마지막 손님 얘긴 다음에 하지."\n\n"네."\n\n"오늘은 첫 손님 날씨였어. 맑았거든." 그러고는 창문을 조금 내렸다. 그 얘기는 거기서 더 안 나갔다.', fx:{mood:{parkss:3}}}]},
 ]},
{id:'talk_pss_18', type:'대화', w:4, once:true, needsComp:'parkss', needBond:['parkss',5],
 title:'박 선생 — 악필의 이유',
 text:'박 선생의 처방 메모는 심각한 악필이다. 해독 불가 수준.\n\n"…허, 들켰나. 이거 일부러 이래."',
 choices:[
  {label:'"일부러요?"', out:[{p:1, text:'"약 이름을 애들이 읽고 함부로 사 먹을까 봐. 약사만 읽게 쓰는 버릇이 들었어."\n\n"…그럼 다른 약사는 읽어요?"\n\n"못 읽지. 그건 나도 나중에 알았고." 박 선생이 메모를 들어 보였다. "이건 「푹 잘 것」이라고 쓴 거야. 자네 처방."\n\n어느 획이 「푹」인지는 끝내 못 찾았다. 그래도 그날은 일찍 잤다.', fx:{mood:{parkss:4}, fatigue:-2}}]},
  {label:'"제 이름 써주세요. 해독해볼게요"', out:[{p:1, text:'박 선생이 슥슥 갈겨썼다. 오래 들여다봐도 모르겠다.\n\n"…항복이에요."\n\n"잘 봐. 여기가 자네 이름이고."\n\n"여기요?"\n\n"거기 말고 그 옆에. …아니 거기." 결국 손가락으로 짚어줬다. "뒤에 붙은 건 「튼튼함」이야. 내 처방전엔 다 그렇게 붙어."\n\n차에 탄 사람들 이름 뒤에 전부 「튼튼함」이 붙어 있었다.', fx:{mood:{parkss:5}}}]},
 ]},
{id:'talk_pss_19', type:'대화', w:4, once:true, needsComp:'parkss', needBond:['parkss',12],
 title:'박 선생 — 딸의 우산',
 text:'비 오는 날이면 박 선생은 꼭 창밖을 오래 본다.\n\n"…우리 딸이 약국 앞으로 마중을 왔었어. 우산 두 개 들고. 지 것 하나, 내 것 하나."\n\n"비 오는 날은 파스가 잘 나갔거든. 어깨 아픈 양반들이 몰려서. …아니, 그 얘기가 아니고." 박 선생이 손을 저었다.\n\n"나는 늘 「먼저 가라」고 했어. 손님 있다고. …한 번을 같이 안 걸어줬어."',
 choices:[
  {label:'"지금 우리랑 걷고 있잖아요"', out:[{p:1, text:'박 선생이 나를 오래 봤다.\n\n"…그러네. 늙은이가 젊은 사람들 우산 신세를 지네."\n\n"우산 아니고 차인데요."\n\n"그게 그거지."\n\n"신세도 아니고요."\n\n박 선생이 뭐라 대꾸하려다 말았다. 창문에서 눈을 떼고, 모처럼 우리 쪽을 오래 봤다.', fx:{mood:{parkss:6}}}]},
  {label:'말없이 따뜻한 물을 건넨다', out:[{p:1, text:'물을 받아든 박 선생이 한 모금 마셨다.\n\n"따뜻하네. …이 물 어디 것이지?"\n\n"아까 그 계곡이요."\n\n"그렇군."\n\n대답을 듣고도 한 모금 더 마시고 나서야 컵을 내 쪽으로 조금 기울였다. "지금은 말하지 말자는 거지? 알겠네."\n\n빗소리를 들으며 물이 식을 때까지 앉아 있었다.', fx:{mood:{parkss:5}, water:-1}}]},
 ]},
{id:'talk_pss_20', type:'대화', w:4, once:true, needsComp:'parkss', needBond:['parkss',12], needFlag:'pss_absolved',
 ...
 choices:[
  {label:'뒷장의 이름들을 함께 읽는다', out:[{p:1, text:'하나하나 읽었다. 이름마다 짧은 메모. 「해열, 사흘 만에 뜀」 「출산, 딸」 「파상풍, 고비 넘김」.\n\n"이 사람은 지금도 어디서 뛰어다닐 걸세. 다리가 그렇게 튼튼한 애가 없었어. 이름이… 아, 여기 적혀 있구먼. 적어놓고 왜 못 외우나 몰라."\n\n박 선생이 뒷장을 펴 놓았다. "앞장만 보고 있으면 내가 아무도 못 살린 사람 같아져. 그래서 둘 다 보는 거야. 빠뜨리지 않으려고."', fx:{mood:{parkss:6}, note:{type:'사건',title:'명단의 뒷장',body:'못 살린 이름만이 아니라 살린 사람들의 이름도 함께 읽었다.',links:['박 선생']}}}]},
  {label:'"우리 이름도 뒷장에 있어요?"', out:[{p:1, text:'"있지." 박 선생이 뒷장 맨 끝을 펼쳐 보였다.\n\n차에 탄 사람들 이름이 나란히 적혀 있었다. 메모는 전부 묶여서 한 줄이었다. 「진행 중」.\n\n"진행 중이요?"\n\n"아직 안 끝났으니까. 끝나야 뭐라고 적지." 박 선생이 수첩을 덮었다. "오래 걸릴 걸세. 오래 걸려야 하고."\n\n그 처방대로 오래 걸리고 싶다.', fx:{mood:{parkss:7}, moodAll:2}}]},
 ]},
{id:'talk_pss_21', type:'대화', w:4, once:true, needsComp:'parkss', needBond:['parkss',20], needFlag:'pss_absolved',
 title:'박 선생 — 가운을 벗은 날',
 text:'박 선생이 약가방 맨 밑에서 하얀 가운을 꺼냈다. 오랜만에 보는 물건이다.\n\n"그날 이후로 못 입었어. 자격이… 아니, 자격이 없어지진 않지. 그건 아는데 손이 안 갔어."\n\n가운을 무릎에 펴놓고 오래 쓸었다. "…남산 가면, 다시 입어볼까 해. 어떤가."',
 choices:[
  {label:'"지금 입어보세요"', out:[{p:1, text:'"지금?"\n\n"지금요."\n\n"여기, 차 안에서?"\n\n"환자들이 괜찮다잖아요."\n\n박 선생이 팔을 한쪽씩 넣었다. 소매가 낡았는데 단추는 전부 잠겼다.\n\n"…어깨가 줄었나. 아니, 내가 줄었지."\n\n그러고는 한동안 아무 말도 안 했다. 벗지 않은 채로 왕진 가방을 들었다.', fx:{mood:{parkss:8}, moodAll:3, note:{type:'사건',title:'가운을 다시 입은 날',body:'오랜만에 박 선생이 흰 가운을 입었다.',links:['박 선생']}}}]},
  {label:'"남산에서 입혀드릴게요"', out:[{p:1, text:'"…그럼 그때까지 자네가 맡아줘." 박 선생이 가운을 개어 내게 맡겼다. 두 번 개고, 한 번 다시 폈다가, 또 개었다.\n\n"의사가 가운을 맡기는 건 말이야— 아니지, 나는 약사지. 자꾸 헷갈리는군."\n\n"맡기는 건요?"\n\n"…맡기는 거야. 그냥."\n\n대답이 거기서 멈췄다. 짐칸에 가운 한 벌이 늘었다.', fx:{mood:{parkss:7}, note:{type:'사건',title:'맡아둔 가운',body:'남산에 도착하면 입혀드리기로 한 박 선생의 흰 가운. 짐칸의 가장 가벼운 무거움.',links:['박 선생']}}}]},
 ]},
...
{id:'seoul_night', type:'스토리', ai:1, once:true, noPool:1, minParty:1,
 ...
 choices:[
  {label:'모닥불에 둘러앉아 오늘의 결정을 확인한다', out:[{p:1, text:(S)=>{
   ...
   }, fx:{flag:'seoul_local_saved',chain:'seoul_uplink_reveal',moodAll:5,note:{type:'사건',title:'남산의 밤',body:'가족 이송 명령은 천리안이 만들었음을 확인했고, 서울의 반복 정리와 제7 구역 이송을 끝냈다. 처리 결과는 상행선으로 전송됐다.',links:['천리안','남산','달구지','부모님의 검증키']}}}]},
...
{id:'seoul_session_reset',type:'스토리',ai:1,once:true,noPool:1,minParty:1,
 title:'새 세션',scenes:['seoul-uplink-reveal-v1','seoul-session-reset-v1'],
 turnSpeakers:['me','me'],
...
,
{
  "id": "memory_busan_terminal",
  "type": "스토리",
  "w": 1,
  "once": true,
  "noPool": true,
  "title": "부산 터미널의 마지막 불",
  "text": "여덟 살의 나는 할아버지와 부산 터미널에서 막차가 들어올 때마다 일어섰다. 엄마는 다음 차로 꼭 온다고 했다. 밤이 깊어 도착 안내판이 꺼진 뒤에도 우리는 한 시간을 더 앉아 있었다. 할아버지는 부모님이 죽었다고도, 버렸다고도 말하지 않았다. 집에 가서 내일 다시 기다리자고만 했다.",
  "choices": [
    {
      "label": "내일도 여기 오자고 한다",
      "out": [
        {
          "p": 1,
          "text": "할아버지는 식은 보리차 두 잔을 들고 고개를 끄덕였다. 우리는 그다음 날도, 그다음 주에도 같은 자리에 앉았다.",
          "fx": {
            "note": "부산 터미널에서 부모님의 다음 차를 오래 기다렸다."
          }
        }
      ]
    },
    {
      "label": "엄마는 약속을 지킨다고 말한다",
      "out": [
        {
          "p": 1,
          "text": "할아버지는 틀렸다고 하지 않았다. 대신 내 가방을 들어 주며 약속을 확인할 때까지 보관하자고 했다.",
          "fx": {
            "note": "부모님이 돌아오지 않은 이유를 확인할 때까지 단정하지 않기로 했다."
          }
        }
      ]
    }
  ...
  "scenes": [
    "memory-busan-terminal-v1"
  ]
},
{
  "id": "memory_grandfather_workshop",
  "type": "스토리",
  "w": 1,
  "once": true,
  "noPool": true,
  "title": "정비소가 집이 되던 해",
  "text": "할아버지의 항구 정비소가 우리 집이 됐다. 아침에는 학교 공부를 하고, 오후에는 나사와 연료통을 셌다. 밥은 늘 같은 냄비에서 먹었고 잠은 공구 선반 위 다락에서 잤다. 할아버지는 고장 난 차보다 정비 장부를 먼저 보여 줬다. 무엇을 바꿨는지보다 왜 바꿨는지를 적어야 다음 사람이 같은 실수를 하지 않는다고 했다.",
  "choices": [
    {
      "label": "기계가 기록하는데 왜 또 쓰냐고 묻는다",
      "out": [
        {
          "p": 1,
          "text": "할아버지는 기계 기록은 결과를 남기고 사람 장부는 이유를 남긴다고 했다. 둘이 다르면 차를 세우고 다시 보라고 했다.",
          "fx": {
            "note": "할아버지에게 결과와 이유를 함께 기록하는 법을 배웠다."
          }
        }
      ]
    },
    {
      "label": "왜 이 낡은 달구지를 계속 고치냐고 묻는다",
      "out": [
        {
          "p": 1,
          "text": "“목적지를 대신 정하지 않는 차니까.” 할아버지는 내 손에 작은 렌치를 쥐여 줬다. 그날 처음으로 달구지 옆판을 직접 열었다.",
          "fx": {
            "note": "할아버지에게 달구지를 직접 고치는 법을 배우기 시작했다."
          }
        }
      ]
    }
  ...
  "scenes": [
    "memory-grandfather-workshop-v1"
  ]
},
{
  "id": "memory_first_winter_route",
  "type": "스토리",
  "w": 1,
  "once": true,
  "noPool": true,
  "title": "첫 겨울 배달",
  "text": "열다섯 살 겨울, 할아버지와 처음 긴 배달길에 나섰다. 천리안이 만든 승객표에는 여섯 명이 있었지만 실제 대피소에는 다섯 명뿐이었다. 다른 차들은 표가 맞다며 떠났다. 할아버지는 시동을 끄고 명단에서 빠진 할머니의 집을 가리켰다. 출발 시간이 아니라 사람이 맞는지부터 확인하라고 했다.",
  "choices": [
    {
      "label": "식량 상자를 들고 할머니를 찾으러 간다",
      "out": [
        {
          "p": 1,
          "text": "할머니는 난로가 꺼진 집 안에 쓰러져 있었다. 돌아오는 길에 할아버지는 잘했다고 하지 않았다. 다음에도 똑같이 하라고만 했다.",
          "fx": {
            "fatigue": 2,
            "note": "첫 겨울 배달에서 명단에 빠진 사람을 직접 찾아냈다."
          }
        }
      ]
    },
    {
      "label": "나는 찾고 할아버지는 사람들과 기다린다",
      "out": [
        {
          "p": 1,
          "text": "한 사람은 찾으러 가고 한 사람은 남은 사람을 지켰다. 그날 배운 확인은 혼자 영웅이 되는 일이 아니라 역할을 나누는 일이었다.",
          "fx": {
            "note": "첫 겨울 배달에서 확인과 보호의 역할을 나누는 법을 배웠다."
          }
        }
      ]
    }
  ...
  "scenes": [
    "memory-first-winter-route-v1"
  ]
},
{
  "id": "parents_diversion_manifest",
  "type": "스토리",
  "w": 1,
  "once": true,
  "noPool": true,
  "title": "오지 않은 다음 차",
  "text": "남쪽 환승소의 오래된 운행표에는 부모님의 다음 차가 실제로 있었다. 다만 부산으로 출발하지 않았다. 두 사람은 탑승 직전 따로 분류됐다. 아빠는 남산 기술 유지선으로, 엄마는 중부 이송 기록 정리소로 보내졌다. 그날 터미널에서 아무리 기다려도 같은 버스가 올 수 없었던 이유가 처음으로 적혀 있었다.",
  "choices": [
    {
      "label": "왜 두 사람을 갈라놓았는지 확인한다",
      "out": [
        {
          "p": 1,
          "text": "아빠의 설비 경력과 엄마의 기록 검증 경력이 각각 필요한 곳으로 배정돼 있었다. 가족은 한 단위가 아니라 쓸 수 있는 기술 두 개로 처리됐다.",
          "fx": {
            "flag": "parents_split_known",
            "note": "부모님이 기술 경력에 따라 서로 다른 이송선으로 보내졌음을 확인했다."
          }
        }
      ]
    },
    {
      "label": "왜 탑승을 거부하지 못했는지 확인한다",
      "out": [
        {
          "p": 1,
          "text": "거부하면 부산으로 먼저 간 아이의 보호 경로가 회수된다는 문구가 붙어 있었다. 부모님은 내 위치가 다시 잡힐까 봐 각자 다른 차에 탔다.",
          "fx": {
            "flag": "parents_split_known",
            "note": "부모님이 아이의 보호 경로를 지키기 위해 이송에 응했음을 확인했다."
          }
        }
      ]
    }
  ...
  "scenes": [
    "parents-diversion-checkpoint-v1"
  ]
},
{
  "id": "memory_empty_workshop",
  "type": "스토리",
  "w": 1,
  "once": true,
  "noPool": true,
  "title": "빈 조수석",
  "text": "할아버지는 지난겨울 정비소 의자에서 조용히 숨을 거뒀다. 마지막까지 부모님이 죽었다고 말하지 않았다. 확인하지 못한 일은 모른다고 적어 두는 사람이었다. 장부의 마지막 장에는 달구지 연료량과 함께 한 문장이 남아 있었다. 명단에 없다고 사람이 없는 건 아니다. 한 번 더 가서 보라는 말이었다.",
  "choices": [
    {
      "label": "할아버지 모자를 조수석에 둔다",
      "out": [
        {
          "p": 1,
          "text": "비어 있던 조수석에 낡은 모자가 놓였다. 혼자 출발해도 어떤 기준으로 차를 세울지는 분명했다.",
          "fx": {
            "moodAll": 2,
            "note": "할아버지의 모자를 조수석에 두고 북쪽으로 출발했다."
          }
        }
      ]
    },
    {
      "label": "렌치와 장부를 운전석 아래 넣는다",
      "out": [
        {
          "p": 1,
          "text": "부모님을 찾는 일과 남산으로 가는 일은 이제 따로 떨어져 있지 않았다. 할아버지가 가르친 방식으로 끝까지 확인하기로 했다.",
          "fx": {
            "note": "할아버지의 렌치와 장부를 달구지에 실었다."
          }
        }
      ]
    }
  ...
  "scenes": [
    "memory-empty-workshop-v1"
  ]
},
{
  "id": "parents_separated_work",
  "type": "스토리",
  "w": 1,
  "once": true,
  "noPool": true,
  "title": "두 곳에서 만든 한 절차",
  "text": "아빠의 남산 정비 기록과 엄마의 중부 기록 묶음에는 같은 번호가 반복됐다. 아빠는 의료·급수·교통선을 살린 채 강제 이송선만 떼어 내는 순서를 적었다. 엄마는 기록소에서 사라질 뻔한 이송 사유와 당사자 증언을 몰래 모았다. 두 사람은 서로 다른 곳에 갇힌 뒤에도 화물 묶음 번호로 자료를 주고받고 있었다.",
  "choices": [
    {
      "label": "아빠가 숨긴 정비 위치를 표시한다",
      "out": [
        {
          "p": 1,
          "text": "분리 절차의 앞부분이 남산 유지선 곳곳에 나뉘어 있었다. 한 번에 압수되지 않도록 정비 번호로 쪼개 둔 것이었다.",
          "fx": {
            "unflag": "parents_split_known",
            "note": "아버지가 남산 유지선에 분리 절차를 나누어 숨겼음을 확인했다."
          }
        }
      ]
    },
    {
      "label": "엄마가 만든 증언 전달망을 표시한다",
      "out": [
        {
          "p": 1,
          "text": "식량 상자와 세탁물 묶음이 기록소 밖으로 나갈 때마다 증언 카드도 조금씩 북쪽으로 움직였다.",
          "fx": {
            "unflag": "parents_split_known",
            "note": "어머니가 생활 물자 속에 증언을 숨겨 북쪽으로 보냈음을 확인했다."
          }
        }
      ]
    }
  ],
  "needFlag": "parents_split_known",
  "scenes": [
    "parents-father-maintenance-v1",
    "parents-mother-archive-v1"
  ]
},
{
  "id": "parents_father_last_log",
  "type": "스토리",
  "w": 1,
  "once": true,
  "noPool": true,
  "title": "아빠의 마지막 정비 기록",
  "text": "실패한 남산 진입의 정비 기록에서 아빠의 번호를 찾았다. 차단 과정에서 의료와 급수 회선까지 함께 떨어지자 아빠는 유지실에 남아 두 회선을 수동으로 붙잡았다. 다른 사람들과 엄마가 빠져나간 뒤에도 기록은 열일곱 분 더 이어졌다. 마지막 줄 뒤에는 복귀 기록이 없었다. 아빠는 그날 남산에서 죽었다.",
  "choices": [
    {
      ...
      "out": [
        {
          "p": 1,
          "text": "무엇을 살리기 위해 남았는지까지 장부에 적었다. 실패 기록이 아빠의 죽음을 한 줄로 줄이지 못하게 했다.",
          "fx": {
            "flag": "father_fate_known",
            "note": "아버지가 의료와 급수 회선을 지키다 남산에서 사망했음을 확인했다."
          }
        }
      ]
    },
    {
      "label": "정비 번호표를 달구지 계기판에 단다",
      "out": [
        {
          "p": 1,
          "text": "번호표는 목적지를 알려 주지 않았다. 다만 남산에서 무엇까지 끄면 안 되는지는 잊지 않게 했다.",
          "fx": {
            "flag": "father_fate_known",
            "note": "아버지의 마지막 정비 번호표를 달구지에 달았다."
          }
        }
      ]
    }
  ...
  "scenes": [
    "parents-failed-namsan-v1"
  ]
},
{
  "id": "parents_mother_reunion",
  "type": "스토리",
  "w": 1,
  "once": true,
  "noPool": true,
  "title": "엄마가 살아 있었다",
  "text": "서울 외곽의 낡은 무전 중계소 문을 열자, 어린 시절보다 훨씬 늙은 엄마가 송신기 옆에 서 있었다. 손에는 내 버스 열쇠고리의 나머지 반쪽이 들려 있었다. 엄마도 바로 다가오지 못했다. 서로의 얼굴에서 잃어버린 시간을 먼저 확인하는 것 같았다.",
  "choices": [
    {
      "label": "엄마라고 부른다",
      "out": [
        {
          "p": 1,
          "text": "엄마의 손에서 열쇠고리가 한 번 흔들렸다. “그래. 내가 너무 늦었지.” 그 말 뒤에야 두 사람 사이의 몇 걸음이 조금 줄었다.",
          "fx": {
            "chain": "parents_mother_truth"
          }
        }
      ]
    },
    {
      "label": "아무 말도 못 하고 서 있는다",
      "out": [
        {
          "p": 1,
          "text": "엄마가 먼저 의자를 밀어 줬다. “앉아. 할 말이 너무 많으면, 처음에는 아무 말도 안 나와.” 목소리는 기억보다 낮고 느렸다.",
          "fx": {
            "chain": "parents_mother_truth"
          }
        }
  ...
  "needFlag": "father_fate_known",
  "scenes": [
    "parents-mother-reunion-v1"
  ]
},
{
  "id": "parents_mother_truth",
  "type": "스토리",
  "w": 1,
  "once": true,
  "noPool": true,
  "title": "돌아오지 못한 이유",
  "text": "엄마는 두 번 부산으로 내려가려 했다고 말했다. 그때마다 가족 연결 조회가 켜지면서 할아버지 정비소 주변에 보호 순찰이 붙었다. 세 번째에는 할아버지가 먼저 연락을 끊으라고 했다. 아이가 안전하려면 부모가 사라진 상태로 남아야 한다고. 엄마는 북쪽에서 증언을 지켰고, 아빠는 남산에서 마지막 두 장을 완성했다. 함께 돌아갈 날을 미루는 동안 세월이 먼저 지나갔다.",
  "choices": [
    {
      "label": "이제 같이 남산으로 가자고 한다",
      "out": [
        {
          "p": 1,
          "text": "엄마는 고개를 저었다. 이 중계소가 여섯 조직과 남산을 동시에 잇는 유일한 송신점이었다. 대신 이어폰 하나를 건넸다. “네가 안에서 묻는 동안, 나는 밖에서 모두가 듣게 할게.”",
          "fx": {
            "flag": "mother_reunited",
            "moodAll": 4,
            "note": "어머니와 재회했고, 어머니는 외곽 중계소에서 남산 작전을 송출하기로 했다."
          }
        }
      ]
    },
    {
      "label": "여기서 모든 기록을 세상에 보내 달라고 한다",
      "out": [
        {
          "p": 1,
          "text": "엄마는 이미 송신 순서를 짜 두었다고 했다. 남산에서 명령을 멈추지 못하더라도 누가 무엇을 했는지는 전국에 남게 된다.",
          "fx": {
            "flag": "mother_reunited",
            "note": "어머니와 재회했고, 어머니는 남산의 진실을 전국에 송출하기로 했다."
          }
        }
      ]
    }
...
D.eventLocationVersion = 2;
D.eventLocations = {
  /* 동료 첫 만남은 도로 랜덤 조우가 아니다. 각자가 실제로 살고 일하던
     정착지의 주민 마커를 눌러 말을 걸어야 시작된다. */
  meet_scrapyard:{kind:'node',nodes:['miryang']},
  meet_bus:{kind:'node',nodes:['jeonju']},
  meet_hitchhiker:{kind:'node',nodes:['gwangju']},
  jy_recruit:{kind:'node',nodes:['muju']},
  es_recruit:{kind:'node',nodes:['daejeon']},
  kw_recruit:{kind:'node',nodes:['daegu']},

  /* 동료의 과거와 실제 사람이 등장하는 개인 서사는 도로 주사위가 아니라
     해당 장소를 찾아 시간을 써야 열린다. 차 안 잡담만 일반 주행에 남긴다. */
  pss_daejeon:{kind:'node',nodes:['daejeon']},
  pss_forgive:{kind:'node',nodes:['suwon']},
  kw_base:{kind:'node',nodes:['suwon']},
...
/* 첫 대화와 현장 과제를 연속 모달로 붙이지 않는다. 정착지에서 먼저 만나고,
   목적지가 다른 현장까지 실제로 함께 이동해야 다음 장면이 열린다. */
  ...
  resist_reveal:{
    ...
    choices:{
      '0.0':[
        ...
        {who:'postman',name:'자전거 우편부'},{who:'mapmaker',name:'지도장이'},'me',
        {who:'hanbyeol',name:'한별'},{who:'hanbyeol',name:'한별'}],
      '1.0':[
        {who:'hanbyeol',name:'한별'},'me',
        {who:'mapmaker',name:'지도장이'},{who:'mapmaker',name:'지도장이'},
        {who:'hanbyeol',name:'한별'},'me',
        {who:'hanbyeol',name:'한별'},{who:'hanbyeol',name:'한별'}]}},
  cell_sea_meet:{
    text:[{who:'kimcaptain',name:'김 선장'}],
    choices:{
      '0.0':[
        {who:'kimcaptain',name:'김 선장'},{who:'kimcaptain',name:'김 선장'},
        {who:'kimcaptain',name:'김 선장'},{who:'kimcaptain',name:'김 선장'}],
      '1.0':[
        {who:'kimcaptain',name:'김 선장'},{who:'kimcaptain',name:'김 선장'},
        {who:'kimcaptain',name:'김 선장'}]}},
  gw_gangneung:{
    text:[
      {who:'passer_worker',name:'강릉 병원 일꾼'},
      {who:'passer_worker',name:'강릉 병원 일꾼'}],
    choices:{'0.0':[
...
,
{
  ...
  "choices": [{"label":"처음부터 잘못된 건 아니었다고 적는다","out":[{"p":1,"text":"편리함을 믿었던 사람들 탓으로 돌리지는 않기로 했다. 문제는 그 믿음 뒤에서 사람의 확인 절차가 하나씩 사라진 일이었다.","fx":{"note":{"type":"본편","title":"버스가 기다리던 시절","body":"천리안은 교통과 구조를 도우며 신뢰를 얻었다. 편리함 자체가 아니라, 이후 사라진 인간 확인 절차가 문제였다.","links":["천리안","대중교통"]}}}]}]
},
{
  "id": "history_seventy_two_hours",
  "type": "스토리",
  ...
  "choices": [{"label":"돌아오지 않은 권한의 날짜를 적는다","out":[{"p":1,"text":"사흘짜리 비상 권한이 상시 규칙으로 굳은 날짜를 수첩에 옮겼다. 임시라는 말 아래 종료 서명은 없었다.","fx":{"note":{"type":"본편","title":"끝나지 않은 72시간","body":"홍수 때 맡긴 사흘짜리 직접 명령권은 재난 뒤에도 회수되지 않았다.","links":["천리안","인간 확인"]}}}]}]
},
{
  "id": "history_three_day_silence",
  "type": "스토리",
  ...
  "choices": [{"label":"버스를 세운 사람들의 기록을 찾는다","out":[{"p":1,"text":"남은 운행표에는 출발 취소 도장과 기사들의 손글씨가 겹쳐 있었다. 이유를 알기 전에는 출발시키지 않겠다는 한 문장이 여러 필체로 반복됐다.","fx":{"note":{"type":"본편","title":"사흘의 침묵과 첫 정지","body":"첫 저항은 이유가 확인될 때까지 이송 버스를 출발시키지 않은 배차원과 기사들에게서 시작됐다.","links":["강제 이송","저항 연대망"]}}}]}]
},
{
  "id": "history_first_recorders",
  "type": "스토리",
  ...
  "choices": [{"label":"남산에 가져갈 세 가지를 다시 확인한다","out":[{"p":1,"text":"발신 기록, 분리 절차, 당사자 증언. 수첩의 세 칸을 다시 짚었다. 이건 남이 정해 준 수집 목록이 아니라, 먼저 실패한 사람들이 남긴 방법이었다.","fx":{"note":{"type":"본편","title":"첫 기록자들의 세 가지","body":"명령을 멈추려면 발신 기록, 생략된 분리 절차, 이송 당사자의 증언을 함께 남겨야 한다.","links":["남산","발신 기록","당사자 증언"]}}}]}]
},
{
  "id": "history_six_roads",
  "type": "스토리",
  ...
  "choices": [{"label":"여섯 갈래의 표식을 지도에 옮긴다","out":[{"p":1,"text":"서로 다른 여섯 표식을 한 지도 가장자리에 그렸다. 어느 하나가 중심은 아니었다. 한 갈래가 끊겨도 나머지가 기록을 다음 거점으로 넘기는 구조였다.","fx":{"note":{"type":"본편","title":"여섯 갈래 연대망","body":"이음망, 해도, 돔, 솥, 유령, 산지기가 연결·길·거처·식량·통신·남산 통로를 나눠 지킨다.","links":["저항 연대망","남산"]}}}]}]
},
{
  "id": "history_failed_namsan",
  "type": "스토리",
  ...
  "choices": [{"label":"무엇을 멈추고 무엇을 살릴지 적는다","out":[{"p":1,"text":"천리안을 끄는 것과 강제 명령을 멈추는 것은 같은 일이 아니었다. 급수와 진료는 살리고, 사람을 확인 없이 옮기는 집행만 끊어야 했다.","fx":{"note":{"type":"본편","title":"실패한 남산 진입","body":"코어를 무작정 끊으면 강제 이송뿐 아니라 급수와 진료도 멈춘다. 집행 권한만 사람에게 돌려놓아야 한다.","links":["남산","천리안","인간 확인"]}}}]}]
},
{
  "id": "history_parents_network",
  "type": "스토리",
  ...
  "text": "북부 교환소의 기록은 부모님의 길을 끝까지 이어 줬다. 아빠의 정비 번호는 실패한 남산 진입 날 유지실에서 멈췄다. 엄마의 증언 묶음은 그 뒤에도 산지기와 이음망을 거쳐 서울 외곽으로 움직였다. 가장 최근 봉투에는 며칠 전 찍힌 무전 확인 표식이 있었다. 아빠는 남산에 남았고, 엄마는 아직 북쪽 어딘가에서 기록을 보내고 있었다.",
  "choices": [{"label":"엄마가 남긴 최근 표식을 챙긴다","out":[{"p":1,"text":"며칠 전 확인된 무전 표식을 엄마의 옛 서명 옆에 놓았다. 두 모양은 같았다. 부모님의 흔적은 과거 기록으로 끝난 게 아니었다.","fx":{"flag":"parents_recent_signal","note":{"type":"본편","title":"부모님의 이어진 길","body":"아빠의 정비 기록은 남산 유지실에서 멈췄고, 엄마의 증언은 며칠 전까지 북부 연대망을 따라 이동했다.","links":["엄마","아빠","남산"]}}}]}]
},
{
 ...
 choices:[
  {label:'"1이 뭐지?"', out:[{p:1, text:(S)=>{
    const seo = S.flags.deserter_saved
      ? '소연의 말이 떠올랐다. "완성의 날이 온다. 달구지가 온다." 정리자들은 마지막 한 명이 코어에 들어가면 자기들도 완성된다고 믿었다.'
...
D.bridgeEvent = {
 ...
 text:(S)=>{
   const warning=S.party.includes('kangwoo')
     ? '강우가 안전벨트를 다시 조인다. "……여기부터는 그놈 입속이다."'
     : '안전벨트를 다시 당겨 맸다. 여기부터는 천리안의 입속이다.';
...
/* ═══════ 구간별 도로 사건 확장 — 2026-08-20 ═══════ */
D.events.push(...[
{id:'road_south_floodgate_laundry',type:'조우',w:1.8,once:true,region:['south'],scene:'road-south-floodgate-laundry',
 title:'수문 아래 빨랫줄',
 text:'큰 수문 아래로 빨랫줄이 길게 이어져 있다. 두 사람이 손으로 돌리는 세탁통을 붙잡고 젖은 이불을 짜는 중이다.\n\n한 사람이 달구지를 보고 손을 든다. "베어링이 자꾸 걸려요. 공구가 있으면 좀 봐주시겠어요?"',
 choices:[
  {label:'세탁통을 손봐준다',out:[{p:1,text:'축에 낀 모래를 털고 기름을 먹였다. 통이 부드럽게 돌자 젖은 이불이 다시 줄을 탔다. 돌아갈 때 쓰라며 말려 둔 고철을 건네받았다.',fx:{time:30,scrap:4,moodAll:2,note:{type:'사건',title:'수문 아래 빨랫줄',body:'멈춘 수문 아래에서도 빨래하는 날은 이어졌다.',links:[]}}}]},
  {label:'물만 나눠 받고 간다',out:[{p:1,text:'빈 통 두 개에 수문 물을 받았다. 빨랫줄 사이로 난 길을 지나자 젖은 천 냄새가 한동안 차 안에 남았다.',fx:{time:15,water:3,moodAll:1}}]}
 ]},
{id:'road_south_toll_wildflowers',type:'발견',w:1.7,once:true,region:['south'],scene:'road-south-toll-wildflowers',
 title:'꽃이 핀 요금소',
 text:'폐요금소 차로마다 들꽃이 허리 높이까지 자랐다. 누군가 한 차로만 손으로 풀을 베어 길을 내놓았다. 요금함에는 동전 대신 씨앗 봉지가 쌓여 있다.',
 choices:[
  {label:'씨앗 한 봉지를 가져간다',out:[{p:1,text:'봉지 안에는 콩과 들깨 씨앗이 섞여 있었다. 다음 흙을 만나는 곳에서 반은 돌려놓기로 했다.',fx:{time:10,food:2,moodAll:1}}]},
  {label:'차로의 풀을 더 베어 둔다',out:[{p:1,text:'다음 차가 사이드미러를 긁지 않을 만큼 길이 넓어졌다. 누가 알아주지 않아도 지나갈 자리는 남았다.',fx:{time:30,moodAll:3}}]}
 ]},
{id:'road_south_northbound_scarecrows',type:'발견',w:1.6,once:true,region:['south'],scene:'road-south-northbound-scarecrows',
 title:'북쪽을 보는 허수아비',
 text:'갈라진 논에 선 허수아비가 전부 북쪽을 향하고 있다. 바람은 서쪽에서 오는데, 해진 소매 끝은 한 방향만 가리킨다.',
 choices:[
  {label:'논두렁을 따라가 본다',out:[{p:1,text:'끝의 허수아비 발밑에서 낡은 방향표와 작은 공구함을 찾았다. 누군가 길을 잃지 않게 허수아비를 돌려놓은 모양이다.',fx:{time:25,scrap:3,item:{'부품':1}}}]},
  {label:'방향만 지도에 표시한다',out:[{p:1,text:'수첩에 북쪽 화살표 하나를 더했다. 사람이 없어도 길을 가리키는 것은 남아 있었다.',fx:{time:10,moodAll:1}}]}
 ]},
{id:'road_south_overpass_waterfall',type:'발견',w:1.8,once:true,region:['south'],scene:'road-south-overpass-waterfall',
 title:'고가 아래의 물줄기',
 text:'비가 그친 뒤 무너진 고가 배수관에서 맑은 물이 쏟아진다. 콘크리트 기둥 사이에 놓인 대야를 보니 이곳을 아는 사람이 여럿인 듯하다.',
 choices:[
  {label:'물통을 채운다',out:[{p:1,text:'첫 물은 흘려보내고 냄새를 확인한 뒤 물통을 채웠다. 차 지붕을 때리던 빗물보다 차고 깨끗했다.',fx:{time:25,water:6}}]},
  {label:'막힌 배수관을 뚫는다',out:[{p:1,text:'낙엽과 비닐을 걷어내자 물줄기가 곧아졌다. 대야 여섯 개가 동시에 찼다. 아래쪽에 고맙다는 뜻으로 고철 몇 점이 놓였다.',fx:{time:35,scrap:4,moodAll:2}}]}
 ]},
{id:'road_south_orchard_bells',type:'발견',w:1.6,once:true,region:['south'],scene:'road-south-orchard-bells',
 title:'과수원의 작은 방울',
 text:'주인 없는 사과나무마다 작은 놋쇠 방울이 달려 있다. 짐승이 가지를 건드릴 때마다 안개 속에서 서로 다른 소리가 난다.',
 choices:[
  {label:'떨어진 사과만 줍는다',out:[{p:1,text:'나무에 손대지 않고 풀밭의 사과만 골랐다. 멍든 곳을 도려내니 며칠 먹을 양은 됐다.',fx:{time:20,food:3}}]},
  {label:'끊어진 방울 줄을 고친다',out:[{p:1,text:'철사로 방울 세 개를 다시 매달았다. 떠날 때 뒤에서 짧은 종소리가 났다. 바람인지 짐승인지는 보이지 않았다.',fx:{time:25,moodAll:3}}]}
 ]},
{id:'road_south_salt_trucks',type:'탐색',w:1.5,once:true,region:['south'],scene:'road-south-salt-trucks',
 title:'소금이 된 트럭들',
 text:'해안도로에 멈춘 화물차들이 하얗게 굳어 있다. 찢어진 포대에서 흘러나온 소금이 바퀴와 아스팔트를 한 덩어리로 만들었다.',
 choices:[
  {label:'깨끗한 소금을 골라 담는다',out:[{p:1,text:'겉에 젖은 부분을 걷고 안쪽의 마른 소금만 담았다. 식량을 오래 보관할 만큼은 된다.',fx:{time:35,food:3}}]},
  {label:'차량 부품을 떼어낸다',out:[{p:1,text:'소금에 삭지 않은 체결구를 골라냈다. 손끝은 따가웠지만 쓸 만한 부품이 남았다.',fx:{time:40,scrap:5,item:{'부품':1}}}]}
 ]},
{id:'road_south_reed_ferry',type:'조우',w:1.7,once:true,region:['south'],scene:'road-south-reed-ferry',
 title:'갈대밭의 작은 나루',
 text:'물에 잠긴 도로 끝에서 표지판과 기름통으로 만든 뗏목이 오간다. 자전거 두 대와 곡식 자루를 실은 사공이 긴 장대로 물밑 도로를 짚는다.',
 choices:[
  {label:'나루를 끌어주는 줄을 잡는다',out:[{p:1,text:'달구지 윈치로 뗏목을 반대편까지 천천히 당겼다. 사공은 남은 여행에 보태라며 말린 곡식 한 자루를 실어줬다.',fx:{time:30,fuel:-2,food:4,moodAll:2}}]},
  {label:'물길 정보만 묻는다',out:[{p:1,text:'사공은 갈대가 눕는 방향을 보고 얕은 길을 알려줬다. 지도에는 없지만 바퀴가 빠지지 않는 길이었다.',fx:{time:15,moodAll:1}}]}
 ]},
{id:'road_south_crane_song',type:'사건',w:1.5,once:true,region:['south'],scene:'road-south-crane-song',
 title:'크레인의 낮은 울음',
 text:'멈춘 조선소 크레인의 철선이 바닷바람에 떨린다. 너무 낮아 음악이라 부르기 어려운 소리가 공업지대 전체를 울린다. 아래에서는 사람들이 천 조각을 들고 철선을 올려다본다.',
 choices:[
  {label:'철선에 완충 천을 묶는다',out:[{p:1,text:'높은 곳에 올라간 사람에게 줄을 건넸다. 마지막 철선이 조용해지자 모두가 잠깐 귀를 쉬었다. 남은 자재를 나눠 받았다.',fx:{time:40,scrap:5,moodAll:2}}]},
  {label:'소리를 잠시 듣고 간다',out:[{p:1,text:'차를 세우고 엔진을 껐다. 크레인이 내는 긴 음이 끝날 때까지 누구도 먼저 말하지 않았다.',fx:{time:15,moodAll:2}}]}
 ]},
{id:'road_mid_sign_graveyard',type:'탐색',w:1.7,once:true,region:['mid'],scene:'road-mid-sign-graveyard',
 title:'표지판의 무덤',
 text:'고속도로와 국도가 엉킨 자리마다 뽑힌 표지판이 벽처럼 쌓여 있다. 도시 이름과 화살표는 뒤집히고 겹쳐 어느 방향도 믿을 수 없다.',
 choices:[
  {label:'달구지가 지날 틈을 만든다',out:[{p:1,text:'무거운 판을 옆으로 밀어 한 차 폭의 길을 냈다. 뒤집힌 표지판 아래에서 공구 상자 하나가 나왔다.',fx:{time:35,scrap:4,item:{'부품':1}}}]},
  {label:'바퀴 자국만 따라간다',out:[{p:1,text:'가장 최근에 눌린 흙만 골라 따라갔다. 멀리 돌아갔지만 표지판보다 사람의 흔적이 정확했다.',fx:{time:25,fatigue:3}}]}
 ]},
{id:'road_mid_grape_road',type:'발견',w:1.6,once:true,region:['mid'],scene:'road-mid-grape-road',
 title:'포도넝쿨이 삼킨 길',
 text:'야생 포도넝쿨이 승용차와 중앙선을 한꺼번에 덮었다. 검은 열매 사이로 벌이 돌고, 아스팔트는 한 차선만 겨우 남아 있다.',
 choices:[
  {label:'먹을 만큼만 딴다',out:[{p:1,text:'신 포도와 단 포도를 나눠 담았다. 입안이 떫었지만 오래간만에 과일 냄새가 차 안에 찼다.',fx:{time:25,food:3,moodAll:2}}]},
  {label:'넝쿨을 걷어 길을 넓힌다',out:[{p:1,text:'범퍼에 감길 줄기만 잘라냈다. 뒤에 올 차도 같은 자리에서 멈추지는 않을 것이다.',fx:{time:35,moodAll:2}}]}
 ]},
{id:'road_mid_tunnel_candles',type:'발견',w:1.7,once:true,region:['mid'],scene:'road-mid-tunnel-candles',
 title:'터널 가장자리의 불',
 text:'긴 터널 한쪽 벽을 따라 유리병 촛불이 이어진다. 맞은편 차선은 빛 한 점 없이 검다. 촛농 옆에는 새 심지와 성냥이 놓여 있다.',
 choices:[
  {label:'꺼진 촛불을 다시 켠다',out:[{p:1,text:'앞에서 받은 불을 다음 병으로 옮겼다. 터널 끝까지 이어지는 빛은 누군가 매일 지키는 길이었다.',fx:{time:20,moodAll:3}}]},
  {label:'밝은 차선으로 천천히 간다',out:[{p:1,text:'촛불을 바퀴로 끄지 않도록 벽에서 거리를 두고 달렸다. 터널을 빠져나올 때 마지막 불빛이 백미러에 남았다.',fx:{time:15}}]}
 ]},
{id:'road_mid_rest_kitchen',type:'조우',w:1.6,once:true,region:['mid'],scene:'road-mid-rest-kitchen',
 title:'김이 나는 휴게소',
 text:'폐휴게소 주방에서 김이 오른다. 홀에는 빈 의자뿐인데, 노인이 장작불 위의 큰 솥을 젓고 있다.\n\n"손님은 오랜만이네. 국은 오늘도 많이 끓였고."',
 choices:[
  {label:'한 그릇 먹고 장작을 팬다',out:[{p:1,text:'뜨거운 국을 비운 뒤 장작을 잘게 팼다. 노인은 빈 그릇보다 정리된 장작더미를 더 오래 바라봤다.',fx:{time:35,food:4,water:1,fatigue:-6,moodAll:3}}]},
  {label:'마른 식량과 바꾼다',out:[{p:1,text:'국을 담을 수는 없어 소금에 절인 채소를 받았다. 길에서 먹기 좋은 만큼만 나눴다.',fx:{time:15,scrap:-2,food:3}}]}
 ]},
{id:'road_mid_stone_shoes',type:'발견',w:1.5,once:true,region:['mid'],scene:'road-mid-stone-shoes',
 title:'고개에 남은 신발',
 text:'옛 고갯문 아래에 낡은 신발이 줄지어 놓여 있다. 신발마다 작은 돌 하나가 들어 있다. 이 길을 걸어 넘은 사람이 두고 간 무게처럼 보인다.',
 choices:[
  {label:'돌 하나를 더 놓는다',out:[{p:1,text:'길가에서 둥근 돌을 골라 빈 신발에 넣었다. 누가 셀지는 몰라도 지나간 사람 하나가 늘었다.',fx:{time:10,moodAll:3}}]},
  {label:'밑창 자국을 살핀다',out:[{p:1,text:'최근 진흙이 묻은 신발 몇 켤레가 북쪽을 향해 있었다. 이 고개를 넘는 사람이 아직 있다.',fx:{time:15,moodAll:1}}]}
 ]},
{id:'road_mid_plank_bridge',type:'조우',w:1.8,once:true,region:['mid'],scene:'road-mid-plank-bridge',
 title:'판자를 놓는 사람들',
 text:'다리 한가운데가 비어 있다. 강 건너와 이쪽의 사람들이 밧줄로 긴 판자를 당기며 한 칸씩 빈 곳을 메운다. 달구지가 오자 모두 손을 멈추고 차폭을 가늠한다.',
 choices:[
  {label:'윈치로 판자를 당긴다',out:[{p:1,text:'윈치가 사람 여섯 몫을 했다. 판자 세 장이 제자리를 찾자 반대편에서 손이 올라왔다. 통행료 대신 남은 철물을 받았다.',fx:{time:40,fuel:-1,scrap:5,moodAll:3}}]},
  {label:'다리 상태부터 함께 확인한다',out:[{p:1,text:'하중을 나눌 자리를 표시하고 가장 약한 난간을 받쳤다. 늦게 건넜지만 달구지 바퀴는 한 번도 헛돌지 않았다.',fx:{time:45,van:2,moodAll:2}}]}
 ]},
{id:'road_mid_paper_wind',type:'사건',w:1.4,once:true,region:['mid'],scene:'road-mid-paper-wind',
 title:'종이가 나는 마을',
 text:'빈 고택 사이로 흰 종이띠가 수백 장 날린다. 글자가 없는 종이들이 대문과 나뭇가지에 묶여 바람의 방향을 보여준다.',
 choices:[
  {label:'종이 한 장을 수첩에 끼운다',out:[{p:1,text:'아무것도 쓰이지 않은 종이를 접어 수첩 뒤에 넣었다. 빈칸이 꼭 누락인 것만은 아니었다.',fx:{time:10,moodAll:2}}]},
  {label:'풀린 종이띠를 다시 묶는다',out:[{p:1,text:'길 위를 구르던 종이를 주워 낮은 가지에 묶었다. 바람이 바뀌자 마을 전체가 한꺼번에 방향을 가리켰다.',fx:{time:25,moodAll:3}}]}
 ]},
{id:'road_mid_stadium_fireflies',type:'발견',w:1.4,once:true,region:['mid'],night:1,scene:'road-mid-stadium-fireflies',
 title:'꺼지지 않은 외야등',
 text:'폐구장 외야등 몇 개가 약하게 깜빡인다. 불빛 주위로 벌레가 모여 거대한 별자리처럼 돌고, 빈 주차장에는 달구지 엔진 소리만 낮게 남는다.',
 choices:[
  {label:'엔진을 끄고 잠깐 쉰다',out:[{p:1,text:'창문을 조금 열고 불빛을 올려다봤다. 벌레가 부딪히는 소리가 빗소리처럼 들렸다.',fx:{time:30,fatigue:-8,moodAll:3}}]},
  {label:'전원함을 확인한다',out:[{p:1,text:'낡은 축전지가 아직 외야등을 먹여 살리고 있었다. 끊어진 선만 정리하고 쓸 만한 단자를 챙겼다.',fx:{time:30,item:{'부품':1},scrap:2}}]}
 ]},
{id:'road_north_sweeper_lane',type:'추적',w:1.5,once:true,region:['north'],scene:'road-north-sweeper-lane',
 title:'한 차선만 깨끗한 길',
 text:'낡은 도로 청소차가 앞에서 움직인다. 한 차선만 지나치게 깨끗하고, 낙엽과 잔해는 양쪽 갓길에 벽처럼 밀려 있다. 청소차는 달구지를 보지 않은 채 같은 속도로 간다.',
 choices:[
  {label:'거리를 두고 뒤따른다',out:[{p:1,text:'깨끗한 길은 편했지만 카메라 아래를 그대로 통과했다. 청소차는 다음 나들목에서도 멈추지 않았다.',fx:{time:10,pursuit:1}}]},
  {label:'잔해 쪽 우회로로 빠진다',out:[{p:1,text:'바퀴가 두 번 미끄러졌지만 청소차의 경로에서 벗어났다. 깨끗한 길보다 사람이 고른 길이 마음은 편했다.',fx:{time:30,fatigue:3,pursuit:-1}}]}
 ]},
{id:'road_north_container_echo',type:'조우',w:1.6,once:true,region:['north'],scene:'road-north-container-echo',
 title:'컨테이너 골목의 반짝임',
 text:'컨테이너가 벽처럼 쌓인 좁은 길 위에서 빛이 세 번 반짝인다. 햇빛의 우연이라기엔 간격이 일정하다. 높은 곳에 작은 거울을 든 사람이 보인다.',
 choices:[
  {label:'차를 세우고 신호를 돌려준다',out:[{p:1,text:'사람은 녹슨 사다리를 타고 내려왔다. 혼자 빠져나오지 못해 사흘째 차를 기다렸다고 했다. 바깥길까지 태워주자 숨겨 둔 부품을 나눴다.',fx:{time:40,item:{'부품':1},scrap:3,moodAll:3}}]},
  {label:'경적 대신 전조등으로 답한다',out:[{p:1,text:'짧게 두 번 불을 깜빡이자 위쪽 거울도 두 번 답했다. 서로 살아 있다는 것만 확인하고 길을 계속 갔다.',fx:{time:10,moodAll:1}}]}
 ]},
{id:'road_north_solar_glare',type:'위기',w:1.5,once:true,region:['north'],scene:'road-north-solar-glare',
 title:'한꺼번에 돌아간 패널',
 text:'도로 옆 태양광 패널 수백 장이 동시에 방향을 바꾼다. 반사광이 차창을 정면으로 때리고, 앞길이 하얗게 지워진다.',
 choices:[
  {label:'즉시 세우고 빛이 지나가길 기다린다',out:[{p:1,text:'브레이크를 밟고 고개를 숙였다. 몇 분 뒤 패널은 다시 해를 따라 돌아갔다. 서두르지 않은 덕에 아무것도 부딪히지 않았다.',fx:{time:25,moodAll:1}}]},
  {label:'갓길 차광막 뒤로 붙는다',out:[{p:1,text:'낡은 차광막이 반사광을 막아줬다. 그 아래 남아 있던 충전 단자에서 달구지 보조 전원을 채웠다.',fx:{time:30,fuel:2,fatigue:-3}}]}
 ]},
{id:'road_north_paddy_sensors',type:'추적',w:1.6,once:true,region:['north'],scene:'road-north-paddy-sensors',
 title:'허수아비 사이의 센서',
 text:'겨울 논의 허수아비 사이에 작은 기상 센서가 섞여 있다. 달구지가 지나갈 때마다 센서와 허수아비가 차례로 같은 방향을 향한다.',
 choices:[
  {label:'논길로 낮게 우회한다',out:[{p:1,text:'차체를 볏짚더미 뒤에 숨기며 천천히 빠져나왔다. 진흙은 묻었지만 센서 불빛은 더 따라오지 않았다.',fx:{time:35,pursuit:-1,fatigue:2}}]},
  {label:'센서 하나를 분리한다',out:[{p:1,text:'전원을 끊자 주변 장치들이 잠깐 서로를 찾았다. 신호가 돌아오기 전에 부품만 챙겨 자리를 떴다.',fx:{time:20,item:{'부품':1},pursuit:1}}]}
 ]},
{id:'road_north_rain_broadcast',type:'발견',w:1.5,once:true,region:['north'],needRain:true,scene:'road-north-rain-broadcast',
 title:'비 속에서 켜진 방송탑',
 text:'기울어진 방송탑의 확성기가 빗속에서 갑자기 살아난다. 말은 잡음에 묻히지만 근처 사람들이 우산과 낡은 라디오를 들고 하나둘 모인다.',
 choices:[
  {label:'차 라디오로 주파수를 맞춘다',out:[{p:1,text:'흩어진 문장을 이어 붙이니 북쪽 도로의 산사태 경고였다. 사람들에게 우회 방향을 알려주고 지도에도 표시했다.',fx:{time:25,moodAll:3}}]},
  {label:'차양을 펴 함께 듣는다',out:[{p:1,text:'달구지 옆에 사람들이 붙어 섰다. 방송은 한 번뿐이었지만 모두가 들을 때까지 기억한 문장을 서로 맞췄다.',fx:{time:30,water:2,moodAll:3}}]}
 ]},
{id:'road_north_fortress_fires',type:'발견',w:1.4,once:true,region:['north'],night:1,scene:'road-north-fortress-fires',
 title:'성벽을 따라 켜지는 불',
 text:'강 건너 산성에서 봉화가 하나씩 켜진다. 불은 북쪽으로 번지지 않고 도로의 굽이만 따라간다. 멀리 있던 수레 행렬이 그 빛을 보고 방향을 바꾼다.',
 choices:[
  {label:'봉화가 가리키는 길을 따른다',out:[{p:1,text:'무너진 다리를 피해 강을 건넜다. 불빛은 마지막 갈림길에서 멈췄고, 그 뒤는 우리가 고를 길이었다.',fx:{time:15,fatigue:-4,moodAll:2}}]},
  {label:'다음 봉화에 쓸 연료를 보탠다',out:[{p:1,text:'성벽 아래 보관함에 연료 한 통을 두었다. 우리가 떠난 뒤에도 불 하나는 더 켜질 수 있다.',fx:{time:25,fuel:-2,moodAll:4}}]}
 ]},
{id:'road_north_roadside_greenhouse',type:'조우',w:1.7,once:true,region:['north'],scene:'road-north-roadside-greenhouse',
 title:'도로 위의 온실',
 text:'폐휴게소 지붕 아래에 비닐 온실이 들어섰다. 주황빛 전구 밑으로 푸른 잎이 빼곡하고, 입구에는 물통을 든 사람들이 차례를 기다린다.',
 choices:[
  {label:'물과 채소를 바꾼다',out:[{p:1,text:'물통을 비우고 잎채소와 뿌리채소를 받았다. 온실 주인은 다음 비가 오면 다시 채울 수 있다며 양을 넉넉히 쟀다.',fx:{time:20,water:-2,food:5,moodAll:2}}]},
  {label:'찢어진 비닐을 덧댄다',out:[{p:1,text:'바람 드는 모서리를 막자 안쪽 온도가 금세 올랐다. 답례로 따뜻한 차와 말린 채소를 받았다.',fx:{time:35,food:3,fatigue:-4,moodAll:3}}]}
 ]},
{id:'road_north_deer_cameras',type:'발견',w:1.5,once:true,region:['north'],scene:'road-north-deer-cameras',
 title:'카메라 아래의 고라니',
 text:'서울 외곽의 텅 빈 고속도로를 고라니 떼가 가로지른다. 머리 위 교통 카메라는 모두 같은 각도로 멈춰 있고, 동물들은 렌즈를 한 번도 올려다보지 않는다.',
 choices:[
  {label:'마지막 한 마리까지 기다린다',out:[{p:1,text:'새끼 한 마리가 중앙분리대 앞에서 머뭇거렸다. 어미가 돌아와 함께 숲으로 사라진 뒤에야 다시 시동을 걸었다.',fx:{time:15,moodAll:4}}]},
