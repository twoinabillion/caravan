...
(() => {
  ...
  D.companionMilestones = Object.assign({
    ...
    kangwoo: ['차 안에서 지킬 선을 정한다', '명령보다 사람을 먼저 보는 법을 확인한다', '수비대에서 있었던 일을 끝까지 듣는다'],
    leo: ['농담 뒤의 침묵을 알아챈다', '끝내지 못한 노래를 함께 붙든다', '길 위 사람들의 목소리로 노래를 완성한다'],
    jaeyi: ['물건과 사람의 값을 다르게 매긴다', '열쇠가 가리키는 곳까지 동행한다', '떠나온 자리와 다시 마주한다'],
    eunsu: ['기록하지 않을 말도 있다는 걸 배운다', '관제실에서 놓친 신호를 다시 연다', '자신이 남긴 접속 코드의 책임을 진다']
  ...
  const chats = [
    ...
    },
    {
      ...
      lines: [
        ...
        ['minji', '아저씨를 못 믿는 게 아니라, 밤을 못 믿는 거예요. 밤에는 다들 참을성이 줄잖아요.'],
    ...
    },
    {
      ...
      lines: [
        ...
        ['eunsu', '위로는 별로 안 됩니다.'],
        ['parkss', '위로하려고 한 말이 아니에요. 모르는 걸 안다고 해 주면 은수 씨가 제일 싫어하잖아요.'],
    ...
    },
    {
      ...
      lines: [
        ...
        ['parkss', '아니요. 확인할 기회를 믿는 편이에요. 사람은 그다음이고.']
      ]
    },
    {
