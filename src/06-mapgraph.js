...
const MAPR = (()=>{
  ...
  const COAST = [
    /* 휴전선 (서→동, 동쪽이 약간 더 북) */
    [214,140],[248,130],[292,122],[338,114],[386,106],[434,100],[478,96],[504,104],
    /* 동해안 (북→남) — 직선, 포항 영일만만 돌출 */
    [508,150],[510,200],[508,250],[510,305],[514,355],[520,405],
    [528,460],[532,492],[516,512],
    [520,552],[512,592],[502,626],[494,652],
    /* 남해안 (동→서) — 다도해, 여수·고흥 반도 */
    [474,656],[458,672],[440,652],[422,670],[402,650],[384,672],
    [364,652],[346,672],[328,652],[310,668],[292,652],[274,666],
    [256,650],[238,660],[222,648],
    /* 목포·서남 끝 */
    [210,632],[202,612],
    /* 서해안 (남→북) — 리아스 + 태안반도 + 경기만 */
    [210,586],[196,564],[210,540],[194,518],[208,494],[196,472],
    [204,450],[212,428],[190,404],[178,380],[194,358],
    [186,334],[204,310],[192,284],[206,258],[194,232],[208,206],[200,180],[212,158],
  ];
  /* 섬들 (장식) — [x,y,rx,ry] */
  const ISLES = [
    [458,672,9,4],[388,684,11,4],[300,682,8,3],[236,668,7,3],[344,690,5,2],  // 거제·남해·완도·진도·소섬
    [176,300,3,1.6],[170,352,2.5,1.4],[182,420,3,1.6],[174,470,2.5,1.4],[186,522,3,1.6], // 서해 섬
    [556,150,4,2],[566,156,1.5,1],                                            // 울릉도·독도
  ];
  /* 백두대간·소백산맥 능선 (장식) */
  const RIDGE = [
    [[470,110],[478,160],[470,215],[458,270],[448,330],[430,390]],   // 태백(강원 동부)
    [[430,390],[404,418],[374,448],[344,478],[314,510],[290,542]],   // 소백
  ];
  ...
  function draw(dt){
    ...
    ctx.beginPath();
    [[218,148],[262,138],[310,128],[360,118],[410,110],[478,102]].forEach((p,i)=>
