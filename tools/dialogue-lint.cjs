...
const source = ['03-data.js','03k-main-evidence.js','03l-main-recovery.js','03m-finale-reading.js','03n-route-aftermath.js'].map(file=>fs.readFileSync(path.join(root,'src',file),'utf8')).join('\n');
