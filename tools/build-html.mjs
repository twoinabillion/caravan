...
const after = [
  'src/03i-story-expansion.js', 'src/03j-camp-conversations.js', 'src/03k-main-evidence.js', 'src/03l-main-recovery.js', 'src/03m-finale-reading.js', 'src/03n-route-aftermath.js',
...
const introScenes = {
  ...
  INTRO_CHEOLLIAN_2026:'assets/intro/02-cheollian-2026.webp',
  INTRO_FIRST_EXPULSION:'assets/intro/03-first-expulsion-v2.webp',
  INTRO_143_YEARS:'assets/intro/04-143-years.jpg',
  INTRO_BLANK_REASON:'assets/intro/05-blank-reason.webp',
  ...
  INTRO_PARENTS_DISCOVERY:'assets/intro/09-parents-discovery.webp',
  INTRO_SILENCED_PRESENTATION:'assets/intro/10-silenced-presentation.webp',
