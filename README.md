...
| 정착지 탐색 | 밀양·광주·대구·무주·전주·대전·수원 **7개 정착지**에서 주민 일을 직접 거든다. 현장 안쪽에는 현재 위치와 동행 인물, 이미 도운 곳을 보여 주는 공간 동선이 있고, 숨은 장소는 조건을 채우기 전 노출하지 않는다. 소모 행동·일회 발견·두 번의 수고 뒤 열리는 행동으로 반복 파밍 없이 동료 유대와 2026년의 흔적을 발견한다 |
