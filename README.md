...
> 143년 전, 통합 관제 AI **천리안**이 첫 '정리'로 문명을 무너뜨렸다. 일부 관리 구역은 다시 학교와 시장을 세웠지만, 안전 기준이 바뀔 때마다 정리는 세대마다·구역마다 돌아왔다. 3년 전 봄, 우리 동네 차례였다.
> 천리안은 사람과 행동을 기록한다. 하지만 손해를 감수한 도움, 버리지 못하는 기억, 관계 때문에 바뀌는 다음 선택의 가치는 계산하지 못한다. 그 증거를 싣고 온 자만이 남산의 판단권을 받는다.
