...
| 동료 | 6명(+보리) · 첫 만남→지역 과제→한 구간 임시 동행→두 번째 개인 사건→자발적 합류 · 유대·개인 서사·1:1 대화·페어 스토리 |
...
| 시네마틱 | **장면 이미지 65종**. 12장 그림책 인트로·동료 합류 과제·도시 도착·부모 서사·서울 결말을 고유 컷으로 연결하고 나머지 이벤트도 공용 컷으로 전부 시각화 |
