...
| 출발 이유 | 엄마의 철제 상자에서 현재 이송 명령과 같은 규격의 남산 회로도, 달구지 계기판 속 검증 모듈을 발견한다. **첫 이송까지 30일** 안에 뜯긴 분리 절차·발신 기록·당사자 증언을 모아 이번 명령을 멈추는 것이 현재의 목표다 |
| 세대의 흔적 | 143년의 추방이 행정·말·길·생활용품에 남긴 9개 기록. 2026년의 응원봉·월드컵 대진표·네 컷 사진·배송 가방도 2169년의 생활로 변형 |
| 정착지 탐색 | 밀양·광주·대구·무주·전주·대전·수원 **7개 정착지**에서 주민 일을 직접 거든다. 현재 위치와 동행 인물, 이미 도운 곳을 보여 주는 현장 동선에서 숨은 장소를 직접 연다. 처음 거든 일은 세이브에 영구히 남아 같은 배경의 불빛·증기·물길·작업 흔적을 바꾸고, 재방문 대사와 현지 신뢰·품앗이 가격·교환 조건까지 이어진다. 작업 직후에는 ‘작업 전→지금’을 한 화면에서 비교한다 |
...
| 전투 | 북부 초계·드론·검문소의 **정찰→대응→교전/이탈 3단계**. 같은 전술을 연속 사용하면 상대가 읽고, 전술 전환과 동료 전문 연계가 유리해진다. 폐차 행렬·터널·배수로 같은 지형 적합도, 소음 노출, 앞 단계에서 쌓인 시간 압박이 실제 성공률을 바꾸며 목표·실패 위험·압박은 HUD와 교전 일지에 남는다 |
| 시네마틱 | **장면 이미지 107종**. 제목 화면의 스포일러 없는 8장짜리 「여정 미리보기」와, 이름을 먼저 정한 뒤 어린 주인공 전용 초상으로 시작하는 **14장 그림책 인트로**. 엄마의 유품과 계기판 모듈을 발견하는 새 장면, 동료별 합류 18장, 전투·도로수선단·도시 도착·부모 서사·서울의 증언과 해방까지 고유 컷으로 연결한다 |
| UI·접근성 | 동료 과제 중에도 일반 의뢰와 마감이 사라지지 않는 이중 미션 표시 · 상태창에서 출발 이유와 남은 준비를 상시 확인 · 인트로 자동 진행 ON/OFF와 재방문 건너뛰기 · 기기별 큰 글자·움직임 줄임 설정 · 움직임 줄임 시 캔버스 갱신 부담 완화 · 키보드 모달 포커스 순환 · 탭 선택 상태와 장면별 스크린리더 안내 |
