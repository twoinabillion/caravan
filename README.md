...
| 정착지 탐색 | 밀양·광주·대구·무주·전주·대전·수원 **7개 정착지**에서 주민 일을 직접 거든다. 장소마다 소모 행동·일회 발견·두 번의 수고 뒤 열리는 숨은 행동이 있고, 같은 날 반복 파밍 없이 동료 유대와 2026년의 흔적을 발견한다 |
...
| 전투 | 북부 초계·드론·검문소의 **정찰→대응→교전/이탈 3단계**. 같은 전술을 연속 사용하면 상대가 읽고, 전술 전환과 동료 전문 연계가 유리해진다. 전술 기록은 일지에 남고 실패 부상은 2–3일 동안 운전 피로·동료 퍼크에 남는다 |
...
| UI·접근성 | 동료 과제 중에도 일반 의뢰와 마감이 사라지지 않는 이중 미션 표시 · 상태창에서 출발 이유와 남은 준비를 상시 확인 · 인트로 자동 진행 ON/OFF와 재방문 건너뛰기 · 키보드 모달 포커스 순환 · 탭 선택 상태와 장면별 스크린리더 안내 |
