...
| 시네마틱 | **장면 이미지 58종**. 11장 그림책 인트로·도시 도착·부모 서사·서울 결말을 고유 컷으로 연결하고 나머지 836개 이벤트도 공용 컷으로 전부 시각화 |
...
낡은 봉고차 **달구지**를 고치고 확장하면서 부산에서 서울 남산까지 411km를 이동한다. 날씨와 시간대가 바뀌는 도로, 생존자들과의 선택, 동료 관계, 천리안의 추적이 하나의 여정을 만든다. 무작위 사건이 많아도 본편이 묻히지 않도록 60·100·140·220·240·300km에서 세대 서사와 부모의 수정안이 다음 도착 장면으로 보장된다.
