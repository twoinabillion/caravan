...
| 지도 | 노드 58곳 전부 WGS84 실측 좌표 · 도로 77 · 오프라인 여정도 + **대한민국 OSM 2026 기록**(주요 도로 54,438·철도 8,922·도시/읍 1,497) + 서울 서남부 골목/건물 상세 + 선택형 V-World 2D |
...
```
src/     01-style → 02-dom → 03-data → 03h-osm → 03b-portraits → 03c-icons → 03d-bgm → 03f-npc-portraits
...
불변 설정은 [docs/SERIES-BIBLE.md](docs/SERIES-BIBLE.md), 대한민국 OSM
오프라인 기록 지도는 [docs/osm-offline-map.md](docs/osm-offline-map.md),
V-World 연결과 키 보안 원칙은 [docs/vworld-map.md](docs/vworld-map.md) 참고.
