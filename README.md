...
| 시네마틱 | **장면 이미지 33종**. 도시 도착 9곳 · 고유 사건 25연결 · 나머지 834개 이벤트도 발견/조우/위기/추적/이야기 공용 컷으로 전부 시각화 |
...
낡은 봉고차 **달구지**를 고치고 확장하면서 부산에서 서울 남산까지 411km를 이동한다. 날씨와 시간대가 바뀌는 도로, 생존자들과의 선택, 동료 관계, 천리안의 추적이 하나의 여정을 만든다. 무작위 사건이 많아도 본편이 묻히지 않도록 60·140·220·300km에서 세대 서사가 다음 도착 장면으로 보장된다.
