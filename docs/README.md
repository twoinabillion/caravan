...
| 에셋 | 초상·아이콘 + **16:9 시네마틱 58종**. 11장 그림책 인트로와 부모·서울 핵심 장면을 단일 HTML에 내장 |
...
| 시각화 | 세대 본편 4장면·부모 본편 2장면·11장 그림책·2026 유물·서울 오르막/결말은 전용 컷. 나머지 이벤트도 유형별 공용 장면을 사용해 이미지 없는 시트를 없앰 |
