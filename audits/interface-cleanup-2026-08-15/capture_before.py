#!/usr/bin/env python3
"""Capture current event and secondary interfaces before cleanup."""
...
with sync_playwright() as playwright:
    ...
    shot(page, "01-event-reading-before.png")
    page.evaluate("UI.finishStory()")
    shot(page, "02-event-choice-before.png")
    page.evaluate("document.querySelector('#ev-wrap').classList.remove('on')")

    page.click("#dk-menu")
    shot(page, "03-menu-before.png")

    page.click("#menu-crew")
    shot(page, "04-crew-before.png")
    page.click("#st-x")

    page.click("#dk-menu")
    page.click("#menu-settings")
    shot(page, "05-settings-before.png")
    page.click("#st-x")

    page.click("#dk-menu")
    page.click("#dk-journal")
    shot(page, "06-journal-before.png")
    page.click("#j-x")

    page.click("#dk-menu")
    page.click("#dk-camp")
    shot(page, "07-camp-before.png")
    ...
    (OUT / "before-metrics.json").write_text(
